                                     ...
                                     public nsIEditActionListener
{
 private:
  typedef enum {
    eIsDone =
        0,   // No iterator (I), or iterator doesn't point to anything valid.
 ...
 public:
  ...
  NS_DECL_CYCLE_COLLECTION_CLASS_AMBIGUOUS(nsTextServicesDocument,
 ...
 private:
  ...
  static nsresult FirstTextNode(nsIContentIterator* aIterator,
                                TSDIteratorStatus* IteratorStatus);
  ...
  nsresult SetSelectionInternal(int32_t aOffset,
                                int32_t aLength,
                                bool aDoUpdate);
