...
NS_IMPL_CYCLE_COLLECTION_INHERITED(CompositionTransaction,
                                   EditTransactionBase,
                                   mEditorBase,
                                   mTextNode)
...
CompositionTransaction::SetSelectionForRanges()
{
  ...
  return SetIMESelection(
      *mEditorBase, mTextNode, mOffset, mStringToInsert.Length(), mRanges);
}
                                        ...
                                        const TextRangeArray* aRanges)
{
  ...
  for (uint32_t i = 0; i < countOfRanges; ++i) {
    ...
    rv = nsRange::CreateRange(aTextNode,
                              startOffset,
                              aTextNode,
                              endOffset,
