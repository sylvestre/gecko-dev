...
struct StyleCache final : public PropItem
{
  ...
  StyleCache(nsAtom* aTag, const nsAString& aAttr, const nsAString& aValue)
      : PropItem(aTag, aAttr, aValue), mPresent(false)
  {
    MOZ_COUNT_CTOR(StyleCache);
  }

  StyleCache(nsAtom* aTag, const nsAString& aAttr)
...
class HTMLEditRules : public TextEditRules, public nsIEditActionListener
{
 public:
  ...
  NS_IMETHOD AfterEdit(EditAction action,
                       nsIEditor::EDirection aDirection) override;
  NS_IMETHOD WillDoAction(Selection* aSelection,
                          RulesInfo* aInfo,
                          bool* aCancel,
                          bool* aHandled) override;
  NS_IMETHOD DidDoAction(Selection* aSelection,
                         RulesInfo* aInfo,
 ...
 protected:
  ...
  nsresult WillInsertBreak(Selection& aSelection,
                           bool* aCancel,
                           bool* aHandled);
  nsresult StandardBreakImpl(nsINode& aNode,
                             int32_t aOffset,
                             Selection& aSelection);
   ...
   */
  EditActionResult MoveBlock(Element& aLeftBlock,
                             Element& aRightBlock,
                             int32_t aLeftOffset,
   ...
   *                                canceled is always false.
   */
  EditActionResult MoveNodeSmart(nsIContent& aNode,
   ...
   *                                canceled is always false.
   */
  EditActionResult MoveContents(Element& aElement,
                                Element& aDestElement,
                                int32_t* aInOutDestOffset);
  ...
  nsresult WillRemoveList(Selection* aSelection,
                          bool aOrdered,
                          bool* aCancel,
                          bool* aHandled);
  ...
  nsresult WillAlign(Selection& aSelection,
                     const nsAString& aAlignType,
                     bool* aCancel,
                     bool* aHandled);
  nsresult WillAbsolutePosition(Selection& aSelection,
                                bool* aCancel,
                                bool* aHandled);
  nsresult WillRemoveAbsolutePosition(Selection* aSelection,
                                      bool* aCancel,
                                      bool* aHandled);
  nsresult WillRelativeChangeZIndex(Selection* aSelection,
                                    int32_t aChange,
                                    bool* aCancel,
                                    bool* aHandled);
  ...
  nsresult DidMakeBasicBlock(Selection* aSelection,
                             RulesInfo* aInfo,
                             nsresult aResult);
  ...
  void GetInnerContent(nsINode& aNode,
                       ...
                       int32_t* aIndex,
                       Lists aLists = Lists::yes,
                       Tables aTables = Tables::yes);
  Element* IsInListItem(nsINode* aNode);
  nsAtom& DefaultParagraphSeparator();
  nsresult ReturnInHeader(Selection& aSelection,
                          Element& aHeader,
                          nsINode& aNode,
                          int32_t aOffset);
  nsresult ReturnInParagraph(Selection* aSelection,
                             nsINode* aHeader,
                             nsINode* aTextNode,
                             int32_t aOffset,
  ...
  nsresult SplitParagraph(nsIDOMNode* aPara,
                          ...
                          int32_t* aOffset);
  nsresult ReturnInListItem(Selection& aSelection,
                            Element& aHeader,
                            nsINode& aNode,
                            int32_t aOffset);
  nsresult AfterEditInner(EditAction action, nsIEditor::EDirection aDirection);
  nsresult RemovePartOfBlock(Element& aBlock,
  ...
  already_AddRefed<Element> ConvertListType(Element* aList,
                                            nsAtom* aListType,
                                            nsAtom* aItemType);

  nsresult CreateStyleForInsertText(Selection& aSelection, nsIDocument& aDoc);
  enum class MozBRCounts
  {
    yes,
    no
  };
  nsresult IsEmptyBlock(Element& aNode,
  ...
  nsresult CheckForEmptyBlock(nsINode* aStartNode,
                              ...
                              nsIEditor::EDirection aAction,
                              bool* aHandled);
  enum class BRLocation
  {
    beforeBlock,
    blockEnd
  };
  Element* CheckForInvisibleBR(Element& aBlock,
                               BRLocation aWhere,
                               int32_t aOffset = 0);
  ...
  EditorDOMPoint GetPromotedPoint(RulesEndpoint aWhere,
                                  nsINode& aNode,
                                  int32_t aOffset,
                                  EditAction actionID);
  ...
  nsresult SplitAsNeeded(nsAtom& aTag,
                         OwningNonNull<nsINode>& inOutParent,
                         int32_t& inOutOffset,
