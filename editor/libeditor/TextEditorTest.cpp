...
void
TextEditorTest::Run(nsIEditor* aEditor,
                    int32_t* outNumTests,
...
nsresult
TextEditorTest::RunUnitTest(int32_t* outNumTests, int32_t* outNumTestsFailed)
{
...
nsresult
TextEditorTest::TestInsertBreak()
{
...
nsresult
TextEditorTest::TestTextProperties()
{
