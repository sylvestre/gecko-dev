...
static bfd*
try_debug_file(const char* filename, unsigned long crc32)
{
...
static bfd*
find_debug_file(bfd* lib, const char* aFileName)
{
...
void
leaky::ReadSymbols(const char* aFileName, u_long aBaseAddress)
{
