...
glxtest()
{
  ...
  if (gtk3) {
    auto gtk_get_major_version =
        reinterpret_cast<guint (*)(void)>(dlsym(gtk3, "gtk_get_major_version"));
    auto gtk_get_minor_version =
        reinterpret_cast<guint (*)(void)>(dlsym(gtk3, "gtk_get_minor_version"));
    auto gtk_get_micro_version =
        reinterpret_cast<guint (*)(void)>(dlsym(gtk3, "gtk_get_micro_version"));
...
#define LIBGL_FILENAME "libGL.so.1"
  ...
  typedef GLXContext (*PFNGLXCREATECONTEXT)(
      Display*, XVisualInfo*, GLXContext, Bool);
  ...
  glXMakeCurrent(
      dpy, None, nullptr);  // must release the GL context before destroying it
