...
bool
CheckHook(HookTestFunc aHookTestFunc,
          void* aOrigFunc,
          const char* aDllName,
...
bool
TestHook(HookTestFunc funcTester, const char* dll, const char* func)
{
  void* orig_func;
...
bool
TestDetour(const char* dll, const char* func)
{
  void* orig_func;
  bool successful = false;
  {
...
bool
MaybeTestHook(const bool cond,
              HookTestFunc funcTester,
              const char* dll,
              const char* func)
{
  if (!cond) {
...
ShouldTestTipTsf()
{
  ...
  if (FAILED(pSHGetKnownFolderPath(
          FOLDERID_ProgramFilesCommon, 0, nullptr, &commonFilesPath))) {
    return true;
  }
...
bool
TestSetWindowLongPtr(void* aFunc)
{
...
bool
TestNtFlushBuffersFile(void* aFunc)
{
...
bool
TestNtReadFile(void* aFunc)
{
  typedef NTSTATUS(WINAPI * NtReadFileType)(HANDLE,
                                            HANDLE,
                                            PIO_APC_ROUTINE,
                                            PVOID,
                                            PIO_STATUS_BLOCK,
...
bool
TestNtReadFileScatter(void* aFunc)
{
  typedef NTSTATUS(WINAPI * NtReadFileScatterType)(HANDLE,
                                                   HANDLE,
                                                   PIO_APC_ROUTINE,
                                                   PVOID,
                                                   PIO_STATUS_BLOCK,
...
bool
TestNtWriteFile(void* aFunc)
{
  typedef NTSTATUS(WINAPI * NtWriteFileType)(HANDLE,
                                             HANDLE,
                                             PIO_APC_ROUTINE,
                                             PVOID,
                                             PIO_STATUS_BLOCK,
...
bool
TestNtWriteFileGather(void* aFunc)
{
  typedef NTSTATUS(WINAPI * NtWriteFileGatherType)(HANDLE,
                                                   HANDLE,
                                                   PIO_APC_ROUTINE,
                                                   PVOID,
                                                   PIO_STATUS_BLOCK,
...
bool
TestNtQueryFullAttributesFile(void* aFunc)
{
...
bool
TestLdrResolveDelayLoadedAPI(void* aFunc)
{
  // These pointers are disguised as PVOID to avoid pulling in obscure headers
  typedef PVOID(WINAPI * LdrResolveDelayLoadedAPIType)(
      PVOID, PVOID, PVOID, PVOID, PVOID, ULONG);
...
#ifdef _M_AMD64
bool
TestRtlInstallFunctionTableCallback(void* aFunc)
{
...
bool
TestSetUnhandledExceptionFilter(void* aFunc)
{
...
bool
TestCreateDIBSection(void* aFunc)
{
...
bool
TestQueryDosDeviceW(void* aFunc)
{
...
bool
TestInSendMessageEx(void* aFunc)
{
...
bool
TestImmGetCompositionStringW(void* aFunc)
{
...
bool
TestImmSetCandidateWindow(void* aFunc)
{
...
bool
TestGetSaveFileNameW(void* aFunc)
{
...
bool
TestGetOpenFileNameW(void* aFunc)
{
...
bool
TestSendMessageTimeoutW(void* aFunc)
{
...
bool
TestProcessCaretEvents(void* aFunc)
{
...
main()
{
  ...
  if (TestHook(TestGetWindowInfo, "user32.dll", "GetWindowInfo") &&
      ...
      TestHook(TestNtQueryFullAttributesFile,
               "ntdll.dll",
               "NtQueryFullAttributesFile") &&
      // Bug 733892: toolkit/crashreporter/nsExceptionHandler.cpp
      TestHook(TestSetUnhandledExceptionFilter,
               "kernel32.dll",
      ...
      TestHook(
          TestCreateFileW, "kernel32.dll", "CreateFileW") &&  // see Bug 1316415
#endif
      ...
      TestHook(TestImmGetCompositionStringW,
               "imm32.dll",
               "ImmGetCompositionStringW") &&
      TestHook(
          TestImmSetCandidateWindow, "imm32.dll", "ImmSetCandidateWindow") &&
...
#ifdef _M_X64
      TestHook(
          TestGetKeyState, "user32.dll", "GetKeyState") &&  // see Bug 1316415
      TestHook(TestLdrUnloadDll, "ntdll.dll", "LdrUnloadDll") &&
      MaybeTestHook(IsWin8OrLater(),
...
#endif
      MaybeTestHook(ShouldTestTipTsf(),
