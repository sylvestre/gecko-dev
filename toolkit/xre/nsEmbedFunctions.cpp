...
nsresult
XRE_LockProfileDirectory(nsIFile* aDirectory, nsISupports** aLockObject)
{
                   ...
                   nsIDirectoryServiceProvider* aAppDirProvider)
{
  ...
  rv = gDirServiceProvider->Initialize(
      aAppDirectory, aLibXULDirectory, aAppDirProvider);
...
bool
XRE_TakeMinidumpForChild(uint32_t aChildPid,
                         nsIFile** aDump,
                         uint32_t* aSequence)
{
...
nsresult
XRE_InitChildProcess(int aArgc, char* aArgv[], const XREChildData* aChildData)
{
...
#ifdef XP_MACOSX
  mozilla::ipc::SharedMemoryBasic::SetupMachMemory(parentPID,
                                                   ports_in_receiver,
                                                   ports_in_sender,
                                                   ports_out_sender,
                                                   ports_out_receiver,
...
bool
XRE_SendTestShellCommand(JSContext* aCx, JSString* aCommand, void* aCallback)
{
