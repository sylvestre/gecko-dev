...
DummyEntryPoint(HINSTANCE instance, DWORD reason, void* reserved)
{
  __debugbreak();
...
extern "C" BOOL WINAPI
_CRT_INIT(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpReserved);
...
extern "C" __declspec(dllexport) DWORD Start(void* context)
{
  ...
  ExceptionHandler* e =
      new (std::nothrow) ExceptionHandler(wstring(),
                                          nullptr,
                                          nullptr,
                                          nullptr,
