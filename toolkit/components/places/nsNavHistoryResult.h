...
#define NS_DECL_BOOKMARK_HISTORY_OBSERVER_INTERNAL \
  ...
  NS_IMETHOD OnVisit(nsIURI* aURI,                 \
                     int64_t aVisitId,             \
                     PRTime aTime,                 \
                     int64_t aSessionId,           \
...
#define NS_DECL_BOOKMARK_HISTORY_OBSERVER_EXTERNAL(...) \
  ...
  NS_IMETHOD OnVisit(nsIURI* aURI,                      \
                     ...
                     uint32_t aTyped,                   \
                     const nsAString& aLastKnownTitle) __VA_ARGS__;
...
{
 public:
  nsNavHistoryResultNode(const nsACString& aURI,
                                        ...
                                        public nsINavHistoryContainerResultNode
{
 ...
 public:
  ...
  uint32_t FindInsertionPoint(nsNavHistoryResultNode* aNode,
                              ...
                              const char* aData,
                              bool* aItemExists);
  bool DoesChildNeedResorting(uint32_t aIndex,
                              SortComparator aComparator,
                              const char* aData);
  ...
  bool UpdateURIs(bool aRecursive,
                  bool aOnlyOne,
                  bool aUpdateSort,
                  const nsCString& aSpec,
                  ...
                  const void* aClosure);
  nsresult ChangeTitles(nsIURI* aURI,
