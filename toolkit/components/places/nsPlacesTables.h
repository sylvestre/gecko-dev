...
#define CREATE_MOZ_BOOKMARKS                                                                                               \
  NS_LITERAL_CSTRING(                                                                                                      \
      ...
      ", guid TEXT" /* The sync status is determined from the change source. We set this to
    ...
    */                                \
      ", syncStatus INTEGER NOT NULL DEFAULT 0" /* This field is incremented for every bookmark change that should trigger
...
#define CREATE_UPDATEHOSTS_TEMP                  \
  NS_LITERAL_CSTRING(                            \
