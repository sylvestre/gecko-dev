                                     ...
                                     nsresult aStatus)
{
  ...
  if (aStateFlags & STATE_START) {
    ...
    if (aStateFlags & STATE_IS_REQUEST) {
      ...
      if (!mUseRealProgressFlag && mTotalRequests)
        OnProgressChange(
            nullptr, nullptr, 0, 0, mFinishedRequests, mTotalRequests);
    }
  ...
  if ((aStateFlags & nsIWebProgressListener::STATE_IS_NETWORK ||
    ...
    return mListener->OnStateChange(
                                        ...
                                        int32_t aMaxTotalProgress)
{
  ...
  if (!mUseRealProgressFlag && aRequest) return NS_OK;
                                          ...
                                          int64_t aMaxTotalProgress)
{
  ...
  return OnProgressChange(aWebProgress,
                          aRequest,
                          (int32_t)aCurSelfProgress,
                          (int32_t)aMaxSelfProgress,
                          (int32_t)aCurTotalProgress,
                                          ...
                                          bool* allowRefresh)
{
  ...
  return listener->OnRefreshAttempted(
      aWebProgress, aUri, aDelay, aSameUri, allowRefresh);
}
...
nsBrowserStatusFilter::MaybeSendProgress()
{
  ...
  if (percentage > (mCurrentPercentage + 3)) {
    ...
    mListener->OnProgressChange(
        nullptr, nullptr, 0, 0, (int32_t)mCurProgress, (int32_t)mMaxProgress);
  }
}
