...
void
CheckUintScalar(const char* aName,
                JSContext* aCx,
...
void
CheckBoolScalar(const char* aName,
                JSContext* aCx,
                JS::HandleValue aSnapshot,
                bool expectedValue)
{
...
void
CheckStringScalar(const char* aName,
                  JSContext* aCx,
                  JS::HandleValue aSnapshot,
...
void
CheckKeyedUintScalar(const char* aName,
                     const char* aKey,
                     JSContext* aCx,
                     JS::HandleValue aSnapshot,
                     uint32_t expectedValue)
...
void
CheckKeyedBoolScalar(const char* aName,
                     const char* aKey,
                     JSContext* aCx,
                     JS::HandleValue aSnapshot,
                     bool expectedValue)
...
void
CheckNumberOfProperties(const char* aName,
                        JSContext* aCx,
                        JS::HandleValue aSnapshot,
...
void
GetScalarsSnapshot(bool aKeyed,
                   JSContext* aCx,
...
TEST_F(TelemetryTestFixture, ScalarUnsigned)
{
  ...
  CheckUintScalar("telemetry.test.unsigned_int_kind",
                  cx.GetJSContext(),
                  scalarsSnapshot,
                  kExpectedUint);
...
// Don't run this part in debug builds as that intentionally asserts.
  ...
  GetScalarsSnapshot(false, cx.GetJSContext(), &scalarsSnapshot);
  CheckBoolScalar(
      "telemetry.test.boolean_kind", cx.GetJSContext(), scalarsSnapshot, true);
}
...
// Don't run this part in debug builds as that intentionally asserts.
  ...
  JS::RootedValue scalarsSnapshot(cx.GetJSContext());
  GetScalarsSnapshot(false, cx.GetJSContext(), &scalarsSnapshot);
  CheckStringScalar("telemetry.test.string_kind",
                    cx.GetJSContext(),
                    scalarsSnapshot,
                    EXPECTED_STRING);
}
...
TEST_F(TelemetryTestFixture, KeyedScalarUnsigned)
{
  ...
  Telemetry::ScalarSet(Telemetry::ScalarID::TELEMETRY_TEST_KEYED_UNSIGNED_INT,
                       NS_LITERAL_STRING("key1"),
                       kKey1Value);
  Telemetry::ScalarSet(Telemetry::ScalarID::TELEMETRY_TEST_KEYED_UNSIGNED_INT,
                       NS_LITERAL_STRING("key2"),
                       kKey1Value);
...
// Don't run this part in debug builds as that intentionally asserts.
  ...
  CheckKeyedUintScalar(
      kScalarName, "key1", cx.GetJSContext(), scalarsSnapshot, kKey1Value);
  CheckKeyedUintScalar(
      kScalarName, "key2", cx.GetJSContext(), scalarsSnapshot, kKey2Value);
  ...
  CheckKeyedUintScalar(kScalarName,
                       "key1",
                       cx.GetJSContext(),
                       scalarsSnapshot,
                       kExpectedUintMaximum);
...
// Don't run this part in debug builds as that intentionally asserts.
  ...
  CheckKeyedBoolScalar(
      kScalarName, "key1", cx.GetJSContext(), scalarsSnapshot, false);
  CheckKeyedBoolScalar(
      kScalarName, "key2", cx.GetJSContext(), scalarsSnapshot, true);
  CheckNumberOfProperties(kScalarName, cx.GetJSContext(), scalarsSnapshot, 2);
}
...
// Don't run this part in debug builds as that intentionally asserts.
  ...
  for (auto id : kTestFakeIds) {
    ...
    Telemetry::ScalarSet(
        scalarId, NS_LITERAL_STRING("key1"), static_cast<uint32_t>(1));
