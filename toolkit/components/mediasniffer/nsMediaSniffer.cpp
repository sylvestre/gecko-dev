...
nsMediaSnifferEntry sFtypEntries[] = {
    ...
    PATTERN_ENTRY(
        "\xFF\xFF\xFF", "avc", VIDEO_MP4),  // Could be avc1, avc2, ...
    PATTERN_ENTRY(
        "\xFF\xFF\xFF", "3gp", VIDEO_3GPP),  // Could be 3gp4, 3gp5, ...
...
static bool
MatchesMP4(const uint8_t* aData,
...
static bool
MatchesADTS(const uint8_t* aData, const uint32_t aLength)
{
