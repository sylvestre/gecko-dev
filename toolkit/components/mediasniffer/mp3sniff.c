...
static void
mp3_parse(const uint8_t* p, mp3_header* header)
{
  const int bitrates[2][16] = {/* MPEG version 1 layer 3 bitrates. */
                               {0,
                                32000,
                                40000,
                                48000,
...
static int
mp3_framesize(mp3_header* header)
{
  int size;
  int scale;
...
static int
is_mp3(const uint8_t* p, long length)
{
...
static int
is_id3(const uint8_t* p, long length)
{
...
static int
id3_framesize(const uint8_t* p, long length)
{
  int size;
...
int
mp3_sniff(const uint8_t* buf, long length)
{
  mp3_header header;
  const uint8_t* p;
  long skip;
