...
MockWebBrowserPrint::MockWebBrowserPrint(const PrintData& aData) : mData(aData)
{
}
...
NS_IMETHODIMP
MockWebBrowserPrint::GetCurrentChildDOMWindow(
    mozIDOMWindowProxy** aCurrentPrintSettings)
{
  return NS_ERROR_NOT_IMPLEMENTED;
}
