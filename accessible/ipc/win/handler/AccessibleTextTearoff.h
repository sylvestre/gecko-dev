...
class AccessibleTextTearoff final : public IAccessibleHypertext
{
 public:
  ...
  STDMETHODIMP get_selection(long selectionIndex,
                             long* startOffset,
  ...
  STDMETHODIMP setSelection(long selectionIndex,
                            long startOffset,
                            long endOffset) override;
  STDMETHODIMP get_nCharacters(long* nCharacters) override;
  STDMETHODIMP scrollSubstringTo(long startIndex,
                                 long endIndex,
                                 enum IA2ScrollType scrollType) override;
  STDMETHODIMP scrollSubstringToPoint(long startIndex,
                                      long endIndex,
