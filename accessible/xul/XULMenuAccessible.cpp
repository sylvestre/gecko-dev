...
{
  mContent->GetAttr(kNameSpaceID_None, nsGkAtoms::description, aDescription);
}
...
XULMenuitemAccessible::NativeRole()
{
  ...
  if (mContent->AttrValueIs(
          kNameSpaceID_None, nsGkAtoms::type, nsGkAtoms::radio, eCaseMatters))
