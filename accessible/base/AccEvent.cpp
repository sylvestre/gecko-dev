...
AccEvent::AccEvent(uint32_t aEventType,
...
AccTextChangeEvent::AccTextChangeEvent(Accessible* aAccessible,
                                       int32_t aStart,
...
AccTextSelChangeEvent::AccTextSelChangeEvent(HyperTextAccessible* aTarget,
                                             ...
                                             int32_t aReason)
    : AccEvent(nsIAccessibleEvent::EVENT_TEXT_SELECTION_CHANGED,
               aTarget,
               eAutoDetect,
...
AccSelChangeEvent::AccSelChangeEvent(Accessible* aWidget,
                                     Accessible* aItem,
...
AccVCChangeEvent::AccVCChangeEvent(Accessible* aAccessible,
                                   ...
                                   int16_t aReason,
                                   EIsFromUserInput aIsFromUserInput)
    : AccEvent(::nsIAccessibleEvent::EVENT_VIRTUALCURSOR_CHANGED,
               aAccessible,
               aIsFromUserInput),
...
a11y::MakeXPCEvent(AccEvent* aEvent)
{
  ...
  if (eventGroup & (1 << AccEvent::eStateChangeEvent)) {
    ...
    xpEvent = new xpcAccStateChangeEvent(type,
                                         ToXPC(acc),
                                         ToXPCDocument(doc),
                                         domNode,
                                         fromUser,
  ...
  if (eventGroup & (1 << AccEvent::eTextChangeEvent)) {
    ...
    xpEvent = new xpcAccTextChangeEvent(type,
                                        ToXPC(acc),
                                        ToXPCDocument(doc),
                                        domNode,
                                        fromUser,
  ...
  if (eventGroup & (1 << AccEvent::eHideEvent)) {
    ...
    xpEvent = new xpcAccHideEvent(type,
                                  ToXPC(acc),
                                  ToXPCDocument(doc),
                                  domNode,
                                  fromUser,
  ...
  if (eventGroup & (1 << AccEvent::eCaretMoveEvent)) {
    ...
    xpEvent = new xpcAccCaretMoveEvent(type,
                                       ToXPC(acc),
                                       ToXPCDocument(doc),
                                       domNode,
                                       fromUser,
