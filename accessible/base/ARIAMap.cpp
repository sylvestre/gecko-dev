...
static const nsRoleMapEntry sLandmarkRoleMap = {&nsGkAtoms::_empty,
                                                roles::NOTHING,
                                                kUseNativeRole,
                                                eNoValue,
                                                eNoAction,
...
nsRoleMapEntry aria::gEmptyRoleMap = {&nsGkAtoms::_empty,
                                      roles::NOTHING,
                                      kUseMapRole,
                                      eNoValue,
                                      eNoAction,
...
static const AttrCharacteristics gWAIUnivAttrMap[] = {
    ...
    {&nsGkAtoms::aria_atomic,
     ATTR_BYPASSOBJ_IF_FALSE | ATTR_VALTOKEN | ATTR_GLOBAL},
    {&nsGkAtoms::aria_busy, ATTR_VALTOKEN | ATTR_GLOBAL},
    {&nsGkAtoms::aria_checked,
     ATTR_BYPASSOBJ | ATTR_VALTOKEN}, /* exposes checkable obj attr */
    ...
    {&nsGkAtoms::aria_hidden,
     ATTR_BYPASSOBJ | ATTR_VALTOKEN | ATTR_GLOBAL}, /* handled special way */
...
aria::GetRoleMapIndex(dom::Element* aEl)
{
  ...
  while (tokenizer.hasMoreTokens()) {
    ...
    size_t idx;
    if (BinarySearchIf(sWAIRoleMaps,
                       0,
    ...
    if (attr->NamespaceEquals(kNameSpaceID_None)) {
      ...
      if ((attrFlags & ATTR_BYPASSOBJ_IF_FALSE) &&
          mContent->AttrValueIs(
              kNameSpaceID_None, attrAtom, nsGkAtoms::_false, eCaseMatters)) {
