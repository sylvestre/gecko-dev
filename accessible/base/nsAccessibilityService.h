                                     ...
                                     public nsIObserver
{
 ...
 public:
  ...
  void GetStringStates(uint32_t aState,
   ...
   * switched.
   */
  void DeckPanelSwitched(nsIPresShell* aPresShell,
   ...
   */
  void TreeViewChanged(nsIPresShell* aPresShell,
                       nsIContent* aContent,
                       nsITreeView* aView);
   ...
   */
  void UpdateLabelValue(nsIPresShell* aPresShell,
   ...
   */
  Accessible* CreateAccessible(nsINode* aNode,
                               Accessible* aContext,
 ...
 private:
   ...
   */
  already_AddRefed<Accessible> CreateAccessibleByType(nsIContent* aContent,
                                                      DocAccessible* aDoc);
   ...
   */
  already_AddRefed<Accessible> CreateAccessibleForXULTree(nsIContent* aContent,
                                                          DocAccessible* aDoc);
#endif
