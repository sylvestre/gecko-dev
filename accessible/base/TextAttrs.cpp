                            ...
                            uint32_t* aEndOffset)
{
  ...
  TextAttr* attrArray[] = {&langTextAttr,
                           &invalidTextAttr,
                           &bgColorTextAttr,
                           &colorTextAttr,
                           &fontFamilyTextAttr,
...
void
TextAttrsMgr::GetRange(TextAttr* aAttrArray[],
...
bool
TextAttrsMgr::LangTextAttr::GetValueFor(Accessible* aAccessible,
                                        nsString* aValue)
{
...
bool
TextAttrsMgr::InvalidTextAttr::GetValueFor(Accessible* aAccessible,
                                           uint32_t* aValue)
{
...
void
TextAttrsMgr::InvalidTextAttr::ExposeValue(nsIPersistentProperties* aAttributes,
                                           const uint32_t& aValue)
{
  switch (aValue) {
    case eFalse:
      nsAccUtils::SetAccAttr(
          aAttributes, nsGkAtoms::invalid, NS_LITERAL_STRING("false"));
      break;

    case eGrammar:
      nsAccUtils::SetAccAttr(
          aAttributes, nsGkAtoms::invalid, NS_LITERAL_STRING("grammar"));
      break;
    ...
    case eTrue:
      nsAccUtils::SetAccAttr(
          aAttributes, nsGkAtoms::invalid, NS_LITERAL_STRING("true"));
      break;
  }
}

bool
TextAttrsMgr::InvalidTextAttr::GetValue(nsIContent* aElm, uint32_t* aValue)
{
  nsIContent* elm = aElm;
  do {
    if (nsAccUtils::HasDefinedARIAToken(elm, nsGkAtoms::aria_invalid)) {
      static nsIContent::AttrValuesArray tokens[] = {&nsGkAtoms::_false,
                                                     &nsGkAtoms::grammar,
                                                     &nsGkAtoms::spelling,
                                                     nullptr};

      int32_t idx = elm->FindAttrValueIn(
...
bool
TextAttrsMgr::BGColorTextAttr::GetValueFor(Accessible* aAccessible,
                                           nscolor* aValue)
{
  nsIContent* elm = nsCoreUtils::GetDOMElementFor(aAccessible->GetContent());
  if (elm) {
                                           ...
                                           const nscolor& aValue)
{
  ...
  nsAccUtils::SetAccAttr(
      aAttributes, nsGkAtoms::backgroundColor, formattedValue);
}

bool
TextAttrsMgr::BGColorTextAttr::GetColor(nsIFrame* aFrame, nscolor* aColor)
{
...
bool
TextAttrsMgr::ColorTextAttr::GetValueFor(Accessible* aAccessible,
                                         nscolor* aValue)
{
  nsIContent* elm = nsCoreUtils::GetDOMElementFor(aAccessible->GetContent());
  if (elm) {
...
bool
TextAttrsMgr::FontFamilyTextAttr::GetValueFor(Accessible* aAccessible,
                                              nsString* aValue)
{
  nsIContent* elm = nsCoreUtils::GetDOMElementFor(aAccessible->GetContent());
  if (elm) {
...
bool
TextAttrsMgr::FontFamilyTextAttr::GetFontFamily(nsIFrame* aFrame,
                                                nsString& aFamily)
{
...
bool
TextAttrsMgr::FontSizeTextAttr::GetValueFor(Accessible* aAccessible,
                                            nscoord* aValue)
{
...
bool
TextAttrsMgr::FontStyleTextAttr::GetValueFor(Accessible* aAccessible,
                                             nscoord* aValue)
{
  nsIContent* elm = nsCoreUtils::GetDOMElementFor(aAccessible->GetContent());
  if (elm) {
...
void
TextAttrsMgr::FontStyleTextAttr::ExposeValue(
    nsIPersistentProperties* aAttributes, const nscoord& aValue)
{
  nsAutoString formattedValue;
...
bool
TextAttrsMgr::FontWeightTextAttr::GetValueFor(Accessible* aAccessible,
                                              int32_t* aValue)
{
  nsIContent* elm = nsCoreUtils::GetDOMElementFor(aAccessible->GetContent());
  if (elm) {
...
void
TextAttrsMgr::FontWeightTextAttr::ExposeValue(
...
int32_t
TextAttrsMgr::FontWeightTextAttr::GetFontWeight(nsIFrame* aFrame)
{
...
bool
TextAttrsMgr::AutoGeneratedTextAttr::GetValueFor(Accessible* aAccessible,
                                                 bool* aValue)
{
...
void
TextAttrsMgr::AutoGeneratedTextAttr::ExposeValue(
...
bool
TextAttrsMgr::TextDecorTextAttr::GetValueFor(Accessible* aAccessible,
...
void
TextAttrsMgr::TextDecorTextAttr::ExposeValue(
    nsIPersistentProperties* aAttributes, const TextDecorValue& aValue)
{
  if (aValue.IsUnderline()) {
    ...
    nsAccUtils::SetAccAttr(
        aAttributes, nsGkAtoms::textUnderlineStyle, formattedStyle);

    nsAutoString formattedColor;
    StyleInfo::FormatColor(aValue.Color(), formattedColor);
    nsAccUtils::SetAccAttr(
        aAttributes, nsGkAtoms::textUnderlineColor, formattedColor);
    return;
  }
  ...
  if (aValue.IsLineThrough()) {
    ...
    StyleInfo::FormatTextDecorationStyle(aValue.Style(), formattedStyle);
    nsAccUtils::SetAccAttr(
        aAttributes, nsGkAtoms::textLineThroughStyle, formattedStyle);

    nsAutoString formattedColor;
    StyleInfo::FormatColor(aValue.Color(), formattedColor);
    nsAccUtils::SetAccAttr(
        aAttributes, nsGkAtoms::textLineThroughColor, formattedColor);
  }
}
...
bool
TextAttrsMgr::TextPosTextAttr::GetValueFor(Accessible* aAccessible,
                                           TextPosValue* aValue)
{
  nsIContent* elm = nsCoreUtils::GetDOMElementFor(aAccessible->GetContent());
  if (elm) {
...
void
TextAttrsMgr::TextPosTextAttr::ExposeValue(nsIPersistentProperties* aAttributes,
                                           const TextPosValue& aValue)
{
  switch (aValue) {
    case eTextPosBaseline:
      nsAccUtils::SetAccAttr(
          aAttributes, nsGkAtoms::textPosition, NS_LITERAL_STRING("baseline"));
      break;

    case eTextPosSub:
      nsAccUtils::SetAccAttr(
          aAttributes, nsGkAtoms::textPosition, NS_LITERAL_STRING("sub"));
      break;

    case eTextPosSuper:
      nsAccUtils::SetAccAttr(
          aAttributes, nsGkAtoms::textPosition, NS_LITERAL_STRING("super"));
      break;
...
TextAttrsMgr::TextPosTextAttr::GetTextPosValue(nsIFrame* aFrame) const
{
