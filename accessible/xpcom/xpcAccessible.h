...
class xpcAccessible : public nsIAccessible
{
 public:
  ...
  NS_IMETHOD GetPreviousSibling(
      nsIAccessible** aPreviousSibling) final override;
  ...
  NS_IMETHOD GetChildAt(int32_t aChildIndex,
                        nsIAccessible** aChild) final override;
  ...
  NS_IMETHOD GetRootDocument(
      nsIAccessibleDocument** aRootDocument) final override;

  NS_IMETHOD GetRole(uint32_t* aRole) final override;
  NS_IMETHOD GetState(uint32_t* aState, uint32_t* aExtraState) final override;
  ...
  NS_IMETHOD GetAttributes(
      nsIPersistentProperties** aAttributes) final override;
  NS_IMETHOD GetBounds(int32_t* aX,
                       int32_t* aY,
                       int32_t* aWidth,
                       int32_t* aHeight) final override;
  NS_IMETHOD GroupPosition(int32_t* aGroupLevel,
                           int32_t* aSimilarItemsInGroup,
                           int32_t* aPositionInGroup) final override;
  NS_IMETHOD GetRelationByType(
      uint32_t aType, nsIAccessibleRelation** aRelation) final override;
  NS_IMETHOD GetRelations(nsIArray** aRelations) final override;

  NS_IMETHOD GetFocusedChild(nsIAccessible** aChild) final override;
  NS_IMETHOD GetChildAtPoint(int32_t aX,
                             int32_t aY,
                             nsIAccessible** aAccessible) final override;
  NS_IMETHOD GetDeepestChildAtPoint(int32_t aX,
                                    int32_t aY,
                                    nsIAccessible** aAccessible) final override;
