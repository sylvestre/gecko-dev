...
class ia2AccessibleText : public IAccessibleText
{
 public:
  ...
  static void UpdateTextChangeData(HyperTextAccessibleWrap* aAcc,
                                   bool aInsert,
                                   const nsString& aStr,
                                   int32_t aStart,
                                   uint32_t aLen);
...
#define FORWARD_IACCESSIBLETEXT(Class)                                       \
  ...
  virtual HRESULT STDMETHODCALLTYPE get_characterExtents(                    \
      ...
      long* height)                                                          \
  {                                                                          \
    return Class::get_characterExtents(                                      \
  ...
  virtual HRESULT STDMETHODCALLTYPE get_textBeforeOffset(                    \
      ...
      BSTR* text)                                                            \
  {                                                                          \
    return Class::get_textBeforeOffset(                                      \
  ...
  virtual HRESULT STDMETHODCALLTYPE get_textAfterOffset(                     \
      ...
      BSTR* text)                                                            \
  {                                                                          \
    return Class::get_textAfterOffset(                                       \
        offset, boundaryType, startOffset, endOffset, text);                 \
  }                                                                          \
                                                                             \
  ...
  virtual HRESULT STDMETHODCALLTYPE scrollSubstringToPoint(                  \
      ...
      long y)                                                                \
  {                                                                          \
    return Class::scrollSubstringToPoint(                                    \
