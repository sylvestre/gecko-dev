                                              ...
                                              int __RPC_FAR* aHeight)
{
  ...
  HRESULT rv = get_unclippedSubstringBounds(
      aStartIndex, aEndIndex, &x, &y, &width, &height);
                                      ...
                                      nsPoint& aOutPoint)
{
  ...
  int32_t outOffset;
  aContainingFrame->GetChildFrameContainingOffset(
      aOffset, aPreferNext, &outOffset, &textFrame);
