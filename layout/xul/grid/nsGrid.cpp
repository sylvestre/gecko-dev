 ...
 */
void
nsGrid::CountRowsColumns(nsIFrame* aRowBox,
                         int32_t& aRowCount,
 ...
 */
void
nsGrid::PopulateCellMap(nsGridRow* aRows,
                        nsGridRow* aColumns,
                        int32_t aRowCount,
 ...
 */
nsSize
nsGrid::GetPrefRowSize(nsBoxLayoutState& aState,
                       int32_t aRowIndex,
                       bool aIsHorizontal)
{
  nsSize size(0, 0);
...
nsSize
nsGrid::GetMinRowSize(nsBoxLayoutState& aState,
                      int32_t aRowIndex,
                      bool aIsHorizontal)
{
  nsSize size(0, 0);
...
nsSize
nsGrid::GetMaxRowSize(nsBoxLayoutState& aState,
                      int32_t aRowIndex,
                      bool aIsHorizontal)
{
 ...
 */
void
nsGrid::GetRowOffsets(int32_t aIndex,
                      nscoord& aTop,
                      nscoord& aBottom,
                      bool aIsHorizontal)
{
 ...
 */
nscoord
nsGrid::GetPrefRowHeight(nsBoxLayoutState& aState,
                         int32_t aIndex,
                         bool aIsHorizontal)
{
  RebuildIfNeeded();
...
nscoord
nsGrid::GetMinRowHeight(nsBoxLayoutState& aState,
                        int32_t aIndex,
                        bool aIsHorizontal)
{
  RebuildIfNeeded();
...
nscoord
nsGrid::GetMaxRowHeight(nsBoxLayoutState& aState,
                        int32_t aIndex,
                        bool aIsHorizontal)
{
  RebuildIfNeeded();
 ...
 */
void
nsGrid::CellAddedOrRemoved(nsBoxLayoutState& aState,
                           int32_t aIndex,
                           bool aIsHorizontal)
{
 ...
 */
void
nsGrid::RowAddedOrRemoved(nsBoxLayoutState& aState,
                          int32_t aIndex,
                          bool aIsHorizontal)
{
