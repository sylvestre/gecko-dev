...
static nsIContent*
FindBodyElement(nsIContent* aParent)
{
...
{
  if (!CanTrustView(aView)) return NS_ERROR_DOM_SECURITY_ERR;
...
void
TreeBoxObject::SetView(nsITreeView* aView, ErrorResult& aRv)
{
  aRv = SetView(aView);
}

bool
TreeBoxObject::Focused()
{
  nsTreeBodyFrame* body = GetTreeBodyFrame();
...
NS_IMETHODIMP
TreeBoxObject::GetFocused(bool* aFocused)
{
  *aFocused = Focused();
  return NS_OK;
}
...
NS_IMETHODIMP
TreeBoxObject::SetFocused(bool aFocused)
{
  nsTreeBodyFrame* body = GetTreeBodyFrame();
...
NS_IMETHODIMP
TreeBoxObject::GetTreeBody(nsIDOMElement** aElement)
{
  *aElement = nullptr;
  nsTreeBodyFrame* body = GetTreeBodyFrame();
...
NS_IMETHODIMP
TreeBoxObject::GetColumns(nsITreeColumns** aColumns)
{
...
NS_IMETHODIMP
TreeBoxObject::GetRowHeight(int32_t* aRowHeight)
{
...
NS_IMETHODIMP
TreeBoxObject::GetRowWidth(int32_t* aRowWidth)
{
  *aRowWidth = RowWidth();
  return NS_OK;
}
...
int32_t
TreeBoxObject::GetFirstVisibleRow()
{
  nsTreeBodyFrame* body = GetTreeBodyFrame();
...
NS_IMETHODIMP
TreeBoxObject::GetFirstVisibleRow(int32_t* aFirstVisibleRow)
{
...
int32_t
TreeBoxObject::GetLastVisibleRow()
{
  nsTreeBodyFrame* body = GetTreeBodyFrame();
...
NS_IMETHODIMP
TreeBoxObject::GetLastVisibleRow(int32_t* aLastVisibleRow)
{
...
int32_t
TreeBoxObject::HorizontalPosition()
{
  nsTreeBodyFrame* body = GetTreeBodyFrame();
...
NS_IMETHODIMP
TreeBoxObject::GetHorizontalPosition(int32_t* aHorizontalPosition)
{
...
NS_IMETHODIMP
TreeBoxObject::GetPageLength(int32_t* aPageLength)
{
...
NS_IMETHODIMP
TreeBoxObject::GetSelectionRegion(nsIScriptableRegion** aRegion)
{
  *aRegion = nullptr;
  nsTreeBodyFrame* body = GetTreeBodyFrame();
...
NS_IMETHODIMP
TreeBoxObject::InvalidateColumnRange(int32_t aStart,
                                     int32_t aEnd,
                                     nsITreeColumn* aCol)
{
  nsTreeBodyFrame* body = GetTreeBodyFrame();
...
NS_IMETHODIMP
TreeBoxObject::GetCellAt(int32_t aX,
                         int32_t aY,
                         int32_t* aRow,
                         nsITreeColumn** aCol,
                         nsAString& aChildElt)
...
void
TreeBoxObject::GetCellAt(int32_t x,
                         int32_t y,
                         TreeCellInfo& aRetVal,
                         ErrorResult& aRv)
{
...
NS_IMETHODIMP
TreeBoxObject::GetCoordsForCellItem(int32_t aRow,
                                    nsITreeColumn* aCol,
                                    ...
                                    int32_t* aHeight)
{
  *aX = *aY = *aWidth = *aHeight = 0;
  ...
  if (body)
    return body->GetCoordsForCellItem(
        aRow, aCol, element, aX, aY, aWidth, aHeight);
  return NS_OK;
}

already_AddRefed<DOMRect>
TreeBoxObject::GetCoordsForCellItem(int32_t row,
                                    nsTreeColumn& col,
...
NS_IMETHODIMP
TreeBoxObject::IsCellCropped(int32_t aRow,
                             nsITreeColumn* aCol,
                             bool* aIsCropped)
{
  *aIsCropped = false;
...
void
TreeBoxObject::RemoveImageCacheEntry(int32_t row,
                                     nsITreeColumn& col,
                                     ErrorResult& aRv)
{
