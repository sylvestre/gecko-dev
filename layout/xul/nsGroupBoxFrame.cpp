...
void
nsDisplayXULGroupBorder::Paint(nsDisplayListBuilder* aBuilder, gfxContext* aCtx)
{
  DrawResult result = static_cast<nsGroupBoxFrame*>(mFrame)->PaintBorder(
      *aCtx, ToReferenceFrame(), mVisibleRect);
                                  ...
                                  const nsDisplayListSet& aLists)
{
  ...
  if (IsVisibleForPainting(aBuilder)) {
    ...
    aLists.BorderBackground()->AppendNewToTop(
        new (aBuilder) nsDisplayXULGroupBorder(aBuilder, this));
...
nsRect
nsGroupBoxFrame::GetBackgroundRectRelativeToSelf(nscoord* aOutYOffset,
