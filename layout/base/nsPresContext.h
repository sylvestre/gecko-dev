                      ...
                      public mozilla::SupportsWeakPtr<nsPresContext>
{
 public:
  ...
  nsFrameManager* FrameManager() { return PresShell()->FrameManager(); }
  ...
  void MediaFeatureValuesChangedAllDocuments(
      nsRestyleHint aRestyleHint, nsChangeHint aChangeHint = nsChangeHint(0));
 ...
 public:
  ...
  {
    if (aMinFontSize == mBaseMinFontSize) return;
  ...
  */
  ...
  bool IsGlyph() const { return mIsGlyph; }

  void SetIsGlyph(bool aValue) { mIsGlyph = aValue; }
 ...
 protected:
  ...
  void SetSMILAnimations(nsIDocument* aDoc,
                         uint16_t aNewMode,
                         uint16_t aOldMode);
