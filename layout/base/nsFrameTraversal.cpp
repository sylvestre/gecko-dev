...
class nsFrameIterator : public nsIFrameEnumerator
{
 public:
  ...
  nsFrameIterator(nsPresContext* aPresContext,
                  nsIFrame* aStart,
...
{
 public:
  nsVisualIterator(nsPresContext* aPresContext,
                   nsIFrame* aStart,
                   nsIteratorType aType,
                   bool aLockScroll,
                   bool aFollowOOFs,
                   bool aSkipPopupChecks)
      : nsFrameIterator(aPresContext,
                        aStart,
                        aType,
                        aLockScroll,
                        aFollowOOFs,
                     ...
                     bool aSkipPopupChecks)
{
  ...
  if (aVisual) {
    trav = new nsVisualIterator(aPresContext,
                                aStart,
                                aType,
                                aLockInScrollView,
                                aFollowOOFs,
    ...
    trav = new nsFrameIterator(aPresContext,
                               aStart,
                               aType,
                               aLockInScrollView,
                               aFollowOOFs,
...
nsFrameTraversal::NewFrameTraversal(nsIFrameEnumerator** aEnumerator,
                                    ...
                                    bool aSkipPopupChecks)
{
  return NS_NewFrameTraversal(aEnumerator,
                              aPresContext,
                              aStart,
...
nsFrameIterator::nsFrameIterator(nsPresContext* aPresContext,
                                 nsIFrame* aStart,
                                 nsIteratorType aType,
                                 bool aLockInScrollView,
                                 bool aFollowOOFs,
