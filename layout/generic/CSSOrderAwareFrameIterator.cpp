...
template<>
bool
CSSOrderAwareFrameIterator::IsForward() const
{
  return true;
}
...
template<>
nsFrameList::iterator
CSSOrderAwareFrameIterator::end(const nsFrameList& aList)
{
  return aList.end();
}
...
template<>
bool
ReverseCSSOrderAwareFrameIterator::CSSBoxOrdinalGroupComparator(
