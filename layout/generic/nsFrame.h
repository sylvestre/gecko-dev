...
{
  DR_intrinsic_width_cookie(nsIFrame* aFrame,
                            const char* aType,
                            nscoord& aResult);
...
{
  DR_intrinsic_size_cookie(nsIFrame* aFrame,
                           const char* aType,
                           nsSize& aResult);
...
{
  DR_init_constraints_cookie(nsIFrame* aFrame,
                             mozilla::ReflowInput* aState,
                             nscoord aCBWidth,
                             nscoord aCBHeight,
...
#define DISPLAY_REFLOW(                                                  \
    dr_pres_context, dr_frame, dr_rf_state, dr_rf_metrics, dr_rf_status) \
  DR_cookie dr_cookie(                                                   \
      dr_pres_context, dr_frame, dr_rf_state, dr_rf_metrics, dr_rf_status);
...
#define DISPLAY_INIT_CONSTRAINTS(                       \
    dr_frame, dr_state, dr_cbw, dr_cbh, dr_bdr, dr_pad) \
  DR_init_constraints_cookie dr_cookie(                 \
      dr_frame, dr_state, dr_cbw, dr_cbh, dr_bdr, dr_pad)
#define DISPLAY_INIT_OFFSETS(                           \
    dr_frame, dr_state, dr_pb, dr_cbwm, dr_bdr, dr_pad) \
  DR_init_offsets_cookie dr_cookie(                     \
      dr_frame, dr_state, dr_pb, dr_cbwm, dr_bdr, dr_pad)
