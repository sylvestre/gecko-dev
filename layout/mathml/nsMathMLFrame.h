...
class nsMathMLFrame : public nsIMathMLFrame
{
 public:
  ...
  static void GetSubDropFromChild(nsIFrame* aChild,
                                  nscoord& aSubDrop,
                                  float aFontSizeInflation)
  {
  ...
  static void GetSupDropFromChild(nsIFrame* aChild,
                                  nscoord& aSupDrop,
                                  float aFontSizeInflation)
  {
    RefPtr<nsFontMetrics> fm =
  ...
  static void GetSubScriptShifts(nsFontMetrics* fm,
  ...
  static void GetSupScriptShifts(nsFontMetrics* fm,
  ...
  static void GetNumeratorShifts(nsFontMetrics* fm,
                                 nscoord& numShift1,
                                 nscoord& numShift2,
                                 nscoord& numShift3)
  {
  ...
  static void GetDenominatorShifts(nsFontMetrics* fm,
                                   nscoord& denShift1,
                                   nscoord& denShift2)
  {
    nscoord xHeight = fm->XHeight();
  ...
  static void GetBigOpSpacings(nsFontMetrics* fm,
