...
class nsMathMLChar
{
 public:
  ...
  nsresult Stretch(nsIFrame* aForFrame,
  ...
  nscoord GetMaxWidth(nsIFrame* aForFrame,
                      DrawTarget* aDrawTarget,
                      float aFontSizeInflation,
 ...
 private:
  ...
  nsresult StretchInternal(nsIFrame* aForFrame,
                           DrawTarget* aDrawTarget,
                           float aFontSizeInflation,
                           nsStretchDirection& aStretchDirection,
                           const nsBoundingMetrics& aContainerSize,
  ...
  void ApplyTransforms(gfxContext* aThebesContext,
