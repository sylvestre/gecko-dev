...
nsPrintPreviewListener::AddListeners()
{
  if (mEventTarget) {
    ...
    mEventTarget->AddEventListener(
        NS_LITERAL_STRING("contextmenu"), this, true);
...
nsPrintPreviewListener::RemoveListeners()
{
  if (mEventTarget) {
    ...
    mEventTarget->RemoveEventListener(
        NS_LITERAL_STRING("mousemove"), this, true);
    mEventTarget->RemoveEventListener(
        NS_LITERAL_STRING("mouseout"), this, true);
    mEventTarget->RemoveEventListener(
        NS_LITERAL_STRING("mouseover"), this, true);
...
GetActionForEvent(nsIDOMEvent* aEvent)
{
  ...
  static const uint32_t kOKKeyCodes[] = {NS_VK_PAGE_UP,
                                         NS_VK_PAGE_DOWN,
                                         NS_VK_UP,
                                         NS_VK_DOWN,
                                         NS_VK_HOME,
