...
struct BestOverlap
{
  ...
  BestOverlap(Float aOverlap, size_t aCount) : overlap(aOverlap), count(aCount)
  {
  }
};
...
void
DottedCornerFinder::FindPointAndRadius(
    Point& C, Float& r, const Point& innerTangent, const Point& normal, Float t)
{
