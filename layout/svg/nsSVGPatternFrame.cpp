                                ...
                                imgDrawingParams& aImgParams)
{
  ...
  gfxMatrix ctm = ConstructCTM(viewBox,
                               patternContentUnits,
                               patternUnits,
                               callerBBox,
                               aContextMatrix,
  ...
  *patternMatrix = GetPatternMatrix(
      patternUnits, patternTransform, bbox, callerBBox, aContextMatrix);
  ...
  if (resultOverflows || patternWidth != surfaceSize.width ||
    ...
    gfxMatrix tempTM = gfxMatrix(surfaceSize.width / patternWidth,
                                 0.0,
                                 0.0,
                                ...
                                nsIFrame* aTarget)
{
  ...
  Matrix tm = SVGContentUtils::GetViewBoxTransform(viewportWidth * scaleX,
    ...
    const gfxRect* aOverrideBounds)
{
  ...
  // Paint it!
  Matrix pMatrix;
  RefPtr<SourceSurface> surface = PaintPattern(aDrawTarget,
                                               &pMatrix,
