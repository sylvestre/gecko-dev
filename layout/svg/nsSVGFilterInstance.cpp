...
{
  nsSVGLength2 val[4];
  val[0].Init(SVGContentUtils::X,
              0xff,
              aPoint.x,
              nsIDOMSVGLength::SVG_LENGTHTYPE_NUMBER);
  val[1].Init(SVGContentUtils::Y,
              0xff,
              aPoint.y,
              nsIDOMSVGLength::SVG_LENGTHTYPE_NUMBER);
  // Dummy width/height values
  val[2].Init(
      SVGContentUtils::X, 0xff, 0, nsIDOMSVGLength::SVG_LENGTHTYPE_NUMBER);
  val[3].Init(
      SVGContentUtils::Y, 0xff, 0, nsIDOMSVGLength::SVG_LENGTHTYPE_NUMBER);
...
void
nsSVGFilterInstance::GetInputsAreTainted(
    const nsTArray<FilterPrimitiveDescription>& aPrimitiveDescrs,
    const nsTArray<int32_t>& aInputIndices,
...
int32_t
nsSVGFilterInstance::GetOrCreateSourceAlphaIndex(
    ...
    bool aInputIsTainted)
{
  ...
  for (uint32_t primitiveElementIndex = 0;
    ...
    GetInputsAreTainted(
        aPrimitiveDescrs, sourceIndices, aInputIsTainted, sourcesAreTainted);
