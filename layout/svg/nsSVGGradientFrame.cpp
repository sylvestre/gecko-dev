                                     ...
                                     int32_t aModType)
{
  ...
  return nsSVGPaintServerFrame::AttributeChanged(
...
nsSVGGradientFrame::GetEnumValue(uint32_t aIndex, nsIContent* aDefault)
{
  ...
  AutoReferenceChainGuard refChainGuard(
      this, &mLoopFlag, &sRefChainLengthCounter);
...
nsSVGGradientFrame::GetLinearGradientWithLength(
...
nsSVGGradientFrame::GetRadialGradientWithLength(
...
//helper
static void
GetStopInformation(nsIFrame* aStopFrame,
                   float* aOffset,
                   nscolor* aStopColor,
                   float* aStopOpacity)
{
...
nsSVGGradientFrame::GetPaintServerPattern(
    nsIFrame* aSource,
                                           ...
                                           int32_t aModType)
{
  ...
  return nsSVGGradientFrame::AttributeChanged(
      aNameSpaceID, aAttribute, aModType);
}
...
float
nsSVGRadialGradientFrame::GetLengthValueFromElement(
