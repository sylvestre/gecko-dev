...
void
nsSVGForeignObjectFrame::DestroyFrom(nsIFrame* aDestructRoot)
{
                                  ...
                                  const nsIntRect* aDirtyRect)
{
  ...
  if (aDirtyRect) {
    ...
    gfxRect transDirtyRect = gfxRect(
  ...
  Unused << nsLayoutUtils::PaintFrame(&aContext,
                                      kid,
...
void
nsSVGForeignObjectFrame::RequestReflow(nsIPresShell::IntrinsicDirty aType)
{
...
void
nsSVGForeignObjectFrame::AppendDirectlyOwnedAnonBoxes(
