...
void
nsGfxButtonControlFrame::DestroyFrom(nsIFrame* aDestructRoot)
{
...
void
nsGfxButtonControlFrame::AppendAnonymousContentTo(
...
nsGfxButtonControlFrame::GetDefaultLabel(nsAString& aString) const
{
  ...
  return nsContentUtils::GetLocalizedString(
      nsContentUtils::eFORMS_PROPERTIES, prop, aString);
}
                                          ...
                                          int32_t aModType)
{
  ...
  if (nsGkAtoms::value == aAttribute) {
    ...
    rv = nsHTMLButtonControlFrame::AttributeChanged(
