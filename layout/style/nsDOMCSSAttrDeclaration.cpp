...
NS_INTERFACE_MAP_BEGIN_CYCLE_COLLECTION(nsDOMCSSAttributeDeclaration)
  ...
  nsresult nsDOMCSSAttributeDeclaration::SetCSSDeclaration(DeclarationBlock *
                                                           aDecl)
  {
  ...
  DeclarationBlock* nsDOMCSSAttributeDeclaration::GetCSSDeclaration(
  ...
  void nsDOMCSSAttributeDeclaration::GetCSSParsingEnvironment(
      CSSParsingEnvironment & aCSSParseEnv)
  {
    NS_ASSERTION(
        mElement,
        "Something is severely broken -- there should be an Element here!");
  ...
  /* virtual */ nsINode* nsDOMCSSAttributeDeclaration::GetParentObject()
  {
    return mElement;
  }
