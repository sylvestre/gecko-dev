...
static void
GetWidth(nsPresContext* aPresContext,
...
static void
GetHeight(nsPresContext* aPresContext,
          const nsMediaFeature*,
          nsCSSValue& aResult)
{
  nsSize size = GetSize(aPresContext);
...
GetDeviceSize(nsPresContext* aPresContext)
{
  ...
  if (ShouldResistFingerprinting(aPresContext) ||
      aPresContext->IsDeviceSizePageSize()) {
...
static void
GetDeviceWidth(nsPresContext* aPresContext,
               const nsMediaFeature*,
               nsCSSValue& aResult)
{
...
static void
GetDeviceHeight(nsPresContext* aPresContext,
                const nsMediaFeature*,
                nsCSSValue& aResult)
{
  nsSize size = GetDeviceSize(aPresContext);
...
static void
GetOrientation(nsPresContext* aPresContext,
               const nsMediaFeature*,
               nsCSSValue& aResult)
{
  nsSize size = GetSize(aPresContext);
...
static void
GetDeviceOrientation(nsPresContext* aPresContext,
                     const nsMediaFeature*,
                     nsCSSValue& aResult)
{
  nsSize size = GetDeviceSize(aPresContext);
...
static void
GetIsResourceDocument(nsPresContext* aPresContext,
                      const nsMediaFeature*,
                      nsCSSValue& aResult)
{
...
static void
GetAspectRatio(nsPresContext* aPresContext,
               const nsMediaFeature*,
               nsCSSValue& aResult)
{
...
static void
GetDeviceAspectRatio(nsPresContext* aPresContext,
                     const nsMediaFeature*,
                     nsCSSValue& aResult)
{
...
static void
GetColor(nsPresContext* aPresContext,
         const nsMediaFeature*,
         nsCSSValue& aResult)
{
...
static void
GetColorIndex(nsPresContext* aPresContext,
              const nsMediaFeature*,
              nsCSSValue& aResult)
{
...
static void
GetMonochrome(nsPresContext* aPresContext,
              const nsMediaFeature*,
              nsCSSValue& aResult)
{
...
static void
GetResolution(nsPresContext* aPresContext,
              const nsMediaFeature*,
              nsCSSValue& aResult)
{
...
static void
GetScan(nsPresContext* aPresContext, const nsMediaFeature*, nsCSSValue& aResult)
{
...
static void
GetDisplayMode(nsPresContext* aPresContext,
               const nsMediaFeature*,
               nsCSSValue& aResult)
{
  ...
  if (baseWindow) {
    ...
    if (mode == nsSizeMode_Fullscreen) {
      aResult.SetIntValue(NS_STYLE_DISPLAY_MODE_FULLSCREEN,
                          eCSSUnit_Enumerated);
      return;
    }
  }
  ...
  static_assert(
      nsIDocShell::DISPLAY_MODE_BROWSER == NS_STYLE_DISPLAY_MODE_BROWSER &&
...
static void
GetGrid(nsPresContext* aPresContext, const nsMediaFeature*, nsCSSValue& aResult)
{
...
static void
GetDevicePixelRatio(nsPresContext* aPresContext,
                    const nsMediaFeature*,
                    nsCSSValue& aResult)
{
  if (!ShouldResistFingerprinting(aPresContext)) {
...
static void
GetTransform3d(nsPresContext* aPresContext,
               const nsMediaFeature*,
               nsCSSValue& aResult)
{
...
static void
GetSystemMetric(nsPresContext* aPresContext,
...
static void
GetWindowsTheme(nsPresContext* aPresContext,
                const nsMediaFeature* aFeature,
                nsCSSValue& aResult)
{
  aResult.Reset();
...
#ifdef XP_WIN
  uint8_t windowsThemeId = nsCSSRuleProcessor::GetWindowsThemeIdentifier();
...
static void
GetOperatingSystemVersion(nsPresContext* aPresContext,
                          const nsMediaFeature* aFeature,
                          nsCSSValue& aResult)
{
  aResult.Reset();
...
static void
GetIsGlyph(nsPresContext* aPresContext,
           const nsMediaFeature* aFeature,
           nsCSSValue& aResult)
{
