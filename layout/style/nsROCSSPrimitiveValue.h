                                    ...
                                    public nsIDOMCSSPrimitiveValue
{
 public:
  ...
  NS_DECL_CYCLE_COLLECTION_SCRIPT_HOLDER_CLASS_AMBIGUOUS(nsROCSSPrimitiveValue,
  ...
  void SetFloatValue(uint16_t aUnitType,
                     float aValue,
  ...
  void SetStringValue(uint16_t aUnitType,
