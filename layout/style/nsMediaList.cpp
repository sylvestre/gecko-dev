                           ...
                           const nsCSSValue& aActualValue) const
{
  ...
  switch (mFeature->mValueType) {
    ...
    case nsMediaFeature::eIdent: {
      NS_ASSERTION(actual.GetUnit() == eCSSUnit_Ident, "bad actual value");
      NS_ASSERTION(required.GetUnit() == eCSSUnit_Ident, "bad required value");
      NS_ASSERTION(mFeature->mRangeType == nsMediaFeature::eMinMaxNotAllowed,
                   "bad range");
...
size_t
nsDocumentRuleResultCacheKey::SizeOfExcludingThis(
    ...
    if (expr.mValue.GetUnit() != eCSSUnit_Null) {
      ...
      switch (feature->mValueType) {
        ...
        case nsMediaFeature::eEnumerated:
          ...
          break;
        case nsMediaFeature::eIdent:
          NS_ASSERTION(expr.mValue.GetUnit() == eCSSUnit_Ident, "bad unit");
