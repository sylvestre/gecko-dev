                ...
                TransformReferenceBox& aRefBox)
{
  ...
  temp._42 = ProcessTranslatePart(aData->Item(14),
                                  ...
                                  &aRefBox,
                                  &TransformReferenceBox::Height);
  temp._43 = ProcessTranslatePart(
      aData->Item(15), aContext, aPresContext, aConditions, nullptr);
...
class Accumulate
{
 public:
                                    ...
                                    double aCoeff)
  {
    ...
    gfxQuaternion result =
        gfxQuaternion(
            scale * aTwo.x, scale * aTwo.y, scale * aTwo.z, cos(theta)) *
        aOne;
                       ...
                       double aProgress)
{
  ...
  float yzshear = Operator::operate(
      shear1[ShearType::YZSHEAR], shear2[ShearType::YZSHEAR], aProgress);
  if (yzshear != 0.0) {
    result.SkewYZ(yzshear);
  }

  float xzshear = Operator::operate(
      shear1[ShearType::XZSHEAR], shear2[ShearType::XZSHEAR], aProgress);
  if (xzshear != 0.0) {
    result.SkewXZ(xzshear);
  }

  float xyshear = Operator::operate(
      shear1[ShearType::XYSHEAR], shear2[ShearType::XYSHEAR], aProgress);
  if (xyshear != 0.0) {
...
ProcessInterpolateMatrix(Matrix4x4& aMatrix,
                         ...
                         bool* aContains3dTransform)
{
  ProcessMatrixOperator<Interpolate>(aMatrix,
                                     aData,
                                     aContext,
                                     aPresContext,
                                     aConditions,
...
ProcessAccumulateMatrix(Matrix4x4& aMatrix,
                        ...
                        bool* aContains3dTransform)
{
  ProcessMatrixOperator<Accumulate>(aMatrix,
                                    aData,
                                    aContext,
                                    aPresContext,
                                    aConditions,
                  ...
                  RuleNodeCacheConditions& aConditions)
{
  ...
  temp.z = ProcessTranslatePart(
      aData->Item(1), aContext, aPresContext, aConditions, nullptr);
  aMatrix.PreTranslate(temp);
}
                   ...
                   TransformReferenceBox& aRefBox)
{
  ...
  temp.z = ProcessTranslatePart(
      aData->Item(3), aContext, aPresContext, aConditions, nullptr);
...
ProcessScale(Matrix4x4& aMatrix, const nsCSSValue::Array* aData)
{
  ...
  ProcessScaleHelper(
      aMatrix, scaleX.GetFloatValue(), scaleY.GetFloatValue(), 1.0f);
}
                   ...
                   RuleNodeCacheConditions& aConditions)
{
  ...
  float depth = ProcessTranslatePart(
      aData->Item(1), aContext, aPresContext, aConditions, nullptr);
                           ...
                           bool* aContains3dTransform)
{
  ...
  switch (TransformFunctionOf(aData)) {
    case eCSSKeyword_translatex:
      ProcessTranslateX(
          aMatrix, aData, aContext, aPresContext, aConditions, aRefBox);
      break;
               ...
               bool* aContains3dTransform)
{
  ...
  for (const nsCSSValueList* curr = aList; curr != nullptr;
    ...
    MatrixForTransformFunction(result,
                               currElem.GetArrayValue(),
                               contextIfGecko,
                               aPresContext,
                               aConditions,
                               aRefBox,
