...
#define STYLE_STRUCT(name_, checkdata_cb_)                       \
  const nsStyle##name_* nsStyleContext::Style##name_()           \
  {                                                              \
    return DoGetStyle##name_<true>();                            \
  }                                                              \
  const nsStyle##name_* nsStyleContext::ThreadsafeStyle##name_() \
  {                                                              \
...
#define STYLE_STRUCT_INHERITED(name_, checkdata_cb_)                        \
  ...
  {                                                                         \
    if (auto gecko = GetAsGecko()) {                                        \
      const nsStyle##name_* cachedData = static_cast<nsStyle##name_*>(      \
          gecko->mCachedInheritedData.mStyleStructs[eStyleStruct_##name_]); \
      ...
      const nsStyle##name_* newData =                                       \
          gecko->RuleNode()->GetStyle##name_<aComputeData>(gecko, mBits);   \
...
nsPresContext*
nsStyleContext::PresContext() const {MOZ_STYLO_FORWARD(PresContext, ())}

nsStyleContext* nsStyleContext::GetStyleIfVisited() const
{
