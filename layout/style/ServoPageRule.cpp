...
NS_INTERFACE_MAP_BEGIN(ServoPageRuleDeclaration)
  ...
  nsresult ServoPageRuleDeclaration::SetCSSDeclaration(DeclarationBlock * aDecl)
  {
  ...
  ServoPageRule::ServoPageRule(
      RefPtr<RawServoPageRule> aRawRule, uint32_t aLine, uint32_t aColumn)
  ...
  void ServoPageRule::GetCssTextImpl(nsAString & aCssText) const
  {
