...
CSS_KEY(-moz - window - button - box - maximized,
...
CSS_KEY(-moz - mac - disclosure - button - closed,
        _moz_mac_disclosure_button_closed)
CSS_KEY(-moz - mac - disclosure - button - open,
...
CSS_KEY(-moz - mac - active - source - list - selection,
