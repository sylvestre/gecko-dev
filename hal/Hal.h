 ...
 */
void
Vibrate(const nsTArray<uint32_t>& pattern, nsPIDOMWindowInner* aWindow);
void
Vibrate(const nsTArray<uint32_t>& pattern, const hal::WindowIdentifier& id);
 ...
 */
void
CancelVibrate(nsPIDOMWindowInner* aWindow);
void
CancelVibrate(const hal::WindowIdentifier& id);
 ...
 */
void
NotifyBatteryChange(const hal::BatteryInformation& aBatteryInfo);
 ...
 */
void
RegisterSensorObserver(hal::SensorType aSensor,
 ...
 */
void
UnregisterSensorObserver(hal::SensorType aSensor,
                         hal::ISensorObserver* aObserver);
 ...
 */
void
RegisterNetworkObserver(NetworkObserver* aNetworkObserver);
 ...
 */
void
UnregisterNetworkObserver(NetworkObserver* aNetworkObserver);
 ...
 */
void
NotifyNetworkChange(const hal::NetworkInformation& aNetworkInfo);
 ...
 */
void
RegisterSystemClockChangeObserver(hal::SystemClockChangeObserver* aObserver);
 ...
 */
void
UnregisterSystemClockChangeObserver(hal::SystemClockChangeObserver* aObserver);
 ...
 */
void
GetWakeLockInfo(const nsAString& aTopic,
 ...
 */
void
NotifyWakeLockChange(const hal::WakeLockInformation& aWakeLockInfo);
 ...
 */
void
RegisterSwitchObserver(hal::SwitchDevice aDevice,
 ...
 */
void
UnregisterSwitchObserver(hal::SwitchDevice aDevice,
                         hal::SwitchObserver* aSwitchObserver);
 ...
 */
void
SetProcessPriority(int aPid, hal::ProcessPriority aPriority);
