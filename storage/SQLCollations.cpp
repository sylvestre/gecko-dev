...
int
registerCollations(sqlite3* aDB, Service* aService)
{
  ...
  for (size_t i = 0; SQLITE_OK == rv && i < ArrayLength(collations); ++i) {
    ...
    rv = ::sqlite3_create_collation(
        aDB, p->zName, p->enc, aService, p->xCompare);
  }
...
int
localeCollation8(
    void* aService, int aLen1, const void* aStr1, int aLen2, const void* aStr2)
{
  return localeCollationHelper8(aService,
                                aLen1,
                                aStr1,
                                aLen2,
                                aStr2,
...
localeCollation16(
    void* aService, int aLen1, const void* aStr1, int aLen2, const void* aStr2)
{
  return localeCollationHelper16(aService,
                                 aLen1,
                                 aStr1,
                                 aLen2,
                                 aStr2,
