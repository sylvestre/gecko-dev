...
#define BOILERPLATE_BIND_PROXIES(_class, _optionalGuard)                      \
  ...
  BIND_GEN_IMPL(_class,                                                       \
                ...
                (uint32_t aWhere, int64_t aValue),                            \
                (aWhere, aValue))                                             \
  BIND_GEN_IMPL(_class,                                                       \
                _optionalGuard,                                               \
                Null,                                                         \
