...
int
sqlite3_T_int(BindingColumnData aData, int aValue)
{
  return ::sqlite3_bind_int(aData.stmt, aData.column + 1, aValue);
}

int
sqlite3_T_int64(BindingColumnData aData, sqlite3_int64 aValue)
{
  return ::sqlite3_bind_int64(aData.stmt, aData.column + 1, aValue);
}

int
sqlite3_T_double(BindingColumnData aData, double aValue)
{
  return ::sqlite3_bind_double(aData.stmt, aData.column + 1, aValue);
}

int
sqlite3_T_text(BindingColumnData aData, const nsCString& aValue)
{
...
int
sqlite3_T_text16(BindingColumnData aData, const nsString& aValue)
{
...
int
sqlite3_T_blob(BindingColumnData aData, const void* aBlob, int aSize)
{
...
NS_IMPL_ISUPPORTS(BindingParams,
...
NS_IMETHODIMP
BindingParams::BindUTF8StringByIndex(uint32_t aIndex, const nsACString& aValue)
{
  nsCOMPtr<nsIVariant> value(new UTF8TextVariant(aValue));
  NS_ENSURE_TRUE(value, NS_ERROR_OUT_OF_MEMORY);
