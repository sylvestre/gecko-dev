...
inline NS_IMETHODIMP
Variant_base::GetAsArray(uint16_t*, nsIID*, uint32_t*, void**)
{
  return NS_ERROR_CANNOT_CONVERT_DATA;
}
...
inline NS_IMETHODIMP
Variant_base::GetAsInterface(nsIID**, void**)
{
  return NS_ERROR_CANNOT_CONVERT_DATA;
}
...
inline NS_IMETHODIMP
Variant_base::GetAsStringWithSize(uint32_t*, char**)
{
  return NS_ERROR_CANNOT_CONVERT_DATA;
}

inline NS_IMETHODIMP
Variant_base::GetAsWStringWithSize(uint32_t*, char16_t**)
{
  return NS_ERROR_CANNOT_CONVERT_DATA;
}
