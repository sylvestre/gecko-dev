...
inline bool
IsUpperCase(uint32_t c)
{
  return ToLowerCase(c) != c;
}

inline bool
IsLowerCase(uint32_t c)
{
                              ...
                              nsAString::const_iterator& aSearchEnd)
{
  return FindInReadable(
      aPattern, aSearchStart, aSearchEnd, nsCaseInsensitiveStringComparator());
}
...
int32_t
CaseInsensitiveCompare(const char* aLeft,
                       const char* aRight,
                       uint32_t aLeftBytes,
 ...
 */
bool
CaseInsensitiveUTF8CharsEqual(const char* aLeft,
                              const char* aRight,
                              const char* aLeftEnd,
