...
class nsCyrXPCOMDetector : public nsCyrillicDetector, public nsICharsetDetector
{
 public:
                                 ...
                                 public nsIStringCharsetDetector
{
 public:
  ...
  nsCyrXPCOMStringDetector(uint8_t aItems,
                           const uint8_t** aCyrillicClass,
                           const char** aCharsets);
  NS_IMETHOD DoIt(const char* aBuf,
                  uint32_t aLen,
                  const char** oCharset,
...
{
 public:
  nsRUStringProbDetector() : nsCyrXPCOMStringDetector(5, gCyrillicCls, gRussian)
  {
  }
};
