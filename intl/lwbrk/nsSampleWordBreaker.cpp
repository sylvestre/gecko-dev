...
bool
nsSampleWordBreaker::BreakInBetween(const char16_t* aText1,
                                    uint32_t aTextLen1,
...
nsWordRange
nsSampleWordBreaker::FindWord(const char16_t* aText,
                              uint32_t aTextLen,
                              uint32_t aOffset)
{
  nsWordRange range;
...
int32_t
nsSampleWordBreaker::NextWord(const char16_t* aText,
                              uint32_t aLen,
                              uint32_t aPos)
{
