...
TEST(DateTimeFormat, FormatPRExplodedTime)
{
  ...
  prExplodedTime = {
      0, 0, 0, 7, 1, 0, 1970, 4, 0, {(6 * 60 * 60), (1 * 60 * 60)}};
  rv = mozilla::DateTimeFormat::FormatPRExplodedTime(
      kDateFormatLong, kTimeFormatSeconds, &prExplodedTime, formattedTime);
  ASSERT_TRUE(NS_SUCCEEDED(rv));
...
TEST(DateTimeFormat, DateFormatSelectors)
{
  ...
  rv = mozilla::DateTimeFormat::FormatPRExplodedTime(kDateFormatYearMonthLong,
                                                     kTimeFormatNone,
                                                     &prExplodedTime,
                                                     formattedTime);
  ASSERT_TRUE(NS_SUCCEEDED(rv));
  ...
  rv = mozilla::DateTimeFormat::FormatPRExplodedTime(kDateFormatYearMonth,
