...
#define LOCAL_GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TESS_EVALUATION_SHADER \
  0x92C9
...
#define LOCAL_GL_FRAMEBUFFER_INCOMPLETE_INSUFFICIENT_SHADER_COMBINED_LOCAL_STORAGE_EXT \
  0x9652
...
#define LOCAL_EGL_NO_FILE_DESCRIPTOR_KHR \
  EGL_CAST(EGLNativeFileDescriptorKHR, -1)
