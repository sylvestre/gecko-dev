...
class SurfaceFactory_EGLImage : public SurfaceFactory
{
 ...
 protected:
  ...
  SurfaceFactory_EGLImage(GLContext* prodGL,
                          ...
                          EGLContext context)
      : SurfaceFactory(
            SharedSurfaceType::EGLImageShare, prodGL, caps, allocator, flags),
        mContext(context)
  {
  }
 ...
 public:
      ...
      const gfx::IntSize& size) override
  {
    ...
    return SharedSurface_EGLImage::Create(
        mGL, mFormats, size, hasAlpha, mContext);
  }
};
...
class SurfaceFactory_SurfaceTexture : public SurfaceFactory
{
 ...
 protected:
  SurfaceFactory_SurfaceTexture(
      ...
      const RefPtr<layers::LayersIPCChannel>& allocator,
      const layers::TextureFlags& flags)
      : SurfaceFactory(SharedSurfaceType::AndroidSurfaceTexture,
                       prodGL,
                       caps,
                       allocator,
                       flags)
