 ...
 */
 ...
 private:
  ...
  GLenum RawGetError() { return mSymbols.fGetError(); }
 ...
 public:
  class LocalErrorScope
  {
   ...
   public:
    explicit LocalErrorScope(GLContext& gl) : mGL(gl), mHasBeenChecked(false)
    {
...
#define MOZ_FUNCTION_NAME \
  __func__  // defined in C99, supported in various C++ compilers. Just raw function name.
#endif
#endif
  ...
  void BeforeGLCall(const char* funcName)
  {
    ...
    if (mDebugFlags) {
      ...
      GLContext* tlsContext =
          (GLContext*)PR_GetThreadPrivate(sCurrentGLContextTLS);
      if (this != tlsContext) {
        printf_stderr(
            "Fatal: %s called on non-current context %p. The"
...
#define ASSERT_SYMBOL_PRESENT(func)                                            \
 ...
 public:
  ...
  void fInvalidateFramebuffer(GLenum target,
  ...
  void fInvalidateSubFramebuffer(GLenum target,
                                 GLsizei numAttachments,
                                 const GLenum* attachments,
                                 GLint x,
                                 GLint y,
                                 ...
                                 GLsizei height)
  {
    ...
    mSymbols.fInvalidateSubFramebuffer(
  ...
  void fBlendFuncSeparate(GLenum sfactorRGB,
                          GLenum dfactorRGB,
                          GLenum sfactorAlpha,
                          GLenum dfactorAlpha)
  {
    BEFORE_GL_CALL;
    mSymbols.fBlendFuncSeparate(
        sfactorRGB, dfactorRGB, sfactorAlpha, dfactorAlpha);
    AFTER_GL_CALL;
  }

 private:
  void raw_fBufferData(GLenum target,
                       GLsizeiptr size,
                       const GLvoid* data,
                       GLenum usage)
  {
 ...
 public:
  void fBufferData(GLenum target,
                   GLsizeiptr size,
                   const GLvoid* data,
                   GLenum usage)
  {
  ...
  void fBufferSubData(GLenum target,
                      GLintptr offset,
                      GLsizeiptr size,
                      const GLvoid* data)
  {
 ...
 public:
  ...
  void fClearBufferfi(GLenum buffer,
                      GLint drawbuffer,
                      GLfloat depth,
                      GLint stencil)
  {
  ...
  void fColorMask(realGLboolean red,
                  realGLboolean green,
                  realGLboolean blue,
                  realGLboolean alpha)
  {
  ...
  void fCompressedTexImage2D(GLenum target,
                             GLint level,
                             ...
                             const GLvoid* pixels)
  {
    ...
    BEFORE_GL_CALL;
    mSymbols.fCompressedTexImage2D(target,
                                   level,
                                   internalformat,
                                   width,
                                   height,
  ...
  void fCompressedTexSubImage2D(GLenum target,
                                GLint level,
                                GLint xoffset,
                                GLint yoffset,
                                GLsizei width,
                                ...
                                const GLvoid* pixels)
  {
    ASSERT_NOT_PASSING_STACK_BUFFER_TO_GL(pixels);
    BEFORE_GL_CALL;
    mSymbols.fCompressedTexSubImage2D(target,
                                      level,
                                      xoffset,
                                      yoffset,
                                      width,
  ...
  void fCopyTexImage2D(GLenum target,
                       GLint level,
                       GLenum internalformat,
                       GLint x,
                       GLint y,
  ...
  void fCopyTexSubImage2D(GLenum target,
                          GLint level,
                          GLint xoffset,
                          GLint yoffset,
                          GLint x,
  ...
  void fDebugMessageControl(GLenum source,
                            GLenum type,
                            GLenum severity,
                            GLsizei count,
                            const GLuint* ids,
  ...
  void fDebugMessageInsert(GLenum source,
                           GLenum type,
                           GLuint id,
                           GLenum severity,
                           GLsizei length,
 ...
 private:
  ...
  void raw_fDrawElements(GLenum mode,
                         GLsizei count,
                         GLenum type,
 ...
 public:
  ...
  void fDrawElements(GLenum mode,
                     GLsizei count,
                     GLenum type,
                     const GLvoid* indices)
  {
  ...
  void fGetActiveAttrib(GLuint program,
                        GLuint index,
                        GLsizei maxLength,
                        GLsizei* length,
                        GLint* size,
  ...
  {
    BEFORE_GL_CALL;
    mSymbols.fGetActiveAttrib(
        program, index, maxLength, length, size, type, name);
    OnSyncCall();
    AFTER_GL_CALL;
  }

  void fGetActiveUniform(GLuint program,
                         GLuint index,
                         GLsizei maxLength,
                         GLsizei* length,
                         GLint* size,
  ...
  {
    BEFORE_GL_CALL;
    mSymbols.fGetActiveUniform(
        program, index, maxLength, length, size, type, name);
    OnSyncCall();
    AFTER_GL_CALL;
  }

  void fGetAttachedShaders(GLuint program,
                           GLsizei maxCount,
                           GLsizei* count,
                           GLuint* shaders)
  {
 ...
 public:
  ...
  GLuint fGetDebugMessageLog(GLuint count,
                             GLsizei bufsize,
                             GLenum* sources,
                             GLenum* types,
                             GLuint* ids,
                             ...
                             GLchar* messageLog)
  {
    ...
    GLuint ret = mSymbols.fGetDebugMessageLog(
  ...
  void fGetObjectLabel(GLenum identifier,
                       GLuint name,
                       GLsizei bufSize,
                       GLsizei* length,
                       GLchar* label)
  ...
  void fGetObjectPtrLabel(const GLvoid* ptr,
                          GLsizei bufSize,
                          GLsizei* length,
                          GLchar* label)
  {
  ...
  void fGetProgramInfoLog(GLuint program,
                          GLsizei bufSize,
                          GLsizei* length,
                          GLchar* infoLog)
  {
  ...
  void fGetTexImage(
      GLenum target, GLint level, GLenum format, GLenum type, GLvoid* img)
  {
    BEFORE_GL_CALL;
  ...
  void fGetTexLevelParameteriv(GLenum target,
                               GLint level,
                               GLenum pname,
                               GLint* params)
  {
  ...
  void fObjectLabel(GLenum identifier,
                    GLuint name,
                    GLsizei length,
                    const GLchar* label)
  {
  ...
  void fPushDebugGroup(GLenum source,
                       GLuint id,
                       GLsizei length,
                       const GLchar* message)
  {
 ...
 public:
  ...
  void fStencilFuncSeparate(GLenum frontfunc,
                            GLenum backfunc,
                            GLint reference,
                            GLuint mask)
  {
  ...
  void fStencilOpSeparate(GLenum face,
                          GLenum sfail,
                          GLenum dpfail,
                          GLenum dppass)
  {
 ...
 private:
  void raw_fTexImage2D(GLenum target,
                       GLint level,
 ...
 public:
  void fTexImage2D(GLenum target,
                   GLint level,
                   GLint internalformat,
                   GLsizei width,
                   GLsizei height,
  ...
  void fTexSubImage2D(GLenum target,
                      GLint level,
                      GLint xoffset,
                      GLint yoffset,
                      GLsizei width,
  ...
  void fUniformMatrix2fv(GLint location,
                         GLsizei count,
  ...
  void fUniformMatrix2x3fv(GLint location,
                           GLsizei count,
                           realGLboolean transpose,
                           const GLfloat* value)
  {
  ...
  void fUniformMatrix2x4fv(GLint location,
                           GLsizei count,
                           realGLboolean transpose,
                           const GLfloat* value)
  {
  ...
  void fUniformMatrix3fv(GLint location,
                         GLsizei count,
                         realGLboolean transpose,
                         const GLfloat* value)
  {
  ...
  void fUniformMatrix3x2fv(GLint location,
                           GLsizei count,
                           realGLboolean transpose,
                           const GLfloat* value)
  {
  ...
  void fUniformMatrix3x4fv(GLint location,
                           GLsizei count,
                           realGLboolean transpose,
                           const GLfloat* value)
  {
  ...
  void fUniformMatrix4fv(GLint location,
                         GLsizei count,
                         realGLboolean transpose,
                         const GLfloat* value)
  {
  ...
  void fUniformMatrix4x2fv(GLint location,
                           GLsizei count,
                           realGLboolean transpose,
                           const GLfloat* value)
  {
  ...
  void fUniformMatrix4x3fv(GLint location,
                           GLsizei count,
                           realGLboolean transpose,
                           const GLfloat* value)
  {
  ...
  void fVertexAttribPointer(GLuint index,
                            GLint size,
                            GLenum type,
  ...
  void fVertexPointer(GLint size,
                      GLenum type,
                      GLsizei stride,
                      const GLvoid* pointer)
  {
 ...
 private:
  ...
  void raw_fCopyTexImage2D(GLenum target,
                           GLint level,
                           GLenum internalformat,
                           GLint x,
                           GLint y,
  ...
  {
    BEFORE_GL_CALL;
    mSymbols.fCopyTexImage2D(
        target, level, internalformat, x, y, width, height, border);
    AFTER_GL_CALL;
  }

  void raw_fCopyTexSubImage2D(GLenum target,
                              GLint level,
                              GLint xoffset,
                              GLint yoffset,
                              GLint x,
 ...
 public:
  ...
  void fGetShaderInfoLog(GLuint shader,
                         GLsizei bufSize,
                         GLsizei* length,
                         GLchar* infoLog)
  {
 ...
 private:
  void raw_fGetShaderPrecisionFormat(GLenum shadertype,
                                     ...
                                     GLint* precision)
  {
    ...
    mSymbols.fGetShaderPrecisionFormat(
 ...
 public:
  void fGetShaderPrecisionFormat(GLenum shadertype,
                                 GLenum precisiontype,
                                 GLint* range,
                                 GLint* precision)
  {
  ...
  void fGetShaderSource(GLint obj,
                        GLsizei maxLength,
                        GLsizei* length,
                        GLchar* source)
  {
  ...
  void fShaderSource(GLuint shader,
                     GLsizei count,
 ...
 public:
  ...
  void fFramebufferRenderbuffer(GLenum target,
                                GLenum attachmentPoint,
                                GLenum renderbufferTarget,
                                GLuint renderbuffer)
  {
    BEFORE_GL_CALL;
    mSymbols.fFramebufferRenderbuffer(
        target, attachmentPoint, renderbufferTarget, renderbuffer);
    AFTER_GL_CALL;
  }

  void fFramebufferTexture2D(GLenum target,
                             GLenum attachmentPoint,
  ...
  {
    BEFORE_GL_CALL;
    mSymbols.fFramebufferTexture2D(
        target, attachmentPoint, textureTarget, texture, level);
    AFTER_GL_CALL;
  ...
  void fFramebufferTextureLayer(GLenum target,
                                GLenum attachment,
                                GLuint texture,
                                GLint level,
                                GLint layer)
  {
    ...
    mSymbols.fFramebufferTextureLayer(
        target, attachment, texture, level, layer);
    AFTER_GL_CALL;
  }

  void fGetFramebufferAttachmentParameteriv(GLenum target,
                                            GLenum attachment,
                                            GLenum pname,
                                            GLint* value)
  {
    BEFORE_GL_CALL;
    mSymbols.fGetFramebufferAttachmentParameteriv(
 ...
 public:
  ...
  void fRenderbufferStorage(GLenum target,
                            GLenum internalFormat,
                            GLsizei width,
                            GLsizei height)
  {
 ...
 public:
  void fBindBufferOffset(GLenum target,
                         GLuint index,
                         GLuint buffer,
                         GLintptr offset)
  {
 ...
 public:
  void fDrawArraysInstanced(GLenum mode,
                            GLint first,
                            GLsizei count,
                            GLsizei primcount)
  {
  ...
  void fDrawElementsInstanced(GLenum mode,
                              GLsizei count,
                              GLenum type,
                              const GLvoid* indices,
                              GLsizei primcount)
 ...
 private:
  void raw_fDrawArraysInstanced(GLenum mode,
                                GLint first,
                                GLsizei count,
                                GLsizei primcount)
  {
  ...
  void raw_fDrawElementsInstanced(GLenum mode,
                                  GLsizei count,
                                  GLenum type,
                                  const GLvoid* indices,
                                  GLsizei primcount)
 ...
 public:
  void fDrawRangeElements(GLenum mode,
                          GLuint start,
                          GLuint end,
                          GLsizei count,
                          GLenum type,
 ...
 private:
  void raw_fDrawRangeElements(GLenum mode,
                              GLuint start,
                              GLuint end,
                              GLsizei count,
                              GLenum type,
 ...
 public:
  // Draw/Read
  void fBlitFramebuffer(GLint srcX0,
                        GLint srcY0,
                        GLint srcX1,
                        GLint srcY1,
                        GLint dstX0,
 ...
 private:
  void raw_fBlitFramebuffer(GLint srcX0,
                            GLint srcY0,
                            GLint srcX1,
                            GLint srcY1,
                            GLint dstX0,
 ...
 public:
  void fRenderbufferStorageMultisample(GLenum target,
                                       GLsizei samples,
                                       GLenum internalFormat,
                                       GLsizei width,
                                       GLsizei height)
  {
    ...
    mSymbols.fRenderbufferStorageMultisample(
 ...
 public:
  ...
  void fVertexAttribIPointer(GLuint index,
                             GLint size,
                             GLenum type,
                             GLsizei stride,
                             const GLvoid* offset)
 ...
 public:
  void fGetInternalformativ(GLenum target,
                            GLenum internalformat,
                            GLenum pname,
                            GLsizei bufSize,
                            GLint* params)
 ...
 */
 ...
 public:
  ...
  void fBindBufferRange(GLenum target,
                        GLuint index,
                        GLuint buffer,
                        GLintptr offset,
                        GLsizeiptr size)
  ...
  void fTransformFeedbackVaryings(GLuint program,
                                  GLsizei count,
  ...
  void fGetTransformFeedbackVarying(GLuint program,
                                    GLuint index,
                                    GLsizei bufSize,
                                    GLsizei* length,
                                    GLsizei* size,
                                    ...
                                    GLchar* name)
  {
    ...
    mSymbols.fGetTransformFeedbackVarying(
 ...
 public:
  void fCopyBufferSubData(GLenum readtarget,
                          GLenum writetarget,
                          GLintptr readoffset,
 ...
 public:
  void* fMapBufferRange(GLenum target,
                        GLintptr offset,
                        GLsizeiptr length,
                        GLbitfield access)
  {
  ...
  void fFlushMappedBufferRange(GLenum target,
                               GLintptr offset,
                               GLsizeiptr length)
  {
 ...
 public:
  void fGetUniformIndices(GLuint program,
                          ...
                          GLuint* uniformIndices)
  {
    ...
    BEFORE_GL_CALL;
    mSymbols.fGetUniformIndices(
        program, uniformCount, uniformNames, uniformIndices);
    OnSyncCall();
    AFTER_GL_CALL;
  }

  void fGetActiveUniformsiv(GLuint program,
                            GLsizei uniformCount,
  ...
  void fGetActiveUniformBlockiv(GLuint program,
                                ...
                                GLint* params)
  {
    ...
    BEFORE_GL_CALL;
    mSymbols.fGetActiveUniformBlockiv(
        program, uniformBlockIndex, pname, params);
    OnSyncCall();
    AFTER_GL_CALL;
  }

  void fGetActiveUniformBlockName(GLuint program,
                                  GLuint uniformBlockIndex,
                                  GLsizei bufSize,
                                  GLsizei* length,
                                  GLchar* uniformBlockName)
  {
    ...
    BEFORE_GL_CALL;
    mSymbols.fGetActiveUniformBlockName(
        program, uniformBlockIndex, bufSize, length, uniformBlockName);
    OnSyncCall();
    AFTER_GL_CALL;
  }

  void fUniformBlockBinding(GLuint program,
                            GLuint uniformBlockIndex,
                            GLuint uniformBlockBinding)
  {
    ASSERT_SYMBOL_PRESENT(fUniformBlockBinding);
    BEFORE_GL_CALL;
    mSymbols.fUniformBlockBinding(
  ...
  void fTexStorage2D(GLenum target,
                     GLsizei levels,
                     GLenum internalformat,
                     GLsizei width,
                     GLsizei height)
  ...
  void fTexStorage3D(GLenum target,
                     GLsizei levels,
                     GLenum internalformat,
                     GLsizei width,
                     GLsizei height,
  ...
  // -----------------------------------------------------------------------------
  // 3D Textures
  void fTexImage3D(GLenum target,
                   GLint level,
                   GLint internalFormat,
                   GLsizei width,
                   GLsizei height,
  ...
  void fTexSubImage3D(GLenum target,
                      GLint level,
                      GLint xoffset,
                      GLint yoffset,
                      GLint zoffset,
                      ...
                      const GLvoid* pixels)
  {
    ...
    mSymbols.fTexSubImage3D(target,
                            level,
                            xoffset,
                            yoffset,
                            zoffset,
  ...
  void fCopyTexSubImage3D(GLenum target,
                          GLint level,
                          GLint xoffset,
                          GLint yoffset,
                          GLint zoffset,
                          ...
                          GLsizei height)
  {
    ...
    mSymbols.fCopyTexSubImage3D(
        target, level, xoffset, yoffset, zoffset, x, y, width, height);
    AFTER_GL_CALL;
    AfterGLReadCall();
  }

  void fCompressedTexImage3D(GLenum target,
                             GLint level,
                             GLenum internalformat,
                             GLsizei width,
                             GLsizei height,
                             ...
                             const GLvoid* data)
  {
    ...
    mSymbols.fCompressedTexImage3D(target,
                                   level,
                                   internalformat,
                                   width,
                                   height,
  ...
  void fCompressedTexSubImage3D(GLenum target,
                                GLint level,
                                GLint xoffset,
                                GLint yoffset,
                                GLint zoffset,
                                ...
                                const GLvoid* data)
  {
    ...
    mSymbols.fCompressedTexSubImage3D(target,
                                      level,
                                      xoffset,
                                      yoffset,
                                      zoffset,
 ...
 private:
  void GetShaderPrecisionFormatNonES2(GLenum shadertype,
                                      GLenum precisiontype,
                                      GLint* range,
                                      GLint* precision)
  {
 ...
 public:
  ...
  void AttachBuffersToFB(GLuint colorTex,
                         GLuint colorRB,
                         GLuint depthRB,
                         GLuint stencilRB,
                         GLuint fb,
 ...
 private:
  ...
  bool LoadExtSymbols(const char* prefix,
                      bool trygl,
                      const SymLoadStruct* list,
                      GLExtensions ext);
  bool LoadFeatureSymbols(const char* prefix,
                          bool trygl,
                          const SymLoadStruct* list,
                          GLFeature feature);
 ...
 protected:
  ...
  bool IsTextureSizeSafeToPassToDriver(GLenum target,
                                       GLsizei width,
 ...
 public:
  GLsizei MaxSamples() const { return mMaxSamples; }
...
#undef ASSERT_SYMBOL_PRESENT
  ...
  void DeletedTextures(GLContext* aOrigin,
                       GLsizei aCount,
                       const GLuint* aNames);
  void DeletedFramebuffers(GLContext* aOrigin,
                           GLsizei aCount,
                           const GLuint* aNames);
  void DeletedRenderbuffers(GLContext* aOrigin,
                            GLsizei aCount,
                            const GLuint* aNames);
...
template<size_t N>
bool
MarkBitfieldByString(const nsACString& str,
