...
void
BeforeEGLCall(const char* funcName);
void
AfterEGLCall(const char* funcName);
...
#define VOID_WRAP(X) \
  ...
  EGLDisplay fGetDisplay(void* display_id) const WRAP(fGetDisplay(display_id))
      ...
      EGLDisplay fGetPlatformDisplayEXT(EGLenum platform,
                                        void* native_display,
      ...
      WRAP(fGetCurrentSurface(id))
          ...
          EGLContext fGetCurrentContext() const WRAP(fGetCurrentContext())
              ...
              EGLBoolean fMakeCurrent(EGLDisplay dpy,
                                      EGLSurface draw,
                                      EGLSurface read,
      ...
      WRAP(fDestroyContext(dpy, ctx))
          ...
          EGLContext fCreateContext(EGLDisplay dpy,
                                    EGLConfig config,
      ...
      WRAP(fDestroySurface(dpy, surface))
          ...
          EGLSurface fCreateWindowSurface(EGLDisplay dpy,
                                          EGLConfig config,
                                          EGLNativeWindowType win,
                                          const EGLint* attrib_list) const
      WRAP(fCreateWindowSurface(dpy, config, win, attrib_list))

          EGLSurface fCreatePbufferSurface(EGLDisplay dpy,
                                           EGLConfig config,
                                           const EGLint* attrib_list) const
      ...
      fCreatePbufferFromClientBuffer(EGLDisplay dpy,
                                     ...
                                     EGLConfig config,
                                     const EGLint* attrib_list) const
      WRAP(fCreatePbufferFromClientBuffer(
          dpy, buftype, buffer, config, attrib_list))

          EGLSurface fCreatePixmapSurface(EGLDisplay dpy,
                                          EGLConfig config,
      ...
      WRAP(fChooseConfig(dpy, attrib_list, configs, config_size, num_config))
          ...
          EGLint fGetError() const WRAP(fGetError())
              ...
              EGLBoolean fGetConfigAttrib(EGLDisplay dpy,
                                          EGLConfig config,
                                          EGLint attribute,
                                          EGLint* value) const
      WRAP(fGetConfigAttrib(dpy, config, attribute, value))

          EGLBoolean fGetConfigs(EGLDisplay dpy,
                                 EGLConfig* configs,
                                 EGLint config_size,
                                 EGLint* num_config) const
      ...
      WRAP(fSwapBuffers(dpy, surface))
          ...
          EGLBoolean fCopyBuffers(EGLDisplay dpy,
                                  EGLSurface surface,
      ...
      WRAP(fQueryString(dpy, name))
          ...
          EGLBoolean fQueryContext(EGLDisplay dpy,
                                   EGLContext ctx,
                                   EGLint attribute,
                                   EGLint* value) const
      ...
      WRAP(fReleaseTexImage(dpy, surface, buffer))
          ...
          EGLImage fCreateImage(EGLDisplay dpy,
                                EGLContext ctx,
                                EGLenum target,
                                EGLClientBuffer buffer,
                                const EGLint* attrib_list) const
      ...
      WRAP(fDestroyImageKHR(dpy, image))
          ...
          EGLBoolean fLockSurface(EGLDisplay dpy,
                                  EGLSurface surface,
                                  const EGLint* attrib_list) const
      ...
      WRAP(fUnlockSurfaceKHR(dpy, surface))
          ...
          EGLBoolean fQuerySurface(EGLDisplay dpy,
                                   EGLSurface surface,
                                   EGLint attribute,
                                   EGLint* value) const
      WRAP(fQuerySurface(dpy, surface, attribute, value))

          EGLBoolean fQuerySurfacePointerANGLE(EGLDisplay dpy,
                                               EGLSurface surface,
                                               EGLint attribute,
                                               void** value) const
      ...
      WRAP(fDestroySyncKHR(dpy, sync))
          ...
          EGLint fClientWaitSync(EGLDisplay dpy,
                                 EGLSync sync,
                                 EGLint flags,
                                 EGLTime timeout) const
      WRAP(fClientWaitSyncKHR(dpy, sync, flags, timeout))

          EGLBoolean fGetSyncAttrib(EGLDisplay dpy,
                                    EGLSync sync,
                                    EGLint attribute,
                                    EGLint* value) const
      ...
      WRAP(fDestroyStreamKHR(dpy, stream))
          ...
          EGLBoolean fQueryStreamKHR(EGLDisplay dpy,
                                     EGLStreamKHR stream,
                                     EGLenum attribute,
                                     EGLint* value) const
      ...
      // EXT_device_query
      EGLBoolean fQueryDisplayAttribEXT(EGLDisplay dpy,
                                        EGLint attribute,
                                        EGLAttrib* value) const
      WRAP(fQueryDisplayAttribEXT(dpy, attribute, value))

          EGLBoolean fQueryDeviceAttribEXT(EGLDeviceEXT device,
                                           EGLint attribute,
                                           EGLAttrib* value) const
      ...
      // ANGLE_stream_producer_d3d_texture_nv12
      EGLBoolean fCreateStreamProducerD3DTextureNV12ANGLE(
          EGLDisplay dpy,
          EGLStreamKHR stream,
          const EGLAttrib* attrib_list) const
      WRAP(fCreateStreamProducerD3DTextureNV12ANGLE(dpy, stream, attrib_list))
          ...
          EGLBoolean
      fStreamPostD3DTextureNV12ANGLE(EGLDisplay dpy,
                                     EGLStreamKHR stream,
                                     void* texture,
                                     const EGLAttrib* attrib_list) const
...
#undef MOZ_FUNCTION_NAME
 ...
 private:
  struct
  {
    ...
    EGLBoolean(GLAPIENTRY* fMakeCurrent)(EGLDisplay dpy,
                                         EGLSurface draw,
                                         EGLSurface read,
                                         EGLContext ctx);
    EGLBoolean(GLAPIENTRY* fDestroyContext)(EGLDisplay dpy, EGLContext ctx);
    EGLContext(GLAPIENTRY* fCreateContext)(EGLDisplay dpy,
                                           EGLConfig config,
                                           EGLContext share_context,
                                           const EGLint* attrib_list);
    ...
    EGLBoolean(GLAPIENTRY* fInitialize)(EGLDisplay dpy,
                                        EGLint* major,
                                        EGLint* minor);
    ...
    EGLBoolean(GLAPIENTRY* fGetConfigAttrib)(EGLDisplay dpy,
                                             EGLConfig config,
                                             EGLint attribute,
                                             EGLint* value);
    EGLBoolean(GLAPIENTRY* fGetConfigs)(EGLDisplay dpy,
                                        EGLConfig* configs,
                                        EGLint config_size,
                                        EGLint* num_config);
    EGLBoolean(GLAPIENTRY* fWaitNative)(EGLint engine);
    EGLBoolean(GLAPIENTRY* fSwapBuffers)(EGLDisplay dpy, EGLSurface surface);
    EGLBoolean(GLAPIENTRY* fCopyBuffers)(EGLDisplay dpy,
                                         EGLSurface surface,
                                         EGLNativePixmapType target);
    const GLubyte*(GLAPIENTRY* fQueryString)(EGLDisplay, EGLint name);
    EGLBoolean(GLAPIENTRY* fQueryContext)(EGLDisplay dpy,
                                          EGLContext ctx,
                                          EGLint attribute,
                                          EGLint* value);
    EGLBoolean(GLAPIENTRY* fBindTexImage)(EGLDisplay,
                                          EGLSurface surface,
                                          EGLint buffer);
    EGLBoolean(GLAPIENTRY* fReleaseTexImage)(EGLDisplay,
                                             EGLSurface surface,
                                             EGLint buffer);
    EGLImage(GLAPIENTRY* fCreateImageKHR)(EGLDisplay dpy,
                                          EGLContext ctx,
                                          EGLenum target,
                                          EGLClientBuffer buffer,
                                          const EGLint* attrib_list);
    ...
    EGLBoolean(GLAPIENTRY* fLockSurfaceKHR)(EGLDisplay dpy,
                                            EGLSurface surface,
                                            const EGLint* attrib_list);
    EGLBoolean(GLAPIENTRY* fUnlockSurfaceKHR)(EGLDisplay dpy,
                                              EGLSurface surface);
    EGLBoolean(GLAPIENTRY* fQuerySurface)(EGLDisplay dpy,
                                          EGLSurface surface,
                                          EGLint attribute,
                                          EGLint* value);
    EGLBoolean(GLAPIENTRY* fQuerySurfacePointerANGLE)(EGLDisplay dpy,
                                                      ...
                                                      EGLint attribute,
                                                      void** value);
    EGLSync(GLAPIENTRY* fCreateSyncKHR)(EGLDisplay dpy,
                                        EGLenum type,
                                        const EGLint* attrib_list);
    EGLBoolean(GLAPIENTRY* fDestroySyncKHR)(EGLDisplay dpy, EGLSync sync);
    EGLint(GLAPIENTRY* fClientWaitSyncKHR)(EGLDisplay dpy,
                                           EGLSync sync,
                                           EGLint flags,
                                           EGLTime timeout);
    EGLBoolean(GLAPIENTRY* fGetSyncAttribKHR)(EGLDisplay dpy,
                                              EGLSync sync,
                                              EGLint attribute,
                                              EGLint* value);
    ...
    // ANGLE_stream_producer_d3d_texture_nv12
    EGLBoolean(GLAPIENTRY* fCreateStreamProducerD3DTextureNV12ANGLE)(
        EGLDisplay dpy, EGLStreamKHR stream, const EGLAttrib* attrib_list);
    EGLBoolean(GLAPIENTRY* fStreamPostD3DTextureNV12ANGLE)(
        EGLDisplay dpy,
        EGLStreamKHR stream,
        void* texture,
