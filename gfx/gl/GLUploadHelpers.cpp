                                    ...
                                    const GLvoid* pixels)
{
  ...
  gl->fTexSubImage2D(
      target, level, xoffset, yoffset, width, height - 1, format, type, pixels);
                    ...
                    const GLvoid* pixels)
{
  if (gl->IsGLES()) {
    if (stride == width * pixelsize) {
      ...
      TexSubImage2DWithUnpackSubimageGLES(gl,
                                          target,
                                          level,
                                          xoffset,
                                          yoffset,
      ...
      TexSubImage2DWithoutUnpackSubimage(gl,
                                         target,
                                         level,
                                         xoffset,
                                         yoffset,
                       ...
                       GLenum aTextureTarget)
{
  ...
  unsigned char* data =
      aSurface->GetData() + DataOffset(aSrcPoint, stride, format);
