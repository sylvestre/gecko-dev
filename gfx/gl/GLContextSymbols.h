...
{
  GLContextSymbols() { Zero(); }

  void Zero() { memset(this, 0, sizeof(GLContextSymbols)); }
  ...
  void(GLAPIENTRY* fColorMask)(realGLboolean,
                               realGLboolean,
                               realGLboolean,
                               realGLboolean);
  void(GLAPIENTRY* fCompressedTexImage2D)(
      GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, const GLvoid*);
  void(GLAPIENTRY* fCompressedTexSubImage2D)(GLenum,
                                             GLint,
                                             GLint,
                                             GLint,
                                             GLsizei,
  ...
  void(GLAPIENTRY* fGetActiveAttrib)(
      GLuint, GLuint, GLsizei, GLsizei*, GLint*, GLenum*, GLchar*);
  void(GLAPIENTRY* fGetActiveUniform)(
      GLuint, GLuint, GLsizei, GLsizei*, GLint*, GLenum*, GLchar*);
  ...
  void(GLAPIENTRY* fTexImage2D)(GLenum,
                                GLint,
                                GLint,
                                GLsizei,
                                GLsizei,
                                ...
                                GLenum,
                                const GLvoid*);
  void(GLAPIENTRY* fTexSubImage2D)(GLenum,
                                   GLint,
                                   GLint,
                                   GLint,
                                   GLsizei,
  ...
  void(GLAPIENTRY* fUniformMatrix2fv)(GLint,
                                      GLsizei,
                                      realGLboolean,
                                      const GLfloat*);
  void(GLAPIENTRY* fUniformMatrix2x3fv)(GLint,
                                        GLsizei,
                                        realGLboolean,
                                        const GLfloat*);
  void(GLAPIENTRY* fUniformMatrix2x4fv)(GLint,
                                        GLsizei,
                                        realGLboolean,
                                        const GLfloat*);
  void(GLAPIENTRY* fUniformMatrix3fv)(GLint,
                                      GLsizei,
                                      realGLboolean,
                                      const GLfloat*);
  void(GLAPIENTRY* fUniformMatrix3x2fv)(GLint,
                                        GLsizei,
                                        realGLboolean,
                                        const GLfloat*);
  void(GLAPIENTRY* fUniformMatrix3x4fv)(GLint,
                                        GLsizei,
                                        realGLboolean,
                                        const GLfloat*);
  void(GLAPIENTRY* fUniformMatrix4fv)(GLint,
                                      GLsizei,
                                      realGLboolean,
                                      const GLfloat*);
  void(GLAPIENTRY* fUniformMatrix4x2fv)(GLint,
                                        GLsizei,
                                        realGLboolean,
                                        const GLfloat*);
  void(GLAPIENTRY* fUniformMatrix4x3fv)(GLint,
                                        GLsizei,
                                        realGLboolean,
                                        const GLfloat*);
  ...
  void(GLAPIENTRY* fVertexAttribPointer)(
      GLuint, GLint, GLenum, realGLboolean, GLsizei, const GLvoid*);
  ...
  void(GLAPIENTRY* fCopyTexImage2D)(
      GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLsizei, GLint);
  void(GLAPIENTRY* fCopyTexSubImage2D)(
  ...
  void(GLAPIENTRY* fShaderSource)(GLuint,
                                  GLsizei,
                                  const GLchar* const*,
                                  const GLint*);
  ...
  void(GLAPIENTRY* fFramebufferTexture2D)(
      GLenum, GLenum, GLenum, GLuint, GLint);
  void(GLAPIENTRY* fFramebufferTextureLayer)(
      GLenum, GLenum, GLuint, GLint, GLint);
  void(GLAPIENTRY* fGetFramebufferAttachmentParameteriv)(GLenum,
                                                         GLenum,
                                                         GLenum,
                                                         GLint*);
  ...
  void(GLAPIENTRY* fInvalidateSubFramebuffer)(
  ...
  void(GLAPIENTRY* fBlitFramebuffer)(GLint,
                                     GLint,
                                     GLint,
                                     GLint,
                                     GLint,
                                     ...
                                     GLbitfield,
                                     GLenum);
  void(GLAPIENTRY* fRenderbufferStorageMultisample)(
  ...
  void(GLAPIENTRY* fCopyBufferSubData)(
  ...
  void(GLAPIENTRY* fDrawElementsInstanced)(
  ...
  void(GLAPIENTRY* fGetInternalformativ)(
  ...
  void(GLAPIENTRY* fBindBufferRange)(
  ...
  void(GLAPIENTRY* fTransformFeedbackVaryings)(GLuint,
                                               GLsizei,
                                               const GLchar* const*,
                                               GLenum);
  void(GLAPIENTRY* fGetTransformFeedbackVarying)(
  ...
  // KHR_debug
  void(GLAPIENTRY* fDebugMessageControl)(
      GLenum, GLenum, GLenum, GLsizei, const GLuint*, realGLboolean);
  void(GLAPIENTRY* fDebugMessageInsert)(
      GLenum, GLenum, GLuint, GLenum, GLsizei, const GLchar*);
  void(GLAPIENTRY* fDebugMessageCallback)(GLDEBUGPROC, const GLvoid*);
  GLuint(GLAPIENTRY* fGetDebugMessageLog)(
  ...
  void(GLAPIENTRY* fGetObjectPtrLabel)(const GLvoid*,
                                       GLsizei,
                                       GLsizei*,
                                       GLchar*);

  // draw_range_elements
  void(GLAPIENTRY* fDrawRangeElements)(
  ...
  void(GLAPIENTRY* fTexStorage3D)(
      GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLsizei);

  // uniform_buffer_object
  void(GLAPIENTRY* fGetUniformIndices)(GLuint,
                                       GLsizei,
                                       const GLchar* const*,
                                       GLuint*);
  void(GLAPIENTRY* fGetActiveUniformsiv)(
  ...
  void(GLAPIENTRY* fGetActiveUniformBlockName)(
  ...
  void(GLAPIENTRY* fVertexAttribIPointer)(
  ...
  // 3D Textures
  void(GLAPIENTRY* fTexImage3D)(GLenum,
                                GLint,
                                GLenum,
                                GLenum,
                                GLsizei,
  ...
  void(GLAPIENTRY* fTexSubImage3D)(GLenum,
                                   GLint,
                                   GLint,
                                   GLint,
                                   GLint,
  ...
  void(GLAPIENTRY* fCopyTexSubImage3D)(
      GLenum, GLint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei);

  void(GLAPIENTRY* fCompressedTexImage3D)(GLenum,
                                          GLint,
                                          GLenum,
                                          GLsizei,
                                          GLsizei,
  ...
  void(GLAPIENTRY* fCompressedTexSubImage3D)(GLenum,
                                             GLint,
                                             GLint,
                                             GLint,
                                             GLint,
