...
struct PipelineId
{
  ...
  {
    return mNamespace == aOther.mNamespace && mHandle == aOther.mHandle;
  }
};
...
struct WrVecU8
{
  ...
  {
    return data == aOther.data && length == aOther.length &&
...
struct WrOpacityProperty
{
  ...
  {
    return id == aOther.id && opacity == aOther.opacity;
  }
};
...
struct TypedTransform3D_f32__LayoutPixel__LayoutPixel
{
  ...
  bool operator==(
      const TypedTransform3D_f32__LayoutPixel__LayoutPixel& aOther) const
  {
    return m11 == aOther.m11 && m12 == aOther.m12 && m13 == aOther.m13 &&
           m14 == aOther.m14 && m21 == aOther.m21 && m22 == aOther.m22 &&
           m23 == aOther.m23 && m24 == aOther.m24 && m31 == aOther.m31 &&
           m32 == aOther.m32 && m33 == aOther.m33 && m34 == aOther.m34 &&
           m41 == aOther.m41 && m42 == aOther.m42 && m43 == aOther.m43 &&
           m44 == aOther.m44;
  }
};
...
struct TypedRect_f32__LayerPixel
{
  ...
  {
    return origin == aOther.origin && size == aOther.size;
  }
};
...
struct BorderRadius
{
  ...
  {
    return top_left == aOther.top_left && top_right == aOther.top_right &&
...
struct ComplexClipRegion
{
  ...
  {
    return rect == aOther.rect && radii == aOther.radii;
  }
};
...
struct WrImageMask
{
  ...
  {
    return image == aOther.image && rect == aOther.rect &&
...
struct StickySideConstraint
{
  ...
  {
    return margin == aOther.margin && max_offset == aOther.max_offset;
  }
};
...
struct BorderSide
{
  ...
  {
    return color == aOther.color && style == aOther.style;
  }
};
...
struct GradientStop
{
  ...
  {
    return offset == aOther.offset && color == aOther.color;
  }
};
...
struct SideOffsets2D_f32
{
  ...
  {
    return top == aOther.top && right == aOther.right &&
           bottom == aOther.bottom && left == aOther.left;
  }
};
...
struct WrFilterOp
{
  ...
  {
    return filter_type == aOther.filter_type && argument == aOther.argument;
  }
};
...
struct GlyphInstance
{
  ...
  {
    return index == aOther.index && point == aOther.point;
  }
};
...
struct ByteSlice
{
  ...
  {
    return buffer == aOther.buffer && len == aOther.len;
  }
};
...
struct WrExternalImage
{
  ...
  {
    return image_type == aOther.image_type && handle == aOther.handle &&
           u0 == aOther.u0 && v0 == aOther.v0 && u1 == aOther.u1 &&
           v1 == aOther.v1 && buff == aOther.buff && size == aOther.size;
  }
};
...
typedef WrExternalImage (*LockExternalImageCallback)(void*,
                                                     WrExternalImageId,
                                                     uint8_t);
...
struct WrExternalImageHandler
{
  ...
  bool operator==(const WrExternalImageHandler& aOther) const
  {
    return external_image_obj == aOther.external_image_obj &&
           lock_func == aOther.lock_func && unlock_func == aOther.unlock_func;
  }
};
...
struct WrImageDescriptor
{
  ...
  {
    return format == aOther.format && width == aOther.width &&
           height == aOther.height && stride == aOther.stride &&
...
struct FontInstanceOptions
{
  ...
  {
    return render_mode == aOther.render_mode && subpx_dir == aOther.subpx_dir &&
...
struct FontInstancePlatformOptions
{
  ...
  bool operator==(const FontInstancePlatformOptions& aOther) const
  {
    return flags == aOther.flags && lcd_filter == aOther.lcd_filter &&
...
extern void
gfx_critical_note(const char* aMsg);
...
extern bool
is_glcontext_egl(void* aGlcontextPtr);
...
WR_INLINE
const VecU8*
wr_add_ref_arc(const ArcVecU8* aArc) WR_FUNC;

WR_INLINE
void
wr_api_clear_display_list(DocumentHandle* aDh,
                          WrEpoch aEpoch,
                          WrPipelineId aPipelineId) WR_FUNC;

WR_INLINE
void
wr_api_clone(DocumentHandle* aDh, DocumentHandle** aOutHandle) WR_FUNC;

WR_INLINE
void
wr_api_delete(DocumentHandle* aDh) WR_DESTRUCTOR_SAFE_FUNC;

WR_INLINE
void
wr_api_finalize_builder(WrState* aState,
...
WR_INLINE
void
wr_api_generate_frame(DocumentHandle* aDh) WR_FUNC;
...
wr_api_generate_frame_with_properties(
    ...
    size_t aTransformCount) WR_FUNC;

WR_INLINE
WrIdNamespace
wr_api_get_namespace(DocumentHandle* aDh) WR_FUNC;

WR_INLINE
void
wr_api_send_external_event(DocumentHandle* aDh,
                           size_t aEvt) WR_DESTRUCTOR_SAFE_FUNC;

WR_INLINE
void
wr_api_set_display_list(DocumentHandle* aDh,
                        ColorF aColor,
                        WrEpoch aEpoch,
                        ...
                        uint8_t* aDlData,
                        size_t aDlSize,
                        ResourceUpdates* aResources) WR_FUNC;

WR_INLINE
void
wr_api_set_root_pipeline(DocumentHandle* aDh, WrPipelineId aPipelineId) WR_FUNC;

WR_INLINE
void
wr_api_set_window_parameters(DocumentHandle* aDh,
                             int32_t aWidth,
                             int32_t aHeight) WR_FUNC;

WR_INLINE
void
wr_api_update_pipeline_resources(DocumentHandle* aDh,
                                 WrPipelineId aPipelineId,
                                 WrEpoch aEpoch,
                                 ResourceUpdates* aResources) WR_FUNC;
...
WR_INLINE
void
wr_api_update_resources(DocumentHandle* aDh,
                        ResourceUpdates* aResources) WR_FUNC;

WR_INLINE
void
wr_dec_ref_arc(const VecU8* aArc) WR_FUNC;

WR_INLINE
void
wr_dp_clear_save(WrState* aState) WR_FUNC;

WR_INLINE
uint64_t
wr_dp_define_clip(WrState* aState,
                  LayoutRect aClipRect,
                  const ComplexClipRegion* aComplex,
                  size_t aComplexCount,
                  const WrImageMask* aMask) WR_FUNC;

WR_INLINE
void
wr_dp_define_scroll_layer(WrState* aState,
                          uint64_t aScrollId,
                          LayoutRect aContentRect,
                          LayoutRect aClipRect) WR_FUNC;

WR_INLINE
uint64_t
wr_dp_define_sticky_frame(WrState* aState,
                          LayoutRect aContentRect,
                          const StickySideConstraint* aTopRange,
                          const StickySideConstraint* aRightRange,
                          const StickySideConstraint* aBottomRange,
                          const StickySideConstraint* aLeftRange) WR_FUNC;

WR_INLINE
void
wr_dp_pop_all_shadows(WrState* aState) WR_FUNC;

WR_INLINE
void
wr_dp_pop_clip(WrState* aState) WR_FUNC;

WR_INLINE
void
wr_dp_pop_clip_and_scroll_info(WrState* aState) WR_FUNC;

WR_INLINE
void
wr_dp_pop_scroll_layer(WrState* aState) WR_FUNC;

WR_INLINE
void
wr_dp_pop_stacking_context(WrState* aState) WR_FUNC;

WR_INLINE
void
wr_dp_push_border(WrState* aState,
                  LayoutRect aRect,
                  LayoutRect aClip,
                  ...
                  BorderSide aBottom,
                  BorderSide aLeft,
                  BorderRadius aRadius) WR_FUNC;

WR_INLINE
void
wr_dp_push_border_gradient(WrState* aState,
                           LayoutRect aRect,
                           LayoutRect aClip,
                           bool aIsBackfaceVisible,
                           BorderWidths aWidths,
                           ...
                           SideOffsets2D_f32 aOutset) WR_FUNC;

WR_INLINE
void
wr_dp_push_border_image(WrState* aState,
                        LayoutRect aRect,
                        LayoutRect aClip,
                        bool aIsBackfaceVisible,
                        BorderWidths aWidths,
                        ...
                        RepeatMode aRepeatVertical) WR_FUNC;

WR_INLINE
void
wr_dp_push_border_radial_gradient(WrState* aState,
                                  LayoutRect aRect,
                                  LayoutRect aClip,
                                  bool aIsBackfaceVisible,
                                  BorderWidths aWidths,
...
WR_INLINE
void
wr_dp_push_box_shadow(WrState* aState,
                      LayoutRect aRect,
                      LayoutRect aClip,
                      bool aIsBackfaceVisible,
                      ...
                      float aSpreadRadius,
                      float aBorderRadius,
                      BoxShadowClipMode aClipMode) WR_FUNC;

WR_INLINE
void
wr_dp_push_clip(WrState* aState, uint64_t aClipId) WR_FUNC;

WR_INLINE
void
wr_dp_push_clip_and_scroll_info(WrState* aState,
                                uint64_t aScrollId,
                                const uint64_t* aClipId) WR_FUNC;

WR_INLINE
void
wr_dp_push_iframe(WrState* aState,
                  LayoutRect aRect,
                  bool aIsBackfaceVisible,
                  WrPipelineId aPipelineId) WR_FUNC;
...
WR_INLINE
void
wr_dp_push_image(WrState* aState,
                 LayoutRect aBounds,
                 LayoutRect aClip,
                 bool aIsBackfaceVisible,
                 ...
                 WrImageKey aKey) WR_FUNC;

WR_INLINE
void
wr_dp_push_line(WrState* aState,
                LayoutRect aClip,
                bool aIsBackfaceVisible,
                float aBaseline,
                float aStart,
                ...
                float aWidth,
                ColorF aColor,
                LineStyle aStyle) WR_FUNC;

WR_INLINE
void
wr_dp_push_linear_gradient(WrState* aState,
                           LayoutRect aRect,
                           LayoutRect aClip,
                           bool aIsBackfaceVisible,
                           LayoutPoint aStartPoint,
                           ...
                           LayoutSize aTileSpacing) WR_FUNC;

WR_INLINE
void
wr_dp_push_radial_gradient(WrState* aState,
                           LayoutRect aRect,
                           LayoutRect aClip,
                           bool aIsBackfaceVisible,
                           LayoutPoint aCenter,
...
WR_INLINE
void
wr_dp_push_rect(WrState* aState,
                LayoutRect aRect,
                LayoutRect aClip,
                bool aIsBackfaceVisible,
                ColorF aColor) WR_FUNC;

WR_INLINE
void
wr_dp_push_scroll_layer(WrState* aState, uint64_t aScrollId) WR_FUNC;

WR_INLINE
void
wr_dp_push_shadow(WrState* aState,
                  LayoutRect aBounds,
                  LayoutRect aClip,
                  bool aIsBackfaceVisible,
                  Shadow aShadow) WR_FUNC;

WR_INLINE
void
wr_dp_push_stacking_context(WrState* aState,
                            LayoutRect aBounds,
                            ...
                            size_t aFilterCount,
                            bool aIsBackfaceVisible) WR_FUNC;

WR_INLINE
void
wr_dp_push_text(WrState* aState,
                LayoutRect aBounds,
                LayoutRect aClip,
                bool aIsBackfaceVisible,
                ColorF aColor,
                ...
                const GlyphOptions* aGlyphOptions) WR_FUNC;

// Push a 2 planar NV12 image.
WR_INLINE
void
wr_dp_push_yuv_NV12_image(WrState* aState,
                          LayoutRect aBounds,
                          LayoutRect aClip,
                          bool aIsBackfaceVisible,
                          ...
                          ImageRendering aImageRendering) WR_FUNC;

// Push a yuv interleaved image.
WR_INLINE
void
wr_dp_push_yuv_interleaved_image(WrState* aState,
                                 LayoutRect aBounds,
                                 LayoutRect aClip,
                                 bool aIsBackfaceVisible,
                                 WrImageKey aImageKey0,
...
WR_INLINE
void
wr_dp_push_yuv_planar_image(WrState* aState,
                            LayoutRect aBounds,
                            LayoutRect aClip,
                            bool aIsBackfaceVisible,
                            WrImageKey aImageKey0,
...
WR_INLINE
void
wr_dp_restore(WrState* aState) WR_FUNC;

WR_INLINE
void
wr_dp_save(WrState* aState) WR_FUNC;

extern bool
wr_moz2d_render_cb(ByteSlice aBlob,
                   uint32_t aWidth,
                   uint32_t aHeight,
                   ImageFormat aFormat,
...
extern void
wr_notifier_external_event(WrWindowId aWindowId, size_t aRawEvent);

extern void
wr_notifier_new_frame_ready(WrWindowId aWindowId);

extern void
wr_notifier_new_scroll_frame_ready(WrWindowId aWindowId, bool aCompositeNeeded);

WR_INLINE
void
wr_rendered_epochs_delete(WrRenderedEpochs* aPipelineEpochs)
    WR_DESTRUCTOR_SAFE_FUNC;

WR_INLINE
bool
wr_rendered_epochs_next(WrRenderedEpochs* aPipelineEpochs,
                        WrPipelineId* aOutPipeline,
                        WrEpoch* aOutEpoch) WR_FUNC;

WR_INLINE
bool
wr_renderer_current_epoch(Renderer* aRenderer,
                          WrPipelineId aPipelineId,
                          WrEpoch* aOutEpoch) WR_FUNC;

WR_INLINE
void
wr_renderer_delete(Renderer* aRenderer) WR_DESTRUCTOR_SAFE_FUNC;

WR_INLINE
WrRenderedEpochs*
wr_renderer_flush_rendered_epochs(Renderer* aRenderer) WR_FUNC;

WR_INLINE
WrDebugFlags
wr_renderer_get_debug_flags(Renderer* aRenderer) WR_FUNC;

WR_INLINE
void
wr_renderer_readback(Renderer* aRenderer,
                     uint32_t aWidth,
                     uint32_t aHeight,
                     uint8_t* aDstBuffer,
                     size_t aBufferSize) WR_FUNC;

WR_INLINE
bool
wr_renderer_render(Renderer* aRenderer,
                   uint32_t aWidth,
                   uint32_t aHeight) WR_FUNC;

WR_INLINE
void
wr_renderer_set_debug_flags(Renderer* aRenderer, WrDebugFlags aFlags) WR_FUNC;

WR_INLINE
void
wr_renderer_set_external_image_handler(
    Renderer* aRenderer, WrExternalImageHandler* aExternalImageHandler) WR_FUNC;

WR_INLINE
void
wr_renderer_update(Renderer* aRenderer) WR_FUNC;

WR_INLINE
void
wr_resource_updates_add_blob_image(ResourceUpdates* aResources,
                                   WrImageKey aImageKey,
                                   const WrImageDescriptor* aDescriptor,
                                   WrVecU8* aBytes) WR_FUNC;

WR_INLINE
void
wr_resource_updates_add_external_image(ResourceUpdates* aResources,
                                       WrImageKey aImageKey,
                                       const WrImageDescriptor* aDescriptor,
                                       WrExternalImageId aExternalImageId,
                                       WrExternalImageBufferType aBufferType,
                                       uint8_t aChannelIndex) WR_FUNC;
...
wr_resource_updates_add_font_instance(
    ...
    WrVecU8* aVariations) WR_FUNC;

WR_INLINE
void
wr_resource_updates_add_image(ResourceUpdates* aResources,
                              WrImageKey aImageKey,
                              const WrImageDescriptor* aDescriptor,
                              WrVecU8* aBytes) WR_FUNC;
...
WR_INLINE
void
wr_resource_updates_add_raw_font(ResourceUpdates* aResources,
                                 WrFontKey aKey,
                                 WrVecU8* aBytes,
                                 uint32_t aIndex) WR_FUNC;

WR_INLINE
void
wr_resource_updates_clear(ResourceUpdates* aResources) WR_FUNC;

WR_INLINE
void
wr_resource_updates_delete(ResourceUpdates* aUpdates) WR_DESTRUCTOR_SAFE_FUNC;

WR_INLINE
void
wr_resource_updates_delete_font(ResourceUpdates* aResources,
                                WrFontKey aKey) WR_FUNC;

WR_INLINE
void
wr_resource_updates_delete_font_instance(ResourceUpdates* aResources,
                                         WrFontInstanceKey aKey) WR_FUNC;

WR_INLINE
void
wr_resource_updates_delete_image(ResourceUpdates* aResources,
                                 WrImageKey aKey) WR_FUNC;

WR_INLINE
ResourceUpdates*
wr_resource_updates_deserialize(ByteSlice aData) WR_FUNC;

WR_INLINE
ResourceUpdates*
wr_resource_updates_new() WR_FUNC;

WR_INLINE
void
wr_resource_updates_serialize(ResourceUpdates* aResources,
                              VecU8* aInto) WR_FUNC;

WR_INLINE
void
wr_resource_updates_update_blob_image(ResourceUpdates* aResources,
                                      WrImageKey aImageKey,
                                      const WrImageDescriptor* aDescriptor,
                                      WrVecU8* aBytes) WR_FUNC;
...
WR_INLINE
void
wr_resource_updates_update_external_image(ResourceUpdates* aResources,
                                          WrImageKey aKey,
                                          const WrImageDescriptor* aDescriptor,
                                          WrExternalImageId aExternalImageId,
...
WR_INLINE
void
wr_resource_updates_update_image(ResourceUpdates* aResources,
                                 WrImageKey aKey,
                                 const WrImageDescriptor* aDescriptor,
                                 WrVecU8* aBytes) WR_FUNC;
...
WR_INLINE
void
wr_scroll_layer_with_id(DocumentHandle* aDh,
                        WrPipelineId aPipelineId,
                        uint64_t aScrollId,
                        LayoutPoint aNewScrollOrigin) WR_FUNC;

WR_INLINE
void
wr_state_delete(WrState* aState) WR_DESTRUCTOR_SAFE_FUNC;

WR_INLINE
WrState*
wr_state_new(WrPipelineId aPipelineId,
             LayoutSize aContentSize,
             size_t aCapacity) WR_FUNC;

WR_INLINE
void
wr_thread_pool_delete(WrThreadPool* aThreadPool) WR_DESTRUCTOR_SAFE_FUNC;

WR_INLINE
WrThreadPool*
wr_thread_pool_new() WR_FUNC;

WR_INLINE
void
wr_vec_u8_free(WrVecU8 aV) WR_FUNC;

WR_INLINE
void
wr_vec_u8_push_bytes(WrVecU8* aV, ByteSlice aBytes) WR_FUNC;

WR_INLINE
bool
wr_window_new(WrWindowId aWindowId,
              ...
              uint32_t* aOutMaxTextureSize) WR_FUNC;
