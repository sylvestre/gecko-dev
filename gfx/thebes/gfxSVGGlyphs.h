...
class gfxSVGGlyphsDocument final : public nsAPostRefreshObserver
{
 ...
 public:
  gfxSVGGlyphsDocument(const uint8_t* aBuffer,
                       uint32_t aBufLen,
...
class gfxSVGGlyphs
{
 ...
 public:
  ...
  /**
     ...
     *   See |SVGContextPaint|.
     */
  void RenderGlyph(gfxContext* aContext,
                   uint32_t aGlyphId,
  ...
  /**
     ...
     */
  bool GetGlyphExtents(uint32_t aGlyphId,
...
class SimpleTextContextPaint : public mozilla::SVGContextPaint
{
 ...
 public:
  SimpleTextContextPaint(gfxPattern* aFillPattern,
