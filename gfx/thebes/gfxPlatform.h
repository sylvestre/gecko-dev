...
class gfxPlatform
{
 ...
 public:
  ...
  /**
     ...
     */
  virtual bool CanRenderContentToDataSurface() const { return false; }
  ...
  virtual void GetCommonFallbackFonts(uint32_t /*aCh*/,
                                      uint32_t /*aNextCh*/,
                                      Script /*aRunScript*/,
  ...
  /**
     ...
     */
  static void TransformPixel(const Color& in,
                             Color& out,
  ...
  already_AddRefed<DrawTarget> CreateDrawTargetForBackend(
      mozilla::gfx::BackendType aBackend,
      const mozilla::gfx::IntSize& aSize,
      mozilla::gfx::SurfaceFormat aFormat);
  ...
  /**
     ...
     * */
  static bool IsGfxInfoStatusOkay(int32_t aFeature,
