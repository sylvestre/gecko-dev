...
static hb_bool_t
HBGetNominalGlyph(hb_font_t* font,
                  void* font_data,
...
static hb_bool_t
HBGetVariationGlyph(hb_font_t* font,
                    void* font_data,
                    hb_codepoint_t unicode,
...
/* static */
hb_position_t
gfxHarfBuzzShaper::HBGetGlyphHAdvance(hb_font_t* font,
                                      void* font_data,
                                      hb_codepoint_t glyph,
                                      void* user_data)
{
...
/* static */
hb_position_t
gfxHarfBuzzShaper::HBGetGlyphVAdvance(hb_font_t* font,
                                      void* font_data,
                                      hb_codepoint_t glyph,
                                      void* user_data)
{
...
/* static */
hb_bool_t
gfxHarfBuzzShaper::HBGetGlyphVOrigin(hb_font_t* font,
                                     void* font_data,
                                     hb_codepoint_t glyph,
                                     hb_position_t* x,
                                     hb_position_t* y,
...
static hb_bool_t
HBGetGlyphExtents(hb_font_t* font,
                  void* font_data,
                  hb_codepoint_t glyph,
...
static hb_bool_t
HBGetContourPoint(hb_font_t* font,
                  void* font_data,
                               ...
                               uint16_t aSecondGlyph) const
{
  ...
  if (uint16_t(kern0->version) == 0) {
    ...
    for (uint16_t i = 0; i < nTables; ++i) {
      ...
      switch (format) {
        case 0:
          GetKernValueFmt0(st0 + 1,
                           subtableLen - sizeof(*st0),
                           aFirstGlyph,
                           aSecondGlyph,
                           value,
    ...
    if (uint32_t(kern1->version) == 0x00010000) {
      ...
      for (uint32_t i = 0; i < nTables; ++i) {
        ...
        switch (format) {
          case 0:
            GetKernValueFmt0(st1 + 1,
                             subtableLen - sizeof(*st1),
                             aFirstGlyph,
                             aSecondGlyph,
                             value);
            break;
          case 2:
            value = GetKernValueVersion1Fmt2(
                st1, subtableLen, aFirstGlyph, aSecondGlyph);
            break;
          case 3:
            value = GetKernValueVersion1Fmt3(
                st1, subtableLen, aFirstGlyph, aSecondGlyph);
            break;
          default:
            // TODO: implement support for other formats.
...
HBGetGeneralCategory(hb_unicode_funcs_t* ufuncs,
                     hb_codepoint_t aCh,
                     void* user_data)
{
...
HBGetCombiningClass(hb_unicode_funcs_t* ufuncs,
                    hb_codepoint_t aCh,
                    void* user_data)
{
                   ...
                   void* user_data)
{
  ...
  int32_t len = unorm2_getRawDecomposition(
      sNormalizer, ab, decomp, MAX_DECOMP_LENGTH, &error);
...
gfxHarfBuzzShaper::Initialize()
{
  ...
  if (!sHBFontFuncs) {
    ...
    hb_font_funcs_set_nominal_glyph_func(
        sHBFontFuncs, HBGetNominalGlyph, nullptr, nullptr);
    hb_font_funcs_set_variation_glyph_func(
        sHBFontFuncs, HBGetVariationGlyph, nullptr, nullptr);
    hb_font_funcs_set_glyph_h_advance_func(
        sHBFontFuncs, HBGetGlyphHAdvance, nullptr, nullptr);
    hb_font_funcs_set_glyph_v_advance_func(
        sHBFontFuncs, HBGetGlyphVAdvance, nullptr, nullptr);
    hb_font_funcs_set_glyph_v_origin_func(
        sHBFontFuncs, HBGetGlyphVOrigin, nullptr, nullptr);
    hb_font_funcs_set_glyph_extents_func(
        sHBFontFuncs, HBGetGlyphExtents, nullptr, nullptr);
    hb_font_funcs_set_glyph_contour_point_func(
        sHBFontFuncs, HBGetContourPoint, nullptr, nullptr);
    hb_font_funcs_set_glyph_h_kerning_func(
        sHBFontFuncs, HBGetHKerning, nullptr, nullptr);

    sHBUnicodeFuncs = hb_unicode_funcs_create(hb_unicode_funcs_get_empty());
    hb_unicode_funcs_set_mirroring_func(
        sHBUnicodeFuncs, HBGetMirroring, nullptr, nullptr);
    hb_unicode_funcs_set_script_func(
        sHBUnicodeFuncs, HBGetScript, nullptr, nullptr);
    ...
    hb_unicode_funcs_set_compose_func(
        sHBUnicodeFuncs, HBUnicodeCompose, nullptr, nullptr);
    hb_unicode_funcs_set_decompose_func(
        sHBUnicodeFuncs, HBUnicodeDecompose, nullptr, nullptr);
                             ...
                             gfxShapedText* aShapedText)
{
  ...
  if (style->variantCaps != NS_FONT_VARIANT_CAPS_NORMAL) {
    switch (style->variantCaps) {
      ...
      case NS_FONT_VARIANT_CAPS_PETITECAPS:
        ...
        mFont->SupportsVariantCaps(
            aScript, style->variantCaps, addSmallCaps, synLower, synUpper);
        break;
      default:
        break;
    }
  ...
  hb_buffer_add_utf16(
      mBuffer, reinterpret_cast<const uint16_t*>(aText), length, 0, length);
  ...
  nsresult rv = SetGlyphsFromRun(
      aShapedText, aOffset, aLength, aText, aVertical, aRounding);
                                    ...
                                    RoundingFlags aRounding)
{
  ...
  while (glyphStart < int32_t(numGlyphs)) {
    ...
    if (glyphsInClump == 1 &&
        gfxTextRun::CompressedGlyph::IsSimpleGlyphID(
      ...
      aShapedText->SetGlyphs(
          aOffset + baseCharIndex, g, detailedGlyphs.Elements());
