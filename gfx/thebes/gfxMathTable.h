...
class gfxMathTable
{
 public:
  ...
  /**
     ...
     */
  nscoord Constant(MathConstant aConstant, uint32_t aAppUnitsPerDevPixel) const
  {
  ...
  /**
     ...
     */
  uint32_t VariantsSize(uint32_t aGlyphID,
                        bool aVertical,
  ...
  /**
     ...
     *
     */
  bool VariantsParts(uint32_t aGlyphID,
                     bool aVertical,
