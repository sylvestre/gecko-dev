                                   ...
                                   uint32_t numClipRects)
{
  ...
  return DrawWithGDK(drawable,
                     offset.x,
                     offset.y,
                     numClipRects ? &clipRect : nullptr,
                     numClipRects);
}

void
gfxGdkNativeRenderer::Draw(gfxContext* ctx,
