...
gfxASurface::SetSurfaceWrapper(cairo_surface_t* csurf, gfxASurface* asurf)
{
  ...
  cairo_surface_set_user_data(
      csurf, &gfxasurface_pointer_key, asurf, SurfaceDestroyFunc);
}
...
gfxASurface::MarkDirty(const gfxRect& r)
{
  ...
  cairo_surface_mark_dirty_rectangle(
      mSurface, (int)r.X(), (int)r.Y(), (int)r.Width(), (int)r.Height());
  gfxPlatform::ClearSourceSurfaceForSurface(this);
}
...
already_AddRefed<gfxASurface>
gfxASurface::CreateSimilarSurface(gfxContentType aContent, const IntSize& aSize)
{
...
nsresult
gfxASurface::BeginPrinting(const nsAString& aTitle,
