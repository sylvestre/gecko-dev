...
class gfxUserFontSet
{
 ...
 public:
  ...
  enum
  {
    ...
    FLAG_FORMATS_COMMON = FLAG_FORMAT_OPENTYPE | FLAG_FORMAT_TRUETYPE |
                          FLAG_FORMAT_WOFF | FLAG_FORMAT_WOFF2,
     ...
     public:
      ...
      static PLDHashNumber HashKey(const KeyTypePointer aKey)
      {
        ...
        return mozilla::HashGeneric(
            principalHash + int(aKey->mPrivate),
            aKey->mURI->Hash(),
...
class gfxUserFontEntry : public gfxFontEntry
{
 ...
 protected:
  ...
  bool FontDataDownloadComplete(const uint8_t* aFontData,
                                uint32_t aLength,
