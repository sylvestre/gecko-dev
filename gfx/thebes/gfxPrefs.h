...
#define DECL_GFX_PREF(Update, Prefname, Name, Type, Default)            \
 public:                                                                \
  ...
  {                                                                     \
    MOZ_ASSERT(SingletonExists());                                      \
    GetSingleton().mPref##Name.Set(                                     \
        UpdatePolicy::Update, Get##Name##PrefName(), aVal);             \
  }                                                                     \
  ...
  {                                                                     \
    ...
    GetSingleton().mPref##Name.SetChangeCallback(aCallback);            \
                                                                        ...
                                                                        \
 private:                                                               \
  PrefTemplate<UpdatePolicy::Update,                                    \
               Type,                                                    \
               Get##Name##PrefDefault,                                  \
               Get##Name##PrefName>                                     \
      mPref##Name
...
#define DECL_OVERRIDE_PREF(Update, Prefname, Name, BaseValue)           \
 public:                                                                \
  ...
  {                                                                     \
    MOZ_ASSERT(SingletonExists());                                      \
    GetSingleton().mPref##Name.Set(                                     \
        UpdatePolicy::Update, Get##Name##PrefName(), aVal ? 1 : 0);     \
  }                                                                     \
  static const char* Get##Name##PrefName() { return Prefname; }         \
...
class gfxPrefs final
{
 ...
 private:
  ...
  DECL_GFX_PREF(
      Live, "apz.allow_checkerboarding", APZAllowCheckerboarding, bool, true);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(
      Live, "apz.autoscroll.enabled", APZAutoscrollEnabled, bool, false);
  DECL_GFX_PREF(Live,
                "apz.axis_lock.breakout_angle",
                APZAxisBreakoutAngle,
                float,
                float(M_PI / 8.0) /* 22.5 degrees */);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(
      Live, "apz.drag.initial.enabled", APZDragInitiationEnabled, bool, false);
  DECL_GFX_PREF(
      Live, "apz.drag.touch.enabled", APZTouchDragEnabled, bool, false);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(Live,
                ...
                1.0f);
  DECL_GFX_PREF(
      Live, "apz.fling_accel_interval_ms", APZFlingAccelInterval, int32_t, 500);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(Live,
                ...
                1.5f);
  DECL_GFX_PREF(
      Once, "apz.fling_curve_function_x1", APZCurveFunctionX1, float, 0.0f);
  DECL_GFX_PREF(
      Once, "apz.fling_curve_function_x2", APZCurveFunctionX2, float, 1.0f);
  DECL_GFX_PREF(
      Once, "apz.fling_curve_function_y1", APZCurveFunctionY1, float, 0.0f);
  DECL_GFX_PREF(
      Once, "apz.fling_curve_function_y2", APZCurveFunctionY2, float, 1.0f);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(Live,
                ...
                0.01f);
  DECL_GFX_PREF(
      Live, "apz.frame_delay.enabled", APZFrameDelayEnabled, bool, false);
  ...
  DECL_GFX_PREF(Live,
                ...
                false);
  DECL_GFX_PREF(
      Live, "apz.max_velocity_inches_per_ms", APZMaxVelocity, float, -1.0f);
  DECL_GFX_PREF(Once,
  ...
  DECL_GFX_PREF(Live,
                ...
                false);
  DECL_GFX_PREF(
      Live, "apz.one_touch_pinch.enabled", APZOneTouchPinchEnabled, bool, true);
  DECL_GFX_PREF(
      Live, "apz.overscroll.enabled", APZOverscrollEnabled, bool, false);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(Live,
                ...
                0.5f);
  DECL_GFX_PREF(
      Live, "apz.paint_skipping.enabled", APZPaintSkipping, bool, true);
  ...
  DECL_GFX_PREF(Live,
                ...
                false);
  DECL_GFX_PREF(
      Live, "apz.second_tap_tolerance", APZSecondTapTolerance, float, 0.5f);
  DECL_GFX_PREF(Live,
                ...
                false);
  DECL_GFX_PREF(
      Live, "apz.test.logging_enabled", APZTestLoggingEnabled, bool, false);
  DECL_GFX_PREF(
      Live, "apz.touch_move_tolerance", APZTouchMoveTolerance, float, 0.1f);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(Live,
                ...
                150);
  DECL_GFX_PREF(
      Live, "apz.x_skate_highmem_adjust", APZXSkateHighMemAdjust, float, 0.0f);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(Live,
                ...
                3.0f);
  DECL_GFX_PREF(
      Live, "apz.y_skate_highmem_adjust", APZYSkateHighMemAdjust, float, 0.0f);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(Live,
                ...
                250);
  DECL_GFX_PREF(
      Live, "apz.scale_repaint_delay_ms", APZScaleRepaintDelay, int32_t, 500);
  ...
  DECL_GFX_PREF(Live,
                ...
                false);
  DECL_GFX_PREF(
      Live, "dom.meta-viewport.enabled", MetaViewportEnabled, bool, false);
  DECL_GFX_PREF(Once, "dom.vr.enabled", VREnabled, bool, false);
  DECL_GFX_PREF(
      Live, "dom.vr.autoactivate.enabled", VRAutoActivateEnabled, bool, false);
  DECL_GFX_PREF(Live,
                ...
                0.1f);
  DECL_GFX_PREF(
      Live, "dom.vr.navigation.timeout", VRNavigationTimeout, int32_t, 1000);
  ...
  DECL_GFX_PREF(Live,
                ...
                10000);
  DECL_GFX_PREF(
      Live, "dom.vr.oculus.quit.timeout", VROculusQuitTimeout, int32_t, 30000);
  ...
  DECL_GFX_PREF(
      Live, "dom.vr.puppet.submitframe", VRPuppetSubmitFrame, uint32_t, 0);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(Live,
                ...
                false);
  DECL_GFX_PREF(
      Live, "dom.w3c_touch_events.enabled", TouchEventsEnabled, int32_t, 0);
  ...
  DECL_GFX_PREF(Live,
                ...
                200);
  DECL_GFX_PREF(
      Live, "general.smoothScroll.lines", LineSmoothScrollEnabled, bool, true);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(Live,
                ...
                150);
  DECL_GFX_PREF(
      Live, "general.smoothScroll.pages", PageSmoothScrollEnabled, bool, true);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(
      Once, "gfx.android.rgb16.force", AndroidRGB16Force, bool, false);
#if defined(ANDROID)
...
#endif
  DECL_GFX_PREF(
      Live, "gfx.compositor.clearstate", CompositorClearState, bool, false);
  DECL_GFX_PREF(Live,
                "gfx.canvas.auto_accelerate.min_calls",
                CanvasAutoAccelerateMinCalls,
                int32_t,
                4);
  DECL_GFX_PREF(Live,
                "gfx.canvas.auto_accelerate.min_frames",
                CanvasAutoAccelerateMinFrames,
                int32_t,
                30);
  DECL_GFX_PREF(Live,
                "gfx.canvas.auto_accelerate.min_seconds",
  ...
  DECL_GFX_PREF(Live,
                ...
                false);
  DECL_GFX_PREF(Once,
                "gfx.canvas.azure.accelerated.limit",
  ...
  DECL_GFX_PREF(Once,
                ...
                256);
  DECL_GFX_PREF(
      Once, "gfx.canvas.skiagl.cache-size", CanvasSkiaGLCacheSize, int32_t, 96);
  DECL_GFX_PREF(Once,
  ...
  DECL_GFX_PREF(
      Live, "gfx.color_management.enablev4", CMSEnableV4, bool, false);
  ...
  DECL_GFX_PREF(
      Once, "gfx.device-reset.limit", DeviceResetLimitCount, int32_t, 10);
  DECL_GFX_PREF(Once,
  ...
  DECL_GFX_PREF(
      Once, "gfx.direct2d.force-enabled", Direct2DForceEnabled, bool, false);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(Live,
                ...
                true);
  DECL_GFX_PREF(
      Live, "gfx.draw-color-bars", CompositorDrawColorBars, bool, false);
  DECL_GFX_PREF(Once,
  ...
  DECL_GFX_PREF(Live,
                ...
                GfxLoggingLevel,
                int32_t,
                mozilla::gfx::LOG_DEFAULT);
  DECL_GFX_PREF(
      Once, "gfx.logging.crash.length", GfxLoggingCrashLength, uint32_t, 16);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(
      Live, "gfx.testing.device-fail", DeviceFailForTesting, bool, false);
  ...
  DECL_GFX_PREF(Live,
                ...
                false);
  DECL_GFX_PREF(
      Once, "gfx.use-iosurface-textures", UseIOSurfaceTextures, bool, false);
  DECL_GFX_PREF(
      Once, "gfx.use-mutex-on-present", UseMutexOnPresent, bool, false);
  // These times should be in milliseconds
  DECL_GFX_PREF(Once,
                "gfx.touch.resample.delay-threshold",
                TouchResampleVsyncDelayThreshold,
                int32_t,
                20);
  DECL_GFX_PREF(Once,
                "gfx.touch.resample.max-predict",
                TouchResampleMaxPredict,
                int32_t,
                8);
  DECL_GFX_PREF(
      Once, "gfx.touch.resample.min-delta", TouchResampleMinDelta, int32_t, 2);
  DECL_GFX_PREF(Once,
                "gfx.touch.resample.old-touch-threshold",
                TouchResampleOldTouchThreshold,
                int32_t,
                17);
  DECL_GFX_PREF(Once,
                "gfx.touch.resample.vsync-adjust",
  ...
  DECL_GFX_PREF(
      Live, "gfx.webrender.blob-images", WebRenderBlobImages, bool, false);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(
      Once, "gfx.work-around-driver-bugs", WorkAroundDriverBugs, bool, true);
  DECL_GFX_PREF(Once,
  ...
  DECL_GFX_PREF(Live,
                ...
                -1);
  DECL_GFX_PREF(
      Once, "image.cache.size", ImageCacheSize, int32_t, 5 * 1024 * 1024);
  DECL_GFX_PREF(
      Once, "image.cache.timeweight", ImageCacheTimeWeight, int32_t, 500);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(Once,
                ...
                200000);
  DECL_GFX_PREF(
      Live, "image.mem.discardable", ImageMemDiscardable, bool, false);
  DECL_GFX_PREF(Once,
  ...
  DECL_GFX_PREF(Live,
                ...
                bool,
                false);
  DECL_OVERRIDE_PREF(Live,
                     "layers.advanced.background-image",
  ...
  DECL_OVERRIDE_PREF(Live,
                     ...
                     gfxPrefs::OverrideBase_WebRender());
  DECL_OVERRIDE_PREF(Live,
                     "layers.advanced.canvas-background-color",
  ...
  DECL_GFX_PREF(Live,
                ...
                false);
  DECL_OVERRIDE_PREF(Live,
                     "layers.advanced.columnRule-layers",
  ...
  DECL_OVERRIDE_PREF(Live,
                     ...
                     gfxPrefs::OverrideBase_WebRender());
  DECL_OVERRIDE_PREF(Live,
                     "layers.advanced.outline-layers",
  ...
  DECL_GFX_PREF(Once,
                ...
                true);
  DECL_GFX_PREF(Once,
                "layers.async-pan-zoom.separate-event-thread",
                AsyncPanZoomSeparateEventThread,
                bool,
                false);
  DECL_GFX_PREF(Live, "layers.bench.enabled", LayersBenchEnabled, bool, false);
  DECL_GFX_PREF(
      Once, "layers.bufferrotation.enabled", BufferRotationEnabled, bool, true);
  DECL_GFX_PREF(
      Live, "layers.child-process-shutdown", ChildProcessShutdown, bool, true);
  ...
  DECL_GFX_PREF(
      Once, "layers.componentalpha.enabled", ComponentAlphaEnabled, bool, true);
#endif
  DECL_GFX_PREF(Live,
                ...
                false);
  DECL_GFX_PREF(
      Once, "layers.d3d11.force-warp", LayersD3D11ForceWARP, bool, false);
  DECL_GFX_PREF(Live, "layers.deaa.enabled", LayersDEAAEnabled, bool, false);
  DECL_GFX_PREF(
      Live, "layers.draw-bigimage-borders", DrawBigImageBorders, bool, false);
  ...
  DECL_GFX_PREF(
      Live, "layers.dump-client-layers", DumpClientLayers, bool, false);
  ...
  DECL_GFX_PREF(
      Live, "layers.effect.contrast", LayersEffectContrast, float, 0.0f);
  DECL_GFX_PREF(
      Live, "layers.effect.grayscale", LayersEffectGrayscale, bool, false);
  ...
  DECL_GFX_PREF(Once,
                ...
                false);
  DECL_GFX_PREF(
      Once, "layers.gpu-process.enabled", GPUProcessEnabled, bool, false);
  DECL_GFX_PREF(Once,
  ...
  DECL_GFX_PREF(Once,
                ...
                5000);
  DECL_GFX_PREF(
      Live, "layers.low-precision-buffer", UseLowPrecisionBuffer, bool, false);
  DECL_GFX_PREF(
      Live, "layers.low-precision-opacity", LowPrecisionOpacity, float, 1.0f);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(Live,
                ...
                -1);
  DECL_GFX_PREF(
      Live, "layers.omtp.force-sync", LayersOMTPForceSync, bool, false);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(
      Live, "layers.progressive-paint", ProgressivePaint, bool, false);
  DECL_GFX_PREF(Live,
                ...
                false);
  DECL_GFX_PREF(
      Live, "layers.single-tile.enabled", LayersSingleTileEnabled, bool, true);
  DECL_GFX_PREF(
      Once, "layers.stereo-video.enabled", StereoVideoEnabled, bool, false);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(
      Once, "layers.tiles.edge-padding", TileEdgePaddingEnabled, bool, true);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(
      Live, "layers.geometry.opengl.enabled", OGLLayerGeometry, bool, false);
  DECL_GFX_PREF(
      Live, "layers.geometry.basic.enabled", BasicLayerGeometry, bool, false);
  DECL_GFX_PREF(
      Live, "layers.geometry.d3d11.enabled", D3D11LayerGeometry, bool, false);
  ...
  DECL_GFX_PREF(Live,
                ...
                200);
  DECL_GFX_PREF(
      Live, "layout.css.touch_action.enabled", TouchActionEnabled, bool, false);
  DECL_GFX_PREF(Live,
                ...
                false);
  DECL_GFX_PREF(
      Live, "layout.display-list.retain", LayoutRetainDisplayList, bool, true);

  DECL_GFX_PREF(
      Live, "layout.display-list.dump", LayoutDumpDisplayList, bool, false);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(
      Live, "layout.min-active-layer-size", LayoutMinActiveLayerSize, int, 64);
  DECL_GFX_PREF(Once,
...
#ifdef XP_WIN
  DECL_GFX_PREF(
      Live, "media.wmf.dxva.d3d11.enabled", PDMWMFAllowD3D11, bool, true);
  DECL_GFX_PREF(
      Live, "media.wmf.dxva.max-videos", PDMWMFMaxDXVAVideos, uint32_t, 8);
  DECL_GFX_PREF(
      Live, "media.wmf.use-nv12-format", PDMWMFUseNV12Format, bool, true);
  DECL_GFX_PREF(
      Once, "media.wmf.use-sync-texture", PDMWMFUseSyncTexture, bool, true);
  DECL_GFX_PREF(Live,
                ...
                false);
  DECL_GFX_PREF(
      Live, "media.wmf.skip-blacklist", PDMWMFSkipBlacklist, bool, false);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(
      Once, "slider.snapMultiplier", SliderSnapMultiplier, int32_t, 0);

  DECL_GFX_PREF(
      Live, "test.events.async.enabled", TestEventsAsyncEnabled, bool, false);
  DECL_GFX_PREF(
      Live, "test.mousescroll", MouseScrollTestingEnabled, bool, false);
  ...
  DECL_GFX_PREF(
      Live, "webgl.1.allow-core-profiles", WebGL1AllowCoreProfile, bool, false);

  DECL_GFX_PREF(
      Live, "webgl.all-angle-options", WebGLAllANGLEOptions, bool, false);
  DECL_GFX_PREF(
      Live, "webgl.angle.force-d3d11", WebGLANGLEForceD3D11, bool, false);
  DECL_GFX_PREF(Live, "webgl.angle.try-d3d11", WebGLANGLETryD3D11, bool, false);
  DECL_GFX_PREF(
      Live, "webgl.angle.force-warp", WebGLANGLEForceWARP, bool, false);
  DECL_GFX_PREF(Live,
  ...
  DECL_GFX_PREF(Live,
                ...
                true);
  DECL_GFX_PREF(
      Live, "webgl.default-no-alpha", WebGLDefaultNoAlpha, bool, false);
  ...
  DECL_GFX_PREF(
      Live, "webgl.disable-extensions", WebGLDisableExtensions, bool, false);
  DECL_GFX_PREF(Live, "webgl.dxgl.enabled", WebGLDXGLEnabled, bool, false);
  DECL_GFX_PREF(
      Live, "webgl.dxgl.needs-finish", WebGLDXGLNeedsFinish, bool, false);
  ...
  DECL_GFX_PREF(Live,
                ...
                32);
  DECL_GFX_PREF(
      Live, "webgl.min_capability_mode", WebGLMinCapabilityMode, bool, false);
  ...
  DECL_GFX_PREF(Live,
                ...
                false);
  DECL_GFX_PREF(
      Live, "webgl.allow-fb-invalidation", WebGLFBInvalidation, bool, false);

  DECL_GFX_PREF(
      Live, "webgl.perf.max-warnings", WebGLMaxPerfWarnings, int32_t, 0);
  DECL_GFX_PREF(Live,
                ...
                0);
  DECL_GFX_PREF(
      Live, "webgl.perf.spew-frame-allocs", WebGLSpewFrameAllocs, bool, true);

  DECL_GFX_PREF(
      Live, "webgl.webgl2-compat-mode", WebGL2CompatMode, bool, false);
