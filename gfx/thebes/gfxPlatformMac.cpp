...
gfxPlatformMac::gfxPlatformMac()
{
  ...
  InitBackendPrefs(
      canvasMask, BackendType::SKIA, contentMask, BackendType::SKIA);
...
{
  gfxMacPlatformFontList::PlatformFontList()->GetSystemFontFamilyList(
      aFontFamilies);
}
...
void
gfxPlatformMac::GetCommonFallbackFonts(uint32_t aCh,
                                       uint32_t aNextCh,
                                       Script aRunScript,
                                 ...
                                 float aDevPixPerCSSPixel)
{
  ...
  return pfl->LookupSystemFont(
      aSystemFontID, aSystemFontName, aFontStyle, aDevPixPerCSSPixel);
}
   ...
   public:
    ...
    void EnableVsync() override
    {
      ...
      if (CVDisplayLinkCreateWithActiveCGDisplays(&mDisplayLink) !=
        ...
        uint32_t delay = 100;
        mTimer->InitWithNamedFuncCallback(RetryEnableVsync,
                                          this,
                                          delay,
