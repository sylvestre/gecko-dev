...
static const uint32_t sLanguageTagList[] = {
    ...
    TRUETYPE_TAG(
        'i', 'a', 0, 0),  // ia = Interlingua (International Auxiliary Language
    ...
    TRUETYPE_TAG(
        'a', 's', 'w', 0),  // asw = Australian Aborigines Sign Language
    ...
    TRUETYPE_TAG(
        'b', 'c', 'p', 0),  // bcp = Bali (Democratic Republic of Congo)
    ...
    TRUETYPE_TAG(
        'b', 'k', 'p', 0),  // bkp = Boko (Democratic Republic of Congo)
    ...
    TRUETYPE_TAG(
        'b', 'm', 'y', 0),  // bmy = Bemba (Democratic Republic of Congo)
    ...
    TRUETYPE_TAG(
        'b', 'x', 'x', 0),  // bxx = Borna (Democratic Republic of Congo)
    ...
    TRUETYPE_TAG(
        'c', 'p', 'p', 0),  // cpp = Portuguese-based creoles and pidgins
    ...
    TRUETYPE_TAG(
        'k', 'e', 'l', 0),  // kel = Kela (Democratic Republic of Congo)
    ...
    TRUETYPE_TAG(
        'k', 'h', 'y', 0),  // khy = Kele (Democratic Republic of Congo)
    ...
    TRUETYPE_TAG(
        'k', 'm', 'w', 0),  // kmw = Komo (Democratic Republic of Congo)
    ...
    TRUETYPE_TAG(
        'k', 't', 'u', 0),  // ktu = Kituba (Democratic Republic of Congo)
    ...
    TRUETYPE_TAG(
        'l', 'e', 'l', 0),  // lel = Lele (Democratic Republic of Congo)
    ...
    TRUETYPE_TAG(
        'm', 'n', 'h', 0),  // mnh = Mono (Democratic Republic of Congo)
    ...
    TRUETYPE_TAG(
        'n', 'g', 'c', 0),  // ngc = Ngombe (Democratic Republic of Congo)
    ...
    TRUETYPE_TAG(
        'n', 'h', 'i', 0),  // nhi = Zacatlán-Ahuacatlán-Tepetzintla Nahuatl
    ...
    TRUETYPE_TAG(
        'n', 'x', 'd', 0),  // nxd = Ngando (Democratic Republic of Congo)
    ...
    TRUETYPE_TAG(
        'p', 'l', 'f', 0),  // plf = Central Malayo-Polynesian languages
    ...
    TRUETYPE_TAG(
        'p', 'q', 'e', 0),  // pqe = Eastern Malayo-Polynesian languages
    ...
    TRUETYPE_TAG(
        'q', 'v', 'h', 0),  // qvh = Huamalíes-Dos de Mayo Huánuco Quechua
    ...
    TRUETYPE_TAG(
        'q', 'v', 'm', 0),  // qvm = Margos-Yarowilca-Lauricocha Quechua
    ...
    TRUETYPE_TAG(
        's', 'f', 'b', 0),  // sfb = Langue des signes de Belgique Francophone
    ...
    TRUETYPE_TAG(
        's', 'n', 'g', 0),  // sng = Sanga (Democratic Republic of Congo)
    ...
    TRUETYPE_TAG(
        't', 'm', 'r', 0),  // tmr = Jewish Babylonian Aramaic (ca. 200-1200 CE)
    ...
    TRUETYPE_TAG(
        'y', 'a', 'f', 0),  // yaf = Yaka (Democratic Republic of Congo)
