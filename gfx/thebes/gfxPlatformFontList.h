...
class gfxPlatformFontList : public gfxFontInfoLoader
{
 ...
 public:
  ...
  gfxFontEntry* SystemFindFontForChar(uint32_t aCh,
                                      uint32_t aNextCh,
                                      Script aRunScript,
  ...
  void GetLangPrefs(eFontPrefLang aPrefLangs[],
                    uint32_t& aLen,
  ...
  static void AppendPrefLang(eFontPrefLang aPrefLangs[],
                             uint32_t& aLen,
  ...
  void GetSampleLangForGroup(nsAtom* aLanguage,
                             nsACString& aLangStr,
 ...
 protected:
  ...
  gfxFontEntry* CommonFontFallback(uint32_t aCh,
                                   uint32_t aNextCh,
                                   Script aRunScript,
  ...
  void AppendCJKPrefLangs(eFontPrefLang aPrefLangs[],
                          uint32_t& aLen,
                          eFontPrefLang aCharLang,
                          eFontPrefLang aPageLang);
  ...
  bool TryLangForGroup(const nsACString& aOSLang,
                       nsAtom* aLangGroup,
                       nsACString& aLang);
  ...
  void ResolveGenericFontNames(
      mozilla::FontFamilyType aGenericType,
