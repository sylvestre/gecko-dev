...
*/
OSVR_INLINE void
osvrQuatToQuatlib(q_type dest, OSVR_Quaternion const* src)
{
...
OSVR_INLINE void
osvrQuatFromQuatlib(OSVR_Quaternion* dest, q_type const src)
{
...
OSVR_INLINE void
osvrVec3ToQuatlib(q_vec_type dest, OSVR_Vec3 const* src)
{
  memcpy((void*)(dest), (void const*)(src->data), sizeof(double) * 3);
}

OSVR_INLINE void
osvrVec3FromQuatlib(OSVR_Vec3* dest, q_vec_type const src)
{
  memcpy((void*)(dest->data), (void const*)(src), sizeof(double) * 3);
}

OSVR_INLINE void
osvrPose3ToQuatlib(q_xyz_quat_type* dest, OSVR_Pose3 const* src)
{
...
OSVR_INLINE void
osvrPose3FromQuatlib(OSVR_Pose3* dest, q_xyz_quat_type const* src)
{
