...
*/
OSVR_UTIL_EXPORT OSVR_ReturnCode
osvrPose3ToMatrixd(OSVR_Pose3 const* pose,
...
*/
OSVR_UTIL_EXPORT OSVR_ReturnCode
osvrPose3ToMatrixf(OSVR_Pose3 const* pose,
                   OSVR_MatrixConventions flags,
                   float* mat);
/** @} */
...
osvrPose3ToMatrix(OSVR_Pose3 const* pose,
                  OSVR_MatrixConventions flags,
                  double* mat)
{
