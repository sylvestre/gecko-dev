...
VRManager::VRManager() : mInitialized(false), mVRTestSystemCreated(false)
{
...
void
VRManager::VibrateHaptic(uint32_t aControllerIdx,
...
void
VRManager::DispatchSubmitFrameResult(uint32_t aDisplayID,
