...
struct ParamTraits<mozilla::gfx::Matrix>
{
  ...
  {
    aLog->append(StringPrintf(L"[[%g %g] [%g %g] [%g %g]]",
                              aParam._11,
                              aParam._12,
                              aParam._21,
                              aParam._22,
...
struct ParamTraits<gfxContentType>
    : public ContiguousEnumSerializer<gfxContentType,
...
struct ParamTraits<gfxSurfaceType>
    : public ContiguousEnumSerializer<gfxSurfaceType,
...
struct ParamTraits<GeckoProcessType>
    : public ContiguousEnumSerializer<GeckoProcessType,
