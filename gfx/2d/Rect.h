...
struct MarginTyped : public BaseMargin<F, MarginTyped<units, F> >, public units
{
  static_assert(IsPixel<units>::value,
                "'units' must be a coordinate system tag");
...
template<class units>
IntMarginTyped<units>
RoundedToInt(const MarginTyped<units>& aMargin)
{
...
template<class units>
struct IntRectTyped : public BaseRect<int32_t,
                                      IntRectTyped<units>,
                                      IntPointTyped<units>,
                                      IntSizeTyped<units>,
                                      IntMarginTyped<units> >,
                      public units
{
  ...
  static IntRectTyped<units> RoundIn(const RectTyped<units, float>& aRect)
  {
    auto tmp(aRect);
    tmp.RoundIn();
    return IntRectTyped(int32_t(tmp.x),
                        int32_t(tmp.y),
                        int32_t(tmp.Width()),
                        int32_t(tmp.Height()));
  }
  ...
  {
    return IntRectTyped<UnknownUnits>(
...
template<class units, class F = Float>
struct RectTyped : public BaseRect<F,
                                   RectTyped<units, F>,
                                   PointTyped<units, F>,
                                   SizeTyped<units, F>,
                                   MarginTyped<units, F> >,
                   public units
{
  ...
  {
    *aOut = IntRectTyped<units>(int32_t(this->X()),
                                int32_t(this->Y()),
                                int32_t(this->Width()),
                                int32_t(this->Height()));
    return RectTyped<units, F>(
               F(aOut->x), F(aOut->y), F(aOut->Width()), F(aOut->Height()))
        .IsEqualEdges(*this);
  }
  ...
  {
    return RectTyped<UnknownUnits, F>(
        this->x, this->y, this->Width(), this->Height());
  }
...
template<class units>
IntRectTyped<units>
RoundedToInt(const RectTyped<units>& aRect)
{
...
template<class units>
IntRectTyped<units>
RoundedIn(const RectTyped<units>& aRect)
{
...
template<class units>
IntRectTyped<units>
RoundedOut(const RectTyped<units>& aRect)
{
...
template<class units>
IntRectTyped<units>
TruncatedToInt(const RectTyped<units>& aRect)
{
...
template<class units>
RectTyped<units>
IntRectToRect(const IntRectTyped<units>& aRect)
{
