 ...
 */
class FilterNodeSoftware : public FilterNode, public FilterInvalidationListener
{
 public:
  ...
  void Draw(DrawTarget* aDrawTarget,
    ...
    : public FilterNodeComponentTransferSoftware
{
 ...
 private:
  void FillLookupTableImpl(Float aAmplitude,
                           Float aExponent,
                           Float aOffset,
                           uint8_t aTable[256]);
