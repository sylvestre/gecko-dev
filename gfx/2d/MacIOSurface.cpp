...
IOSurfacePtr
MacIOSurfaceLib::IOSurfaceCreate(CFDictionaryRef properties)
{
  return sCreate(properties);
}

IOSurfacePtr
MacIOSurfaceLib::IOSurfaceLookup(IOSurfaceID aIOSurfaceID)
{
  return sLookup(aIOSurfaceID);
}

IOSurfaceID
MacIOSurfaceLib::IOSurfaceGetID(IOSurfacePtr aIOSurfacePtr)
{
  return sGetID(aIOSurfacePtr);
}

void*
MacIOSurfaceLib::IOSurfaceGetBaseAddress(IOSurfacePtr aIOSurfacePtr)
{
  return sGetBaseAddress(aIOSurfacePtr);
}

void*
MacIOSurfaceLib::IOSurfaceGetBaseAddressOfPlane(IOSurfacePtr aIOSurfacePtr,
                                                size_t planeIndex)
{
...
size_t
MacIOSurfaceLib::IOSurfaceGetPlaneCount(IOSurfacePtr aIOSurfacePtr)
{
  return sPlaneCount(aIOSurfacePtr);
}

size_t
MacIOSurfaceLib::IOSurfaceGetWidth(IOSurfacePtr aIOSurfacePtr, size_t plane)
{
  return sWidth(aIOSurfacePtr, plane);
}

size_t
MacIOSurfaceLib::IOSurfaceGetHeight(IOSurfacePtr aIOSurfacePtr, size_t plane)
{
  return sHeight(aIOSurfacePtr, plane);
}

size_t
MacIOSurfaceLib::IOSurfaceGetBytesPerRow(IOSurfacePtr aIOSurfacePtr,
                                         size_t plane)
{
...
size_t
MacIOSurfaceLib::IOSurfaceGetPropertyMaximum(CFStringRef property)
{
  return sGetPropertyMaximum(property);
}

OSType
MacIOSurfaceLib::IOSurfaceGetPixelFormat(IOSurfacePtr aIOSurfacePtr)
{
  return sPixelFormat(aIOSurfacePtr);
}

IOReturn
MacIOSurfaceLib::IOSurfaceLock(IOSurfacePtr aIOSurfacePtr,
                               uint32_t options,
                               uint32_t* seed)
{
...
IOReturn
MacIOSurfaceLib::IOSurfaceUnlock(IOSurfacePtr aIOSurfacePtr,
                                 uint32_t options,
                                 uint32_t* seed)
{
...
void
MacIOSurfaceLib::IOSurfaceIncrementUseCount(IOSurfacePtr aIOSurfacePtr)
{
  sIncrementUseCount(aIOSurfacePtr);
}

void
MacIOSurfaceLib::IOSurfaceDecrementUseCount(IOSurfacePtr aIOSurfacePtr)
{
  sDecrementUseCount(aIOSurfacePtr);
}

CGLError
MacIOSurfaceLib::CGLTexImageIOSurface2D(CGLContextObj ctxt,
                                        GLenum target,
                                        ...
                                        GLenum format,
                                        GLenum type,
                                        IOSurfacePtr ioSurface,
                                        GLuint plane)
{
  return sTexImage(ctxt,
                   target,
                   internalFormat,
                   width,
                   height,
...
IOSurfacePtr
MacIOSurfaceLib::CVPixelBufferGetIOSurface(CVPixelBufferRef aPixelBuffer)
{
  return sCVPixelBufferGetIOSurface(aPixelBuffer);
}

CGContextRef
MacIOSurfaceLib::IOSurfaceContextCreate(IOSurfacePtr aIOSurfacePtr,
                                        unsigned aWidth,
                                        unsigned aHeight,
                                        unsigned aBitsPerComponent,
                                        unsigned aBytes,
                                        CGColorSpaceRef aColorSpace,
                                        CGBitmapInfo bitmapInfo)
{
  if (!sIOSurfaceContextCreate) return nullptr;
  return sIOSurfaceContextCreate(aIOSurfacePtr,
                                 aWidth,
                                 aHeight,
                                 aBitsPerComponent,
                                 aBytes,
...
CGImageRef
MacIOSurfaceLib::IOSurfaceContextCreateImage(CGContextRef aContext)
{
...
IOSurfacePtr
MacIOSurfaceLib::IOSurfaceContextGetSurface(CGContextRef aContext)
{
...
CFStringRef
MacIOSurfaceLib::GetIOConst(const char* symbole)
{
                              ...
                              bool aHasAlpha)
{
  ...
  ::CFDictionaryAddValue(
      props, MacIOSurfaceLib::kPropBytesPerElem, cfBytesPerElem);
...
size_t
MacIOSurface::GetWidth(size_t plane)
{
...
size_t
MacIOSurface::GetHeight(size_t plane)
{
  size_t intScaleFactor = ceil(mContentsScaleFactor);
...
void
MacIOSurface::DecrementUseCount()
{
...
{
  MacIOSurfaceLib::IOSurfaceLock(
      mIOSurfacePtr, aReadOnly ? READ_ONLY : 0, nullptr);
}

void
MacIOSurface::Unlock(bool aReadOnly)
{
  MacIOSurfaceLib::IOSurfaceUnlock(
      mIOSurfacePtr, aReadOnly ? READ_ONLY : 0, nullptr);
}
    ...
    mozilla::gfx::SurfaceFormat* aOutReadFormat)
{
  ...
  return CGLTexImageIOSurface2D(ctx,
...
MacIOSurface::CreateIOSurfaceContext()
{
  ...
  CGContextRef ref =
      MacIOSurfaceLib::IOSurfaceContextCreate(mIOSurfacePtr,
                                              GetDevicePixelWidth(),
...
CGImageRef
MacIOSurface::CreateImageFromIOSurfaceContext(CGContextRef aContext)
{
...
already_AddRefed<MacIOSurface>
MacIOSurface::IOSurfaceContextGetSurface(CGContextRef aContext,
                                         double aContentsScaleFactor,
                                         bool aHasAlpha)
{
  if (!MacIOSurfaceLib::isInit() || aContentsScaleFactor <= 0) return nullptr;
...
CGContextType
GetContextType(CGContextRef ref)
{
