...
inline uint32_t
Avg2x2(uint32_t a, uint32_t b, uint32_t c, uint32_t d)
{
...
ImageHalfScaler::ScaleForSize(const IntSize& aSize)
{
  ...
  while (verticalDownscales && horizontalDownscales) {
    ...
    HalfImage2D(currentSampledData,
  ...
  while (verticalDownscales) {
    ...
    HalfImageVertical(currentSampledData,
                      currentSampledStride,
                      currentSampledSize,
                      mData,
                      mStride);
  ...
  while (horizontalDownscales) {
    ...
    HalfImageHorizontal(currentSampledData,
                        currentSampledStride,
                        currentSampledSize,
                        mData,
                        mStride);
...
void
ImageHalfScaler::HalfImage2D(uint8_t* aSource,
...
void
ImageHalfScaler::HalfImageVertical(uint8_t* aSource,
                                   int32_t aSourceStride,
                                   const IntSize& aSourceSize,
                                   uint8_t* aDest,
                                   uint32_t aDestStride)
{
  ...
  if (Factory::HasSSE2()) {
    HalfImageVertical_SSE2(
        aSource, aSourceStride, aSourceSize, aDest, aDestStride);
  } else
#endif
  {
    HalfImageVertical_C(
...
void
ImageHalfScaler::HalfImageHorizontal(uint8_t* aSource,
                                     int32_t aSourceStride,
                                     const IntSize& aSourceSize,
                                     uint8_t* aDest,
                                     uint32_t aDestStride)
...
void
ImageHalfScaler::HalfImage2D_C(uint8_t* aSource,
                               int32_t aSourceStride,
                               const IntSize& aSourceSize,
                               uint8_t* aDest,
                               uint32_t aDestStride)
{
  for (int y = 0; y < aSourceSize.height; y += 2) {
    ...
    for (int x = 0; x < aSourceSize.width; x += 2) {
      ...
      *storage++ = Avg2x2(*(uint32_t*)upperRow,
                          *((uint32_t*)upperRow + 1),
                          *(uint32_t*)lowerRow,
                          *((uint32_t*)lowerRow + 1));
    }
...
void
ImageHalfScaler::HalfImageVertical_C(uint8_t* aSource,
                                     int32_t aSourceStride,
                                     const IntSize& aSourceSize,
                                     uint8_t* aDest,
                                     uint32_t aDestStride)
...
void
ImageHalfScaler::HalfImageHorizontal_C(uint8_t* aSource,
                                       int32_t aSourceStride,
                                       const IntSize& aSourceSize,
                                       uint8_t* aDest,
                                       uint32_t aDestStride)
