...
template<class units>
IntPointTyped<units>
RoundedToInt(const PointTyped<units>& aPoint)
{
...
template<class units>
IntPointTyped<units>
TruncatedToInt(const PointTyped<units>& aPoint)
{
...
template<class units>
IntSizeTyped<units>
RoundedToInt(const SizeTyped<units>& aSize)
{
