...
class GradientStopsCairo : public GradientStops
{
 public:
  ...
  GradientStopsCairo(GradientStop* aStops,
                     uint32_t aNumStops,
...
class DrawTargetCairo final : public DrawTarget
{
 public:
  ...
  virtual bool LockBits(uint8_t** aData,
                        IntSize* aSize,
                        int32_t* aStride,
 ...
 private:  // methods
  ...
  bool InitAlreadyReferenced(cairo_surface_t* aSurface,
                             const IntSize& aSize,
                             SurfaceFormat* aFormat = nullptr);
  enum DrawPatternType
  {
    DRAW_FILL,
    DRAW_STROKE
  };
