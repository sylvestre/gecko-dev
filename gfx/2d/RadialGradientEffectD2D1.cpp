...
RadialGradientEffectD2D1::Register(ID2D1Factory1* aFactory)
{
  D2D1_PROPERTY_BINDING bindings[] = {
      ...
      D2D1_VALUE_TYPE_BINDING(L"Center1",
                              &RadialGradientEffectD2D1::SetCenter1,
                              &RadialGradientEffectD2D1::GetCenter1),
      D2D1_VALUE_TYPE_BINDING(L"Center2",
                              &RadialGradientEffectD2D1::SetCenter2,
                              &RadialGradientEffectD2D1::GetCenter2),
      D2D1_VALUE_TYPE_BINDING(L"Radius1",
                              &RadialGradientEffectD2D1::SetRadius1,
                              &RadialGradientEffectD2D1::GetRadius1),
      D2D1_VALUE_TYPE_BINDING(L"Radius2",
                              &RadialGradientEffectD2D1::SetRadius2,
  ...
  HRESULT hr = aFactory->RegisterEffectFromString(CLSID_RadialGradientEffect,
                                                  kXmlDescription,
                                                  bindings,
                                                  ARRAYSIZE(bindings),
                                                  CreateEffect);
...
HRESULT __stdcall RadialGradientEffectD2D1::CreateEffect(IUnknown** aEffectImpl)
{
...
RadialGradientEffectD2D1::CreateGradientTexture()
{
  ...
  HRESULT hr = mEffectContext->CreateResourceTexture(nullptr,
                                                     &props,
                                                     &textureData.front(),
                                                     &stride,
                                                     4096 * 4,
