...
DWriteFontFileStream::DWriteFontFileStream(uint8_t* aData,
                                           uint32_t aSize,
...
NativeFontResourceDWrite::Create(uint8_t* aFontData,
                                 ...
                                 bool aNeedsCairo)
{
  ...
  HRESULT hr =
      factory->CreateCustomFontFileReference(&fontFileKey,
                                             sizeof(fontFileKey),
  ...
  RefPtr<NativeFontResourceDWrite> fontResource = new NativeFontResourceDWrite(
      factory, fontFile.forget(), faceType, numberOfFaces, aNeedsCairo);
                                             ...
                                             uint32_t aInstanceDataLength)
{
  ...
  if (FAILED(mFactory->CreateFontFace(mFaceType,
                                      1,
                                      &fontFile,
                                      aIndex,
  ...
  RefPtr<UnscaledFont> unscaledFont = new UnscaledFontDWrite(
      fontFace, DWRITE_FONT_SIMULATIONS_NONE, mNeedsCairo);
