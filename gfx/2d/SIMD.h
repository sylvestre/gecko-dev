...
i32x4_t
From32(int32_t a, int32_t b, int32_t c, int32_t d);
...
f32x4_t
FromF32(float a, float b, float c, float d);
...
inline void
Store8(uint8_t* aTarget, Scalaru8x16_t aM)
{
...
FromI16<Scalari16x8_t>(int16_t a,
                       int16_t b,
                       int16_t c,
                       int16_t d,
                       int16_t e,
...
FromU16<Scalaru16x8_t>(uint16_t a,
                       uint16_t b,
                       uint16_t c,
                       uint16_t d,
                       uint16_t e,
...
From32<Scalari32x4_t>(int32_t a, int32_t b, int32_t c, int32_t d)
{
  Scalari32x4_t m;
  m.i32[0] = a;
  m.i32[1] = b;
...
template<>
inline Scalarf32x4_t
FromF32<Scalarf32x4_t>(float a, float b, float c, float d)
{
  Scalarf32x4_t m;
  m.f32[0] = a;
  m.f32[1] = b;
...
template<>
inline Scalari32x4_t
From32<Scalari32x4_t>(int32_t a)
{
...
{
  return From32<Scalari32x4_t>(aM.i32[0] >> aNumberOfBits,
                               aM.i32[1] >> aNumberOfBits,
                               aM.i32[2] >> aNumberOfBits,
                               aM.i32[3] >> aNumberOfBits);
}

inline Scalaru16x8_t
Add16(Scalaru16x8_t aM1, Scalaru16x8_t aM2)
{
  return FromU16<Scalaru16x8_t>(aM1.u16[0] + aM2.u16[0],
                                aM1.u16[1] + aM2.u16[1],
                                aM1.u16[2] + aM2.u16[2],
                                aM1.u16[3] + aM2.u16[3],
                                aM1.u16[4] + aM2.u16[4],
...
inline Scalari32x4_t
Add32(Scalari32x4_t aM1, Scalari32x4_t aM2)
{
  return From32<Scalari32x4_t>(aM1.i32[0] + aM2.i32[0],
                               aM1.i32[1] + aM2.i32[1],
                               aM1.i32[2] + aM2.i32[2],
                               aM1.i32[3] + aM2.i32[3]);
}
...
inline Scalaru16x8_t
Sub16(Scalaru16x8_t aM1, Scalaru16x8_t aM2)
{
  return FromU16<Scalaru16x8_t>(aM1.u16[0] - aM2.u16[0],
                                aM1.u16[1] - aM2.u16[1],
                                aM1.u16[2] - aM2.u16[2],
...
inline Scalari32x4_t
Sub32(Scalari32x4_t aM1, Scalari32x4_t aM2)
{
  return From32<Scalari32x4_t>(aM1.i32[0] - aM2.i32[0],
                               aM1.i32[1] - aM2.i32[1],
                               aM1.i32[2] - aM2.i32[2],
...
inline Scalaru8x16_t
Min8(Scalaru8x16_t aM1, Scalaru8x16_t aM2)
{
  return From8<Scalaru8x16_t>(umin(aM1.u8[0], aM2.u8[0]),
                              umin(aM1.u8[1], aM2.u8[1]),
                              umin(aM1.u8[2], aM2.u8[2]),
                              umin(aM1.u8[3], aM2.u8[3]),
                              umin(aM1.u8[4], aM2.u8[4]),
                              umin(aM1.u8[5], aM2.u8[5]),
                              umin(aM1.u8[6], aM2.u8[6]),
                              umin(aM1.u8[7], aM2.u8[7]),
                              umin(aM1.u8[8 + 0], aM2.u8[8 + 0]),
                              umin(aM1.u8[8 + 1], aM2.u8[8 + 1]),
                              umin(aM1.u8[8 + 2], aM2.u8[8 + 2]),
                              umin(aM1.u8[8 + 3], aM2.u8[8 + 3]),
                              umin(aM1.u8[8 + 4], aM2.u8[8 + 4]),
                              umin(aM1.u8[8 + 5], aM2.u8[8 + 5]),
                              umin(aM1.u8[8 + 6], aM2.u8[8 + 6]),
                              umin(aM1.u8[8 + 7], aM2.u8[8 + 7]));
}

inline Scalaru8x16_t
Max8(Scalaru8x16_t aM1, Scalaru8x16_t aM2)
{
  return From8<Scalaru8x16_t>(umax(aM1.u8[0], aM2.u8[0]),
                              umax(aM1.u8[1], aM2.u8[1]),
                              umax(aM1.u8[2], aM2.u8[2]),
                              umax(aM1.u8[3], aM2.u8[3]),
                              umax(aM1.u8[4], aM2.u8[4]),
                              umax(aM1.u8[5], aM2.u8[5]),
                              umax(aM1.u8[6], aM2.u8[6]),
                              umax(aM1.u8[7], aM2.u8[7]),
                              umax(aM1.u8[8 + 0], aM2.u8[8 + 0]),
                              umax(aM1.u8[8 + 1], aM2.u8[8 + 1]),
                              umax(aM1.u8[8 + 2], aM2.u8[8 + 2]),
                              umax(aM1.u8[8 + 3], aM2.u8[8 + 3]),
                              umax(aM1.u8[8 + 4], aM2.u8[8 + 4]),
                              umax(aM1.u8[8 + 5], aM2.u8[8 + 5]),
                              umax(aM1.u8[8 + 6], aM2.u8[8 + 6]),
                              umax(aM1.u8[8 + 7], aM2.u8[8 + 7]));
}

inline Scalari32x4_t
Min32(Scalari32x4_t aM1, Scalari32x4_t aM2)
{
  return From32<Scalari32x4_t>(umin(aM1.i32[0], aM2.i32[0]),
                               umin(aM1.i32[1], aM2.i32[1]),
                               umin(aM1.i32[2], aM2.i32[2]),
                               umin(aM1.i32[3], aM2.i32[3]));
}

inline Scalari32x4_t
Max32(Scalari32x4_t aM1, Scalari32x4_t aM2)
{
  return From32<Scalari32x4_t>(umax(aM1.i32[0], aM2.i32[0]),
                               umax(aM1.i32[1], aM2.i32[1]),
                               umax(aM1.i32[2], aM2.i32[2]),
                               umax(aM1.i32[3], aM2.i32[3]));
}

inline Scalaru16x8_t
Mul16(Scalaru16x8_t aM1, Scalaru16x8_t aM2)
{
...
inline void
Mul16x4x2x2To32x4x2(Scalari16x8_t aFactorsA1B1,
...
inline Scalari32x4_t
MulAdd16x8x2To32x4(Scalari16x8_t aFactorsA, Scalari16x8_t aFactorsB)
{
...
Splat32(Scalari32x4_t aM)
{
  AssertIndex<aIndex>();
  return From32<Scalari32x4_t>(
      aM.i32[aIndex], aM.i32[aIndex], aM.i32[aIndex], aM.i32[aIndex]);
}
...
{
  AssertIndex<i>();
  return From8<Scalaru8x16_t>(aM.u8[i * 4],
                              aM.u8[i * 4 + 1],
                              aM.u8[i * 4 + 2],
                              aM.u8[i * 4 + 3],
                              aM.u8[i * 4],
...
{
  return From8<Scalaru8x16_t>(m1.u8[0],
                              m2.u8[0],
                              m1.u8[1],
                              m2.u8[1],
                              m1.u8[2],
...
{
  return From8<Scalaru8x16_t>(m1.u8[8 + 0],
                              m2.u8[8 + 0],
                              m1.u8[8 + 1],
                              m2.u8[8 + 1],
                              m1.u8[8 + 2],
...
{
  return FromU16<Scalaru16x8_t>(m1.u16[0],
                                m2.u16[0],
                                m1.u16[1],
                                m2.u16[1],
                                m1.u16[2],
...
{
  return FromU16<Scalaru16x8_t>(m1.u16[4],
                                m2.u16[4],
                                m1.u16[5],
                                m2.u16[5],
                                m1.u16[6],
...
{
  return FromU16<Scalaru16x8_t>(uint16_t(aM.u8[0]),
                                uint16_t(aM.u8[1]),
                                uint16_t(aM.u8[2]),
                                uint16_t(aM.u8[3]),
                                uint16_t(aM.u8[4]),
...
{
  return FromU16<Scalaru16x8_t>(aM.u8[8 + 0],
                                aM.u8[8 + 1],
                                aM.u8[8 + 2],
                                aM.u8[8 + 3],
                                aM.u8[8 + 4],
...
inline Scalarf32x4_t
MixF32(Scalarf32x4_t a, Scalarf32x4_t b, float t)
{
...
inline Scalarf32x4_t
WSumF32(Scalarf32x4_t a, Scalarf32x4_t b, float wa, float wb)
{
...
AbsF32(Scalarf32x4_t a)
{
  return FromF32<Scalarf32x4_t>(
      fabs(a.f32[0]), fabs(a.f32[1]), fabs(a.f32[2]), fabs(a.f32[3]));
}

inline Scalarf32x4_t
AddF32(Scalarf32x4_t a, Scalarf32x4_t b)
{
...
inline Scalarf32x4_t
MulF32(Scalarf32x4_t a, Scalarf32x4_t b)
{
  return FromF32<Scalarf32x4_t>(a.f32[0] * b.f32[0],
                                a.f32[1] * b.f32[1],
                                a.f32[2] * b.f32[2],
...
inline Scalarf32x4_t
DivF32(Scalarf32x4_t a, Scalarf32x4_t b)
{
  return FromF32<Scalarf32x4_t>(a.f32[0] / b.f32[0],
                                a.f32[1] / b.f32[1],
                                a.f32[2] / b.f32[2],
...
SplatF32(Scalarf32x4_t m)
{
  AssertIndex<aIndex>();
  return FromF32<Scalarf32x4_t>(
      m.f32[aIndex], m.f32[aIndex], m.f32[aIndex], m.f32[aIndex]);
}
...
inline void
Store8(uint8_t* aTarget, __m128i aM)
{
...
template<>
inline __m128i
From32<__m128i>(int32_t a, int32_t b, int32_t c, int32_t d)
{
...
template<>
inline __m128
FromF32<__m128>(float a, float b, float c, float d)
{
...
inline __m128i
Add16(__m128i aM1, __m128i aM2)
{
  return _mm_add_epi16(aM1, aM2);
}

inline __m128i
Add32(__m128i aM1, __m128i aM2)
{
  return _mm_add_epi32(aM1, aM2);
}

inline __m128i
Sub16(__m128i aM1, __m128i aM2)
{
  return _mm_sub_epi16(aM1, aM2);
}

inline __m128i
Sub32(__m128i aM1, __m128i aM2)
{
  return _mm_sub_epi32(aM1, aM2);
}

inline __m128i
Min8(__m128i aM1, __m128i aM2)
{
  return _mm_min_epu8(aM1, aM2);
}

inline __m128i
Max8(__m128i aM1, __m128i aM2)
{
  return _mm_max_epu8(aM1, aM2);
}

inline __m128i
Min32(__m128i aM1, __m128i aM2)
{
...
inline __m128i
Mul16(__m128i aM1, __m128i aM2)
{
  return _mm_mullo_epi16(aM1, aM2);
}

inline __m128i
MulU16(__m128i aM1, __m128i aM2)
{
  return _mm_mullo_epi16(aM1, aM2);
}

inline void
Mul16x4x2x2To32x4x2(__m128i aFactorsA1B1,
...
inline __m128i
MulAdd16x8x2To32x4(__m128i aFactorsA, __m128i aFactorsB)
{
...
inline __m128
MixF32(__m128 a, __m128 b, float t)
{
  return _mm_add_ps(a, _mm_mul_ps(_mm_sub_ps(b, a), _mm_set1_ps(t)));
}

inline __m128
WSumF32(__m128 a, __m128 b, float wa, float wb)
{
...
inline __m128
AddF32(__m128 a, __m128 b)
{
  return _mm_add_ps(a, b);
}

inline __m128
MulF32(__m128 a, __m128 b)
{
  return _mm_mul_ps(a, b);
}

inline __m128
DivF32(__m128 a, __m128 b)
{
