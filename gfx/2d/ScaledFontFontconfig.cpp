...
#ifdef USE_SKIA
SkTypeface*
ScaledFontFontconfig::GetSkTypeface()
{
  if (!mTypeface) {
    mTypeface =
...
void
ScaledFontFontconfig::InstanceData::SetupFontOptions(
...
void
ScaledFontFontconfig::InstanceData::SetupFontMatrix(
...
bool
ScaledFontFontconfig::GetFontInstanceData(FontInstanceDataOutput aCb,
                                          void* aBaton)
{
...
bool
ScaledFontFontconfig::GetWRFontInstanceOptions(
...
already_AddRefed<ScaledFont>
ScaledFontFontconfig::CreateFromInstanceData(
...
UnscaledFontFontconfig::CreateFromFontDescriptor(const uint8_t* aData,
                                                 uint32_t aDataLength)
{
  ...
  const char* path =
      reinterpret_cast<const char*>(aData + sizeof(FontDescriptor));
  ...
  RefPtr<UnscaledFont> unscaledFont =
      new UnscaledFontFontconfig(path, desc->mIndex);
