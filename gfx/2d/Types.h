...
inline bool
IsOpaque(SurfaceFormat aFormat)
{
  switch (aFormat) {
...
constexpr bool
HalfCornerIsX(HalfCorner aHalfCorner)
{
...
constexpr HalfCorner
FullToHalfCorner(Corner aCorner, bool aIsVertical)
{
  return HalfCorner(aCorner * 2 + aIsVertical);
}

constexpr bool
SideIsVertical(Side aSide)
{
  return aSide % 2;
}
...
constexpr Corner
SideToFullCorner(Side aSide, bool aIsSecond)
{
...
constexpr HalfCorner
SideToHalfCorner(Side aSide, bool aIsSecond, bool aIsParallel)
{
