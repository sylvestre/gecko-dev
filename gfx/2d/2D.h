...
class SurfacePattern : public Pattern
{
 public:
  /// For constructor parameter description, see member data documentation.
  SurfacePattern(SourceSurface* aSourceSurface,
...
static inline bool
operator==(const Glyph& aOne, const Glyph& aOther)
{
...
class UnscaledFont : public SupportsThreadSafeWeakPtr<UnscaledFont>
{
 public:
  ...
  typedef void (*FontFileDataOutput)(const uint8_t* aData,
                                     uint32_t aLength,
                                     uint32_t aIndex,
                                     void* aBaton);
  typedef void (*FontInstanceDataOutput)(const uint8_t* aData,
                                         uint32_t aLength,
                                         void* aBaton);
  typedef void (*FontDescriptorOutput)(const uint8_t* aData,
                                       uint32_t aLength,
                                       void* aBaton);
...
class DrawTarget : public external::AtomicRefCounted<DrawTarget>
{
 public:
  ...
  {
    aScaledFont->GetGlyphDesignMetrics(
        aGlyphIndices, aNumGlyphs, aGlyphMetrics);
  }
...
struct Config
{
  ...
  Config()
      : mLogForwarder(nullptr), mMaxTextureSize(8192), mMaxAllocSize(52000000)
  {
  }
};
...
class GFX2D_API Factory
{
 ...
 public:
...
#ifdef XP_DARWIN
  static already_AddRefed<GlyphRenderingOptions> CreateCGGlyphRenderingOptions(
  ...
  static FT_Face NewFTFace(FT_Library aFTLibrary,
                           const char* aFileName,
                           int aFaceIndex);
  static FT_Face NewFTFaceFromData(FT_Library aFTLibrary,
                                   const uint8_t* aData,
                                   size_t aDataSize,
                                   int aFaceIndex);
