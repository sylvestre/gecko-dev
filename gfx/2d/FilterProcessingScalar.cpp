...
void
FilterProcessing::ExtractAlpha_Scalar(const IntSize& size,
                                      uint8_t* sourceData,
...
static void
ApplyMorphologyHorizontal_Scalar(uint8_t* aSourceData,
...
void
FilterProcessing::ApplyMorphologyHorizontal_Scalar(uint8_t* aSourceData,
                                                   int32_t aSourceStride,
                                                   uint8_t* aDestData,
                                                   int32_t aDestStride,
                                                   const IntRect& aDestRect,
...
template<MorphologyOperator Operator>
static void
ApplyMorphologyVertical_Scalar(uint8_t* aSourceData,
                               int32_t aSourceStride,
                               uint8_t* aDestData,
                               int32_t aDestStride,
                               const IntRect& aDestRect,
...
void
FilterProcessing::ApplyMorphologyVertical_Scalar(uint8_t* aSourceData,
                                                 int32_t aSourceStride,
                                                 uint8_t* aDestData,
                                                 int32_t aDestStride,
                                                 const IntRect& aDestRect,
...
already_AddRefed<DataSourceSurface>
FilterProcessing::ApplyColorMatrix_Scalar(DataSourceSurface* aInput,
                                          const Matrix5x4& aMatrix)
{
  return ApplyColorMatrix_SIMD<simd::Scalari32x4_t,
                               simd::Scalari16x8_t,
                               simd::Scalaru8x16_t>(aInput, aMatrix);
}

void
FilterProcessing::ApplyComposition_Scalar(DataSourceSurface* aSource,
                                          DataSourceSurface* aDest,
                                          CompositeOperator aOperator)
{
  return ApplyComposition_SIMD<simd::Scalari32x4_t,
                               simd::Scalaru16x8_t,
                               simd::Scalaru8x16_t>(aSource, aDest, aOperator);
}

void
FilterProcessing::SeparateColorChannels_Scalar(const IntSize& size,
                                               uint8_t* sourceData,
                                               int32_t sourceStride,
...
void
FilterProcessing::CombineColorChannels_Scalar(const IntSize& size,
...
void
FilterProcessing::DoUnpremultiplicationCalculation_Scalar(const IntSize& aSize,
                                                          uint8_t* aTargetData,
                                                          int32_t aTargetStride,
                                                          uint8_t* aSourceData,
                                                          int32_t aSourceStride)
...
already_AddRefed<DataSourceSurface>
FilterProcessing::RenderTurbulence_Scalar(const IntSize& aSize,
                                          const Point& aOffset,
...
{
  return RenderTurbulence_SIMD<simd::Scalarf32x4_t,
                               simd::Scalari32x4_t,
                               simd::Scalaru8x16_t>(aSize,
                                                    aOffset,
                                                    aBaseFrequency,
                                                    aSeed,
                                                    aNumOctaves,
...
FilterProcessing::ApplyArithmeticCombine_Scalar(DataSourceSurface* aInput1,
                                                ...
                                                Float aK4)
{
  return ApplyArithmeticCombine_SIMD<simd::Scalari32x4_t,
                                     simd::Scalari16x8_t,
                                     simd::Scalaru8x16_t>(
