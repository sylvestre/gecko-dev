...
void
RenderTraceLayers(Layer* aLayer,
                  const char* aColor,
...
void
RenderTraceInvalidateStart(Layer* aLayer,
                           const char* aColor,
...
void
RenderTraceInvalidateEnd(Layer* aLayer, const char* aColor)
{
...
void
renderTraceEventStart(const char* aComment, const char* aColor)
{
...
void
renderTraceEventEnd(const char* aComment, const char* aColor)
{
...
void
renderTraceEventEnd(const char* aColor)
{
