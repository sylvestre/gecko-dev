...
class MLGDeviceD3D11 final : public MLGDevice
{
 public:
  ...
  bool Map(MLGResource* aResource,
           MLGMapType aType,
           MLGMappedResource* aMap) override;
  void Unmap(MLGResource* aResource) override;
  void UpdatePartialResource(MLGResource* aResource,
  ...
  void SetPSTextures(uint32_t aSlot,
  ...
  RefPtr<MLGBuffer> CreateBuffer(MLGBufferType aType,
                                 uint32_t aSize,
                                 MLGUsage aUsage,
 ...
 private:
  ...
  typedef EnumeratedArray<PixelShaderID,
                          PixelShaderID::MaxShaders,
                          RefPtr<ID3D11PixelShader>>
      PixelShaderArray;
  typedef EnumeratedArray<VertexShaderID,
                          VertexShaderID::MaxShaders,
  ...
  typedef EnumeratedArray<VertexShaderID,
      ...
      InputLayoutArray;
  typedef EnumeratedArray<SamplerMode,
                          SamplerMode::MaxModes,
                          RefPtr<ID3D11SamplerState>>
      SamplerStateArray;
  typedef EnumeratedArray<MLGBlendState,
                          MLGBlendState::MaxStates,
