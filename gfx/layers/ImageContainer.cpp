...
ImageFactory::CreatePlanarYCbCrImage(const gfx::IntSize& aScaleHint,
...
void
ImageContainerListener::NotifyComposite(
...
void
ImageContainer::SetCurrentImagesInTransaction(
...
RecyclingPlanarYCbCrImage::CopyData(const Data& aData)
{
  ...
  CopyPlane(mData.mYChannel,
            ...
            mData.mYStride,
            mData.mYSkip);
  CopyPlane(mData.mCbChannel,
            aData.mCbChannel,
            mData.mCbCrSize,
            mData.mCbCrStride,
            mData.mCbSkip);
  CopyPlane(mData.mCrChannel,
            aData.mCrChannel,
            mData.mCbCrSize,
            mData.mCbCrStride,
            mData.mCrSkip);
...
NVImage::GetAsSourceSurface()
{
  ...
  if (mData.mCbChannel < mData.mCrChannel) {  // NV12
    libyuv::NV12ToI420(mData.mYChannel,
                       mData.mYStride,
                       mData.mCbChannel,
                       mData.mCbCrStride,
                       aData.mYChannel,
    ...
    libyuv::NV21ToI420(mData.mYChannel,
                       mData.mYStride,
                       mData.mCrChannel,
                       mData.mCbCrStride,
                       aData.mYChannel,
