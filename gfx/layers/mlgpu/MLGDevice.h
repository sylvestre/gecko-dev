...
class MLGDevice
{
 public:
  ...
  // Resource access
  virtual bool Map(MLGResource* aResource,
                   MLGMapType aType,
  ...
  virtual void UpdatePartialResource(MLGResource* aResource,
                                     ...
                                     void* aData,
                                     uint32_t aStride) = 0;
  virtual void CopyTexture(MLGTexture* aDest,
  ...
  virtual void SetVertexBuffer(uint32_t aSlot,
                               MLGBuffer* aBuffer,
                               uint32_t aStride,
                               uint32_t aOffset = 0) = 0;
  ...
  virtual void SetPSTextures(uint32_t aSlot,
  ...
  virtual void SetVSConstantBuffer(uint32_t aSlot,
                                   MLGBuffer* aBuffer,
                                   uint32_t aFirstConstant,
                                   uint32_t aNumConstants) = 0;
  virtual void SetPSConstantBuffer(uint32_t aSlot,
                                   MLGBuffer* aBuffer,
                                   uint32_t aFirstConstant,
                                   uint32_t aNumConstants) = 0;
  ...
  virtual void ClearView(MLGRenderTarget* aRT,
...
#pragma GCC diagnostic pop
 ...
 private:
  ...
  typedef EnumeratedArray<YUVColorSpace,
