...
void
LayerTransactionParent::SetLayerManager(
...
LayerTransactionParent::SetLayerAttributes(const OpSetLayerAttributes& aOp)
{
  ...
  switch (specific.type()) {
    ...
    case Specific::TContainerLayerAttributes: {
      ...
      if (attrs.eventRegionsOverride() !=
          containerLayer->GetEventRegionsOverride()) {
    ...
    case Specific::TTextLayerAttributes: {
      ...
      textLayer->SetGlyphs(
          Move(const_cast<nsTArray<GlyphArray>&>(tla.glyphs())));
      textLayer->SetScaledFont(
          reinterpret_cast<gfx::ScaledFont*>(tla.scaledFont()));
      break;
    }
    case Specific::TBorderLayerAttributes: {
      ...
      borderLayer->SetCornerRadii(
          specific.get_BorderLayerAttributes().corners());
...
mozilla::ipc::IPCResult
LayerTransactionParent::RecvSetLayerObserverEpoch(
...
mozilla::ipc::IPCResult
LayerTransactionParent::RecvGetAnimationOpacity(
...
GetAPZCForViewID(Layer* aLayer, FrameMetrics::ViewID aScrollID)
{
  ...
  ForEachNode<ForwardIterator>(aLayer, [aScrollID, &resultApzc](Layer* layer) {
...
mozilla::ipc::IPCResult
LayerTransactionParent::RecvSetAsyncScrollOffset(
...
mozilla::ipc::IPCResult
LayerTransactionParent::RecvRequestProperty(const nsString& aProperty,
                                            float* aValue)
{
  *aValue = -1;
  return IPC_OK();
...
mozilla::ipc::IPCResult
LayerTransactionParent::RecvSetConfirmedTargetAPZC(
...
bool
LayerTransactionParent::AllocUnsafeShmem(
...
bool
LayerTransactionParent::IsSameProcess() const
{
...
void
LayerTransactionParent::SendAsyncMessage(
...
void
LayerTransactionParent::NotifyNotUsed(PTextureParent* aTexture,
...
bool
LayerTransactionParent::BindLayerToHandle(RefPtr<Layer> aLayer,
...
mozilla::ipc::IPCResult
LayerTransactionParent::RecvNewCompositable(const CompositableHandle& aHandle,
...
mozilla::ipc::IPCResult
LayerTransactionParent::RecvReleaseCompositable(
...
mozilla::ipc::IPCResult
LayerTransactionParent::RecvGetTextureFactoryIdentifier(
