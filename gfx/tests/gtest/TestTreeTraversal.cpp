...
template<class T>
void
TestNodeReverse<T>::SetLastChild(RefPtr<TestNodeReverse<T>> aNode)
{
...
template<class T>
void
TestNodeReverse<T>::AddChild(RefPtr<TestNodeReverse<T>> aNode)
{
...
template<class T>
void
TestNodeReverse<T>::SetPrevSibling(RefPtr<TestNodeReverse<T>> aNode)
{
  mSiblingNode = aNode;
}
...
template<class T>
void
TestNodeForward<T>::AddChild(RefPtr<TestNodeForward<T>> aNode)
{
...
template<class T>
void
TestNodeForward<T>::SetLastChild(RefPtr<TestNodeForward<T>> aNode)
{
  mLastChildNode = aNode;
}
...
template<class T>
void
TestNodeForward<T>::SetFirstChild(RefPtr<TestNodeForward<T>> aNode)
{
...
template<class T>
void
TestNodeForward<T>::SetNextSibling(RefPtr<TestNodeForward<T>> aNode)
{
  mSiblingNode = aNode;
}
...
template<class T>
int
TestNodeBase<T>::GetActualTraversalRank()
{
...
template<class T>
void
TestNodeBase<T>::SetActualTraversalRank(int aRank)
{
...
template<class T>
int
TestNodeBase<T>::GetExpectedTraversalRank()
{
...
template<class T>
void
TestNodeBase<T>::SetType(T aType)
{
  mType = aType;
}
...
template<class T>
void
TestNodeBase<T>::SetRegion(nsRegion aRegion)
{
  mRegion = aRegion;
}
...
template<class T>
void
TestNodeBase<T>::SetValue(int aValue)
{
  mValue = aValue;
}
...
bool
FindNeedle(SearchTestNode* aNode)
{
  return aNode->GetType() == SearchNodeType::Needle;
}
...
void
ForEachNodeDoNothing(ForEachTestNode* aNode)
{
}

template<typename Node>
static RefPtr<Node>
DepthFirstSearchForwardRecursive(RefPtr<Node> aNode)
{
...
template<typename Node>
static RefPtr<Node>
DepthFirstSearchCaptureVariablesForwardRecursive(RefPtr<Node> aNode,
                                                 int a,
                                                 int b,
                                                 int c,
                                                 int d,
                                                 ...
                                                 int& z)
{
  ...
  for (RefPtr<Node> node = aNode->GetFirstChild(); node != nullptr;
    ...
    if (RefPtr<Node> foundNode =
            DepthFirstSearchCaptureVariablesForwardRecursive(node,
                                                             a,
                                                             b,
                                                             c,
                                                             d,
...
template<typename Node>
static RefPtr<Node>
DepthFirstSearchPostOrderForwardRecursive(RefPtr<Node> aNode)
{
  for (RefPtr<Node> node = aNode->GetFirstChild(); node != nullptr;
       node = node->GetNextSibling()) {
    if (RefPtr<Node> foundNode =
...
template<typename Node>
static RefPtr<Node>
BreadthFirstSearchForwardQueue(RefPtr<Node> aNode)
{
...
template<typename Node>
static RefPtr<Node>
DepthFirstSearchReverseRecursive(RefPtr<Node> aNode)
{
  if (aNode->GetType() == SearchNodeType::Needle) {
    return aNode;
  }
...
template<typename Node>
static RefPtr<Node>
DepthFirstSearchCaptureVariablesReverseRecursive(RefPtr<Node> aNode,
                                                 int a,
                                                 int b,
                                                 int c,
                                                 int d,
                                                 ...
                                                 int& z)
{
  ...
  for (RefPtr<Node> node = aNode->GetLastChild(); node != nullptr;
       node = node->GetPrevSibling()) {
    if (RefPtr<Node> foundNode =
            DepthFirstSearchCaptureVariablesReverseRecursive(node,
                                                             a,
                                                             b,
                                                             c,
                                                             d,
...
template<typename Node>
static RefPtr<Node>
DepthFirstSearchPostOrderReverseRecursive(RefPtr<Node> aNode)
{
  for (RefPtr<Node> node = aNode->GetLastChild(); node != nullptr;
       node = node->GetPrevSibling()) {
    if (RefPtr<Node> foundNode =
...
template<typename Node>
static RefPtr<Node>
BreadthFirstSearchReverseQueue(RefPtr<Node> aNode)
{
  queue<RefPtr<Node>> nodes;
  nodes.push(aNode);
  while (!nodes.empty()) {
