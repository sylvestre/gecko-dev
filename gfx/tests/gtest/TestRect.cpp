...
TestConstructors()
{
  ...
  EXPECT_TRUE(rect1.x == 10 && rect1.y == 20 && rect1.Width() == 30 &&
              rect1.Height() == 40)
  ...
  EXPECT_TRUE(!rect1.IsEmpty() && rect1.IsFinite() && !rect2.IsEmpty() &&
              rect2.IsFinite())
...
TestContainment()
{
  ...
  EXPECT_FALSE(!rect1.Contains(rect1.x + rect1.Width() / 2,
...
TestIntersection()
{
  ...
  EXPECT_FALSE(!dest.IsEmpty()) << "[4] Make sure an empty rect is returned";
  ...
  // Make sure an empty rect is returned
  EXPECT_FALSE(!dest.IsEmpty()) << "[6] Make sure an empty rect is returned";
  ...
  EXPECT_FALSE(!dest.IntersectRect(rect1, rect2) ||
               !(dest.IsEqualInterior(RectType(
                   rect1.x + 1, rect1.y, rect1.Width() - 1, rect1.Height()))))
  ...
  // Make sure an empty rect is returned
  EXPECT_FALSE(!dest.IsEmpty()) << "[8] Make sure an empty rect is returned";
  ...
  EXPECT_FALSE(!dest.IntersectRect(rect1, rect2) ||
               !(dest.IsEqualInterior(RectType(
                   rect1.x, rect1.y + 1, rect1.Width(), rect1.Height() - 1))))
  ...
  // Make sure an empty rect is returned
  EXPECT_FALSE(!dest.IsEmpty()) << "[10] Make sure an empty rect is returned";
...
TestUnion()
{
  ...
  EXPECT_FALSE(
      dest.IsEmpty() ||
      !(dest.IsEqualInterior(RectType(
          rect1.x, rect1.y, rect2.XMost() - rect1.x, rect2.YMost() - rect1.y))))
  ...
  EXPECT_FALSE(
      dest.IsEmpty() ||
      !(dest.IsEqualInterior(RectType(
          rect2.x, rect2.y, rect1.XMost() - rect2.x, rect1.YMost() - rect2.y))))
...
TestSetWH()
{
  ...
  EXPECT_TRUE(rect.X() == 1 && rect.Y() == 2 && rect.Width() == 3 &&
              rect.Height() == 4);
  rect.SetWidth(13);
  EXPECT_TRUE(rect.X() == 1 && rect.Y() == 2 && rect.Width() == 13 &&
              rect.Height() == 4);
  rect.SetHeight(14);
  EXPECT_TRUE(rect.X() == 1 && rect.Y() == 2 && rect.Width() == 13 &&
              rect.Height() == 14);
  rect.SizeTo(23, 24);
  EXPECT_TRUE(rect.X() == 1 && rect.Y() == 2 && rect.Width() == 23 &&
              rect.Height() == 24);
  return true;
}
...
TestSwap()
{
  ...
  EXPECT_TRUE(rect.X() == 1 && rect.Y() == 2 && rect.Width() == 3 &&
              rect.Height() == 4);
  rect.Swap();
  EXPECT_TRUE(rect.X() == 2 && rect.Y() == 1 && rect.Width() == 4 &&
              rect.Height() == 3);
  return true;
}
