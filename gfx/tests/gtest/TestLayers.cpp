...
static already_AddRefed<Layer>
CreateLayer(char aLayerType, LayerManager* aManager)
{
...
static void
ValidateTreePointers(Layer* aLayer)
{
...
static void
ValidateTreePointers(nsTArray<RefPtr<Layer> >& aLayers)
{
...
TEST_F(LayerMetricsWrapperTester, MultiFramemetricsTree)
{
  ...
  metadata.InsertElementAt(0,
                           MakeMetadata(FrameMetrics::START_SCROLL_ID +
