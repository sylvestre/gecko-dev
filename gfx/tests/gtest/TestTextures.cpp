...
void
AssertSurfacesEqual(gfxImageSurface* surface1, gfxImageSurface* surface2)
{
...
void
AssertSurfacesEqual(SourceSurface* surface1, SourceSurface* surface2)
{
  ASSERT_EQ(surface1->GetSize(), surface2->GetSize());
...
void
TestTextureClientSurface(TextureClient* texture, gfxImageSurface* surface)
{
  // client allocation
  ...
  RefPtr<TextureHost> host = CreateBackendIndependentTextureHost(
      descriptor, nullptr, LayersBackend::LAYERS_NONE, texture->GetFlags());
...
void
TestTextureClientYCbCr(TextureClient* client, PlanarYCbCrData& ycbcrData)
{
  ...
  RefPtr<TextureHost> textureHost = CreateBackendIndependentTextureHost(
      descriptor, nullptr, LayersBackend::LAYERS_NONE, client->GetFlags());
