...
TEST(GfxQcms, LutInverseCrash)
{
  ...
  lut_inverse_interp16(
      (uint16_t)5, lutTable1, (int)mozilla::ArrayLength(lutTable1));
  lut_inverse_interp16(
      (uint16_t)5, lutTable2, (int)mozilla::ArrayLength(lutTable2));
}
...
TEST(GfxQcms, LutInverse)
{
  ...
  value = lut_inverse_interp16(
      65535, lutTable, (int)mozilla::ArrayLength(lutTable));
