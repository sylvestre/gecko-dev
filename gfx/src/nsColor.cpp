...
static int
ComponentValue(const char16_t* aColorSpec, int aLen, int color, int dpc)
{
  int component = 0;
  int index = (color * dpc);
  if (2 < dpc) {
...
bool
NS_HexToRGBA(const nsAString& aColorSpec,
...
bool
NS_LooseHexToRGB(const nsString& aColorSpec, nscolor* aResult)
{
...
bool
NS_ColorNameToRGB(const nsAString& aColorName, nscolor* aResult)
{
...
const char* const*
NS_AllColorNames(size_t* aSizeArray)
{
