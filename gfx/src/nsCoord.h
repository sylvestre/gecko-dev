 ...
 */
inline nscoord
NSCoordDivRem(nscoord aSpace, size_t aN, nscoord* aQuotient)
{
#ifdef NS_COORD_IS_FLOAT
  *aQuotient = aSpace / aN;
  return 0.0f;
...
inline nscoord
NSCoordMulDiv(nscoord aMult1, nscoord aMult2, nscoord aDiv)
{
#ifdef NS_COORD_IS_FLOAT
 ...
 */
inline nscoord
NSCoordSaturatingNonnegativeMultiply(nscoord aCoord, float aScale)
{
 ...
 */
inline nscoord
NSCoordSaturatingMultiply(nscoord aCoord, float aScale)
{
 ...
 */
inline nscoord
NSCoordSaturatingSubtract(nscoord a, nscoord b, nscoord infMinusInfResult)
{
  VERIFY_COORD(a);
  VERIFY_COORD(b);
 ...
 */
inline nscoord
NSFloatPixelsToAppUnits(float aPixels, float aAppUnitsPerPixel)
{
  return NSToCoordRoundWithClamp(aPixels * aAppUnitsPerPixel);
}

inline nscoord
NSIntPixelsToAppUnits(int32_t aPixels, int32_t aAppUnitsPerPixel)
{
...
inline float
NSAppUnitsToFloatPixels(nscoord aAppUnits, float aAppUnitsPerPixel)
{
  return (float(aAppUnits) / aAppUnitsPerPixel);
}

inline double
NSAppUnitsToDoublePixels(nscoord aAppUnits, double aAppUnitsPerPixel)
{
  return (double(aAppUnits) / aAppUnitsPerPixel);
}

inline int32_t
NSAppUnitsToIntPixels(nscoord aAppUnits, float aAppUnitsPerPixel)
{
  return NSToIntRound(float(aAppUnits) / aAppUnitsPerPixel);
}

inline float
NSCoordScale(nscoord aCoord, int32_t aFromAPP, int32_t aToAPP)
{
 ...
 */
inline float
NSUnitsToTwips(float aValue, float aPointsPerUnit)
{
  return aValue * aPointsPerUnit * TWIPS_PER_POINT_FLOAT;
}

inline float
NSTwipsToUnits(float aTwips, float aUnitsPerPoint)
{
