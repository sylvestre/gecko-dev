...
NS_IMETHODIMP
nsThebesFontEnumerator::EnumerateAllFonts(uint32_t* aCount, char16_t*** aResult)
{
...
class EnumerateFontsTask final : public Runnable
{
 public:
  ...
  NS_IMETHOD Run()
  {
    ...
    nsresult rv = gfxPlatform::GetPlatform()->GetFontList(
        mLangGroupAtom, mGeneric, fontList);
