...
class nsDataObj : public IDataObject, public IAsyncOperation
{
 ...
 public:  // IDataObject methods - these are general comments. see CfDragDrop
  ...
  // connection.
  STDMETHODIMP DAdvise(LPFORMATETC pFE,
                       DWORD flags,
 ...
 protected:
  ...
  virtual HRESULT GetText(const nsACString& aDF,
                          FORMATETC& aFE,
                          STGMEDIUM& aSTG);
  virtual HRESULT GetDib(const nsACString& inFlavor,
                         FORMATETC&,
                         STGMEDIUM& aSTG);
  ...
  virtual HRESULT GetUniformResourceLocator(FORMATETC& aFE,
                                            STGMEDIUM& aSTG,
                                            bool aIsUnicode);
  ...
  virtual HRESULT ExtractUniformResourceLocatorW(FORMATETC& aFE,
                                                 STGMEDIUM& aSTG);
  virtual HRESULT GetFileDescriptor(FORMATETC& aFE,
                                    STGMEDIUM& aSTG,
                                    bool aIsUnicode);
  ...
  nsITransferable*
      mTransferable;  // nsDataObj owns and ref counts nsITransferable,
 ...
 private:
  ...
  bool LookupArbitraryFormat(FORMATETC* aFormat,
                             LPDATAENTRY* aDataEntry,
                             BOOL aAddorUpdate);
  bool CopyMediumData(STGMEDIUM* aMediumDst,
