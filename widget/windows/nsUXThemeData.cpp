...
const wchar_t*
nsUXThemeData::GetClassName(nsUXThemeClass cls)
{
  switch (cls) {
    case eUXButton:
      return L"Button";
...
// static
bool
nsUXThemeData::CheckForCompositor(bool aUpdateCache)
{
...
nsUXThemeData::UpdateNativeThemeInfo()
{
  ...
  if (FAILED(GetCurrentThemeName(
          themeFileName, MAX_PATH, themeColor, MAX_PATH, nullptr, 0))) {
    sThemeId = LookAndFeel::eWindowsTheme_Classic;
    return;
  }
