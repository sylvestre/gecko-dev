...
STDMETHODIMP
nsDataObjCollection::QueryInterface(REFIID riid, void** ppv)
{
  *ppv = nullptr;
...
// IDataObject methods
STDMETHODIMP
nsDataObjCollection::GetData(LPFORMATETC pFE, LPSTGMEDIUM pSTM)
{
...
STDMETHODIMP
nsDataObjCollection::GetDataHere(LPFORMATETC pFE, LPSTGMEDIUM pSTM)
{
  return E_FAIL;
}
...
STDMETHODIMP
nsDataObjCollection::SetData(LPFORMATETC pFE, LPSTGMEDIUM pSTM, BOOL fRelease)
{
...
void
nsDataObjCollection::AddDataFlavor(const char* aDataFlavor, LPFORMATETC aFE)
{
...
void
nsDataObjCollection::AddDataObject(IDataObject* aDataObj)
{
...
HRESULT
nsDataObjCollection::GetFile(LPFORMATETC pFE, LPSTGMEDIUM pSTM)
{
...
HRESULT
nsDataObjCollection::GetText(LPFORMATETC pFE, LPSTGMEDIUM pSTM)
{
  STGMEDIUM workingmedium;
  FORMATETC fe = *pFE;
  HGLOBAL hGlobalMemory;
...
HRESULT
nsDataObjCollection::GetFileDescriptors(LPFORMATETC pFE, LPSTGMEDIUM pSTM)
{
  STGMEDIUM workingmedium;
  FORMATETC fe = *pFE;
  HGLOBAL hGlobalMemory;
...
HRESULT
nsDataObjCollection::GetFileContents(LPFORMATETC pFE, LPSTGMEDIUM pSTM)
{
  ULONG num = 0;
...
HRESULT
nsDataObjCollection::GetFirstSupporting(LPFORMATETC pFE, LPSTGMEDIUM pSTM)
{
