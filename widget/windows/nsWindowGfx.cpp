...
bool
nsWindow::OnPaint(HDC aDC, uint32_t aNestingLevel)
{
...
#ifdef WIDGET_DEBUG_OUTPUT
    debug_DumpPaintEvent(stdout, this, region, "noname", (int32_t)mWnd);
#endif  // WIDGET_DEBUG_OUTPUT
      ...
      case LayersBackend::LAYERS_BASIC: {
...

        {
          AutoLayerManagerSetup setupLayerManager(
              this, thebesContext, doubleBuffering);
...
nsresult
nsWindowGfx::CreateIcon(imgIContainer* aContainer,
                        bool aIsCursor,
                        uint32_t aHotspotX,
                        uint32_t aHotspotY,
                        IntSize aScaledSize,
...
uint8_t*
nsWindowGfx::Data32BitTo1Bit(uint8_t* aImageData,
                             uint32_t aWidth,
                             uint32_t aHeight)
{
