...
/* static */
bool
MouseScrollHandler::ProcessMessage(nsWindowBase* aWidget,
                                   UINT msg,
                                   WPARAM wParam,
                                   LPARAM lParam,
                                   MSGResult& aResult)
{
  ...
  switch (msg) {
    ...
    case WM_MOUSEWHEEL:
    case WM_MOUSEHWHEEL:
      GetInstance()->ProcessNativeMouseWheelMessage(
    ...
    uint32_t aAdditionalFlags)
{
  ...
  return sInstance->mSynthesizingEvent->Synthesize(
      pts, target, aNativeMessage, wParam, lParam, kbdState);
}
...
{
  POINT point;
  if (Device::SetPoint::IsGetMessagePosResponseValid(
...
{
  if (SynthesizingEvent::IsSynthesizing()) {
    mSynthesizingEvent->NativeMessageReceived(
        aWidget, aMessage, aWParam, aLParam);
  }
  ...
  if (WinUtils::IsOurProcessWindow(underCursorWnd)) {
    ...
    ::PostMessage(
        destWindow->GetWindowHandle(), internalMessage, aWParam, aLParam);
    return;
  }
                                            ...
                                            LPARAM aLParam)
{
  ...
  MOZ_LOG(gMouseScrollLog,
          ...
          ("MouseScroll::HandleMouseWheelMessage: aWidget=%p, "
           ...
           aWidget,
           aMessage == MOZ_WM_MOUSEVWHEEL ? "V" : "H",
           aWParam,
           aLParam));
  ...
  EventInfo eventInfo(
      aWidget, WinUtils::GetNativeMessage(aMessage), aWParam, aLParam);
...
void
MouseScrollHandler::HandleScrollMessageAsMouseWheelMessage(
    nsWindowBase* aWidget, UINT aMessage, WPARAM aWParam, LPARAM aLParam)
{
  ...
  MOZ_LOG(
      ...
      ("MouseScroll::HandleScrollMessageAsMouseWheelMessage: aWidget=%p, "
       ...
       aWidget,
       (aMessage == MOZ_WM_VSCROLL) ? "V" : "H",
       aWParam,
       aLParam,
       wheelEvent.mRefPoint.x,
       wheelEvent.mRefPoint.y,
       wheelEvent.mDeltaX,
       wheelEvent.mDeltaY,
       wheelEvent.mLineOrPageDeltaX,
       wheelEvent.mLineOrPageDeltaY,
    ...
    const ModifierKeyState& aModKeyState)
{
  ...
  MOZ_LOG(
      ...
      ("MouseScroll::LastEventInfo::InitWheelEvent: aWidget=%p, "
       ...
       "mAccumulatedDelta: %d",
       aWidget,
       aWheelEvent.mRefPoint.x,
       aWheelEvent.mRefPoint.y,
       aWheelEvent.mDeltaX,
       aWheelEvent.mDeltaY,
       aWheelEvent.mLineOrPageDeltaX,
       aWheelEvent.mLineOrPageDeltaY,
    ...
    MOZ_LOG(gMouseScrollLog,
            ...
            ("MouseScroll::SystemSettings::InitScrollLines(): mScrollLines is "
             ...
             mScrollLines));
                 ...
                 SPI_GETWHEELSCROLLLINES, 0, &mScrollLines, 0)) {
    MOZ_LOG(gMouseScrollLog,
            LogLevel::Info,
    ...
    MOZ_LOG(gMouseScrollLog,
            ...
            ("MouseScroll::SystemSettings::InitScrollChars(): mScrollChars is "
             ...
             mScrollChars));
                 ...
                 SPI_GETWHEELSCROLLCHARS, 0, &mScrollChars, 0)) {
    MOZ_LOG(gMouseScrollLog,
            LogLevel::Info,
  ...
  if (sUseSwipeHack && (aWParam == VK_NEXT || aWParam == VK_PRIOR) &&
    ...
    if (aMsg == WM_KEYDOWN) {
      ...
      WidgetCommandEvent commandEvent(
          ...
          (aWParam == VK_NEXT) ? nsGkAtoms::Forward : nsGkAtoms::Back,
          aWidget);
    ...
    nsWindowBase* aWidget, UINT aMessage, WPARAM aWParam, LPARAM aLParam)
{
  ...
  MOZ_LOG(gMouseScrollLog,
          ...
          ("MouseScrollHandler::SynthesizingEvent::NativeMessageReceived(): "
           ...
           aWidget,
           aWidget ? aWidget->GetWindowHandle() : 0,
           mWnd,
           aMessage,
           aWParam,
           aLParam,
