...
nsXPLookAndFeel::Init()
{
  ...
  Preferences::AddBoolVarCache(
      &sUseNativeColors, "ui.use_native_colors", sUseNativeColors);
...
//
nsresult
nsXPLookAndFeel::GetColorImpl(ColorID aID,
...
// static
bool
LookAndFeel::GetFont(FontID aID,
                     nsString& aName,
                     gfxFontStyle& aStyle,
                     float aDevPixPerCSSPixel)
{
  return nsLookAndFeel::GetInstance()->GetFontImpl(
      aID, aName, aStyle, aDevPixPerCSSPixel);
}
