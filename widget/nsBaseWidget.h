...
class nsBaseWidget : public nsIWidget, public nsSupportsWeakReference
{
 ...
 public:
  ...
  virtual nsresult NotifyIME(
      const IMENotification& aIMENotification) override final;
  virtual MOZ_MUST_USE nsresult
  ...
  {
   public:
    AutoLayerManagerSetup(nsBaseWidget* aWidget,
                          gfxContext* aTarget,
 ...
 protected:
  ...
  mozilla::MultiTouchInput UpdateSynthesizedTouchState(
      mozilla::MultiTouchInput* aState,
      uint32_t aTime,
