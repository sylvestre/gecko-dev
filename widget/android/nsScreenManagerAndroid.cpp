...
nsScreenAndroid::nsScreenAndroid(DisplayType aDisplayType, nsIntRect aRect)
    : mId(sScreenId++), mDisplayType(aDisplayType), mRect(aRect), mDensity(0.0)
{
...
NS_IMETHODIMP
nsScreenAndroid::GetRect(int32_t* outLeft,
                         int32_t* outTop,
                         int32_t* outWidth,
                         int32_t* outHeight)
{
...
NS_IMETHODIMP
nsScreenAndroid::GetAvailRect(int32_t* outLeft,
                              int32_t* outTop,
                              int32_t* outWidth,
                              int32_t* outHeight)
{
    ...
    : public ScreenManagerHelper::Natives<ScreenManagerHelperSupport>
{
 public:
  ...
  static int32_t AddDisplay(int32_t aDisplayType,
                            int32_t aWidth,
                            int32_t aHeight,
                            float aDensity)
  {
