...
jmethodID
AndroidBridge::GetMethodID(JNIEnv* env,
                           jclass jClass,
...
jmethodID
AndroidBridge::GetStaticMethodID(JNIEnv* env,
                                 jclass jClass,
                                 const char* methodName,
                                 const char* methodType)
{
...
jfieldID
AndroidBridge::GetFieldID(JNIEnv* env,
                          jclass jClass,
...
jfieldID
AndroidBridge::GetStaticFieldID(JNIEnv* env,
                                jclass jClass,
                                const char* fieldName,
                                const char* fieldType)
{
...
AndroidBridge::AndroidBridge()
{
  ...
  auto msgQueueClass =
      Class::LocalRef::Adopt(jEnv, jEnv->GetObjectClass(mMessageQueue.Get()));
...
// Raw JNIEnv variants.
jstring
AndroidBridge::NewJavaString(JNIEnv* env, const char16_t* string, uint32_t len)
{
...
jstring
AndroidBridge::NewJavaString(JNIEnv* env, const nsAString& string)
{
  return NewJavaString(env, string.BeginReading(), string.Length());
}

jstring
AndroidBridge::NewJavaString(JNIEnv* env, const char* string)
{
  return NewJavaString(env, NS_ConvertUTF8toUTF16(string));
}

jstring
AndroidBridge::NewJavaString(JNIEnv* env, const nsACString& string)
{
  return NewJavaString(env, NS_ConvertUTF8toUTF16(string));
}
...
jstring
AndroidBridge::NewJavaString(AutoLocalJNIFrame* frame,
...
jstring
AndroidBridge::NewJavaString(AutoLocalJNIFrame* frame, const nsAString& string)
{
  return NewJavaString(frame, string.BeginReading(), string.Length());
}

jstring
AndroidBridge::NewJavaString(AutoLocalJNIFrame* frame, const char* string)
{
  return NewJavaString(frame, NS_ConvertUTF8toUTF16(string));
}

jstring
AndroidBridge::NewJavaString(AutoLocalJNIFrame* frame, const nsACString& string)
{
  return NewJavaString(frame, NS_ConvertUTF8toUTF16(string));
}

static void
getHandlersFromStringArray(JNIEnv* aJNIEnv,
                           jobjectArray jArr,
                           jsize aLen,
                                      ...
                                      const nsAString& aAction)
{
  ...
  getHandlersFromStringArray(env,
                             arr.Get(),
                             len,
                             aHandlersArray,
                             aDefaultApp,
                                 ...
                                 const nsAString& aAction)
{
  ...
  getHandlersFromStringArray(
      env, arr.Get(), len, aHandlersArray, aDefaultApp, aAction);
  return true;
}

void
AndroidBridge::GetMimeTypeFromExtensions(const nsACString& aFileExt,
                                         nsCString& aMimeType)
{
...
void
AndroidBridge::GetExtensionFromMimeType(const nsACString& aMimeType,
                                        nsACString& aFileExt)
{
...
void
AndroidBridge::GetIconForExtension(const nsACString& aFileExt,
                                   uint32_t aIconSize,
                                   uint8_t* const aBuf)
{
...
bool
AndroidBridge::GetStaticIntField(const char* className,
                                 const char* fieldName,
                                 int32_t* aInt,
                                 JNIEnv* jEnv /* = nullptr */)
{
...
bool
AndroidBridge::GetStaticStringField(const char* className,
                                    const char* fieldName,
                                    nsAString& result,
                                    JNIEnv* jEnv /* = nullptr */)
{
...
void
AndroidBridge::GetCurrentBatteryInformation(
...
NS_IMETHODIMP
nsAndroidBridge::HandleGeckoMessage(JS::HandleValue val, JSContext* cx)
{
...
NS_IMETHODIMP
nsAndroidBridge::ContentDocumentChanged(mozIDOMWindowProxy* aWindow)
{
...
NS_IMETHODIMP
nsAndroidBridge::IsContentDocumentDisplayed(mozIDOMWindowProxy* aWindow,
                                            bool* aRet)
{
...
NS_IMETHODIMP
nsAndroidBridge::Observe(nsISupports* aSubject,
                         const char* aTopic,
...
NS_IMETHODIMP
nsAndroidBridge::GetBrowserApp(nsIAndroidBrowserApp** aBrowserApp)
{
...
NS_IMETHODIMP
nsAndroidBridge::SetBrowserApp(nsIAndroidBrowserApp* aBrowserApp)
{
  nsAppShell* const appShell = nsAppShell::Get();
...
Java_org_mozilla_gecko_GeckoAppShell_allocateDirectBuffer(JNIEnv* env,
                                                          jclass,
                                                          jlong size);
...
Object::LocalRef
AndroidBridge::ChannelCreate(Object::Param stream)
{
  JNIEnv* const env = GetEnvForThread();
  auto rv = Object::LocalRef::Adopt(
      env,
...
void
AndroidBridge::InputStreamClose(Object::Param obj)
{
  JNIEnv* const env = GetEnvForThread();
...
uint32_t
AndroidBridge::InputStreamAvailable(Object::Param obj)
{
  JNIEnv* const env = GetEnvForThread();
...
nsresult
AndroidBridge::InputStreamRead(Object::Param obj,
                               char* aBuf,
                               uint32_t aCount,
                               uint32_t* aRead)
{
