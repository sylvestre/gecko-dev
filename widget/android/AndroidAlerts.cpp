                                          ...
                                          nsIObserver* aAlertListener)
{
  ...
  java::GeckoAppShell::ShowNotification(name,
                                        cookie,
                                        title,
                                        text,
                                        host,
                                        imageUrl,
                                        !aPersistentData.IsEmpty()
                                            ? jni::StringParam(aPersistentData)
                                            : jni::StringParam(nullptr));
  return NS_OK;
}

NS_IMETHODIMP
AndroidAlerts::CloseAlert(const nsAString& aAlertName, nsIPrincipal* aPrincipal)
{
...
void
AndroidAlerts::NotifyListener(const nsAString& aName,
                              const char* aTopic,
