    ...
    : public mozilla::layers::ChromeProcessController
{
 public:
  AndroidContentController(nsWindow* aWindow,
      ...
      : mozilla::layers::ChromeProcessController(
            aWindow, aAPZEventState, aAPZCTreeManager),
  ...
  void UpdateOverscrollVelocity(const float aX,
                                const float aY,
                                const bool aIsRootContent) override;
  void UpdateOverscrollOffset(const float aX,
                              const float aY,
                              const bool aIsRootContent) override;
