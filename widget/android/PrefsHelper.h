...
class PrefsHelper : public java::PrefsHelper::Natives<PrefsHelper>
{
  ...
  {
    if (NS_FAILED(aObsServ->NotifyObservers(
            aVariant, "android-get-pref", aPrefName->ToString().get()))) {
      return false;
    }
                             ...
                             jni::String::Param aStrVal)
  {
    ...
    if (NS_SUCCEEDED(rv)) {
      rv = aObsServ->NotifyObservers(
          aVariant, "android-set-pref", aPrefName->ToString().get());
    }
 ...
 public:
                      ...
                      jni::String::Param aStrVal)
  {
    ...
    if (Preferences::GetType(name.get()) == nsIPrefBranch::PREF_INVALID) {
      ...
      if (obsServ && SetVariantPref(obsServ,
                                    value,
                                    aPrefName,
                                    aFlush,
                                    aType,
        ...
        GetVariantPref(
            obsServ, value, nullptr, jni::String::LocalRef(aPrefName));
        return;
      }
    }
