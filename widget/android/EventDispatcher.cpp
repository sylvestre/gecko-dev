...
nsresult
BoxArrayPrimitive(JSContext* aCx,
                  JS::HandleObject aData,
...
BoxArray(JSContext* aCx, JS::HandleObject aData, jni::Object::LocalRef& aOut)
{
  ...
  if (element.isBoolean()) {
    return BoxArrayPrimitive<bool,
                             &JS::Value::isBoolean,
                             &JS::Value::toBoolean,
                             jni::BooleanArray,
                             &jni::BooleanArray::New>(
        aCx, aData, aOut, length, element);
  }

  if (element.isInt32()) {
    nsresult rv = BoxArrayPrimitive<int32_t,
                                    &JS::Value::isInt32,
                                    &JS::Value::toInt32,
                                    jni::IntArray,
                                    &jni::IntArray::New>(
  ...
  if (element.isNumber()) {
    return BoxArrayPrimitive<double,
                             &JS::Value::isNumber,
                             &JS::Value::toNumber,
                             jni::DoubleArray,
                             &jni::DoubleArray::New>(
    ...
    if (rv == NS_ERROR_INVALID_ARG && !JS_IsExceptionPending(aCx)) {
      ...
      if (CheckJS(aCx, autoStr.init(aCx, idVal.toString()))) {
        JS_ReportErrorUTF8(aCx,
                           u8"Invalid event data property %s",
...
nsresult
BoxData(const nsAString& aEvent,
        JSContext* aCx,
...
nsresult
UnboxString(JSContext* aCx,
            const jni::Object::LocalRef& aData,
...
nsresult
UnboxValue(JSContext* aCx,
           const jni::Object::LocalRef& aData,
           JS::MutableHandleValue aOut);

nsresult
UnboxBundle(JSContext* aCx,
            const jni::Object::LocalRef& aData,
            JS::MutableHandleValue aOut)
{
  if (!aData) {
  ...
  for (size_t i = 0; i < len; i++) {
    ...
    NS_ENSURE_TRUE(
        CheckJS(aCx,
                JS_SetUCProperty(aCx,
                                 obj,
                                 reinterpret_cast<const char16_t*>(keyChars),
                                 keyLen,
                                 value)),
        NS_ERROR_FAILURE);
  }
...
nsresult
UnboxArrayPrimitive(JSContext* aCx,
                    const jni::Object::LocalRef& aData,
                    JS::MutableHandleValue aOut)
{
  JNIEnv* const env = aData.Env();
...
template<nsresult (*Unbox)(
    JSContext*, const jni::Object::LocalRef&, JS::MutableHandleValue)>
nsresult
UnboxArrayObject(JSContext* aCx,
                 const jni::Object::LocalRef& aData,
                 JS::MutableHandleValue aOut)
{
           ...
           JS::MutableHandleValue aOut)
{
  if (!aData) {
    ...
    return UnboxArrayPrimitive<bool,
                               jboolean,
                               jbooleanArray,
    ...
    return UnboxArrayPrimitive<int32_t,
                               jint,
                               jintArray,
    ...
    return UnboxArrayPrimitive<double,
                               jdouble,
                               jdoubleArray,
...
nsresult
UnboxData(jni::String::Param aEvent,
          JSContext* aCx,
...
class JavaCallbackDelegate final : public nsIAndroidEventCallback
{
  ...
  NS_IMETHOD Call(JS::HandleValue aData,
                  void (java::EventCallback::*aCall)(jni::Object::Param) const)
  {
    MOZ_ASSERT(NS_IsMainThread());
    AutoJSContext cx;

    jni::Object::LocalRef data(jni::GetGeckoThreadEnv());
    nsresult rv = BoxData(NS_LITERAL_STRING("callback"),
                          cx,
                          aData,
                          data,
                          /* ObjectOnly */ false);
          ...
          NativeCallbackDelegateSupport>
{
            ...
            nsresult (nsIAndroidEventCallback::*aCall)(JS::HandleValue))
  {
    ...
    nsresult rv = UnboxData(NS_LITERAL_STRING("callback"),
                            jsapi.cx(),
                            aData,
                            &data,
                            /* BundleOnly */ false);
...
nsresult
EventDispatcher::DispatchOnGecko(ListenersList* list,
...
NS_IMETHODIMP
EventDispatcher::Dispatch(JS::HandleValue aEvent,
                          JS::HandleValue aData,
                          nsIAndroidEventCallback* aCallback,
                          JSContext* aCx)
{
                          ...
                          nsIAndroidEventCallback* aCallback)
{
  ...
  if (list) {
    dom::AutoJSAPI jsapi;
    JS::RootedValue data(jsapi.cx());
    nsresult rv = UnboxData(/* Event */ nullptr,
                            jsapi.cx(),
                            aData,
                            &data,
                            /* BundleOnly */ true);
...
nsresult
EventDispatcher::IterateEvents(JSContext* aCx,
                               JS::HandleValue aEvents,
                               ...
                               nsIAndroidEventListener* aListener)
{
  ...
  auto processEvent =
      [this, aCx, aCallback, aListener](JS::HandleValue event) -> nsresult {
    nsAutoJSString str;
                                  ...
                                  JSContext* aCx)
{
  return IterateEvents(
      aCx, aEvents, &EventDispatcher::RegisterEventLocked, aListener);
}
...
{
  return IterateEvents(
      aCx, aEvents, &EventDispatcher::UnregisterEventLocked, aListener);
}
...
/* static */
nsresult
EventDispatcher::UnboxBundle(JSContext* aCx,
                             jni::Object::Param aData,
                             JS::MutableHandleValue aOut)
{
