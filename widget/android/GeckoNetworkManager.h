    ...
    : public java::GeckoNetworkManager::Natives<GeckoNetworkManager>
{
 ...
 public:
  static void OnConnectionChanged(int32_t aType,
                                  ...
                                  int32_t aGateway)
  {
    ...
    if (os) {
      os->NotifyObservers(
          nullptr, NS_NETWORK_LINK_TYPE_TOPIC, aSubType->ToString().get());
    }
  }
  ...
  static void OnStatusChanged(jni::String::Param aStatus)
  {
    ...
    if (os) {
      os->NotifyObservers(
          nullptr, NS_NETWORK_LINK_TOPIC, aStatus->ToString().get());
    }
  }
};
