...
static nsresult
nsNativeThemeGTKConstructor(nsISupports* aOuter, REFNSIID aIID, void** aResult)
{
  nsresult rv;
...
#if (MOZ_WIDGET_GTK == 3)
static nsresult
nsApplicationChooserConstructor(nsISupports* aOuter,
                                REFNSIID aIID,
                                void** aResult)
{
  *aResult = nullptr;
...
static nsresult
nsColorPickerConstructor(nsISupports* aOuter, REFNSIID aIID, void** aResult)
{
  *aResult = nullptr;
  if (aOuter != nullptr) {
    return NS_ERROR_NO_AGGREGATION;
