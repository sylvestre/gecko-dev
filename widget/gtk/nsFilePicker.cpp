...
nsFilePicker::Open(nsIFilePickerShownCallback* aCallback)
{
  ...
  GtkWidget* file_chooser = gtk_file_chooser_dialog_new(title.get(),
                                                        parent_widget,
                                                        action,
                                                        GTK_STOCK_CANCEL,
                                                        GTK_RESPONSE_CANCEL,
  ...
  if (action == GTK_FILE_CHOOSER_ACTION_OPEN ||
    ...
    g_signal_connect(file_chooser,
                     "update-preview",
                     G_CALLBACK(UpdateFilePreviewWidget),
                     img_preview);
  }
...
/* static */ void
nsFilePicker::OnResponse(GtkWidget* file_chooser,
                         gint response_id,
                         gpointer user_data)
{
...
nsFilePicker::Done(GtkWidget* file_chooser, gint response)
{
  ...
  g_signal_handlers_disconnect_by_func(
      file_chooser, FuncToGpointer(OnDestroy), this);
