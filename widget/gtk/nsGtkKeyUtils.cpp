...
KeymapWrapper::InitBySystemSettings()
{
  ...
  KeySym* xkeymap = XGetKeyboardMapping(display,
                                        min_keycode,
...
KeymapWrapper::~KeymapWrapper()
{
  ...
  g_signal_handlers_disconnect_by_func(
      mGdkKeymap, FuncToGpointer(OnKeysChanged), this);
  g_signal_handlers_disconnect_by_func(
...
/* static */ bool
KeymapWrapper::AreModifiersActive(Modifiers aModifiers, guint aModifierState)
{
...
KeymapWrapper::ComputeDOMKeyCode(const GdkEventKey* aGdkKeyEvent)
{
  ...
  uint32_t shiftedChar = keymapWrapper->GetCharCodeFor(
      aGdkKeyEvent, shiftState, aGdkKeyEvent->group);
                            ...
                            GdkEventKey* aGdkKeyEvent)
{
  ...
  aKeyEvent.mKeyNameIndex = keymapWrapper->ComputeDOMKeyNameIndex(aGdkKeyEvent);
  ...
  MOZ_LOG(gKeymapWrapperLog,
          ...
          ("%p InitKeyEvent, modifierState=0x%08X "
           ...
           GetBoolName(aKeyEvent.IsShift()),
           GetBoolName(aKeyEvent.IsControl()),
           GetBoolName(aKeyEvent.IsAlt()),
           GetBoolName(aKeyEvent.IsMeta())));
...
KeymapWrapper::GetUnmodifiedCharCodeFor(const GdkEventKey* aGdkKeyEvent)
{
  ...
  return GetCharCodeFor(
      aGdkKeyEvent, GdkModifierType(stateWithoutAltGraph), aGdkKeyEvent->group);
}
                                                 ...
                                                 GdkEventKey* aGdkKeyEvent)
{
  ...
  ch = GetCharCodeFor(
      aGdkKeyEvent, baseState | GetModifierMask(SHIFT), minGroup);
