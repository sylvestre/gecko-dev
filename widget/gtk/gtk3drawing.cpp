...
moz_gtk_refresh()
{
  if (gtk_check_version(3, 12, 0) == nullptr &&
    ...
    gtk_style_context_get_style(
        style, "has-tab-gap", &notebook_has_tab_gap, NULL);
  } else {
...
moz_gtk_menuitem_get_horizontal_padding(gint* horizontal_padding)
{
  ...
  gtk_style_context_get_style(
      style, "horizontal-padding", horizontal_padding, nullptr);
  return MOZ_GTK_SUCCESS;
}
                                    ...
                                    gint* border_right)
{
  ...
  gtk_style_context_get_style(
      style, "default-outside-border", &default_outside_border, NULL);
...
static gint
moz_gtk_window_paint(cairo_t* cr,
                     GdkRectangle* rect,
                     GtkTextDirection direction)
{
...
static gint
moz_gtk_button_paint(cairo_t* cr,
                     GdkRectangle* rect,
                     GtkWidgetState* state,
...
static gint
moz_gtk_header_bar_button_paint(cairo_t* cr,
                                GdkRectangle* rect,
                                GtkWidgetState* state,
                                GtkReliefStyle relief,
                                GtkWidget* widget,
...
static gint
moz_gtk_toggle_paint(cairo_t* cr,
                     GdkRectangle* rect,
                     GtkWidgetState* state,
                     gboolean selected,
...
GetMinContentBox(GtkStyleContext* style)
{
  ...
  gtk_style_context_get(
      style, state_flags, "min-width", &width, "min-height", &height, nullptr);
  return {width, height};
}
                            ...
                            int* height)
{
  ...
  GtkStateFlags state_flags = gtk_style_context_get_state(style);
  gtk_style_context_get(
      style, state_flags, "min-height", height, "min-width", width, nullptr);
...
InsetByMargin(GdkRectangle* rect, GtkStyleContext* style)
{
  ...
  gtk_style_context_get_margin(
      style, gtk_style_context_get_state(style), &margin);
  Inset(rect, margin);
}
...
static gint
moz_gtk_scrollbar_button_paint(cairo_t* cr,
                               ...
                               GtkTextDirection direction)
{
  ...
  gtk_render_arrow(
      style, cr, arrow_angle, arrow_rect.x, arrow_rect.y, arrow_size);
...
static void
moz_gtk_draw_styled_frame(GtkStyleContext* style,
                          cairo_t* cr,
                          const GdkRectangle* aRect,
                          bool drawFocus)
{
...
static gint
moz_gtk_spin_paint(cairo_t* cr, GdkRectangle* rect, GtkTextDirection direction)
{
...
static gint
moz_gtk_spin_updown_paint(cairo_t* cr,
                          GdkRectangle* rect,
                          gboolean isDown,
                          GtkWidgetState* state,
                          GtkTextDirection direction)
...
*/
static gint
moz_gtk_scale_paint(cairo_t* cr,
                    GdkRectangle* rect,
                    GtkWidgetState* state,
...
static gint
moz_gtk_scale_thumb_paint(cairo_t* cr,
                          GdkRectangle* rect,
                          GtkWidgetState* state,
                          GtkOrientation flags,
                          GtkTextDirection direction)
...
static gint
moz_gtk_gripper_paint(cairo_t* cr,
                      GdkRectangle* rect,
                      GtkWidgetState* state,
                      GtkTextDirection direction)
{
...
static gint
moz_gtk_hpaned_paint(cairo_t* cr, GdkRectangle* rect, GtkWidgetState* state)
{
  GtkStyleContext* style =
...
static gint
moz_gtk_vpaned_paint(cairo_t* cr, GdkRectangle* rect, GtkWidgetState* state)
{
  GtkStyleContext* style =
...
static gint
moz_gtk_entry_paint(cairo_t* cr,
                    GdkRectangle* rect,
                    GtkWidgetState* state,
                    GtkStyleContext* style)
{
...
static gint
moz_gtk_text_view_paint(cairo_t* cr,
                        GdkRectangle* aRect,
                        GtkWidgetState* state,
                        GtkTextDirection direction)
{
  ...
  gtk_render_frame(
      style_frame, cr, aRect->x, aRect->y, aRect->width, aRect->height);
...
static gint
moz_gtk_treeview_paint(cairo_t* cr,
                       GdkRectangle* rect,
                       GtkWidgetState* state,
                       GtkTextDirection direction)
{
  ...
  gtk_render_background(style_tree,
                        cr,
                        rect->x + xthickness,
                        rect->y + ythickness,
...
static gint
moz_gtk_tree_header_cell_paint(cairo_t* cr,
                               GdkRectangle* rect,
                               GtkWidgetState* state,
                               gboolean isSorted,
                               GtkTextDirection direction)
{
  moz_gtk_button_paint(cr,
                       rect,
                       state,
                       GTK_RELIEF_NORMAL,
...
static gint
moz_gtk_tree_header_sort_arrow_paint(cairo_t* cr,
                                     GdkRectangle* rect,
                                     GtkWidgetState* state,
                                     ...
                                     GtkTextDirection direction)
{
  ...
  arrow_rect.x = rect->x + (rect->width - arrow_rect.width) / 2;
  arrow_rect.y = rect->y + (rect->height - arrow_rect.height) / 2;
  style = GetStyleContext(MOZ_GTK_TREE_HEADER_SORTARROW,
                          direction,
                          GetStateFlagsFromGtkWidgetState(state));
  switch (arrow_type) {
    case GTK_ARROW_LEFT:
  ...
  if (arrow_type != GTK_ARROW_NONE)
    gtk_render_arrow(
        style, cr, arrow_angle, arrow_rect.x, arrow_rect.y, arrow_rect.width);
  return MOZ_GTK_SUCCESS;
}
 ...
 */
static gint
moz_gtk_treeview_expander_paint(cairo_t* cr,
                                GdkRectangle* rect,
                                GtkWidgetState* state,
...
*/
static gint
moz_gtk_combo_box_paint(cairo_t* cr,
                        GdkRectangle* rect,
                        GtkWidgetState* state,
                        GtkTextDirection direction)
{
  ...
  moz_gtk_button_paint(
      cr, rect, state, GTK_RELIEF_NORMAL, comboBoxButton, direction);
...
static gint
moz_gtk_arrow_paint(cairo_t* cr,
                    GdkRectangle* rect,
                    GtkWidgetState* state,
                    GtkArrowType arrow_type,
                    GtkTextDirection direction)
{
  ...
  calculate_arrow_rect(
      GetWidget(MOZ_GTK_BUTTON_ARROW), rect, &arrow_rect, direction);
  GtkStateFlags state_flags = GetStateFlagsFromGtkWidgetState(state);
  GtkStyleContext* style =
...
static gint
moz_gtk_combo_box_entry_button_paint(cairo_t* cr,
                                     GdkRectangle* rect,
                                     GtkWidgetState* state,
                                     ...
                                     GtkTextDirection direction)
{
  ...
  moz_gtk_button_paint(
      cr, rect, state, GTK_RELIEF_NORMAL, comboBoxEntry, direction);
...
static gint
moz_gtk_container_paint(cairo_t* cr,
                        GdkRectangle* rect,
                        GtkWidgetState* state,
                        ...
                        GtkTextDirection direction)
{
  ...
  if (state_flags & GTK_STATE_FLAG_PRELIGHT) {
    gtk_render_background(
        style, cr, rect->x, rect->y, rect->width, rect->height);
  }
...
static gint
moz_gtk_toggle_label_paint(cairo_t* cr,
                           GdkRectangle* rect,
                           GtkWidgetState* state,
                           gboolean isradio,
                           GtkTextDirection direction)
...
static gint
moz_gtk_toolbar_paint(cairo_t* cr,
                      GdkRectangle* rect,
                      GtkTextDirection direction)
{
...
*/
static gint
moz_gtk_toolbar_separator_paint(cairo_t* cr,
                                GdkRectangle* rect,
                                GtkTextDirection direction)
{
  gint separator_width;
...
static gint
moz_gtk_tooltip_paint(cairo_t* cr,
                      const GdkRectangle* aRect,
                      GtkTextDirection direction)
{
...
static gint
moz_gtk_resizer_paint(cairo_t* cr,
                      GdkRectangle* rect,
                      GtkWidgetState* state,
                      GtkTextDirection direction)
{
  GtkStyleContext* style =
      GetStyleContext(MOZ_GTK_RESIZER,
                      GTK_TEXT_DIR_LTR,
                      GetStateFlagsFromGtkWidgetState(state));
...
static gint
moz_gtk_frame_paint(cairo_t* cr, GdkRectangle* rect, GtkTextDirection direction)
{
...
static gint
moz_gtk_progressbar_paint(cairo_t* cr,
                          GdkRectangle* rect,
                          GtkTextDirection direction)
{
...
static gint
moz_gtk_progress_chunk_paint(cairo_t* cr,
                             GdkRectangle* rect,
                             GtkTextDirection direction,
                             WidgetNodeType widget)
{
                  ...
                  WidgetNodeType widget)
{
  ...
  if (notebook_has_tab_gap) {
    if ((flags & MOZ_GTK_TAB_SELECTED) == 0) {
      ...
      if (isBottomTab) {
        ...
        gtk_render_extension(style,
                             cr,
                             tabRect.x,
                             tabRect.y + gap_voffset,
                             tabRect.width,
                             tabRect.height - gap_voffset,
                             GTK_POS_TOP);
        ...
        /* Draw the gap; erase with background color before painting in
                 * case theme does not */
        gtk_render_background(panelStyle,
                              cr,
                              backRect.x,
                              backRect.y,
                              backRect.width,
        ...
        cairo_save(cr);
        cairo_rectangle(
            cr, backRect.x, backRect.y, backRect.width, backRect.height);
        cairo_clip(cr);

        gtk_render_frame_gap(panelStyle,
                             cr,
    ...
    gtk_render_background(
        style, cr, tabRect.x, tabRect.y, tabRect.width, tabRect.height);
    gtk_render_frame(
        style, cr, tabRect.x, tabRect.y, tabRect.width, tabRect.height);
  }
  ...
  if (state->focused) {
    ...
    gtk_style_context_get_padding(
        style, GetStateFlagsFromGtkWidgetState(state), &padding);
    ...
    gtk_render_focus(
        style, cr, focusRect.x, focusRect.y, focusRect.width, focusRect.height);
  }
...
/* tab area*/
static gint
moz_gtk_tabpanels_paint(cairo_t* cr,
                        GdkRectangle* rect,
                        GtkTextDirection direction)
{
  ...
  cairo_save(cr);
  cairo_rectangle(
      cr, rect->x, rect->y, rect->x + rect->width / 2, rect->y + rect->height);
  cairo_clip(cr);
...
static gint
moz_gtk_tab_scroll_arrow_paint(cairo_t* cr,
                               GdkRectangle* rect,
                               GtkWidgetState* state,
                               GtkArrowType arrow_type,
                               GtkTextDirection direction)
{
  ...
  if (arrow_type != GTK_ARROW_NONE) {
    style = GetStyleContext(MOZ_GTK_TAB_SCROLLARROW,
                            direction,
                            GetStateFlagsFromGtkWidgetState(state));
...
static gint
moz_gtk_menu_bar_paint(cairo_t* cr,
                       GdkRectangle* rect,
                       GtkTextDirection direction)
{
  GtkStyleContext* style;
...
static gint
moz_gtk_menu_popup_paint(cairo_t* cr,
                         GdkRectangle* rect,
                         GtkTextDirection direction)
{
  GtkStyleContext* style;
...
static gint
moz_gtk_menu_separator_paint(cairo_t* cr,
                             GdkRectangle* rect,
                             GtkTextDirection direction)
{
  GtkWidgetState defaultState = {0};
  moz_gtk_menu_item_paint(
      MOZ_GTK_MENUSEPARATOR, cr, rect, &defaultState, direction);
...
static gint
moz_gtk_menu_arrow_paint(cairo_t* cr,
                         GdkRectangle* rect,
                         GtkWidgetState* state,
                         GtkTextDirection direction)
{
...
static gint
moz_gtk_info_bar_paint(cairo_t* cr, GdkRectangle* rect, GtkWidgetState* state)
{
  GtkStyleContext* style =
      GetStyleContext(MOZ_GTK_INFO_BAR,
                      GTK_TEXT_DIR_LTR,
                      GetStateFlagsFromGtkWidgetState(state));
  gtk_render_background(style, cr, rect->x, rect->y, rect->width, rect->height);
  gtk_render_frame(style, cr, rect->x, rect->y, rect->width, rect->height);
...
moz_gtk_add_style_margin(
    GtkStyleContext* style, gint* left, gint* top, gint* right, gint* bottom)
{
  GtkBorder margin;
                          ...
                          GtkTextDirection direction)
{
  ...
  *left = *top = *right = *bottom = 0;
    ...
    case MOZ_GTK_DROPDOWN: {
      ...
      *left = *top = *right = *bottom = gtk_container_get_border_width(
      ...
      gtk_widget_get_preferred_size(
          GetWidget(MOZ_GTK_COMBOBOX_ARROW), NULL, &arrow_req);
  ...
  if (w) {
    moz_gtk_add_style_border(
        gtk_widget_get_style_context(w), left, top, right, bottom);
  }
  return MOZ_GTK_SUCCESS;
}
...
moz_gtk_get_combo_box_entry_button_size(gint* width, gint* height)
{
  ...
  gtk_widget_get_preferred_size(
      GetWidget(MOZ_GTK_COMBOBOX_ENTRY_BUTTON), NULL, &requisition);
                     ...
                     GtkTextDirection direction)
{
  ...
  switch (widget) {
    ...
    case MOZ_GTK_TOOLBAR_BUTTON:
      if (state->depressed) {
        return moz_gtk_button_paint(cr,
                                    rect,
                                    state,
    ...
    case MOZ_GTK_HEADER_BAR_BUTTON_MAXIMIZE:
      return moz_gtk_header_bar_button_paint(
          cr, rect, state, (GtkReliefStyle)flags, GetWidget(widget), direction);
      break;
    case MOZ_GTK_CHECKBUTTON:
    case MOZ_GTK_RADIOBUTTON:
      return moz_gtk_toggle_paint(cr,
                                  rect,
                                  state,
    ...
    case MOZ_GTK_SCROLLBAR_VERTICAL:
      ...
      if (gtk_check_version(3, 20, 0) == nullptr) {
        ...
        return moz_gtk_scrollbar_trough_paint(
            trough_widget, cr, rect, state, direction);
      }
      break;
    ...
    case MOZ_GTK_SCROLLBAR_TROUGH_VERTICAL:
      if (gtk_check_version(3, 20, 0) == nullptr) {
        return moz_gtk_scrollbar_trough_paint(
            widget, cr, rect, state, direction);
      }
      break;
    case MOZ_GTK_SCROLLBAR_THUMB_HORIZONTAL:
    case MOZ_GTK_SCROLLBAR_THUMB_VERTICAL:
    ...
    case MOZ_GTK_SCALE_VERTICAL:
      return moz_gtk_scale_paint(
          cr, rect, state, (GtkOrientation)flags, direction);
      break;
    case MOZ_GTK_SCALE_THUMB_HORIZONTAL:
    case MOZ_GTK_SCALE_THUMB_VERTICAL:
    ...
    case MOZ_GTK_SPINBUTTON_ENTRY: {
      GtkStyleContext* style =
          GetStyleContext(MOZ_GTK_SPINBUTTON_ENTRY,
                          direction,
                          GetStateFlagsFromGtkWidgetState(state));
    ...
    case MOZ_GTK_TAB_BOTTOM:
      return moz_gtk_tab_paint(
          cr, rect, state, (GtkTabFlags)flags, direction, widget);
      break;
    case MOZ_GTK_TABPANELS:
    ...
    case MOZ_GTK_RADIOMENUITEM:
      return moz_gtk_check_menu_item_paint(
          widget, cr, rect, state, (gboolean)flags, direction);
      break;
    case MOZ_GTK_SPLITTER_HORIZONTAL:
