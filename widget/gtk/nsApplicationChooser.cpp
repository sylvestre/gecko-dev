...
/* static */ void
nsApplicationChooser::OnResponse(GtkWidget* chooser,
                                 gint response_id,
                                 gpointer user_data)
{
...
void
nsApplicationChooser::Done(GtkWidget* chooser, gint response)
{
  ...
  switch (response) {
    ...
    case GTK_RESPONSE_ACCEPT: {
      ...
      rv = NS_NewNativeLocalFile(nsDependentCString(fileWithFullPath),
                                 false,
  ...
  g_signal_handlers_disconnect_by_func(
      chooser, FuncToGpointer(OnDestroy), this);
