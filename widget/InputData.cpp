...
MultiTouchInput::MultiTouchInput(MultiTouchType aType,
                                 uint32_t aTime,
                                 TimeStamp aTimeStamp,
                                 Modifiers aModifiers)
...
MultiTouchInput::MultiTouchInput(const MultiTouchInput& aOther)
    : InputData(
          MULTITOUCH_INPUT, aOther.mTime, aOther.mTimeStamp, aOther.modifiers),
      mType(aOther.mType),
...
bool
MultiTouchInput::TransformToLocal(
...
MouseInput::MouseInput(MouseType aType,
...
MouseInput::ToWidgetMouseEvent(nsIWidget* aWidget) const
{
  ...
  WidgetMouseEvent event(
      true, msg, aWidget, WidgetMouseEvent::eReal, WidgetMouseEvent::eNormal);
...
PanGestureInput::PanGestureInput(PanGestureType aType,
                                 uint32_t aTime,
                                 TimeStamp aTimeStamp,
...
bool
PanGestureInput::TransformToLocal(
    const ScreenToParentLayerMatrix4x4& aTransform)
{
...
PinchGestureInput::PinchGestureInput(PinchGestureType aType,
                                     uint32_t aTime,
                                     TimeStamp aTimeStamp,
...
bool
PinchGestureInput::TransformToLocal(
    const ScreenToParentLayerMatrix4x4& aTransform)
{
...
TapGestureInput::TapGestureInput(TapGestureType aType,
                                 uint32_t aTime,
                                 TimeStamp aTimeStamp,
...
bool
TapGestureInput::TransformToLocal(
    const ScreenToParentLayerMatrix4x4& aTransform)
{
...
ScrollWheelInput::ScrollWheelInput(uint32_t aTime,
                                   TimeStamp aTimeStamp,
                                   Modifiers aModifiers,
...
bool
ScrollWheelInput::TransformToLocal(
    const ScreenToParentLayerMatrix4x4& aTransform)
{
  Maybe<ParentLayerPoint> point = UntransformBy(aTransform, mOrigin);
  if (!point) {
...
KeyboardInput::KeyboardInput(const WidgetKeyboardEvent& aEvent)
    : InputData(
          KEYBOARD_INPUT, aEvent.mTime, aEvent.mTimeStamp, aEvent.mModifiers),
...
KeyboardInput::KeyboardInput()
    : InputData(KEYBOARD_INPUT), mKeyCode(0), mCharCode(0), mHandledByAPZ(false)
{
}
