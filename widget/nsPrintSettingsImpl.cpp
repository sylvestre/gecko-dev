...
NS_IMETHODIMP
nsPrintSettings::GetPrintSession(nsIPrintSession** aPrintSession)
{
...
NS_IMETHODIMP
nsPrintSettings::SetPrintSession(nsIPrintSession* aPrintSession)
{
...
NS_IMETHODIMP
nsPrintSettings::GetPrinterName(nsAString& aPrinter)
{
  aPrinter = mPrinter;
  return NS_OK;
}
...
NS_IMETHODIMP
nsPrintSettings::SetPrinterName(const nsAString& aPrinter)
{
...
NS_IMETHODIMP
nsPrintSettings::GetToFileName(nsAString& aToFileName)
{
  aToFileName = mToFileName;
  return NS_OK;
}
NS_IMETHODIMP
nsPrintSettings::SetToFileName(const nsAString& aToFileName)
{
...
NS_IMETHODIMP
nsPrintSettings::GetTitle(nsAString& aTitle)
{
  aTitle = mTitle;
  return NS_OK;
}
NS_IMETHODIMP
nsPrintSettings::SetTitle(const nsAString& aTitle)
{
  mTitle = aTitle;
  return NS_OK;
}
...
NS_IMETHODIMP
nsPrintSettings::GetDocURL(nsAString& aDocURL)
{
  aDocURL = mURL;
  return NS_OK;
}
NS_IMETHODIMP
nsPrintSettings::SetDocURL(const nsAString& aDocURL)
{
  mURL = aDocURL;
  return NS_OK;
}
...
NS_IMETHODIMP
nsPrintSettings::GetHeaderStrLeft(nsAString& aTitle)
{
  aTitle = mHeaderStrs[0];
  return NS_OK;
}
NS_IMETHODIMP
nsPrintSettings::SetHeaderStrLeft(const nsAString& aTitle)
{
...
NS_IMETHODIMP
nsPrintSettings::GetHeaderStrCenter(nsAString& aTitle)
{
  aTitle = mHeaderStrs[1];
  return NS_OK;
}
NS_IMETHODIMP
nsPrintSettings::SetHeaderStrCenter(const nsAString& aTitle)
{
...
NS_IMETHODIMP
nsPrintSettings::GetHeaderStrRight(nsAString& aTitle)
{
  aTitle = mHeaderStrs[2];
  return NS_OK;
}
NS_IMETHODIMP
nsPrintSettings::SetHeaderStrRight(const nsAString& aTitle)
{
...
NS_IMETHODIMP
nsPrintSettings::GetFooterStrLeft(nsAString& aTitle)
{
  aTitle = mFooterStrs[0];
  return NS_OK;
}
NS_IMETHODIMP
nsPrintSettings::SetFooterStrLeft(const nsAString& aTitle)
{
...
NS_IMETHODIMP
nsPrintSettings::GetFooterStrCenter(nsAString& aTitle)
{
  aTitle = mFooterStrs[1];
  return NS_OK;
}
NS_IMETHODIMP
nsPrintSettings::SetFooterStrCenter(const nsAString& aTitle)
{
...
NS_IMETHODIMP
nsPrintSettings::GetFooterStrRight(nsAString& aTitle)
{
  aTitle = mFooterStrs[2];
  return NS_OK;
}
NS_IMETHODIMP
nsPrintSettings::SetFooterStrRight(const nsAString& aTitle)
{
...
NS_IMETHODIMP
nsPrintSettings::GetPaperName(nsAString& aPaperName)
{
  aPaperName = mPaperName;
  return NS_OK;
}
NS_IMETHODIMP
nsPrintSettings::SetPaperName(const nsAString& aPaperName)
{
