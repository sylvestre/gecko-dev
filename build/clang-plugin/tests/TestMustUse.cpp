...
void foo() {
  ...
  producesMustUse(); // expected-error {{Unused value of must-use type
                     // 'MustUse'}}
  producesMustUsePointer();
  producesMustUseRef(); // expected-error {{Unused value of must-use type
                        // 'MustUse'}}
  producesMayUse();
  ...
  for (producesMustUse();;)
    ; // expected-error {{Unused value of must-use type 'MustUse'}}
  ...
  use((producesMustUse(),
       false)); // expected-error {{Unused value of must-use type 'MustUse'}}
