...
SimdType TypedObjectPrediction::simdType() const { return descr().as<SimdTypeDescr>().type(); }
...
bool TypedObjectPrediction::hasFieldNamedPrefix(const StructTypeDescr& descr, size_t fieldCount,
...
bool TypedObjectPrediction::hasFieldNamed(jsid id, size_t* fieldOffset,
    ...
    switch (predictionKind()) {
        ...
        case TypedObjectPrediction::Descr:
            return hasFieldNamedPrefix(descr().as<StructTypeDescr>(), ALL_FIELDS, id, fieldOffset,
                                       fieldType, fieldIndex);

        case TypedObjectPrediction::Prefix:
            return hasFieldNamedPrefix(*prefix().descr, prefix().fields, id, fieldOffset,
                                       fieldType, fieldIndex);
