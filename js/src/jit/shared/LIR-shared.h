...
class LBox : public LInstructionHelper<BOX_PIECES, 1, 0> {
   ...
   public:
    ...
    LBox(const LAllocation& payload, MIRType type) : type_(type) { setOperand(0, payload); }
...
class LOsiPoint : public LInstructionHelper<0, 0, 0> {
   ...
   public:
    LOsiPoint(LSafepoint* safepoint, LSnapshot* snapshot) : safepoint_(safepoint) {
...
class LMoveGroup : public LInstructionHelper<0, 0, 0> {
    ...
    explicit LMoveGroup(TempAllocator& alloc) : moves_(alloc) {}

   public:
    LIR_HEADER(MoveGroup)

    static LMoveGroup* New(TempAllocator& alloc) { return new (alloc) LMoveGroup(alloc); }
    ...
    bool uses(Register reg) {
        for (size_t i = 0; i < numMoves(); i++) {
            ...
            if (move.from() == LGeneralReg(reg) || move.to() == LGeneralReg(reg)) return true;
        }
        return false;
    }
};
...
class LSimdSplatX16 : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LSimdSplatX16(const LAllocation& v) { setOperand(0, v); }
...
class LSimdSplatX8 : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LSimdSplatX8(const LAllocation& v) { setOperand(0, v); }
...
class LSimdSplatX4 : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LSimdSplatX4(const LAllocation& v) { setOperand(0, v); }
...
class LSimdReinterpretCast : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LSimdReinterpretCast(const LAllocation& v) { setOperand(0, v); }
...
class LSimdExtractElementBase : public LInstructionHelper<1, 1, 0> {
   protected:
    explicit LSimdExtractElementBase(const LAllocation& base) { setOperand(0, base); }
...
class LSimdExtractElementB : public LSimdExtractElementBase {
   public:
    ...
    explicit LSimdExtractElementB(const LAllocation& base) : LSimdExtractElementBase(base) {}
};
...
class LSimdExtractElementI : public LSimdExtractElementBase {
   public:
    ...
    explicit LSimdExtractElementI(const LAllocation& base) : LSimdExtractElementBase(base) {}
};
...
class LSimdExtractElementF : public LSimdExtractElementBase {
   public:
    ...
    explicit LSimdExtractElementF(const LAllocation& base) : LSimdExtractElementBase(base) {}
};
...
class LSimdInsertElementBase : public LInstructionHelper<1, 2, 0> {
   ...
   public:
    ...
    unsigned length() const { return SimdTypeToLength(mir_->toSimdInsertElement()->type()); }
};
...
class LSimdSwizzleBase : public LInstructionHelper<1, 1, 1> {
   public:
    explicit LSimdSwizzleBase(const LAllocation& base) { setOperand(0, base); }
...
class LSimdGeneralShuffleBase : public LVariadicInstruction<1, 1> {
   public:
    explicit LSimdGeneralShuffleBase(const LDefinition& temp) { setTemp(0, temp); }
...
class LSimdGeneralShuffleI : public LSimdGeneralShuffleBase {
   public:
    ...
    explicit LSimdGeneralShuffleI(const LDefinition& temp) : LSimdGeneralShuffleBase(temp) {}
};

class LSimdGeneralShuffleF : public LSimdGeneralShuffleBase {
   public:
    LIR_HEADER(SimdGeneralShuffleF);
    explicit LSimdGeneralShuffleF(const LDefinition& temp) : LSimdGeneralShuffleBase(temp) {}
};
...
class LSimdBinaryComp : public LInstructionHelper<1, 2, 0> {
   ...
   public:
    const LAllocation* lhs() { return getOperand(0); }
    const LAllocation* rhs() { return getOperand(1); }
    MSimdBinaryComp::Operation operation() const { return mir_->toSimdBinaryComp()->operation(); }
    const char* extraName() const { return MSimdBinaryComp::OperationName(operation()); }
};
...
class LSimdBinaryArith : public LInstructionHelper<1, 2, 1> {
   public:
    ...
    const char* extraName() const { return MSimdBinaryArith::OperationName(operation()); }
};
...
class LSimdBinarySaturating : public LInstructionHelper<1, 2, 0> {
   public:
    ...
    SimdSign signedness() const { return this->mir_->toSimdBinarySaturating()->signedness(); }
    MIRType type() const { return mir_->type(); }
    const char* extraName() const { return MSimdBinarySaturating::OperationName(operation()); }
};

// Unary SIMD arithmetic operation on a SIMD operand
class LSimdUnaryArith : public LInstructionHelper<1, 1, 0> {
   public:
    explicit LSimdUnaryArith(const LAllocation& in) { setOperand(0, in); }
    MSimdUnaryArith::Operation operation() const { return mir_->toSimdUnaryArith()->operation(); }
};
...
class LSimdBinaryBitwise : public LInstructionHelper<1, 2, 0> {
   public:
    ...
    const char* extraName() const { return MSimdBinaryBitwise::OperationName(operation()); }
    MIRType type() const { return mir_->type(); }
};
...
class LSimdShift : public LInstructionHelper<1, 2, 1> {
   public:
    ...
    const LAllocation* value() { return getOperand(1); }
    const LDefinition* temp() { return getTemp(0); }
    MSimdShift::Operation operation() const { return mir_->toSimdShift()->operation(); }
    const char* extraName() const { return MSimdShift::OperationName(operation()); }
...
class LSimdAnyTrue : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LSimdAnyTrue(const LAllocation& input) { setOperand(0, input); }
    const LAllocation* vector() { return getOperand(0); }
...
class LSimdAllTrue : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LSimdAllTrue(const LAllocation& input) { setOperand(0, input); }
    const LAllocation* vector() { return getOperand(0); }
...
class LInteger : public LInstructionHelper<1, 0, 0> {
   ...
   public:
    ...
    explicit LInteger(int32_t i32) : i32_(i32) {}
...
class LInteger64 : public LInstructionHelper<INT64_PIECES, 0, 0> {
   ...
   public:
    ...
    explicit LInteger64(int64_t i64) : i64_(i64) {}
...
class LPointer : public LInstructionHelper<1, 0, 0> {
   ...
   public:
    ...
    explicit LPointer(gc::Cell* ptr) : ptr_(ptr), kind_(GC_THING) {}

    LPointer(void* ptr, Kind kind) : ptr_(ptr), kind_(kind) {}

    void* ptr() const { return ptr_; }
    Kind kind() const { return kind_; }
    const char* extraName() const { return kind_ == GC_THING ? "GC_THING" : "NON_GC_THING"; }
...
class LFloat32 : public LInstructionHelper<1, 0, 0> {
   ...
   public:
    ...
    explicit LFloat32(float f) : f_(f) {}
...
class LValue : public LInstructionHelper<BOX_PIECES, 0, 0> {
   ...
   public:
    ...
    explicit LValue(const Value& v) : v_(v) {}
...
class LCloneLiteral : public LCallInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LCloneLiteral(const LAllocation& obj) { setOperand(0, obj); }
...
class LControlInstructionHelper : public LInstructionHelper<0, Operands, Temps> {
   ...
   public:
    ...
    virtual MBasicBlock* getSuccessor(size_t i) const final override { return successors_[i]; }
...
class LGoto : public LControlInstructionHelper<1, 0, 0> {
   public:
    ...
    explicit LGoto(MBasicBlock* block) { setSuccessor(0, block); }
...
class LNewArray : public LInstructionHelper<1, 0, 1> {
   public:
    ...
    explicit LNewArray(const LDefinition& temp) { setTemp(0, temp); }

    const char* extraName() const { return mir()->isVMCall() ? "VMCall" : nullptr; }
...
class LNewArrayCopyOnWrite : public LInstructionHelper<1, 0, 1> {
   public:
    ...
    explicit LNewArrayCopyOnWrite(const LDefinition& temp) { setTemp(0, temp); }
...
class LNewIterator : public LInstructionHelper<1, 0, 1> {
   public:
    ...
    explicit LNewIterator(const LDefinition& temp) { setTemp(0, temp); }
...
class LNewObject : public LInstructionHelper<1, 0, 1> {
   public:
    ...
    explicit LNewObject(const LDefinition& temp) { setTemp(0, temp); }
...
class LNewTypedObject : public LInstructionHelper<1, 0, 1> {
   public:
    ...
    explicit LNewTypedObject(const LDefinition& temp) { setTemp(0, temp); }
...
class LNewNamedLambdaObject : public LInstructionHelper<1, 0, 1> {
   public:
    ...
    explicit LNewNamedLambdaObject(const LDefinition& temp) { setTemp(0, temp); }
...
class LNewCallObject : public LInstructionHelper<1, 0, 1> {
   public:
    ...
    explicit LNewCallObject(const LDefinition& temp) { setTemp(0, temp); }
...
class LNewSingletonCallObject : public LInstructionHelper<1, 0, 1> {
   public:
    ...
    explicit LNewSingletonCallObject(const LDefinition& temp) { setTemp(0, temp); }

    const LDefinition* temp() { return getTemp(0); }

    MNewSingletonCallObject* mir() const { return mir_->toNewSingletonCallObject(); }
};
...
class LCheckOverRecursed : public LInstructionHelper<0, 0, 1> {
   public:
    ...
    explicit LCheckOverRecursed(const LDefinition& temp) { setTemp(0, temp); }
...
class LWasmReinterpret : public LWasmReinterpretBase<1, 1> {
   public:
    ...
    explicit LWasmReinterpret(const LAllocation& input) { setOperand(0, input); }
};

class LWasmReinterpretFromI64 : public LWasmReinterpretBase<1, INT64_PIECES> {
   public:
    LIR_HEADER(WasmReinterpretFromI64);
    explicit LWasmReinterpretFromI64(const LInt64Allocation& input) { setInt64Operand(0, input); }
};

class LWasmReinterpretToI64 : public LWasmReinterpretBase<INT64_PIECES, 1> {
   public:
    LIR_HEADER(WasmReinterpretToI64);
    explicit LWasmReinterpretToI64(const LAllocation& input) { setOperand(0, input); }
};
...
class LRotateI64 : public details::RotateBase<INT64_PIECES, INT64_PIECES + 1, 1> {
   public:
    ...
    LRotateI64() { setTemp(0, LDefinition::BogusTemp()); }
...
class LInterruptCheck : public LInstructionHelper<0, 0, 1> {
   ...
   public:
    ...
    explicit LInterruptCheck(const LDefinition& temp) : oolEntry_(nullptr), implicit_(false) {
        setTemp(0, temp);
    }
...
class LDefVar : public LCallInstructionHelper<0, 1, 0> {
   public:
    ...
    explicit LDefVar(const LAllocation& envChain) { setOperand(0, envChain); }
...
class LToAsync : public LCallInstructionHelper<1, 1, 0> {
   public:
    LIR_HEADER(ToAsync)
    explicit LToAsync(const LAllocation& input) { setOperand(0, input); }
...
class LToAsyncGen : public LCallInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LToAsyncGen(const LAllocation& input) { setOperand(0, input); }
...
class LToAsyncIter : public LCallInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LToAsyncIter(const LAllocation& input) { setOperand(0, input); }
...
class LCreateThisWithTemplate : public LInstructionHelper<1, 0, 1> {
   public:
    ...
    explicit LCreateThisWithTemplate(const LDefinition& temp) { setTemp(0, temp); }

    MCreateThisWithTemplate* mir() const { return mir_->toCreateThisWithTemplate(); }
...
class LComputeThis : public LInstructionHelper<BOX_PIECES, BOX_PIECES, 0> {
   public:
    ...
    explicit LComputeThis(const LBoxAllocation& value) { setBoxOperand(ValueIndex, value); }
...
class LStackArgV : public LInstructionHelper<0, BOX_PIECES, 0> {
   ...
   public:
    ...
    LStackArgV(uint32_t argslot, const LBoxAllocation& value) : argslot_(argslot) {
...
class LGetDOMProperty : public LDOMPropertyInstructionHelper<BOX_PIECES, 0> {
   public:
    ...
    LGetDOMProperty(const LDefinition& JSContextReg, const LAllocation& ObjectReg,
                    const LDefinition& PrivReg, const LDefinition& ValueReg)
        : LDOMPropertyInstructionHelper<BOX_PIECES, 0>(JSContextReg, ObjectReg, PrivReg,
                                                       ValueReg) {}
...
class LGetDOMMemberV : public LInstructionHelper<BOX_PIECES, 1, 0> {
   public:
    ...
    explicit LGetDOMMemberV(const LAllocation& object) { setOperand(0, object); }
...
class LGetDOMMemberT : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LGetDOMMemberT(const LAllocation& object) { setOperand(0, object); }
...
class LSetDOMProperty : public LDOMPropertyInstructionHelper<0, BOX_PIECES> {
   public:
    ...
    LSetDOMProperty(const LDefinition& JSContextReg, const LAllocation& ObjectReg,
        ...
        : LDOMPropertyInstructionHelper<0, BOX_PIECES>(JSContextReg, ObjectReg, PrivReg,
                                                       ValueReg) {
...
class LGetDynamicName : public LCallInstructionHelper<BOX_PIECES, 2, 3> {
   public:
    ...
    LGetDynamicName(const LAllocation& envChain, const LAllocation& name, const LDefinition& temp1,
...
class LFunctionDispatch : public LInstructionHelper<0, 1, 0> {
   ...
   public:
    ...
    explicit LFunctionDispatch(const LAllocation& in) { setOperand(0, in); }
...
class LObjectGroupDispatch : public LInstructionHelper<0, 1, 1> {
   ...
   public:
    ...
    const char* extraName() const { return mir()->hasFallback() ? "HasFallback" : "NoFallback"; }
...
class LCompare : public LInstructionHelper<1, 2, 0> {
   ...
   public:
    LIR_HEADER(Compare)
    LCompare(JSOp jsop, const LAllocation& left, const LAllocation& right) : jsop_(jsop) {
        setOperand(0, left);
        setOperand(1, right);
    }
...
class LCompareI64AndBranch : public LControlInstructionHelper<2, 2 * INT64_PIECES, 0> {
   ...
   public:
    ...
    LCompareI64AndBranch(MCompare* cmpMir, JSOp jsop, const LInt64Allocation& left,
                         const LInt64Allocation& right, MBasicBlock* ifTrue, MBasicBlock* ifFalse)
...
class LCompareAndBranch : public LControlInstructionHelper<2, 2, 0> {
   ...
   public:
    ...
    LCompareAndBranch(MCompare* cmpMir, JSOp jsop, const LAllocation& left,
                      const LAllocation& right, MBasicBlock* ifTrue, MBasicBlock* ifFalse)
        : cmpMir_(cmpMir), jsop_(jsop) {
        setOperand(0, left);
        setOperand(1, right);
        setSuccessor(0, ifTrue);
...
class LIsNullOrLikeUndefinedT : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LIsNullOrLikeUndefinedT(const LAllocation& input) { setOperand(0, input); }
...
class LNotI : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LNotI(const LAllocation& input) { setOperand(0, input); }
};
...
class LNotI64 : public LInstructionHelper<1, INT64_PIECES, 0> {
   public:
    ...
    explicit LNotI64(const LInt64Allocation& input) { setInt64Operand(0, input); }
};
...
class LNotD : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LNotD(const LAllocation& input) { setOperand(0, input); }
...
class LNotF : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LNotF(const LAllocation& input) { setOperand(0, input); }
...
class LNotO : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LNotO(const LAllocation& input) { setOperand(0, input); }
...
class LBitNotV : public LCallInstructionHelper<1, BOX_PIECES, 0> {
   public:
    ...
    explicit LBitNotV(const LBoxAllocation& input) { setBoxOperand(Input, input); }
};
...
class LBitOpI : public LInstructionHelper<1, 2, 0> {
   ...
   public:
    ...
    explicit LBitOpI(JSOp op) : op_(op) {}
...
class LBitOpI64 : public LInstructionHelper<INT64_PIECES, 2 * INT64_PIECES, 0> {
   ...
   public:
    ...
    explicit LBitOpI64(JSOp op) : op_(op) {}
...
class LBitOpV : public LCallInstructionHelper<1, 2 * BOX_PIECES, 0> {
   ...
   public:
    ...
    LBitOpV(JSOp jsop, const LBoxAllocation& lhs, const LBoxAllocation& rhs) : jsop_(jsop) {
        setBoxOperand(LhsInput, lhs);
        setBoxOperand(RhsInput, rhs);
    }
...
class LShiftI : public LBinaryMath<0> {
   ...
   public:
    ...
    explicit LShiftI(JSOp op) : op_(op) {}
...
class LShiftI64 : public LInstructionHelper<INT64_PIECES, INT64_PIECES + 1, 0> {
   ...
   public:
    ...
    explicit LShiftI64(JSOp op) : op_(op) {}
...
class LSignExtendInt32 : public LInstructionHelper<1, 1, 0> {
   ...
   public:
    ...
    explicit LSignExtendInt32(const LAllocation& num, MSignExtendInt32::Mode mode) : mode_(mode) {
        setOperand(0, num);
    }
...
class LSignExtendInt64 : public LInstructionHelper<INT64_PIECES, INT64_PIECES, 0> {
   public:
    ...
    explicit LSignExtendInt64(const LInt64Allocation& input) { setInt64Operand(0, input); }
...
class LThrow : public LCallInstructionHelper<0, BOX_PIECES, 0> {
   public:
    ...
    explicit LThrow(const LBoxAllocation& value) { setBoxOperand(Value, value); }
};
...
class LNegI : public LInstructionHelper<1, 1, 0> {
   public:
    LIR_HEADER(NegI);
    explicit LNegI(const LAllocation& num) { setOperand(0, num); }
};
...
class LNegD : public LInstructionHelper<1, 1, 0> {
   public:
    LIR_HEADER(NegD)
    explicit LNegD(const LAllocation& num) { setOperand(0, num); }
};
...
class LNegF : public LInstructionHelper<1, 1, 0> {
   public:
    LIR_HEADER(NegF)
    explicit LNegF(const LAllocation& num) { setOperand(0, num); }
};
...
class LAbsI : public LInstructionHelper<1, 1, 0> {
   public:
    LIR_HEADER(AbsI)
    explicit LAbsI(const LAllocation& num) { setOperand(0, num); }
};
...
class LAbsD : public LInstructionHelper<1, 1, 0> {
   public:
    LIR_HEADER(AbsD)
    explicit LAbsD(const LAllocation& num) { setOperand(0, num); }
};
...
class LAbsF : public LInstructionHelper<1, 1, 0> {
   public:
    LIR_HEADER(AbsF)
    explicit LAbsF(const LAllocation& num) { setOperand(0, num); }
};
...
class LClzI : public LInstructionHelper<1, 1, 0> {
   public:
    LIR_HEADER(ClzI)
    explicit LClzI(const LAllocation& num) { setOperand(0, num); }
...
class LClzI64 : public LInstructionHelper<INT64_PIECES, INT64_PIECES, 0> {
   public:
    LIR_HEADER(ClzI64)
    explicit LClzI64(const LInt64Allocation& num) { setInt64Operand(0, num); }
...
class LCtzI : public LInstructionHelper<1, 1, 0> {
   public:
    LIR_HEADER(CtzI)
    explicit LCtzI(const LAllocation& num) { setOperand(0, num); }
...
class LCtzI64 : public LInstructionHelper<INT64_PIECES, INT64_PIECES, 0> {
   public:
    LIR_HEADER(CtzI64)
    explicit LCtzI64(const LInt64Allocation& num) { setInt64Operand(0, num); }
...
class LSqrtD : public LInstructionHelper<1, 1, 0> {
   public:
    LIR_HEADER(SqrtD)
    explicit LSqrtD(const LAllocation& num) { setOperand(0, num); }
};
...
class LSqrtF : public LInstructionHelper<1, 1, 0> {
   public:
    LIR_HEADER(SqrtF)
    explicit LSqrtF(const LAllocation& num) { setOperand(0, num); }
};
...
class LHypot : public LCallInstructionHelper<1, 4, 1> {
   ...
   public:
    LIR_HEADER(Hypot)
    LHypot(const LAllocation& x, const LAllocation& y, const LDefinition& temp) : numOperands_(2) {
        setOperand(0, x);
        setOperand(1, y);
        setTemp(0, temp);
    }
    ...
    LHypot(const LAllocation& x, const LAllocation& y, const LAllocation& z, const LAllocation& w,
           const LDefinition& temp)
        : numOperands_(4) {
        setOperand(0, x);
        setOperand(1, y);
...
class LMathFunctionD : public LCallInstructionHelper<1, 1, 1> {
   public:
    ...
    const char* extraName() const { return MMathFunction::FunctionName(mir()->function()); }
};
...
class LAddI : public LBinaryMath<0> {
   ...
   public:
    ...
    LAddI() : recoversInput_(false) {}

    const char* extraName() const { return snapshot() ? "OverflowCheck" : nullptr; }

    virtual bool recoversInput() const { return recoversInput_; }
...
class LMulI64 : public LInstructionHelper<INT64_PIECES, 2 * INT64_PIECES, 1> {
   public:
    ...
    explicit LMulI64() { setTemp(0, LDefinition()); }
...
class LMathD : public LBinaryMath<0> {
   ...
   public:
    ...
    explicit LMathD(JSOp jsop) : jsop_(jsop) {}
...
class LMathF : public LBinaryMath<0> {
   ...
   public:
    ...
    explicit LMathF(JSOp jsop) : jsop_(jsop) {}
...
class LBinaryV : public LCallInstructionHelper<BOX_PIECES, 2 * BOX_PIECES, 0> {
   ...
   public:
    ...
    LBinaryV(JSOp jsop, const LBoxAllocation& lhs, const LBoxAllocation& rhs) : jsop_(jsop) {
        setBoxOperand(LhsInput, lhs);
        setBoxOperand(RhsInput, rhs);
    }
...
class LFromCharCode : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LFromCharCode(const LAllocation& code) { setOperand(0, code); }
...
class LStringConvertCase : public LCallInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LStringConvertCase(const LAllocation& string) { setOperand(0, string); }
...
class LInt32ToDouble : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LInt32ToDouble(const LAllocation& input) { setOperand(0, input); }
};
...
class LFloat32ToDouble : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LFloat32ToDouble(const LAllocation& input) { setOperand(0, input); }
};
...
class LDoubleToFloat32 : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LDoubleToFloat32(const LAllocation& input) { setOperand(0, input); }
};
...
class LInt32ToFloat32 : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LInt32ToFloat32(const LAllocation& input) { setOperand(0, input); }
};
...
class LValueToDouble : public LInstructionHelper<1, BOX_PIECES, 0> {
   public:
    ...
    explicit LValueToDouble(const LBoxAllocation& input) { setBoxOperand(Input, input); }
...
class LValueToFloat32 : public LInstructionHelper<1, BOX_PIECES, 0> {
   public:
    ...
    explicit LValueToFloat32(const LBoxAllocation& input) { setBoxOperand(Input, input); }
...
class LValueToInt32 : public LInstructionHelper<1, BOX_PIECES, 2> {
   ...
   public:
    ...
    const char* extraName() const { return mode() == NORMAL ? "Normal" : "Truncate"; }
...
class LDoubleToInt32 : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LDoubleToInt32(const LAllocation& in) { setOperand(0, in); }

    MToInt32* mir() const { return mir_->toToInt32(); }
};
...
class LFloat32ToInt32 : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LFloat32ToInt32(const LAllocation& in) { setOperand(0, in); }
...
class LWasmTruncateToInt32 : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LWasmTruncateToInt32(const LAllocation& in) { setOperand(0, in); }
...
class LWrapInt64ToInt32 : public LInstructionHelper<1, INT64_PIECES, 0> {
   public:
    ...
    explicit LWrapInt64ToInt32(const LInt64Allocation& input) { setInt64Operand(Input, input); }
...
class LExtendInt32ToInt64 : public LInstructionHelper<INT64_PIECES, 1, 0> {
   public:
    ...
    explicit LExtendInt32ToInt64(const LAllocation& input) { setOperand(0, input); }
...
class LBooleanToString : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LBooleanToString(const LAllocation& input) { setOperand(0, input); }
...
class LIntToString : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LIntToString(const LAllocation& input) { setOperand(0, input); }
...
class LValueToObject : public LInstructionHelper<1, BOX_PIECES, 0> {
   public:
    ...
    explicit LValueToObject(const LBoxAllocation& input) { setBoxOperand(Input, input); }
...
class LValueToObjectOrNull : public LInstructionHelper<1, BOX_PIECES, 0> {
   public:
    ...
    explicit LValueToObjectOrNull(const LBoxAllocation& input) { setBoxOperand(Input, input); }
...
class LInt32x4ToFloat32x4 : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LInt32x4ToFloat32x4(const LAllocation& input) { setOperand(0, input); }
};
...
class LPowHalfD : public LInstructionHelper<1, 1, 0> {
   public:
    LIR_HEADER(PowHalfD);
    explicit LPowHalfD(const LAllocation& input) { setOperand(0, input); }
...
class LOsrEntry : public LInstructionHelper<1, 0, 1> {
   ...
   public:
    ...
    explicit LOsrEntry(const LDefinition& temp) : frameDepth_(0) { setTemp(0, temp); }
...
class LOsrValue : public LInstructionHelper<BOX_PIECES, 1, 0> {
   public:
    ...
    explicit LOsrValue(const LAllocation& entry) { setOperand(0, entry); }
...
class LOsrEnvironmentChain : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LOsrEnvironmentChain(const LAllocation& entry) { setOperand(0, entry); }
...
class LOsrReturnValue : public LInstructionHelper<BOX_PIECES, 1, 0> {
   public:
    ...
    explicit LOsrReturnValue(const LAllocation& entry) { setOperand(0, entry); }
...
class LOsrArgumentsObject : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LOsrArgumentsObject(const LAllocation& entry) { setOperand(0, entry); }
...
class LRegExp : public LInstructionHelper<1, 0, 1> {
   public:
    ...
    explicit LRegExp(const LDefinition& temp) { setTemp(0, temp); }
    const LDefinition* temp() { return getTemp(0); }
...
class LUnarySharedStub : public LCallInstructionHelper<BOX_PIECES, BOX_PIECES, 0> {
   public:
    ...
    explicit LUnarySharedStub(const LBoxAllocation& input) { setBoxOperand(Input, input); }
...
class LLambdaForSingleton : public LCallInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LLambdaForSingleton(const LAllocation& envChain) { setOperand(0, envChain); }
    const LAllocation* environmentChain() { return getOperand(0); }
...
class LKeepAliveObject : public LInstructionHelper<0, 1, 0> {
   public:
    ...
    explicit LKeepAliveObject(const LAllocation& object) { setOperand(0, object); }
...
class LSlots : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LSlots(const LAllocation& object) { setOperand(0, object); }
...
class LElements : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LElements(const LAllocation& object) { setOperand(0, object); }
...
class LConvertElementsToDoubles : public LInstructionHelper<0, 1, 0> {
   public:
    ...
    explicit LConvertElementsToDoubles(const LAllocation& elements) { setOperand(0, elements); }
...
class LMaybeCopyElementsForWrite : public LInstructionHelper<0, 1, 1> {
   public:
    ...
    const MMaybeCopyElementsForWrite* mir() const { return mir_->toMaybeCopyElementsForWrite(); }
};
...
class LInitializedLength : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LInitializedLength(const LAllocation& elements) { setOperand(0, elements); }
...
class LArrayLength : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LArrayLength(const LAllocation& elements) { setOperand(0, elements); }
...
class LGetNextEntryForIterator : public LInstructionHelper<1, 2, 3> {
   public:
    ...
    const MGetNextEntryForIterator* mir() const { return mir_->toGetNextEntryForIterator(); }
...
class LTypedArrayLength : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LTypedArrayLength(const LAllocation& obj) { setOperand(0, obj); }
...
class LTypedArrayElements : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LTypedArrayElements(const LAllocation& object) { setOperand(0, object); }
    const LAllocation* object() { return getOperand(0); }
};
...
class LTypedObjectDescr : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LTypedObjectDescr(const LAllocation& object) { setOperand(0, object); }
    const LAllocation* object() { return getOperand(0); }
};
...
class LTypedObjectElements : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LTypedObjectElements(const LAllocation& object) { setOperand(0, object); }
    const LAllocation* object() { return getOperand(0); }
    const MTypedObjectElements* mir() const { return mir_->toTypedObjectElements(); }
};
...
class LBoundsCheckLower : public LInstructionHelper<0, 1, 0> {
   public:
    ...
    explicit LBoundsCheckLower(const LAllocation& index) { setOperand(0, index); }
...
class LLoadElementV : public LInstructionHelper<BOX_PIECES, 2, 0> {
   public:
    ...
    const char* extraName() const { return mir()->needsHoleCheck() ? "HoleCheck" : nullptr; }
...
class LLoadUnboxedPointerV : public LInstructionHelper<BOX_PIECES, 2, 0> {
   public:
    ...
    const MLoadUnboxedObjectOrNull* mir() const { return mir_->toLoadUnboxedObjectOrNull(); }
    const LAllocation* elements() { return getOperand(0); }
    const LAllocation* index() { return getOperand(1); }
};
...
class LUnboxObjectOrNull : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LUnboxObjectOrNull(const LAllocation& input) { setOperand(0, input); }
...
class LLoadElementFromStateV : public LVariadicInstruction<BOX_PIECES, 3> {
   public:
    ...
    const MLoadElementFromState* mir() const { return mir_->toLoadElementFromState(); }
    const LAllocation* index() { return getOperand(0); }
    const LDefinition* temp0() { return getTemp(0); }
    const LDefinition* temp1() { return getTemp(1); }
...
class LFallibleStoreElementV : public LInstructionHelper<0, 3 + BOX_PIECES, 0> {
   public:
    ...
    const MFallibleStoreElement* mir() const { return mir_->toFallibleStoreElement(); }
    const LAllocation* object() { return getOperand(0); }
    const LAllocation* elements() { return getOperand(1); }
    const LAllocation* index() { return getOperand(2); }
};
...
class LConvertUnboxedObjectToNative : public LInstructionHelper<0, 1, 0> {
   public:
    ...
    explicit LConvertUnboxedObjectToNative(const LAllocation& object) { setOperand(0, object); }

    MConvertUnboxedObjectToNative* mir() { return mir_->toConvertUnboxedObjectToNative(); }
};
...
class LArrayJoin : public LCallInstructionHelper<1, 2, 1> {
   public:
    ...
    LArrayJoin(const LAllocation& array, const LAllocation& sep, const LDefinition& temp) {
        setOperand(0, array);
        setOperand(1, sep);
        setTemp(0, temp);
    }
...
class LLoadTypedArrayElementHole : public LInstructionHelper<BOX_PIECES, 2, 0> {
   public:
    ...
    const MLoadTypedArrayElementHole* mir() const { return mir_->toLoadTypedArrayElementHole(); }
    const LAllocation* object() { return getOperand(0); }
    const LAllocation* index() { return getOperand(1); }
};
...
class LLoadTypedArrayElementStatic : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LLoadTypedArrayElementStatic(const LAllocation& ptr) { setOperand(0, ptr); }
    MLoadTypedArrayElementStatic* mir() const { return mir_->toLoadTypedArrayElementStatic(); }
...
class LStoreUnboxedScalar : public LInstructionHelper<0, 3, 0> {
   public:
    ...
    const MStoreUnboxedScalar* mir() const { return mir_->toStoreUnboxedScalar(); }
    const LAllocation* elements() { return getOperand(0); }
    const LAllocation* index() { return getOperand(1); }
    const LAllocation* value() { return getOperand(2); }
};
...
class LStoreTypedArrayElementHole : public LInstructionHelper<0, 4, 0> {
   public:
    ...
    const MStoreTypedArrayElementHole* mir() const { return mir_->toStoreTypedArrayElementHole(); }
    const LAllocation* elements() { return getOperand(0); }
    const LAllocation* length() { return getOperand(1); }
    const LAllocation* index() { return getOperand(2); }
    const LAllocation* value() { return getOperand(3); }
...
class LStoreTypedArrayElementStatic : public LInstructionHelper<0, 2, 0> {
   public:
    ...
    MStoreTypedArrayElementStatic* mir() const { return mir_->toStoreTypedArrayElementStatic(); }
    const LAllocation* ptr() { return getOperand(0); }
    const LAllocation* value() { return getOperand(1); }
};
...
class LAtomicIsLockFree : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LAtomicIsLockFree(const LAllocation& value) { setOperand(0, value); }
    const LAllocation* value() { return getOperand(0); }
};
...
class LAtomicTypedArrayElementBinopForEffect : public LInstructionHelper<0, 3, 4> {
   public:
    ...
    LAtomicTypedArrayElementBinopForEffect(
        const LAllocation& elements, const LAllocation& index, const LAllocation& value,
...
class LClampIToUint8 : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LClampIToUint8(const LAllocation& in) { setOperand(0, in); }
};
...
class LLoadFixedSlotV : public LInstructionHelper<BOX_PIECES, 1, 0> {
   public:
    ...
    explicit LLoadFixedSlotV(const LAllocation& object) { setOperand(0, object); }
...
class LLoadFixedSlotT : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LLoadFixedSlotT(const LAllocation& object) { setOperand(0, object); }
    const MLoadFixedSlot* mir() const { return mir_->toLoadFixedSlot(); }
};
...
class LLoadFixedSlotAndUnbox : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LLoadFixedSlotAndUnbox(const LAllocation& object) { setOperand(0, object); }

    const MLoadFixedSlotAndUnbox* mir() const { return mir_->toLoadFixedSlotAndUnbox(); }
};
...
class LCallGetIntrinsicValue : public LCallInstructionHelper<BOX_PIECES, 0, 0> {
   public:
    ...
    const MCallGetIntrinsicValue* mir() const { return mir_->toCallGetIntrinsicValue(); }
};
...
class LGetPropertyPolymorphicV : public LInstructionHelper<BOX_PIECES, 1, 0> {
   public:
    ...
    explicit LGetPropertyPolymorphicV(const LAllocation& obj) { setOperand(0, obj); }
    const LAllocation* obj() { return getOperand(0); }
    const MGetPropertyPolymorphic* mir() const { return mir_->toGetPropertyPolymorphic(); }
    virtual const char* extraName() const { return PropertyNameToExtraName(mir()->name()); }
};
...
class LSetPropertyPolymorphicV : public LInstructionHelper<0, 1 + BOX_PIECES, 1> {
   public:
    ...
    const LAllocation* obj() { return getOperand(0); }
    const LDefinition* temp() { return getTemp(0); }
    const MSetPropertyPolymorphic* mir() const { return mir_->toSetPropertyPolymorphic(); }
};
...
class LCallBindVar : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LCallBindVar(const LAllocation& envChain) { setOperand(0, envChain); }
    const LAllocation* environmentChain() { return getOperand(0); }
...
class LLoadSlotV : public LInstructionHelper<BOX_PIECES, 1, 0> {
   public:
    ...
    explicit LLoadSlotV(const LAllocation& in) { setOperand(0, in); }
...
class LLoadSlotT : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LLoadSlotT(const LAllocation& slots) { setOperand(0, slots); }
...
class LStringLength : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LStringLength(const LAllocation& string) { setOperand(0, string); }
...
class LFloor : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LFloor(const LAllocation& num) { setOperand(0, num); }
};
...
class LFloorF : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LFloorF(const LAllocation& num) { setOperand(0, num); }
};
...
class LCeil : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LCeil(const LAllocation& num) { setOperand(0, num); }
};
...
class LCeilF : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LCeilF(const LAllocation& num) { setOperand(0, num); }
};
...
class LNearbyInt : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LNearbyInt(const LAllocation& num) { setOperand(0, num); }
...
class LNearbyIntF : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LNearbyIntF(const LAllocation& num) { setOperand(0, num); }
    MNearbyInt* mir() const { return mir_->toNearbyInt(); }
};
...
class LFunctionEnvironment : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LFunctionEnvironment(const LAllocation& function) { setOperand(0, function); }
...
class LHomeObject : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LHomeObject(const LAllocation& function) { setOperand(0, function); }
    const LAllocation* function() { return getOperand(0); }
};
...
class LHomeObjectSuperBase : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LHomeObjectSuperBase(const LAllocation& homeObject) { setOperand(0, homeObject); }
...
class LCopyLexicalEnvironmentObject : public LCallInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LCopyLexicalEnvironmentObject(const LAllocation& env) { setOperand(0, env); }
    const LAllocation* env() { return getOperand(0); }

    MCopyLexicalEnvironmentObject* mir() const { return mir_->toCopyLexicalEnvironmentObject(); }
};
...
class LCallGetProperty : public LCallInstructionHelper<BOX_PIECES, BOX_PIECES, 0> {
   public:
    ...
    explicit LCallGetProperty(const LBoxAllocation& val) { setBoxOperand(Value, val); }
...
class LCallInitElementArray : public LCallInstructionHelper<0, 2 + BOX_PIECES, 0> {
   public:
    ...
    const LAllocation* object() { return getOperand(0); }
    const LAllocation* index() { return getOperand(1); }
    const MCallInitElementArray* mir() const { return mir_->toCallInitElementArray(); }
};
...
class LCallDeleteProperty : public LCallInstructionHelper<1, BOX_PIECES, 0> {
   public:
    ...
    explicit LCallDeleteProperty(const LBoxAllocation& value) { setBoxOperand(Value, value); }
...
class LIteratorEnd : public LInstructionHelper<0, 1, 3> {
   public:
    ...
    LIteratorEnd(const LAllocation& iterator, const LDefinition& temp1, const LDefinition& temp2,
...
class LGetFrameArgument : public LInstructionHelper<BOX_PIECES, 1, 0> {
   public:
    ...
    explicit LGetFrameArgument(const LAllocation& index) { setOperand(0, index); }
    const LAllocation* index() { return getOperand(0); }
};
...
class LSetFrameArgumentT : public LInstructionHelper<0, 1, 0> {
   public:
    ...
    explicit LSetFrameArgumentT(const LAllocation& input) { setOperand(0, input); }
...
class LSetFrameArgumentC : public LInstructionHelper<0, 0, 0> {
   ...
   public:
    ...
    explicit LSetFrameArgumentC(const Value& val) { val_ = val; }
    MSetFrameArgument* mir() const { return mir_->toSetFrameArgument(); }
...
class LSetFrameArgumentV : public LInstructionHelper<0, BOX_PIECES, 0> {
   public:
    ...
    explicit LSetFrameArgumentV(const LBoxAllocation& input) { setBoxOperand(Input, input); }
...
class LGuardReceiverPolymorphic : public LInstructionHelper<0, 1, 1> {
   public:
    ...
    const LAllocation* object() { return getOperand(0); }
    const LDefinition* temp() { return getTemp(0); }
    const MGuardReceiverPolymorphic* mir() const { return mir_->toGuardReceiverPolymorphic(); }
};
...
class LGuardUnboxedExpando : public LInstructionHelper<0, 1, 0> {
   public:
    ...
    explicit LGuardUnboxedExpando(const LAllocation& in) { setOperand(0, in); }
    const LAllocation* object() { return getOperand(0); }
    const MGuardUnboxedExpando* mir() const { return mir_->toGuardUnboxedExpando(); }
};
...
class LLoadUnboxedExpando : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LLoadUnboxedExpando(const LAllocation& in) { setOperand(0, in); }
    const LAllocation* object() { return getOperand(0); }
    const MLoadUnboxedExpando* mir() const { return mir_->toLoadUnboxedExpando(); }
};
...
class LMonitorTypes : public LInstructionHelper<0, BOX_PIECES, 1> {
   public:
    ...
    const MMonitorTypes* mir() const { return mir_->toMonitorTypes(); }
    const LDefinition* temp() { return getTemp(0); }
};
...
class LPostWriteBarrierO : public LInstructionHelper<0, 2, 1> {
   public:
    ...
    LPostWriteBarrierO(const LAllocation& obj, const LAllocation& value, const LDefinition& temp) {
        setOperand(0, obj);
        setOperand(1, value);
        setTemp(0, temp);
    }
...
class LPostWriteElementBarrierO : public LInstructionHelper<0, 3, 1> {
   public:
    ...
    const MPostWriteElementBarrier* mir() const { return mir_->toPostWriteElementBarrier(); }
...
class LGuardObjectIdentity : public LInstructionHelper<0, 2, 0> {
   public:
    ...
    const MGuardObjectIdentity* mir() const { return mir_->toGuardObjectIdentity(); }
};
...
class LGuardClass : public LInstructionHelper<0, 1, 1> {
   public:
    ...
    const MGuardClass* mir() const { return mir_->toGuardClass(); }
    const LDefinition* tempInt() { return getTemp(0); }
};
...
class LGuardSharedTypedArray : public LInstructionHelper<0, 1, 1> {
   public:
    ...
    const MGuardSharedTypedArray* mir() const { return mir_->toGuardSharedTypedArray(); }
    const LDefinition* tempInt() { return getTemp(0); }
};
...
class LInstanceOfO : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LInstanceOfO(const LAllocation& lhs) { setOperand(0, lhs); }
...
class LInstanceOfV : public LInstructionHelper<1, BOX_PIECES, 0> {
   public:
    ...
    explicit LInstanceOfV(const LBoxAllocation& lhs) { setBoxOperand(LHS, lhs); }
...
class LIsCallableO : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LIsCallableO(const LAllocation& object) { setOperand(0, object); }
...
class LIsConstructor : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LIsConstructor(const LAllocation& object) { setOperand(0, object); }
...
class LIsArrayO : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LIsArrayO(const LAllocation& object) { setOperand(0, object); }
    const LAllocation* object() { return getOperand(0); }
...
class LIsTypedArray : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LIsTypedArray(const LAllocation& object) { setOperand(0, object); }
    const LAllocation* object() { return getOperand(0); }
};
...
class LIsObject : public LInstructionHelper<1, BOX_PIECES, 0> {
   public:
    ...
    explicit LIsObject(const LBoxAllocation& input) { setBoxOperand(Input, input); }
...
class LHasClass : public LInstructionHelper<1, 1, 0> {
   public:
    LIR_HEADER(HasClass);
    explicit LHasClass(const LAllocation& lhs) { setOperand(0, lhs); }
...
class LObjectClassToString : public LCallInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LObjectClassToString(const LAllocation& lhs) { setOperand(0, lhs); }
    const LAllocation* object() { return getOperand(0); }
...
class LWasmAddOffset : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LWasmAddOffset(const LAllocation& base) { setOperand(0, base); }
...
class LWasmLoadTls : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LWasmLoadTls(const LAllocation& tlsPtr) { setOperand(0, tlsPtr); }
...
class LAsmJSCompareExchangeHeap : public LInstructionHelper<1, 4, 4> {
   public:
    ...
    MAsmJSCompareExchangeHeap* mir() const { return mir_->toAsmJSCompareExchangeHeap(); }
};
...
class LAsmJSAtomicExchangeHeap : public LInstructionHelper<1, 3, 4> {
   public:
    ...
    MAsmJSAtomicExchangeHeap* mir() const { return mir_->toAsmJSAtomicExchangeHeap(); }
};
...
class LAsmJSAtomicBinopHeap : public LInstructionHelper<1, 3, 6> {
   public:
    ...
    MAsmJSAtomicBinopHeap* mir() const { return mir_->toAsmJSAtomicBinopHeap(); }
};
...
class LWasmLoadGlobalVar : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LWasmLoadGlobalVar(const LAllocation& tlsPtr) { setOperand(0, tlsPtr); }
...
class LWasmLoadGlobalVarI64 : public LInstructionHelper<INT64_PIECES, 1, 0> {
   public:
    ...
    explicit LWasmLoadGlobalVarI64(const LAllocation& tlsPtr) { setOperand(0, tlsPtr); }
    MWasmLoadGlobalVar* mir() const { return mir_->toWasmLoadGlobalVar(); }
    const LAllocation* tlsPtr() { return getOperand(0); }
};
...
class LWasmReturnI64 : public LInstructionHelper<0, INT64_PIECES, 0> {
   public:
    ...
    explicit LWasmReturnI64(const LInt64Allocation& input) { setInt64Operand(0, input); }
};
...
class LWasmStackArg : public LInstructionHelper<0, 1, 0> {
   public:
    ...
    explicit LWasmStackArg(const LAllocation& arg) { setOperand(0, arg); }
...
class LWasmStackArgI64 : public LInstructionHelper<0, INT64_PIECES, 0> {
   public:
    ...
    explicit LWasmStackArgI64(const LInt64Allocation& arg) { setInt64Operand(0, arg); }
    MWasmStackArg* mir() const { return mirRaw()->toWasmStackArg(); }
...
class LWasmCallBase : public LInstruction {
   ...
   public:
    LWasmCallBase(LAllocation* operands, uint32_t numOperands, bool needsBoundsCheck)
        : operands_(operands), numOperands_(numOperands), needsBoundsCheck_(needsBoundsCheck) {}
    ...
    size_t numOperands() const override { return numOperands_; }
    ...
    size_t numTemps() const override { return 0; }
    LDefinition* getTemp(size_t index) override { MOZ_CRASH("no temps"); }
    void setTemp(size_t index, const LDefinition& a) override { MOZ_CRASH("no temps"); }
    size_t numSuccessors() const override { return 0; }
    MBasicBlock* getSuccessor(size_t i) const override { MOZ_CRASH("no successors"); }
    void setSuccessor(size_t i, MBasicBlock*) override { MOZ_CRASH("no successors"); }
...
class LWasmCall : public LWasmCallBase {
   ...
   public:
    ...
    LWasmCall(LAllocation* operands, uint32_t numOperands, bool needsBoundsCheck)
        : LWasmCallBase(operands, numOperands, needsBoundsCheck), def_(LDefinition::BogusTemp()) {}

    // LInstruction interface
    size_t numDefs() const { return def_.isBogusTemp() ? 0 : 1; }
...
class LWasmCallI64 : public LWasmCallBase {
   ...
   public:
    ...
    LWasmCallI64(LAllocation* operands, uint32_t numOperands, bool needsBoundsCheck)
        ...
        for (size_t i = 0; i < numDefs(); i++) defs_[i] = LDefinition::BogusTemp();
    }

    // LInstruction interface
    size_t numDefs() const { return INT64_PIECES; }
    LDefinition* getDef(size_t index) {
...
class LAssertRangeI : public LInstructionHelper<0, 1, 0> {
   public:
    ...
    explicit LAssertRangeI(const LAllocation& input) { setOperand(0, input); }
...
class LAssertResultT : public LInstructionHelper<0, 1, 0> {
   public:
    ...
    explicit LAssertResultT(const LAllocation& input) { setOperand(0, input); }
...
class LAssertResultV : public LInstructionHelper<0, BOX_PIECES, 0> {
   public:
    ...
    explicit LAssertResultV(const LBoxAllocation& input) { setBoxOperand(Input, input); }
};
...
class LRecompileCheck : public LInstructionHelper<0, 0, 1> {
   public:
    ...
    explicit LRecompileCheck(const LDefinition& scratch) { setTemp(0, scratch); }
...
class LLexicalCheck : public LInstructionHelper<0, BOX_PIECES, 0> {
   public:
    ...
    explicit LLexicalCheck(const LBoxAllocation& input) { setBoxOperand(Input, input); }
...
class LThrowRuntimeLexicalError : public LCallInstructionHelper<0, 0, 0> {
   public:
    ...
    MThrowRuntimeLexicalError* mir() { return mir_->toThrowRuntimeLexicalError(); }
};
...
class LGlobalNameConflictsCheck : public LInstructionHelper<0, 0, 0> {
   public:
    ...
    MGlobalNameConflictsCheck* mir() { return mir_->toGlobalNameConflictsCheck(); }
};
...
class LArrowNewTarget : public LInstructionHelper<BOX_PIECES, 1, 0> {
   public:
    explicit LArrowNewTarget(const LAllocation& callee) { setOperand(0, callee); }
...
class LRandom : public LInstructionHelper<1, 0, LRANDOM_NUM_TEMPS> {
   public:
    LIR_HEADER(Random)
    LRandom(const LDefinition& temp0, const LDefinition& temp1, const LDefinition& temp2
#ifndef JS_PUNBOX64
            ,
...
class LCheckIsObj : public LInstructionHelper<BOX_PIECES, BOX_PIECES, 0> {
   public:
    ...
    explicit LCheckIsObj(const LBoxAllocation& value) { setBoxOperand(CheckValue, value); }
...
class LCheckObjCoercible : public LCallInstructionHelper<BOX_PIECES, BOX_PIECES, 0> {
   public:
    ...
    explicit LCheckObjCoercible(const LBoxAllocation& value) { setBoxOperand(CheckValue, value); }
};
...
class LGetPrototypeOf : public LInstructionHelper<BOX_PIECES, 1, 0> {
   public:
    ...
    explicit LGetPrototypeOf(const LAllocation& target) { setOperand(0, target); }
