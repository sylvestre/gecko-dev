...
bool ICBinaryArith_Int32::Compiler::generateStubCode(MacroAssembler& masm) {
    ...
    savedRegs.set() =
        GeneralRegisterSet::Intersect(GeneralRegisterSet::NonVolatile(), savedRegs.set());
    ...
    switch (op_) {
        ...
        case JSOP_MUL: {
            ...
            Assembler::Condition cond = masm.ma_check_mul(
                R0.payloadReg(), R1.payloadReg(), scratchReg, scratch, Assembler::Overflow);
            masm.j(cond, &failure);
