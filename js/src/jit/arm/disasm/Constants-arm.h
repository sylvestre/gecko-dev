...
enum { ExclusiveWord = 0, ExclusiveDouble = 1, ExclusiveByte = 2, ExclusiveHalf = 3 };
...
#define DECLARE_STATIC_ACCESSOR(Name) DECLARE_STATIC_TYPED_ACCESSOR(int, Name)
    ...
    inline Condition ConditionValue() const { return static_cast<Condition>(Bits(31, 28)); }
    ...
    static Instruction* At(uint8_t* pc) { return reinterpret_cast<Instruction*>(pc); }
