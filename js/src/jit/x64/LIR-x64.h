...
class LUnboxBase : public LInstructionHelper<1, 1, 0> {
   public:
    explicit LUnboxBase(const LAllocation& input) { setOperand(0, input); }
...
class LUnbox : public LUnboxBase {
   public:
    ...
    explicit LUnbox(const LAllocation& input) : LUnboxBase(input) {}
...
class LWasmUint32ToDouble : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LWasmUint32ToDouble(const LAllocation& input) { setOperand(0, input); }
};
...
class LWasmUint32ToFloat32 : public LInstructionHelper<1, 1, 0> {
   public:
    ...
    explicit LWasmUint32ToFloat32(const LAllocation& input) { setOperand(0, input); }
};
