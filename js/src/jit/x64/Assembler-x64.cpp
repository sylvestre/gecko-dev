...
void Assembler::addPendingJump(JmpSrc src, ImmPtr target, Relocation::Kind reloc) {
...
/* static */
void Assembler::PatchJumpEntry(uint8_t* entry, uint8_t* target, ReprotectCode reprotect) {
...
void Assembler::finish() {
    ...
    if (jumpRelocations_.length()) *(uint32_t*)jumpRelocations_.buffer() = extendedJumpTable_;
