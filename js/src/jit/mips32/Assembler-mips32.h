...
static constexpr FloatRegister SecondScratchFloat32Reg = {FloatRegisters::f16,
                                                          FloatRegister::Single};
static constexpr FloatRegister SecondScratchDoubleReg = {FloatRegisters::f16,
...
class Assembler : public AssemblerMIPSShared {
   ...
   public:
    ...
    static void WriteLuiOriInstructions(Instruction* inst, Instruction* inst1, Register reg,
                                        uint32_t value);
