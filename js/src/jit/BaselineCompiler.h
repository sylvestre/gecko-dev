...
class BaselineCompiler : public BaselineCompilerSpecific {
    ...
    bool needsEarlyStackCheck() const { return script->nslots() > EARLY_STACK_CHECK_SLOT_COUNT; }
   ...
   private:
    ...
    MOZ_MUST_USE bool emitOpIC(ICStub* stub) { return emitIC(stub, ICEntry::Kind_Op); }
    MOZ_MUST_USE bool emitNonOpIC(ICStub* stub) { return emitIC(stub, ICEntry::Kind_NonOp); }
    ...
    void storeValue(const StackValue* source, const Address& dest, const ValueOperand& scratch);
