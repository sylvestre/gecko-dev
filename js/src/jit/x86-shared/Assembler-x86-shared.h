...
class AssemblerX86Shared : public AssemblerShared {
   ...
   public:
    ...
    static void StaticAsserts() {
        ...
        JS_STATIC_ASSERT(!(
            (Equal | NotEqual | Above | AboveOrEqual | Below | BelowOrEqual | Parity | NoParity) &
            DoubleConditionBits));
    }
   ...
   public:
    ...
    void movl(Imm32 imm32, Register dest) { masm.movl_i32r(imm32.value, dest.encoding()); }
    void movl(Register src, Register dest) { masm.movl_rr(src.encoding(), dest.encoding()); }
    ...
    void xchgl(Register src, Register dest) { masm.xchgl_rr(src.encoding(), dest.encoding()); }
    ...
    void vmovsd(const BaseIndex& src, FloatRegister dest) {
        masm.vmovsd_mr(src.offset, src.base.encoding(), src.index.encoding(), src.scale,
                       dest.encoding());
    }
    ...
    void vmovsd(FloatRegister src, const BaseIndex& dest) {
        masm.vmovsd_rm(src.encoding(), dest.offset, dest.base.encoding(), dest.index.encoding(),
                       dest.scale);
    }
    ...
    void vmovss(const BaseIndex& src, FloatRegister dest) {
        masm.vmovss_mr(src.offset, src.base.encoding(), src.index.encoding(), src.scale,
                       dest.encoding());
    }
    ...
    void vmovss(FloatRegister src, const BaseIndex& dest) {
        masm.vmovss_rm(src.encoding(), dest.offset, dest.base.encoding(), dest.index.encoding(),
                       dest.scale);
    }
    ...
    void movsbl(Register src, Register dest) { masm.movsbl_rr(src.encoding(), dest.encoding()); }
    ...
    void movb(Imm32 src, Register dest) { masm.movb_ir(src.value & 255, dest.encoding()); }
    ...
    void movzwl(Register src, Register dest) { masm.movzwl_rr(src.encoding(), dest.encoding()); }
    ...
    void movswl(Register src, Register dest) { masm.movswl_rr(src.encoding(), dest.encoding()); }
   ...
   public:
    ...
    void cmpl(Register rhs, Register lhs) { masm.cmpl_rr(rhs.encoding(), lhs.encoding()); }
    ...
    void cmpl(Imm32 rhs, Register lhs) { masm.cmpl_ir(rhs.value, lhs.encoding()); }
    ...
    void cmpw(Register rhs, Register lhs) { masm.cmpw_rr(rhs.encoding(), lhs.encoding()); }
    ...
    void testw(Register rhs, Register lhs) { masm.testw_rr(lhs.encoding(), rhs.encoding()); }
    void testl(Register rhs, Register lhs) { masm.testl_rr(lhs.encoding(), rhs.encoding()); }
    void testl(Imm32 rhs, Register lhs) { masm.testl_ir(rhs.value, lhs.encoding()); }
    ...
    void addl(Imm32 imm, Register dest) { masm.addl_ir(imm.value, dest.encoding()); }
    ...
    void subl(Imm32 imm, Register dest) { masm.subl_ir(imm.value, dest.encoding()); }
    ...
    void addl(Register src, Register dest) { masm.addl_rr(src.encoding(), dest.encoding()); }
    ...
    void subl(Register src, Register dest) { masm.subl_rr(src.encoding(), dest.encoding()); }
    ...
    void orl(Register reg, Register dest) { masm.orl_rr(reg.encoding(), dest.encoding()); }
    ...
    void xorl(Register src, Register dest) { masm.xorl_rr(src.encoding(), dest.encoding()); }
    ...
    void xorl(Imm32 imm, Register reg) { masm.xorl_ir(imm.value, reg.encoding()); }
    ...
    void andl(Register src, Register dest) { masm.andl_rr(src.encoding(), dest.encoding()); }
    ...
    void andl(Imm32 imm, Register dest) { masm.andl_ir(imm.value, dest.encoding()); }
    ...
    void imull(Register src, Register dest) { masm.imull_rr(src.encoding(), dest.encoding()); }
    ...
    void shrl(const Imm32 imm, Register dest) { masm.shrl_ir(imm.value, dest.encoding()); }
    void shll(const Imm32 imm, Register dest) { masm.shll_ir(imm.value, dest.encoding()); }
    void sarl(const Imm32 imm, Register dest) { masm.sarl_ir(imm.value, dest.encoding()); }
    ...
    void shrdl_cl(Register src, Register dest) { masm.shrdl_CLr(src.encoding(), dest.encoding()); }
    void shldl_cl(Register src, Register dest) { masm.shldl_CLr(src.encoding(), dest.encoding()); }

    void roll(const Imm32 imm, Register dest) { masm.roll_ir(imm.value, dest.encoding()); }
    void roll_cl(Register dest) { masm.roll_CLr(dest.encoding()); }
    void rorl(const Imm32 imm, Register dest) { masm.rorl_ir(imm.value, dest.encoding()); }
    ...
    void lock_xaddb(Register srcdest, const Operand& mem) {
        switch (mem.kind()) {
            case Operand::MEM_REG_DISP:
                ...
                break;
            case Operand::MEM_SCALE:
                masm.lock_xaddb_rm(srcdest.encoding(), mem.disp(), mem.base(), mem.index(),
                                   mem.scale());
                break;
            default:
                MOZ_CRASH("unexpected operand kind");
    ...
    void lock_xaddl(Register srcdest, const Operand& mem) {
        switch (mem.kind()) {
            case Operand::MEM_REG_DISP:
                ...
                break;
            case Operand::MEM_SCALE:
                masm.lock_xaddl_rm(srcdest.encoding(), mem.disp(), mem.base(), mem.index(),
                                   mem.scale());
                break;
            default:
                MOZ_CRASH("unexpected operand kind");
    ...
    void push(const Address& src) { masm.push_m(src.offset, src.base.encoding()); }
    ...
    void movzbl(Register src, Register dest) { masm.movzbl_rr(src.encoding(), dest.encoding()); }
    ...
    void vroundsd(X86Encoding::RoundingMode mode, FloatRegister src1, FloatRegister src0,
                  FloatRegister dest) {
        MOZ_ASSERT(HasSSE41());
        masm.vroundsd_irr(mode, src1.encoding(), src0.encoding(), dest.encoding());
    }
    void vroundss(X86Encoding::RoundingMode mode, FloatRegister src1, FloatRegister src0,
                  FloatRegister dest) {
        MOZ_ASSERT(HasSSE41());
    ...
    void vblendvps(FloatRegister mask, const Operand& src1, FloatRegister src0,
        ...
        switch (src1.kind()) {
            case Operand::FPREG:
                ...
                break;
            case Operand::MEM_REG_DISP:
                masm.vblendvps_mr(mask.encoding(), src1.disp(), src1.base(), src0.encoding(),
                                  dest.encoding());
                break;
            default:
                MOZ_CRASH("unexpected operand kind");
