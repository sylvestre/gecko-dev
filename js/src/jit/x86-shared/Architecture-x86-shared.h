...
class Registers {
   public:
    ...
    static const char* GetName(Code code) { return X86Encoding::GPRegName(Encoding(code)); }
    ...
    static const char* GetName(Code code) {
        static const char* const Names[] = {"rax", "rcx", "rdx", "rbx", "rsp", "rbp",
    ...
    static const SetType VolatileMask =
        (1 << X86Encoding::rax) | (1 << X86Encoding::rcx) | (1 << X86Encoding::rdx);

    static const SetType WrapperMask = VolatileMask | (1 << X86Encoding::rbx);

    static const SetType SingleByteRegs = (1 << X86Encoding::rax) | (1 << X86Encoding::rcx) |
                                          (1 << X86Encoding::rdx) | (1 << X86Encoding::rbx);

    static const SetType NonAllocatableMask = (1 << X86Encoding::rsp);

    // Registers returned from a JS -> JS call.
    static const SetType JSCallMask = (1 << X86Encoding::rcx) | (1 << X86Encoding::rdx);
...
#endif
        (1 << X86Encoding::rdx) | (1 << X86Encoding::rcx) | (1 << X86Encoding::r8) |
        (1 << X86Encoding::r9);

    static const SetType VolatileMask =
        (1 << X86Encoding::rax) | ArgRegMask | (1 << X86Encoding::r10) | (1 << X86Encoding::r11);
    ...
    static const SetType NonVolatileMask = AllMask & ~VolatileMask & ~(1 << X86Encoding::rsp);
...
class FloatRegisters {
   public:
    ...
    static const char* GetName(Encoding code) { return X86Encoding::XMMRegName(code); }
...
#if defined(JS_CODEGEN_X64) && defined(_WIN64)
    static const SetType VolatileMask =
        ((1 << X86Encoding::xmm0) | (1 << X86Encoding::xmm1) | (1 << X86Encoding::xmm2) |
         (1 << X86Encoding::xmm3) | (1 << X86Encoding::xmm4) | (1 << X86Encoding::xmm5)) *
            SpreadScalar |
...
struct FloatRegister {
   ...
   public:
    constexpr FloatRegister() : reg_(Codes::Encoding(0)), type_(Codes::Single), isInvalid_(true) {}
    ...
    void alignedAliased(uint32_t aliasIdx, FloatRegister* ret) const { aliased(aliasIdx, ret); }
...
template <>
inline FloatRegister::SetType FloatRegister::LiveAsIndexableSet<RegTypeName::Vector128>(
    SetType set) {
