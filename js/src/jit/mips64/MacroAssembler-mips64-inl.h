...
void MacroAssembler::and64(Register64 src, Register64 dest) { ma_and(dest.reg, src.reg); }
...
void MacroAssembler::or64(Register64 src, Register64 dest) { ma_or(dest.reg, src.reg); }
...
void MacroAssembler::xor64(Register64 src, Register64 dest) { ma_xor(dest.reg, src.reg); }
...
void MacroAssembler::addPtr(Register src, Register dest) { ma_daddu(dest, src); }
...
void MacroAssembler::add64(Imm32 imm, Register64 dest) { ma_daddu(dest.reg, imm); }
...
void MacroAssembler::subPtr(Register src, Register dest) { as_dsubu(dest, dest, src); }

void MacroAssembler::subPtr(Imm32 imm, Register dest) { ma_dsubu(dest, dest, imm); }
...
void MacroAssembler::clz64(Register64 src, Register dest) { as_dclz(dest, src.reg); }

void MacroAssembler::ctz64(Register64 src, Register dest) { ma_dctz(dest, src.reg); }

void MacroAssembler::popcnt64(Register64 input, Register64 output, Register tmp) {
...
void MacroAssembler::branchTestInt32Truthy(bool b, const ValueOperand& value, Label* label) {
...
void MacroAssembler::branchTestBooleanTruthy(bool b, const ValueOperand& value, Label* label) {
    SecondScratchRegisterScope scratch2(*this);
...
void MacroAssembler::branchTestStringTruthy(bool b, const ValueOperand& value, Label* label) {
    SecondScratchRegisterScope scratch2(*this);
...
void MacroAssembler::branchToComputedAddress(const BaseIndex& addr) {
    ...
    if (addr.offset) asMasm().addPtr(Imm32(addr.offset), ScratchRegister);
...
template <>
inline void MacroAssembler::cmpPtrSet(Assembler::Condition cond, Address lhs, ImmPtr rhs,
                                      Register dest) {
...
template <>
inline void MacroAssembler::cmpPtrSet(Assembler::Condition cond, Register lhs, Address rhs,
                                      Register dest) {
...
template <>
inline void MacroAssembler::cmp32Set(Assembler::Condition cond, Register lhs, Address rhs,
                                     Register dest) {
...
void MacroAssemblerMIPS64Compat::computeEffectiveAddress(const BaseIndex& address, Register dest) {
