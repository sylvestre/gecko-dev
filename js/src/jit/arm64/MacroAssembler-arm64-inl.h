...
void MacroAssembler::move64(Register64 src, Register64 dest) { movePtr(src.reg, dest.reg); }

void MacroAssembler::move64(Imm64 imm, Register64 dest) { movePtr(ImmWord(imm.value), dest.reg); }
...
void MacroAssembler::move64To32(Register64 src, Register dest) { MOZ_CRASH("NYI: move64To32"); }
...
void MacroAssembler::and64(Register64 src, Register64 dest) { MOZ_CRASH("NYI: and64"); }
...
void MacroAssembler::or64(Register64 src, Register64 dest) { orPtr(src.reg, dest.reg); }

void MacroAssembler::xor64(Register64 src, Register64 dest) { xorPtr(src.reg, dest.reg); }
...
void MacroAssembler::addPtr(Register src, Register dest) { addPtr(src, dest, dest); }
...
void MacroAssembler::addPtr(Imm32 imm, Register dest) { addPtr(imm, dest, dest); }
...
void MacroAssembler::add64(Register64 src, Register64 dest) { addPtr(src.reg, dest.reg); }
...
void MacroAssembler::sub64(Register64 src, Register64 dest) { MOZ_CRASH("NYI: sub64"); }

void MacroAssembler::sub64(Imm64 imm, Register64 dest) { MOZ_CRASH("NYI: sub64"); }
...
void MacroAssembler::mul32(Register rhs, Register srcDest) { MOZ_CRASH("NYI - mul32"); }

void MacroAssembler::mul32(Register src1, Register src2, Register dest, Label* onOver,
                           Label* onZero) {
...
void MacroAssembler::lshift64(Register shift, Register64 srcDest) { MOZ_CRASH("NYI: lshift64"); }
...
void MacroAssembler::rshift64(Register shift, Register64 srcDest) { MOZ_CRASH("NYI: rshift64"); }
...
void MacroAssembler::rotateLeft64(Register count, Register64 input, Register64 dest,
                                  Register temp) {
...
void MacroAssembler::rotateRight64(Register count, Register64 input, Register64 dest,
                                   Register temp) {
...
void MacroAssembler::clz64(Register64 src, Register dest) { MOZ_CRASH("NYI: clz64"); }

void MacroAssembler::ctz64(Register64 src, Register dest) { MOZ_CRASH("NYI: ctz64"); }
...
template <class L>
void MacroAssembler::branch32(Condition cond, Register lhs, Imm32 imm, L label) {
    cmp32(lhs, imm);
    B(label, cond);
}
...
void MacroAssembler::branch32(Condition cond, const Address& lhs, Imm32 imm, Label* label) {
    vixl::UseScratchRegisterScope temps(this);
    const Register scratch = temps.AcquireX().asUnsized();
    MOZ_ASSERT(scratch != lhs.base);
    load32(lhs, scratch);
...
template <typename T>
CodeOffsetJump MacroAssembler::branchPtrWithPatch(Condition cond, Register lhs, T rhs,
                                                  RepatchLabel* label) {
    cmpPtr(lhs, rhs);
...
template <typename T>
CodeOffsetJump MacroAssembler::branchPtrWithPatch(Condition cond, Address lhs, T rhs,
                                                  RepatchLabel* label) {
...
template <typename T>
void MacroAssembler::branchTestBooleanImpl(Condition cond, const T& tag, Label* label) {
...
template <typename T>
void MacroAssembler::branchTestGCThingImpl(Condition cond, const T& src, Label* label) {
...
void MacroAssembler::storeUncanonicalizedDouble(FloatRegister src, const Address& dest) {
    Str(ARMFPRegister(src, 64), MemOperand(ARMRegister(dest.base, 64), dest.offset));
}
void MacroAssembler::storeUncanonicalizedDouble(FloatRegister src, const BaseIndex& dest) {
...
void MacroAssembler::memoryBarrier(MemoryBarrierBits barrier) { MOZ_CRASH("NYI"); }
...
template <typename T>
void MacroAssemblerCompat::addToStackPtr(T t) {
    asMasm().addPtr(t, getStackPointer());
}

template <typename T>
void MacroAssemblerCompat::addStackPtrTo(T t) {
    asMasm().addPtr(getStackPointer(), t);
}

template <typename T>
void MacroAssemblerCompat::subFromStackPtr(T t) {
    asMasm().subPtr(t, getStackPointer());
    syncStackPtr();
}

template <typename T>
void MacroAssemblerCompat::subStackPtrFrom(T t) {
    asMasm().subPtr(getStackPointer(), t);
}

template <typename T>
void MacroAssemblerCompat::andToStackPtr(T t) {
    asMasm().andPtr(t, getStackPointer());
    syncStackPtr();
}

template <typename T>
void MacroAssemblerCompat::andStackPtrTo(T t) {
    asMasm().andPtr(getStackPointer(), t);
}

template <typename T>
void MacroAssemblerCompat::branchStackPtr(Condition cond, T rhs, Label* label) {
    asMasm().branchPtr(cond, getStackPointer(), rhs, label);
}

template <typename T>
void MacroAssemblerCompat::branchStackPtrRhs(Condition cond, T lhs, Label* label) {
    asMasm().branchPtr(cond, lhs, getStackPointer(), label);
}

template <typename T>
void MacroAssemblerCompat::branchTestStackPtr(Condition cond, T t, Label* label) {
...
void MacroAssemblerCompat::ensureDouble(const ValueOperand& source, FloatRegister dest,
                                        Label* failure) {
    Label isDouble, done;
