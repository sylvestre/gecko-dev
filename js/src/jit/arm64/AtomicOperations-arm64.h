...
template <>
inline js::uint8_clamped js::jit::AtomicOperations::loadSafeWhenRacy(js::uint8_clamped* addr) {
    uint8_t v;
...
// Clang requires a specialization for uint8_clamped.
template <>
inline void js::jit::AtomicOperations::storeSafeWhenRacy(js::uint8_clamped* addr,
                                                         js::uint8_clamped val) {
