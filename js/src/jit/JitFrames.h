...
class OsiIndex {
   ...
   public:
    OsiIndex(uint32_t callPointDisplacement, uint32_t snapshotOffset)
        : callPointDisplacement_(callPointDisplacement), snapshotOffset_(snapshotOffset) {}
...
class FrameSizeClass {
   ...
   public:
    ...
    static FrameSizeClass None() { return FrameSizeClass(NO_FRAME_SIZE_CLASS_ID); }
    static FrameSizeClass FromClass(uint32_t class_) { return FrameSizeClass(class_); }
    ...
    bool operator==(const FrameSizeClass& other) const { return class_ == other.class_; }
    bool operator!=(const FrameSizeClass& other) const { return class_ != other.class_; }
};
...
class CommonFrameLayout {
   ...
   public:
    static size_t offsetOfDescriptor() { return offsetof(CommonFrameLayout, descriptor_); }
    uintptr_t descriptor() const { return descriptor_; }
    static size_t offsetOfReturnAddress() { return offsetof(CommonFrameLayout, returnAddress_); }
    ...
    bool hasCachedSavedFrame() const { return descriptor_ & HASCACHEDSAVEDFRAME_BIT; }
...
class JitFrameLayout : public CommonFrameLayout {
   ...
   public:
    ...
    void replaceCalleeToken(CalleeToken calleeToken) { calleeToken_ = calleeToken; }

    static size_t offsetOfCalleeToken() { return offsetof(JitFrameLayout, calleeToken_); }
    static size_t offsetOfNumActualArgs() { return offsetof(JitFrameLayout, numActualArgs_); }
...
class ExitFooterFrame {
   ...
   public:
    ...
    inline JitCode* jitCode() const { return jitCode_; }
    inline JitCode** addressOfJitCode() { return &jitCode_; }
    inline const VMFunction* function() const { return function_; }
...
class ExitFrameLayout : public CommonFrameLayout {
   ...
   public:
    ...
    static inline size_t SizeWithFooter() { return Size() + ExitFooterFrame::Size(); }
    ...
    inline bool isWrapperExit() { return footer()->function() != nullptr; }
    inline bool isBareExit() { return footer()->jitCode() == BareToken(); }
...
class NativeExitFrameLayout {
   ...
   public:
    ...
    static size_t offsetOfResult() { return offsetof(NativeExitFrameLayout, loCalleeResult_); }
...
class IonOOLPropertyOpExitFrameLayout {
   ...
   public:
    ...
    static inline size_t Size() { return sizeof(IonOOLPropertyOpExitFrameLayout); }

    static size_t offsetOfObject() { return offsetof(IonOOLPropertyOpExitFrameLayout, obj_); }

    static size_t offsetOfId() { return offsetof(IonOOLPropertyOpExitFrameLayout, id_); }

    static size_t offsetOfResult() { return offsetof(IonOOLPropertyOpExitFrameLayout, vp0_); }

    inline JitCode** stubCode() { return &stubCode_; }
    inline Value* vp() { return reinterpret_cast<Value*>(&vp0_); }
    inline jsid* id() { return &id_; }
    inline JSObject** obj() { return &obj_; }
};
...
class IonOOLSetterOpExitFrameLayout : public IonOOLPropertyOpExitFrameLayout {
   ...
   public:
    ...
    static size_t Size() { return sizeof(IonOOLSetterOpExitFrameLayout); }
};
...
class IonOOLProxyExitFrameLayout {
   ...
   public:
    ...
    static size_t offsetOfResult() { return offsetof(IonOOLProxyExitFrameLayout, vp0_); }
...
class IonDOMExitFrameLayout {
   ...
   public:
    ...
    static size_t offsetOfResult() { return offsetof(IonDOMExitFrameLayout, loCalleeResult_); }
    inline Value* vp() { return reinterpret_cast<Value*>(&loCalleeResult_); }
...
inline bool ExitFrameLayout::is<IonDOMExitFrameLayout>() {
    ...
    return code == IonDOMExitFrameLayout::GetterToken() ||
...
struct IonDOMMethodExitFrameLayoutTraits {
    static const size_t offsetOfArgcFromArgv = offsetof(IonDOMMethodExitFrameLayout, argc_) -
...
class LazyLinkExitFrameLayout {
   ...
   public:
    ...
    static inline size_t Size() { return sizeof(LazyLinkExitFrameLayout); }

    inline JitCode** stubCode() { return &stubCode_; }
    inline JitFrameLayout* jsFrame() { return &exit_; }
    static size_t offsetOfExitFrame() { return offsetof(LazyLinkExitFrameLayout, exit_); }
};

template <>
inline LazyLinkExitFrameLayout* ExitFrameLayout::as<LazyLinkExitFrameLayout>() {
...
class BaselineStubFrameLayout : public JitStubFrameLayout {
   ...
   public:
    ...
    static inline int reverseOffsetOfSavedFramePtr() { return -int(2 * sizeof(void*)); }
...
class InvalidationBailoutStack {
   ...
   public:
    uint8_t* sp() const { return (uint8_t*)this + sizeof(InvalidationBailoutStack); }
    ...
    static size_t offsetOfFpRegs() { return offsetof(InvalidationBailoutStack, fpregs_); }
    static size_t offsetOfRegs() { return offsetof(InvalidationBailoutStack, regs_); }
