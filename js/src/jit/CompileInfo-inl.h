...
InlineScriptTree* InlineScriptTree::New(TempAllocator* allocator, InlineScriptTree* callerTree,
...
InlineScriptTree* InlineScriptTree::addCallee(TempAllocator* allocator, jsbytecode* callerPc,
...
static inline bool CanIonCompile(JSScript* script, AnalysisMode mode) {
    switch (mode) {
        case Analysis_None:
            return script->canIonCompile();
        case Analysis_DefiniteProperties:
            return true;
        case Analysis_ArgumentsUsage:
            return true;
