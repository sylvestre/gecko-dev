...
template <>
TaggedProto DoCallback<TaggedProto>(JS::CallbackTracer* trc, TaggedProto* protop,
                                    const char* name) {
...
void gc::TraceCycleCollectorChildren(JS::CallbackTracer* trc, ObjectGroup* group) {
...
JS_PUBLIC_API(void)
JS_GetTraceThingInfo(char* buf, size_t bufsize, JSTracer* trc, void* thing, JS::TraceKind kind,
                     bool details) {
