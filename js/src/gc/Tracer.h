...
template <typename T>
void TraceNullableEdge(JSTracer* trc, WriteBarrieredBase<T>* thingp, const char* name);

template <typename T>
void TraceNullableEdge(JSTracer* trc, ReadBarriered<T>* thingp, const char* name);
...
template <typename T>
void TraceNullableRoot(JSTracer* trc, ReadBarriered<T>* thingp, const char* name);
...
template <typename T>
void TraceRange(JSTracer* trc, size_t len, WriteBarrieredBase<T>* vec, const char* name);
...
template <typename T>
void TraceCrossCompartmentEdge(JSTracer* trc, JSObject* src, WriteBarrieredBase<T>* dst,
                               const char* name);

// As above but with manual barriers.
template <typename T>
void TraceManuallyBarrieredCrossCompartmentEdge(JSTracer* trc, JSObject* src, T* dst,
                                                const char* name);
...
// specific type.
void TraceGenericPointerRoot(JSTracer* trc, gc::Cell** thingp, const char* name);

// Trace a non-root edge that uses the base GC thing type, instead of a more
// specific type.
void TraceManuallyBarrieredGenericPointerEdge(JSTracer* trc, gc::Cell** thingp, const char* name);
