...
extern bool math_abs_handle(JSContext* cx, js::HandleValue v, js::MutableHandleValue r);
...
extern bool math_pow_handle(JSContext* cx, js::HandleValue base, js::HandleValue power,
                            js::MutableHandleValue result);

extern bool math_pow(JSContext* cx, unsigned argc, js::Value* vp);

extern bool minmax_impl(JSContext* cx, bool max, js::HandleValue a, js::HandleValue b,
                        js::MutableHandleValue res);

extern void math_sincos_uncached(double x, double* sin, double* cos);

extern void math_sincos_impl(MathCache* mathCache, double x, double* sin, double* cos);

extern bool math_sqrt_handle(JSContext* cx, js::HandleValue number, js::MutableHandleValue result);
...
extern bool RoundFloat32(JSContext* cx, HandleValue arg, MutableHandleValue res);
...
extern bool math_log_handle(JSContext* cx, HandleValue val, MutableHandleValue res);
...
extern bool math_sin_handle(JSContext* cx, HandleValue val, MutableHandleValue res);
...
extern bool math_hypot_handle(JSContext* cx, HandleValueArray args, MutableHandleValue res);
...
extern bool math_atan2_handle(JSContext* cx, HandleValue y, HandleValue x, MutableHandleValue res);
...
extern bool math_ceil_handle(JSContext* cx, HandleValue value, MutableHandleValue res);
...
extern bool math_floor_handle(JSContext* cx, HandleValue v, MutableHandleValue r);
...
extern bool math_round_handle(JSContext* cx, HandleValue arg, MutableHandleValue res);
...
extern double powi(double x, int y);
