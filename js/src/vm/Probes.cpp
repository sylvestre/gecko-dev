...
static const char* FunctionName(JSContext* cx, JSFunction* fun, JSAutoByteString* bytes) {
 ...
 */
void probes::DTraceEnterJSFun(JSContext* cx, JSFunction* fun, JSScript* script) {
