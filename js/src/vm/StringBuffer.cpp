...
template <typename CharT, class Buffer>
static JSFlatString* FinishStringFlat(JSContext* cx, StringBuffer& sb, Buffer& cb) {
...
bool js::ValueToStringBufferSlow(JSContext* cx, const Value& arg, StringBuffer& sb) {
