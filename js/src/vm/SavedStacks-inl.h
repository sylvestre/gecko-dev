...
inline void js::AssertObjectIsSavedFrameOrWrapper(JSContext* cx, HandleObject stack) {
    if (stack) MOZ_RELEASE_ASSERT(js::SavedFrame::isSavedFrameOrWrapperAndNotProto(*stack));
}
