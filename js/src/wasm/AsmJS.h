...
extern MOZ_MUST_USE bool CompileAsmJS(JSContext* cx, AsmJSParser& parser,
                                      frontend::ParseNode* stmtList, bool* validated);
...
extern bool IsAsmJSCompilationAvailable(JSContext* cx, unsigned argc, JS::Value* vp);

extern bool IsAsmJSModule(JSContext* cx, unsigned argc, JS::Value* vp);

extern bool IsAsmJSModuleLoadedFromCache(JSContext* cx, unsigned argc, Value* vp);
...
extern JSString* AsmJSModuleToString(JSContext* cx, HandleFunction fun, bool isToSource);
