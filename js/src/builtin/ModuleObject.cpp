...
#define DEFINE_GETTER_FUNCTIONS(cls, name, slot)                                                 \
    static Value cls##_##name##Value(const cls* obj) { return obj->getReservedSlot(cls::slot); } \
                                                                                                 \
...
/* static */ const Class ImportEntryObject::class_ = {
    "ImportEntry",
    JSCLASS_HAS_RESERVED_SLOTS(ImportEntryObject::SlotCount) | JSCLASS_IS_ANONYMOUS};
...
/* static */ bool GlobalObject::initImportEntryProto(JSContext* cx, Handle<GlobalObject*> global) {
    ...
    if (!DefinePropertiesAndFunctions(cx, proto, protoAccessors, nullptr)) return false;

    global->initReservedSlot(IMPORT_ENTRY_PROTO, ObjectValue(*proto));
    return true;
}

/* static */ ImportEntryObject* ImportEntryObject::create(JSContext* cx, HandleAtom moduleRequest,
...
/* static */ const Class ExportEntryObject::class_ = {
    "ExportEntry",
    JSCLASS_HAS_RESERVED_SLOTS(ExportEntryObject::SlotCount) | JSCLASS_IS_ANONYMOUS};
...
/* static */ bool GlobalObject::initExportEntryProto(JSContext* cx, Handle<GlobalObject*> global) {
    static const JSPropertySpec protoAccessors[] = {
...
/* static */ const Class RequestedModuleObject::class_ = {
    "RequestedModule",
    JSCLASS_HAS_RESERVED_SLOTS(RequestedModuleObject::SlotCount) | JSCLASS_IS_ANONYMOUS};
...
/* static */ bool GlobalObject::initRequestedModuleProto(JSContext* cx,
    ...
    static const JSPropertySpec protoAccessors[] = {
        ...
        JS_PSG("columnNumber", RequestedModuleObject_columnNumberGetter, 0), JS_PS_END};
...
/* static */ RequestedModuleObject* RequestedModuleObject::create(JSContext* cx,
...
IndirectBindingMap::IndirectBindingMap(Zone* zone) : map_(ZoneAllocPolicy(zone)) {}

bool IndirectBindingMap::init() { return map_.init(); }
...
bool IndirectBindingMap::putNew(JSContext* cx, HandleId name,
...
/* static */ ModuleNamespaceObject* ModuleNamespaceObject::create(JSContext* cx,
...
ModuleNamespaceObject::ProxyHandler::ProxyHandler() : BaseProxyHandler(&family, false) {}

bool ModuleNamespaceObject::ProxyHandler::getPrototype(JSContext* cx, HandleObject proxy,
                                                       MutableHandleObject protop) const {
    protop.set(nullptr);
    return true;
}

bool ModuleNamespaceObject::ProxyHandler::setPrototype(JSContext* cx, HandleObject proxy,
                                                       HandleObject proto,
...
bool ModuleNamespaceObject::ProxyHandler::getPrototypeIfOrdinary(
    JSContext* cx, HandleObject proxy, bool* isOrdinary, MutableHandleObject protop) const {
    *isOrdinary = false;
    return true;
}

bool ModuleNamespaceObject::ProxyHandler::setImmutablePrototype(JSContext* cx, HandleObject proxy,
                                                                bool* succeeded) const {
    *succeeded = true;
    return true;
}

bool ModuleNamespaceObject::ProxyHandler::isExtensible(JSContext* cx, HandleObject proxy,
                                                       bool* extensible) const {
    *extensible = false;
    return true;
}

bool ModuleNamespaceObject::ProxyHandler::preventExtensions(JSContext* cx, HandleObject proxy,
                                                            ObjectOpResult& result) const {
    result.succeed();
    return true;
}
...
bool ModuleNamespaceObject::ProxyHandler::getOwnPropertyDescriptor(
    JSContext* cx, HandleObject proxy, HandleId id, MutableHandle<PropertyDescriptor> desc) const {
...
static bool ValidatePropertyDescriptor(JSContext* cx, Handle<PropertyDescriptor> desc,
...
bool ModuleNamespaceObject::ProxyHandler::defineProperty(JSContext* cx, HandleObject proxy,
                                                         HandleId id,
...
bool ModuleNamespaceObject::ProxyHandler::has(JSContext* cx, HandleObject proxy, HandleId id,
                                              bool* bp) const {
    Rooted<ModuleNamespaceObject*> ns(cx, &proxy->as<ModuleNamespaceObject>());
    if (JSID_IS_SYMBOL(id)) {
...
bool ModuleNamespaceObject::ProxyHandler::set(JSContext* cx, HandleObject proxy, HandleId id,
                                              HandleValue v, HandleValue receiver,
                                              ObjectOpResult& result) const {
    return result.failReadOnly();
}

bool ModuleNamespaceObject::ProxyHandler::delete_(JSContext* cx, HandleObject proxy, HandleId id,
                                                  ObjectOpResult& result) const {
    Rooted<ModuleNamespaceObject*> ns(cx, &proxy->as<ModuleNamespaceObject>());
    if (JSID_IS_SYMBOL(id)) {
        if (JSID_TO_SYMBOL(id) == cx->wellKnownSymbols().toStringTag)
...
bool ModuleNamespaceObject::ProxyHandler::ownPropertyKeys(JSContext* cx, HandleObject proxy,
    ...
    if (!names.resize(count) || !GetElements(cx, exports, count, names.begin())) return false;
...
/* static */ const ClassOps ModuleObject::classOps_ = {nullptr, /* addProperty */
                                                       nullptr, /* delProperty */
                                                       nullptr, /* enumerate   */
...
/* static */ void ModuleObject::finalize(js::FreeOp* fop, JSObject* obj) {
    ...
    if (IndirectBindingMap* bindings = self->namespaceBindings()) fop->delete_(bindings);
    if (FunctionDeclarationVector* funDecls = self->functionDeclarations()) fop->delete_(funDecls);
}
...
JSObject* ModuleObject::namespaceExports() {
...
IndirectBindingMap* ModuleObject::namespaceBindings() {
...
void ModuleObject::setInitialEnvironment(HandleModuleEnvironmentObject initialEnvironment) {
...
static bool FreezeObjectProperty(JSContext* cx, HandleNativeObject obj, uint32_t slot) {
...
/* static */ bool ModuleObject::Freeze(JSContext* cx, HandleModuleObject self) {
    return FreezeObjectProperty(cx, self, RequestedModulesSlot) &&
           ...
           FreezeObjectProperty(cx, self, StarExportEntriesSlot) && FreezeObject(cx, self);
}

#ifdef DEBUG

static inline bool CheckObjectFrozen(JSContext* cx, HandleObject obj, bool* result) {
    return TestIntegrityLevel(cx, obj, IntegrityLevel::Frozen, result);
}

static inline bool CheckObjectPropertyFrozen(JSContext* cx, HandleNativeObject obj, uint32_t slot,
                                             bool* result) {
    RootedObject property(cx, &obj->getSlot(slot).toObject());
    return CheckObjectFrozen(cx, property, result);
}

/* static */ inline bool ModuleObject::AssertFrozen(JSContext* cx, HandleModuleObject self) {
    static const mozilla::EnumSet<ModuleSlot> slotsToCheck = {
        RequestedModulesSlot, ImportEntriesSlot, LocalExportEntriesSlot, IndirectExportEntriesSlot,
...
Value ModuleObject::error() const {
    MOZ_ASSERT(status() == MODULE_STATUS_ERRORED);
    return getReservedSlot(ErrorSlot);
}

Value ModuleObject::hostDefinedField() const { return getReservedSlot(HostDefinedSlot); }
...
Scope* ModuleObject::enclosingScope() const { return script()->enclosingScope(); }
...
/* static */ void ModuleObject::trace(JSTracer* trc, JSObject* obj) {
    ...
    if (FunctionDeclarationVector* funDecls = module.functionDeclarations()) funDecls->trace(trc);
}

void ModuleObject::createEnvironment() {
...
bool ModuleObject::noteFunctionDeclaration(JSContext* cx, HandleAtom name, HandleFunction fun) {
...
/* static */ bool ModuleObject::instantiateFunctionDeclarations(JSContext* cx,
    ...
    for (const auto& funDecl : *funDecls) {
        ...
        if (!SetProperty(cx, env, funDecl.name->asPropertyName(), value)) return false;
    }
...
/* static */ ModuleNamespaceObject* ModuleObject::createNamespace(JSContext* cx,
                                                                  HandleModuleObject self,
...
static bool InvokeSelfHostedMethod(JSContext* cx, HandleModuleObject self,
    ...
    RootedValue fval(cx);
    if (!GlobalObject::getSelfHostedFunction(cx, cx->global(), name, name, 0, &fval)) return false;

    RootedValue ignored(cx);
    return Call(cx, fval, self, &ignored);
}

/* static */ bool ModuleObject::Instantiate(JSContext* cx, HandleModuleObject self) {
    return InvokeSelfHostedMethod(cx, self, cx->names().ModuleInstantiate);
}

/* static */ bool ModuleObject::Evaluate(JSContext* cx, HandleModuleObject self) {
...
/* static */ bool GlobalObject::initModuleProto(JSContext* cx, Handle<GlobalObject*> global) {
    static const JSPropertySpec protoAccessors[] = {
    ...
    if (!DefinePropertiesAndFunctions(cx, proto, protoAccessors, protoFunctions)) return false;
        ...
        if (!exp->moduleRequest()) {
            ...
            if (!importEntry) {
                ...
                if (importEntry->importName() == cx_->names().star) {
                    ...
                    exportEntry =
                        ExportEntryObject::create(cx_, exportName, moduleRequest, importName,
                                                  nullptr, exp->lineNumber(), exp->columnNumber());
                    if (!exportEntry || !indirectExportEntries_.append(exportEntry)) return false;
                }
            }
...
bool ModuleBuilder::initModule() {
    ...
    module_->initImportExportData(requestedModules, importEntries, localExportEntries,
    ...
    switch (kid->getKind()) {
        ...
        case PNK_LET: {
            ...
            for (ParseNode* var = kid->pn_head; var; var = var->pn_next) {
                if (var->isKind(PNK_ASSIGN)) var = var->pn_left;
...
bool ModuleBuilder::processExportFrom(frontend::ParseNode* pn) {
    ...
    for (ParseNode* spec = pn->pn_left->pn_head; spec; spec = spec->pn_next) {
        if (spec->isKind(PNK_EXPORT_SPEC)) {
            ...
            if (!appendExportFromEntry(nullptr, module, importName, spec)) return false;
        }
    }
...
bool ModuleBuilder::appendExportEntry(HandleAtom exportName, HandleAtom localName,
                                      ParseNode* node) {
    uint32_t line = 0;
    uint32_t column = 0;
    if (node) tokenStream_.lineNumAndColumnIndex(node->pn_pos.begin, &line, &column);

    Rooted<ExportEntryObject*> exportEntry(cx_);
    exportEntry =
        ExportEntryObject::create(cx_, exportName, nullptr, nullptr, localName, line, column);
    return exportEntry && exportEntries_.append(exportEntry);
}

bool ModuleBuilder::appendExportFromEntry(HandleAtom exportName, HandleAtom moduleRequest,
...
bool ModuleBuilder::maybeAppendRequestedModule(HandleAtom specifier, ParseNode* node) {
    ...
    JSContext* cx = cx_;
    RootedRequestedModuleObject req(cx,
                                    RequestedModuleObject::create(cx, specifier, line, column));
    if (!req) return false;
...
ArrayObject* ModuleBuilder::createArray(const JS::Rooted<GCVector<T>>& vector) {
    ...
    for (uint32_t i = 0; i < length; i++) array->initDenseElement(i, ObjectValue(*vector[i]));
