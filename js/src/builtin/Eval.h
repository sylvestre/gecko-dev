...
extern MOZ_MUST_USE bool DirectEval(JSContext* cx, HandleValue v, MutableHandleValue vp);

// Performs a direct eval called from Ion code.
extern MOZ_MUST_USE bool DirectEvalStringFromIon(JSContext* cx, HandleObject scopeObj,
