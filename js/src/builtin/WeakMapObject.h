...
extern bool WeakMap_get(JSContext* cx, unsigned argc, Value* vp);

extern bool WeakMap_set(JSContext* cx, unsigned argc, Value* vp);

extern JSObject* InitBareWeakMapCtor(JSContext* cx, HandleObject obj);
