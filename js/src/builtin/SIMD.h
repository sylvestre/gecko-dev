...
#define BOOL8X16_TERNARY_FUNCTION_LIST(V) V(replaceLane, (ReplaceLane<Bool8x16>), 3)
...
#define BOOL16X8_TERNARY_FUNCTION_LIST(V) V(replaceLane, (ReplaceLane<Bool16x8>), 3)
...
#define BOOL32X4_TERNARY_FUNCTION_LIST(V) V(replaceLane, (ReplaceLane<Bool32x4>), 3)
...
#define BOOL64X2_TERNARY_FUNCTION_LIST(V) V(replaceLane, (ReplaceLane<Bool64x2>), 3)
...
inline bool IsSignedIntSimdType(SimdType type) { return GetSimdSign(type) == SimdSign::Signed; }
...
struct Float32x4 {
    ...
    static Value ToValue(Elem value) { return DoubleValue(JS::CanonicalizeNaN(value)); }
};
...
#define DECLARE_SIMD_FLOAT32X4_FUNCTION(Name, Func, Operands) \
    extern MOZ_MUST_USE bool simd_float32x4_##Name(JSContext* cx, unsigned argc, Value* vp);
...
#define DECLARE_SIMD_FLOAT64X2_FUNCTION(Name, Func, Operands) \
    extern MOZ_MUST_USE bool simd_float64x2_##Name(JSContext* cx, unsigned argc, Value* vp);
...
#define DECLARE_SIMD_INT8X16_FUNCTION(Name, Func, Operands) \
    extern MOZ_MUST_USE bool simd_int8x16_##Name(JSContext* cx, unsigned argc, Value* vp);
...
#define DECLARE_SIMD_INT16X8_FUNCTION(Name, Func, Operands) \
    extern MOZ_MUST_USE bool simd_int16x8_##Name(JSContext* cx, unsigned argc, Value* vp);
...
#define DECLARE_SIMD_INT32X4_FUNCTION(Name, Func, Operands) \
    extern MOZ_MUST_USE bool simd_int32x4_##Name(JSContext* cx, unsigned argc, Value* vp);
...
#define DECLARE_SIMD_UINT8X16_FUNCTION(Name, Func, Operands) \
    extern MOZ_MUST_USE bool simd_uint8x16_##Name(JSContext* cx, unsigned argc, Value* vp);
...
#define DECLARE_SIMD_UINT16X8_FUNCTION(Name, Func, Operands) \
    extern MOZ_MUST_USE bool simd_uint16x8_##Name(JSContext* cx, unsigned argc, Value* vp);
...
#define DECLARE_SIMD_UINT32X4_FUNCTION(Name, Func, Operands) \
    extern MOZ_MUST_USE bool simd_uint32x4_##Name(JSContext* cx, unsigned argc, Value* vp);
...
#define DECLARE_SIMD_BOOL8X16_FUNCTION(Name, Func, Operands) \
    extern MOZ_MUST_USE bool simd_bool8x16_##Name(JSContext* cx, unsigned argc, Value* vp);
...
#define DECLARE_SIMD_BOOL16X8_FUNCTION(Name, Func, Operands) \
    extern MOZ_MUST_USE bool simd_bool16x8_##Name(JSContext* cx, unsigned argc, Value* vp);
...
#define DECLARE_SIMD_BOOL32X4_FUNCTION(Name, Func, Operands) \
    extern MOZ_MUST_USE bool simd_bool32x4_##Name(JSContext* cx, unsigned argc, Value* vp);
...
#define DECLARE_SIMD_BOOL64X2_FUNCTION(Name, Func, Operands) \
    extern MOZ_MUST_USE bool simd_bool64x2_##Name(JSContext* cx, unsigned argc, Value* vp);
