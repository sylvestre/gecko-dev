...
class JSObject : public js::gc::Cell {
   ...
   private:
    ...
    friend bool js::PreventExtensions(JSContext* cx, JS::HandleObject obj,
                                      JS::ObjectOpResult& result, js::IntegrityLevel level);
    friend bool js::SetImmutablePrototype(JSContext* cx, JS::HandleObject obj, bool* succeeded);
   ...
   public:
    ...
    MOZ_ALWAYS_INLINE JS::Zone* zoneFromAnyThread() const { return group_->zoneFromAnyThread(); }
...
template <typename U>
MOZ_ALWAYS_INLINE JS::Handle<U*> js::RootedBase<JSObject*, Wrapper>::as() const {
...
template <typename Wrapper>
template <class U>
MOZ_ALWAYS_INLINE JS::Handle<U*> js::HandleBase<JSObject*, Wrapper>::as() const {
 ...
 */
static MOZ_ALWAYS_INLINE bool operator==(const JSObject& lhs, const JSObject& rhs) {
    return &lhs == &rhs;
}
...
/* static */ MOZ_ALWAYS_INLINE void JSObject::writeBarrierPre(JSObject* obj) {
    if (obj && obj->isTenured()) obj->asTenured().writeBarrierPre(&obj->asTenured());
}

/* static */ MOZ_ALWAYS_INLINE void JSObject::writeBarrierPost(void* cellp, JSObject* prev,
                                                               JSObject* next) {
    MOZ_ASSERT(cellp);
 ...
 */
inline bool GetPrototype(JSContext* cx, HandleObject obj, MutableHandleObject protop);
 ...
 * at least `level`.
 */
extern bool PreventExtensions(JSContext* cx, HandleObject obj, ObjectOpResult& result,
 ...
 * null.
 */
extern bool GetOwnPropertyDescriptor(JSContext* cx, HandleObject obj, HandleId id,
...
extern bool DefineAccessorProperty(JSContext* cx, HandleObject obj, HandleId id, JSGetterOp getter,
                                   JSSetterOp setter, unsigned attrs, ObjectOpResult& result);

extern bool DefineDataProperty(JSContext* cx, HandleObject obj, HandleId id, HandleValue value,
                               unsigned attrs, ObjectOpResult& result);

extern bool DefineAccessorProperty(JSContext* cx, HandleObject obj, PropertyName* name,
                                   JSGetterOp getter, JSSetterOp setter, unsigned attrs,
                                   ObjectOpResult& result);

extern bool DefineDataProperty(JSContext* cx, HandleObject obj, PropertyName* name,
                               HandleValue value, unsigned attrs, ObjectOpResult& result);

extern bool DefineAccessorElement(JSContext* cx, HandleObject obj, uint32_t index,
                                  JSGetterOp getter, JSSetterOp setter, unsigned attrs,
                                  ObjectOpResult& result);

extern bool DefineDataElement(JSContext* cx, HandleObject obj, uint32_t index, HandleValue value,
                              unsigned attrs, ObjectOpResult& result);
...
extern bool DefineAccessorProperty(JSContext* cx, HandleObject obj, HandleId id, JSGetterOp getter,
                                   JSSetterOp setter, unsigned attrs = JSPROP_ENUMERATE);
...
extern bool DefineDataProperty(JSContext* cx, HandleObject obj, PropertyName* name,
                               HandleValue value, unsigned attrs = JSPROP_ENUMERATE);
 ...
 */
inline bool HasProperty(JSContext* cx, HandleObject obj, HandleId id, bool* foundp);

inline bool HasProperty(JSContext* cx, HandleObject obj, PropertyName* name, bool* foundp);
 ...
 */
inline bool GetProperty(JSContext* cx, HandleObject obj, HandleValue receiver, HandleId id,
                        MutableHandleValue vp);

inline bool GetProperty(JSContext* cx, HandleObject obj, HandleValue receiver, PropertyName* name,
                        MutableHandleValue vp) {
    RootedId id(cx, NameToId(name));
    return GetProperty(cx, obj, receiver, id, vp);
}

inline bool GetProperty(JSContext* cx, HandleObject obj, HandleObject receiver, HandleId id,
                        MutableHandleValue vp) {
    RootedValue receiverValue(cx, ObjectValue(*receiver));
    return GetProperty(cx, obj, receiverValue, id, vp);
}

inline bool GetProperty(JSContext* cx, HandleObject obj, HandleObject receiver, PropertyName* name,
                        MutableHandleValue vp) {
    RootedValue receiverValue(cx, ObjectValue(*receiver));
    return GetProperty(cx, obj, receiverValue, name, vp);
}

inline bool GetElement(JSContext* cx, HandleObject obj, HandleValue receiver, uint32_t index,
                       MutableHandleValue vp);

inline bool GetElement(JSContext* cx, HandleObject obj, HandleObject receiver, uint32_t index,
                       MutableHandleValue vp);

inline bool GetPropertyNoGC(JSContext* cx, JSObject* obj, const Value& receiver, jsid id,
                            Value* vp);
...
inline bool GetElementNoGC(JSContext* cx, JSObject* obj, const Value& receiver, uint32_t index,
                           Value* vp);
...
MOZ_ALWAYS_INLINE bool MaybeHasInterestingSymbolProperty(JSContext* cx, JSObject* obj,
                                                         Symbol* symbol,
                                                         JSObject** holder = nullptr);

// Like GetProperty but optimized for interesting symbol properties like
// @@toStringTag.
MOZ_ALWAYS_INLINE bool GetInterestingSymbolProperty(JSContext* cx, HandleObject obj, Symbol* sym,
                                                    MutableHandleValue vp);
 ...
 */
inline bool SetProperty(JSContext* cx, HandleObject obj, HandleId id, HandleValue v,
                        HandleValue receiver, ObjectOpResult& result);

inline bool SetProperty(JSContext* cx, HandleObject obj, HandleId id, HandleValue v) {
    RootedValue receiver(cx, ObjectValue(*obj));
    ObjectOpResult result;
    return SetProperty(cx, obj, id, v, receiver, result) && result.checkStrict(cx, obj, id);
}

inline bool SetProperty(JSContext* cx, HandleObject obj, PropertyName* name, HandleValue v,
                        HandleValue receiver, ObjectOpResult& result) {
    RootedId id(cx, NameToId(name));
...
inline bool SetElement(JSContext* cx, HandleObject obj, uint32_t index, HandleValue v,
                       HandleValue receiver, ObjectOpResult& result);
 ...
 * don't bother doing.
 */
inline bool PutProperty(JSContext* cx, HandleObject obj, HandleId id, HandleValue v, bool strict) {
    RootedValue receiver(cx, ObjectValue(*obj));
    ObjectOpResult result;
    return SetProperty(cx, obj, id, v, receiver, result) &&
 ...
 */
inline bool DeleteProperty(JSContext* cx, HandleObject obj, HandleId id, ObjectOpResult& result);

inline bool DeleteElement(JSContext* cx, HandleObject obj, uint32_t index, ObjectOpResult& result);
 ...
 */
extern bool GetPrototypeIfOrdinary(JSContext* cx, HandleObject obj, bool* isOrdinary,
 ...
 */
extern bool SetImmutablePrototype(JSContext* cx, JS::HandleObject obj, bool* succeeded);
 ...
 */
extern bool LookupProperty(JSContext* cx, HandleObject obj, HandleId id, MutableHandleObject objp,
...
extern bool HasOwnProperty(JSContext* cx, HandleObject obj, HandleId id, bool* result);
...
extern bool DefineFunctions(JSContext* cx, HandleObject obj, const JSFunctionSpec* fs,
 ...
 * Object.observe.
 */
extern bool WatchProperty(JSContext* cx, HandleObject obj, HandleId id, HandleObject callable);

/* Clear a watchpoint. */
extern bool UnwatchProperty(JSContext* cx, HandleObject obj, HandleId id);
...
inline bool ToPrimitive(JSContext* cx, JSType preferredType, MutableHandleValue vp) {
    if (vp.isPrimitive()) return true;
 ...
 */
MOZ_ALWAYS_INLINE const char* GetObjectClassName(JSContext* cx, HandleObject obj);
...
bool GetBuiltinConstructor(JSContext* cx, JSProtoKey key, MutableHandleObject objp);

bool GetBuiltinPrototype(JSContext* cx, JSProtoKey key, MutableHandleObject objp);

JSObject* GetBuiltinPrototypePure(GlobalObject* global, JSProtoKey protoKey);
...
inline gc::InitialHeap GetInitialHeap(NewObjectKind newKind, const Class* clasp) {
    ...
    if (clasp->hasFinalize() && !CanNurseryAllocateFinalizedClass(clasp)) return gc::TenuredHeap;
    return gc::DefaultHeap;
}

bool NewObjectWithTaggedProtoIsCachable(JSContext* cx, Handle<TaggedProto> proto,
                                        NewObjectKind newKind, const Class* clasp);

// ES6 9.1.15 GetPrototypeFromConstructor.
extern bool GetPrototypeFromConstructor(JSContext* cx, js::HandleObject newTarget,
                                        js::MutableHandleObject proto);

MOZ_ALWAYS_INLINE bool GetPrototypeFromBuiltinConstructor(JSContext* cx, const CallArgs& args,
                                                          js::MutableHandleObject proto) {
...
extern JSObject* CreateThisForFunctionWithProto(JSContext* cx, js::HandleObject callee,
...
extern JSObject* CreateThisForFunction(JSContext* cx, js::HandleObject callee,
                                       js::HandleObject newTarget, NewObjectKind newKind);

// Generic call for constructing |this|.
extern JSObject* CreateThis(JSContext* cx, const js::Class* clasp, js::HandleObject callee);
...
bool ToPropertyDescriptor(JSContext* cx, HandleValue descval, bool checkAccessors,
                          MutableHandle<JS::PropertyDescriptor> desc);
 ...
 */
Result<> CheckPropertyDescriptorAccessors(JSContext* cx, Handle<JS::PropertyDescriptor> desc);
 ...
 */
extern bool ReadPropertyDescriptors(JSContext* cx, HandleObject props, bool checkAccessors,
                                    AutoIdVector* ids,
                                    MutableHandle<PropertyDescriptorVector> descs);

/* Read the name using a dynamic lookup on the scopeChain. */
extern bool LookupName(JSContext* cx, HandlePropertyName name, HandleObject scopeChain,
                       MutableHandleObject objp, MutableHandleObject pobjp,
                       MutableHandle<PropertyResult> propp);

extern bool LookupNameNoGC(JSContext* cx, PropertyName* name, JSObject* scopeChain,
 ...
 */
extern bool LookupNameUnqualified(JSContext* cx, HandlePropertyName name, HandleObject scopeChain,
...
bool LookupOwnPropertyPure(JSContext* cx, JSObject* obj, jsid id, PropertyResult* propp,
...
bool GetOwnNativeGetterPure(JSContext* cx, JSObject* obj, jsid id, JSNative* native);

bool HasOwnDataPropertyPure(JSContext* cx, JSObject* obj, jsid id, bool* result);
 ...
 */
extern bool FromPropertyDescriptorToObject(JSContext* cx, Handle<JS::PropertyDescriptor> desc,
                                           MutableHandleValue vp);

extern bool IsDelegate(JSContext* cx, HandleObject obj, const Value& v, bool* result);
...
extern bool IsDelegateOfObject(JSContext* cx, HandleObject protoObj, JSObject* obj, bool* result);
 ...
 */
extern void ReportNotObjectArg(JSContext* cx, const char* nth, const char* fun, HandleValue v);

inline JSObject* NonNullObjectArg(JSContext* cx, const char* nth, const char* fun, HandleValue v) {
    if (v.isObject()) return &v.toObject();
 ...
 */
extern void ReportNotObjectWithName(JSContext* cx, const char* name, HandleValue v);

inline JSObject* NonNullObjectWithName(JSContext* cx, const char* name, HandleValue v) {
    if (v.isObject()) return &v.toObject();
    ReportNotObjectWithName(cx, name, v);
    return nullptr;
}

extern bool GetFirstArgumentAsObject(JSContext* cx, const CallArgs& args, const char* method,
                                     MutableHandleObject objp);

/* Helper for throwing, always returns false. */
extern bool Throw(JSContext* cx, jsid id, unsigned errorNumber, const char* details = nullptr);
 ...
 */
extern bool SetIntegrityLevel(JSContext* cx, HandleObject obj, IntegrityLevel level);
 ...
 * Object.isFrozen.
 */
extern bool TestIntegrityLevel(JSContext* cx, HandleObject obj, IntegrityLevel level,
                               bool* resultp);

extern MOZ_MUST_USE JSObject* SpeciesConstructor(JSContext* cx, HandleObject obj,
                                                 HandleObject defaultCtor,
                                                 bool (*isDefaultSpecies)(JSContext*,
                                                                          JSFunction*));
...
extern bool GetObjectFromIncumbentGlobal(JSContext* cx, MutableHandleObject obj);
