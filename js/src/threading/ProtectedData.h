...
// active thread.
template <typename T>
using ActiveThreadData = ProtectedDataNoCheckArgs<CheckActiveThread<AllowedHelperThread::None>, T>;
...
template <typename T>
using ZoneGroupData = ProtectedDataZoneGroupArg<CheckZoneGroup<AllowedHelperThread::None>, T>;
...
enum class GlobalLock { GCLock, ExclusiveAccessLock, HelperThreadLock };
...
using ExclusiveAccessLockData = ProtectedDataNoCheckArgs<
    CheckGlobalLock<GlobalLock::ExclusiveAccessLock, AllowedHelperThread::None>, T>;
...
template <typename T>
using ExclusiveAccessLockOrGCTaskData = ProtectedDataNoCheckArgs<
    CheckGlobalLock<GlobalLock::ExclusiveAccessLock, AllowedHelperThread::GCTask>, T>;

// Data which may only be accessed while holding the helper thread lock.
template <typename T>
using HelperThreadLockData = ProtectedDataNoCheckArgs<
    CheckGlobalLock<GlobalLock::HelperThreadLock, AllowedHelperThread::None>, T>;
