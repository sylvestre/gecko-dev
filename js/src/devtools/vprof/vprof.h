...
#define _vprof(v, ...)                                                               \
    do {                                                                             \
        static void* id = 0;                                                         \
        if (id == 0) initValueProfile(&id, __FILE__, __LINE__, ##__VA_ARGS__, NULL); \
...
#define _hprof(v, n, ...)                                                               \
    do {                                                                                \
        static void* id = 0;                                                            \
        if (id == 0) initHistProfile(&id, __FILE__, __LINE__, (int)(n), ##__VA_ARGS__); \
...
#endif
    long
    _InterlockedCompareExchange(long volatile* Destination, long Exchange, long Comperand);
