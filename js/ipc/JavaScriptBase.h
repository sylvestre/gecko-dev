...
class JavaScriptBase : public WrapperOwner, public WrapperAnswer, public Base
{
 ...
 public:
  ...
  mozilla::ipc::IPCResult RecvGetPropertyDescriptor(const uint64_t& objId,
                                                    const JSIDVariant& id,
                                                    ReturnStatus* rs,
                                                    PPropertyDescriptor* out)
  {
    if (!Answer::RecvGetPropertyDescriptor(
            ObjectId::deserialize(objId), id, rs, out)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  }
  mozilla::ipc::IPCResult RecvGetOwnPropertyDescriptor(const uint64_t& objId,
                                                       ...
                                                       PPropertyDescriptor* out)
  {
    if (!Answer::RecvGetOwnPropertyDescriptor(
            ObjectId::deserialize(objId), id, rs, out)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  ...
  mozilla::ipc::IPCResult RecvDefineProperty(const uint64_t& objId,
                                             ...
                                             ReturnStatus* rs)
  {
    if (!Answer::RecvDefineProperty(
            ObjectId::deserialize(objId), id, flags, rs)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  }
  ...
  mozilla::ipc::IPCResult RecvHas(const uint64_t& objId,
                                  const JSIDVariant& id,
                                  ReturnStatus* rs,
                                  bool* bp)
  {
  ...
  {
    if (!Answer::RecvGet(
            ObjectId::deserialize(objId), receiverVar, id, rs, result)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  }
  mozilla::ipc::IPCResult RecvSet(const uint64_t& objId,
                                  const JSIDVariant& id,
  ...
  {
    if (!Answer::RecvSet(
            ObjectId::deserialize(objId), id, value, receiverVar, rs)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  }
  ...
  mozilla::ipc::IPCResult RecvCallOrConstruct(const uint64_t& objId,
  ...
  {
    if (!Answer::RecvCallOrConstruct(ObjectId::deserialize(objId),
                                     Move(argv),
                                     construct,
                                     rs,
                                     result,
  ...
  mozilla::ipc::IPCResult RecvGetBuiltinClass(const uint64_t& objId,
                                              ...
                                              uint32_t* classValue)
  {
    if (!Answer::RecvGetBuiltinClass(
            ObjectId::deserialize(objId), rs, classValue)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  }
  mozilla::ipc::IPCResult RecvIsArray(const uint64_t& objId,
                                      ReturnStatus* rs,
                                      uint32_t* answer)
  {
  ...
  mozilla::ipc::IPCResult RecvGetPrototype(const uint64_t& objId,
                                           ReturnStatus* rs,
  ...
  mozilla::ipc::IPCResult RecvGetPrototypeIfOrdinary(
      ...
      ObjectOrNullVariant* result)
  {
    if (!Answer::RecvGetPrototypeIfOrdinary(
            ObjectId::deserialize(objId), rs, isOrdinary, result)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  }
  mozilla::ipc::IPCResult RecvRegExpToShared(const uint64_t& objId,
                                             ...
                                             uint32_t* flags)
  {
    if (!Answer::RecvRegExpToShared(
            ObjectId::deserialize(objId), rs, source, flags)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  }

  mozilla::ipc::IPCResult RecvGetPropertyKeys(const uint64_t& objId,
                                              const uint32_t& flags,
                                              ReturnStatus* rs,
                                              nsTArray<JSIDVariant>* ids)
  {
    if (!Answer::RecvGetPropertyKeys(
            ObjectId::deserialize(objId), flags, rs, ids)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  }
  mozilla::ipc::IPCResult RecvInstanceOf(const uint64_t& objId,
                                         ...
                                         bool* instanceof)
  {
    if (!Answer::RecvInstanceOf(ObjectId::deserialize(objId), iid, rs,
                                instanceof)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  ...
  mozilla::ipc::IPCResult RecvDOMInstanceOf(const uint64_t& objId,
                                            ...
                                            bool* instanceof)
  {
    if (!Answer::RecvDOMInstanceOf(
            ObjectId::deserialize(objId), prototypeID, depth, rs, instanceof)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  }
  ...
  bool SendGetPropertyDescriptor(const ObjectId& objId,
                                 const JSIDVariant& id,
                                 ReturnStatus* rs,
                                 PPropertyDescriptor* out)
  {
  ...
  bool SendDefineProperty(const ObjectId& objId,
                          const JSIDVariant& id,
                          const PPropertyDescriptor& flags,
                          ReturnStatus* rs)
  {
  ...
  bool SendDelete(const ObjectId& objId,
                  const JSIDVariant& id,
                  ReturnStatus* rs)
  {
  ...
  bool SendHas(const ObjectId& objId,
               const JSIDVariant& id,
               ReturnStatus* rs,
               bool* bp)
  {
  ...
  bool SendHasOwn(const ObjectId& objId,
                  const JSIDVariant& id,
                  ReturnStatus* rs,
                  bool* bp)
  {
  ...
  bool SendGet(const ObjectId& objId,
               const JSVariant& receiverVar,
               const JSIDVariant& id,
               ReturnStatus* rs,
               JSVariant* result)
  ...
  bool SendSet(const ObjectId& objId,
               const JSIDVariant& id,
               const JSVariant& value,
               const JSVariant& receiverVar,
               ReturnStatus* rs)
  ...
  bool SendIsExtensible(const ObjectId& objId, ReturnStatus* rs, bool* result)
  {
    return Base::SendIsExtensible(objId.serialize(), rs, result);
  }
  bool SendCallOrConstruct(const ObjectId& objId,
                           ...
                           nsTArray<JSParam>* outparams)
  {
    return Base::SendCallOrConstruct(
        objId.serialize(), argv, construct, rs, result, outparams);
  }
  bool SendHasInstance(const ObjectId& objId,
                       const JSVariant& v,
                       ReturnStatus* rs,
                       bool* bp)
  {
  ...
  bool SendGetBuiltinClass(const ObjectId& objId,
                           ReturnStatus* rs,
                           uint32_t* classValue)
  {
  ...
  bool SendGetPrototype(const ObjectId& objId,
                        ReturnStatus* rs,
                        ObjectOrNullVariant* result)
  {
    return Base::SendGetPrototype(objId.serialize(), rs, result);
  }
  bool SendGetPrototypeIfOrdinary(const ObjectId& objId,
                                  ReturnStatus* rs,
                                  bool* isOrdinary,
                                  ObjectOrNullVariant* result)
  {
    return Base::SendGetPrototypeIfOrdinary(
        objId.serialize(), rs, isOrdinary, result);
  }

  bool SendRegExpToShared(const ObjectId& objId,
                          ReturnStatus* rs,
                          nsString* source,
                          uint32_t* flags)
  {
  ...
  bool SendGetPropertyKeys(const ObjectId& objId,
                           const uint32_t& flags,
                           ReturnStatus* rs,
                           nsTArray<JSIDVariant>* ids)
  {
  ...
  bool SendInstanceOf(const ObjectId& objId,
                      const JSIID& iid,
                      ReturnStatus* rs,
                      bool* instanceof)
  {
  ...
  bool SendDOMInstanceOf(const ObjectId& objId,
                         const int& prototypeID,
                         const int& depth,
                         ReturnStatus* rs,
                         bool* instanceof)
  ...
  virtual bool toObjectVariant(JSContext* cx,
                               JSObject* obj,
