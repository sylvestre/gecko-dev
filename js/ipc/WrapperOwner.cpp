...
bool
WrapperOwner::getPropertyDescriptor(JSContext* cx,
                                    HandleObject proxy,
                                    HandleId id,
...
bool
CPOWProxyHandler::getOwnPropertyDescriptor(
    JSContext* cx,
    HandleObject proxy,
    HandleId id,
    MutableHandle<PropertyDescriptor> desc) const
...
bool
WrapperOwner::getOwnPropertyDescriptor(JSContext* cx,
                                       HandleObject proxy,
                                       HandleId id,
                                       MutableHandle<PropertyDescriptor> desc)
{
...
bool
CPOWProxyHandler::defineProperty(JSContext* cx,
                                 HandleObject proxy,
                                 HandleId id,
                                 Handle<PropertyDescriptor> desc,
...
bool
WrapperOwner::defineProperty(JSContext* cx,
                             HandleObject proxy,
                             HandleId id,
                             Handle<PropertyDescriptor> desc,
...
bool
CPOWProxyHandler::ownPropertyKeys(JSContext* cx,
                                  HandleObject proxy,
...
bool
WrapperOwner::ownPropertyKeys(JSContext* cx,
                              HandleObject proxy,
                              AutoIdVector& props)
{
...
bool
CPOWProxyHandler::delete_(JSContext* cx,
                          HandleObject proxy,
                          HandleId id,
                          ObjectOpResult& result) const
{
...
bool
WrapperOwner::delete_(JSContext* cx,
                      HandleObject proxy,
                      HandleId id,
                      ObjectOpResult& result)
{
...
bool
CPOWProxyHandler::has(JSContext* cx,
                      HandleObject proxy,
                      HandleId id,
                      bool* bp) const
{
...
bool
CPOWProxyHandler::hasOwn(JSContext* cx,
                         HandleObject proxy,
                         HandleId id,
                         bool* bp) const
{
...
bool
CPOWProxyHandler::get(JSContext* cx,
                      HandleObject proxy,
                      HandleValue receiver,
                      HandleId id,
...
bool
CPOWProxyHandler::set(JSContext* cx,
                      JS::HandleObject proxy,
                      JS::HandleId id,
                      JS::HandleValue v,
                      JS::HandleValue receiver,
...
bool
CPOWProxyHandler::getOwnEnumerablePropertyKeys(JSContext* cx,
                                               HandleObject proxy,
                                               AutoIdVector& props) const
{
...
bool
WrapperOwner::getOwnEnumerablePropertyKeys(JSContext* cx,
                                           HandleObject proxy,
                                           AutoIdVector& props)
{
...
bool
CPOWProxyHandler::preventExtensions(JSContext* cx,
                                    HandleObject proxy,
                                    ObjectOpResult& result) const
{
...
bool
WrapperOwner::preventExtensions(JSContext* cx,
                                HandleObject proxy,
                                ObjectOpResult& result)
{
  ObjectId objId = idOf(proxy);
...
bool
CPOWProxyHandler::isExtensible(JSContext* cx,
                               HandleObject proxy,
...
bool
CPOWProxyHandler::call(JSContext* cx,
                       HandleObject proxy,
...
bool
CPOWProxyHandler::construct(JSContext* cx,
                            HandleObject proxy,
                            const CallArgs& args) const
{
...
bool
WrapperOwner::callOrConstruct(JSContext* cx,
                              HandleObject proxy,
                              const CallArgs& args,
                              bool construct)
{
  ...
  if (!SendCallOrConstruct(
          objId, vals, construct, &status, &result, &outparams))
    return ipcfail(cx);
...
bool
CPOWProxyHandler::hasInstance(JSContext* cx,
                              HandleObject proxy,
                              MutableHandleValue v,
                              bool* bp) const
{
...
bool
WrapperOwner::hasInstance(JSContext* cx,
                          HandleObject proxy,
                          MutableHandleValue v,
                          bool* bp)
{
...
bool
CPOWProxyHandler::getBuiltinClass(JSContext* cx,
                                  HandleObject proxy,
                                  ESClass* cls) const
{
...
bool
CPOWProxyHandler::isArray(JSContext* cx,
                          HandleObject proxy,
...
bool
CPOWProxyHandler::getPrototype(JSContext* cx,
                               HandleObject proxy,
...
bool
WrapperOwner::getPrototype(JSContext* cx,
                           HandleObject proxy,
...
bool
CPOWProxyHandler::getPrototypeIfOrdinary(JSContext* cx,
                                         HandleObject proxy,
                                         bool* isOrdinary,
                                         MutableHandleObject objp) const
{
...
bool
WrapperOwner::getPrototypeIfOrdinary(JSContext* cx,
                                     HandleObject proxy,
                                     bool* isOrdinary,
                                     MutableHandleObject objp)
{
...
bool
WrapperOwner::getPropertyKeys(JSContext* cx,
                              HandleObject proxy,
                              uint32_t flags,
                              AutoIdVector& props)
{
...
bool
DOMInstanceOf(
    JSContext* cx, JSObject* proxyArg, int prototypeID, int depth, bool* bp)
{
...
bool
WrapperOwner::toObjectVariant(JSContext* cx,
                              JSObject* objArg,
