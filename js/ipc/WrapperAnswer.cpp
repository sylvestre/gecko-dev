...
bool
WrapperAnswer::RecvGetPropertyDescriptor(const ObjectId& objId,
...
bool
WrapperAnswer::RecvGetOwnPropertyDescriptor(const ObjectId& objId,
                                            const JSIDVariant& idVar,
                                            ReturnStatus* rs,
                                            PPropertyDescriptor* out)
{
...
bool
WrapperAnswer::RecvDefineProperty(const ObjectId& objId,
                                  const JSIDVariant& idVar,
...
bool
WrapperAnswer::RecvDelete(const ObjectId& objId,
                          const JSIDVariant& idVar,
                          ReturnStatus* rs)
{
  MaybeForceDebugGC();
...
bool
WrapperAnswer::RecvHas(const ObjectId& objId,
                       const JSIDVariant& idVar,
                       ReturnStatus* rs,
                       bool* foundp)
{
...
bool
WrapperAnswer::RecvHasOwn(const ObjectId& objId,
                          const JSIDVariant& idVar,
                          ReturnStatus* rs,
                          bool* foundp)
{
...
bool
WrapperAnswer::RecvGet(const ObjectId& objId,
...
bool
WrapperAnswer::RecvSet(const ObjectId& objId,
                       const JSIDVariant& idVar,
...
bool
WrapperAnswer::RecvIsExtensible(const ObjectId& objId,
                                ReturnStatus* rs,
                                bool* result)
{
  MaybeForceDebugGC();
...
bool
WrapperAnswer::RecvHasInstance(const ObjectId& objId,
                               const JSVariant& vVar,
                               ReturnStatus* rs,
                               bool* bp)
{
  MaybeForceDebugGC();
...
bool
WrapperAnswer::RecvGetBuiltinClass(const ObjectId& objId,
                                   ReturnStatus* rs,
                                   uint32_t* classValue)
{
  MaybeForceDebugGC();
...
bool
WrapperAnswer::RecvIsArray(const ObjectId& objId,
                           ReturnStatus* rs,
                           uint32_t* ans)
{
  MaybeForceDebugGC();
...
bool
WrapperAnswer::RecvGetPrototype(const ObjectId& objId,
                                ReturnStatus* rs,
...
bool
WrapperAnswer::RecvGetPrototypeIfOrdinary(const ObjectId& objId,
                                          ReturnStatus* rs,
                                          bool* isOrdinary,
                                          ObjectOrNullVariant* result)
{
...
bool
WrapperAnswer::RecvRegExpToShared(const ObjectId& objId,
                                  ReturnStatus* rs,
                                  nsString* source,
                                  uint32_t* flags)
{
...
bool
WrapperAnswer::RecvGetPropertyKeys(const ObjectId& objId,
...
bool
WrapperAnswer::RecvInstanceOf(const ObjectId& objId,
                              const JSIID& iid,
                              ReturnStatus* rs,
                              bool* instanceof)
{
...
bool
WrapperAnswer::RecvDOMInstanceOf(const ObjectId& objId,
