...
class ObjectToIdMap
{
  ...
  using Table = JS::
      GCHashMap<JS::Heap<JSObject*>, ObjectId, Hasher, js::SystemAllocPolicy>;
...
class JavaScriptShared : public CPOWManager
{
 ...
 protected:
  ...
  bool fromDescriptor(JSContext* cx,
                      JS::Handle<JS::PropertyDescriptor> desc,
                      PPropertyDescriptor* out);
  bool toDescriptor(JSContext* cx,
                    const PPropertyDescriptor& in,
                    JS::MutableHandle<JS::PropertyDescriptor> out);

  bool toObjectOrNullVariant(JSContext* cx,
                             JSObject* obj,
  ...
  bool convertGeckoStringToId(JSContext* cx,
                              const nsString& from,
