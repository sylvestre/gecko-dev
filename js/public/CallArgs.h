    ...
    : public detail::CallArgsBase<detail::IncludeUsedRval>
{
 private:
  ...
  friend CallArgs CallArgsFromSp(unsigned stackSlots,
                                 Value* sp,
                                 bool constructing,
                                 bool ignoresReturnValue);

  static CallArgs create(unsigned argc,
                         Value* argv,
                         bool constructing,
 ...
 public:
  /*
     ...
     */
  JS_PUBLIC_API(bool)
  requireAtLeast(JSContext* cx, const char* fnname, unsigned required) const;
};
...
// JS::CallArgsFromVp!
MOZ_ALWAYS_INLINE CallArgs
CallArgsFromSp(unsigned stackSlots,
               Value* sp,
               bool constructing = false,
               bool ignoresReturnValue = false)
{
  return CallArgs::create(stackSlots - constructing,
                          sp - stackSlots,
                          constructing,
                          ignoresReturnValue);
}
