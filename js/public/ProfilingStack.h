...
class ProfileEntry
{
 ...
 public:
  ...
  void initCppFrame(const char* aLabel,
  ...
  void initJsFrame(const char* aLabel,
                   const char* aDynamicString,
                   JSScript* aScript,
                   jsbytecode* aPc)
  {
...
class PseudoStack
{
 public:
  ...
  void pushCppFrame(const char* label,
                    const char* dynamicString,
                    void* sp,
                    uint32_t line,
                    js::ProfileEntry::Kind kind,
                    js::ProfileEntry::Category category)
  {
    if (stackPointer < MaxEntries) {
      entries[stackPointer].initCppFrame(
          label, dynamicString, sp, line, kind, category);
    }
  ...
  void pushJsFrame(const char* label,
                   const char* dynamicString,
                   JSScript* script,
                   jsbytecode* pc)
  {
