...
class ObjectOpResult
{
 ...
 public:
  ...
  /*
     ...
     */
  bool checkStrictErrorOrWarning(JSContext* cx,
                                 HandleObject obj,
                                 HandleId id,
                                 bool strict)
  {
  ...
  JS_PUBLIC_API(bool)
  reportStrictErrorOrWarning(JSContext* cx,
                             HandleObject obj,
                             HandleId id,
                             bool strict);
  JS_PUBLIC_API(bool)
  reportStrictErrorOrWarning(JSContext* cx, HandleObject obj, bool strict);
...
typedef bool (*JSAddPropertyOp)(JSContext* cx,
                                JS::HandleObject obj,
                                JS::HandleId id,
                                JS::HandleValue v);
 ...
 */
typedef bool (*JSDeletePropertyOp)(JSContext* cx,
                                   JS::HandleObject obj,
                                   JS::HandleId id,
                                   JS::ObjectOpResult& result);
 ...
 */
typedef bool (*JSNewEnumerateOp)(JSContext* cx,
                                 JS::HandleObject obj,
 ...
 */
typedef JSString* (*JSFunToStringOp)(JSContext* cx,
                                     JS::HandleObject obj,
                                     bool isToSource);
 ...
 * on |obj|.
 */
typedef bool (*JSResolveOp)(JSContext* cx,
                            JS::HandleObject obj,
                            JS::HandleId id,
                            bool* resolvedp);
 ...
 * the object.
 */
typedef bool (*JSMayResolveOp)(const JSAtomState& names,
                               jsid id,
                               JSObject* maybeObj);
 ...
 * *bp otherwise.
 */
typedef bool (*JSHasInstanceOp)(JSContext* cx,
                                JS::HandleObject obj,
                                JS::MutableHandleValue vp,
                                bool* bp);
...
typedef bool (*LookupPropertyOp)(JSContext* cx,
                                 JS::HandleObject obj,
                                 JS::HandleId id,
                                 JS::MutableHandleObject objp,
                                 JS::MutableHandle<JS::PropertyResult> propp);
typedef bool (*DefinePropertyOp)(JSContext* cx,
                                 JS::HandleObject obj,
                                 JS::HandleId id,
                                 JS::Handle<JS::PropertyDescriptor> desc,
                                 JS::ObjectOpResult& result);
typedef bool (*HasPropertyOp)(JSContext* cx,
                              JS::HandleObject obj,
                              JS::HandleId id,
                              bool* foundp);
typedef bool (*GetPropertyOp)(JSContext* cx,
                              JS::HandleObject obj,
                              JS::HandleValue receiver,
                              JS::HandleId id,
                              JS::MutableHandleValue vp);
typedef bool (*SetPropertyOp)(JSContext* cx,
                              JS::HandleObject obj,
                              JS::HandleId id,
                              JS::HandleValue v,
                              JS::HandleValue receiver,
...
typedef bool (*DeletePropertyOp)(JSContext* cx,
                                 JS::HandleObject obj,
                                 JS::HandleId id,
                                 JS::ObjectOpResult& result);

typedef bool (*WatchOp)(JSContext* cx,
                        JS::HandleObject obj,
                        JS::HandleId id,
                        JS::HandleObject callable);

typedef bool (*UnwatchOp)(JSContext* cx, JS::HandleObject obj, JS::HandleId id);
...
typedef bool (*GetElementsOp)(JSContext* cx,
                              JS::HandleObject obj,
                              uint32_t begin,
                              uint32_t end,
                              ElementAdder* adder);
...
typedef bool (*FinishClassInitOp)(JSContext* cx,
