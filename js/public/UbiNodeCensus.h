...
struct CountType
{
  ...
  // instance's 'newCount' method.
  virtual MOZ_MUST_USE bool report(JSContext* cx,
                                   CountBase& count,
...
class CensusHandler
{
 ...
 public:
  ...
  MOZ_MUST_USE JS_PUBLIC_API(bool) operator()(
      BreadthFirst<CensusHandler>& traversal,
      Node origin,
      const Edge& edge,
...
MOZ_MUST_USE
JS_PUBLIC_API(bool) ParseCensusOptions(JSContext* cx,
                                       Census& census,
