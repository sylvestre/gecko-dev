...
class Builder
{
 ...
 public:
  ...
  class Object : private BuiltThing<JSObject*>
  {
    ...
    bool definePropertyToTrusted(JSContext* cx,
                                 const char* name,
...
class BuilderOrigin : public Builder
{
 ...
 public:
  BuilderOrigin(JSContext* cx, js::Debugger* debugger_) : Builder(cx, debugger_)
  {
  }
...
class MOZ_STACK_CLASS JS_PUBLIC_API(AutoEntryMonitor)
{
 ...
 public:
  ...
  virtual void Entry(JSContext* cx,
                     JSFunction* function,
