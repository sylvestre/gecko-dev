...
class XrayTraits
{
 public:
  ...
  static bool getBuiltinClass(JSContext* cx,
                              JS::HandleObject wrapper,
  ...
  static const char* className(JSContext* cx,
                               JS::HandleObject wrapper,
                               const js::Wrapper& baseInstance)
  {
  ...
  bool getExpandoObject(JSContext* cx,
                        JS::HandleObject target,
                        JS::HandleObject consumer,
                        JS::MutableHandleObject expandObject);
  JSObject* ensureExpandoObject(JSContext* cx,
                                JS::HandleObject wrapper,
                                JS::HandleObject target);
  ...
  bool cloneExpandoChain(JSContext* cx,
                         JS::HandleObject dst,
 ...
 private:
  ...
  bool getExpandoObjectInternal(JSContext* cx,
  ...
  JSObject* attachExpandoObject(JSContext* cx,
                                JS::HandleObject target,
                                JS::HandleObject exclusiveWrapper,
                                nsIPrincipal* origin);
...
class XPCWrappedNativeXrayTraits : public XrayTraits
{
 public:
  ...
  virtual bool enumerateNames(JSContext* cx,
                              JS::HandleObject wrapper,
                              unsigned flags,
                              JS::AutoIdVector& props);
  static bool call(JSContext* cx,
                   JS::HandleObject wrapper,
...
class DOMXrayTraits : public XrayTraits
{
 public:
  ...
  static bool getPrototype(JSContext* cx,
                           JS::HandleObject wrapper,
                           JS::HandleObject target,
...
class XrayWrapper : public Base
{
 ...
 private:
  ...
  bool getPrototypeHelper(JSContext* cx,
                          JS::HandleObject wrapper,
                          JS::HandleObject target,
                          JS::MutableHandleObject protop) const
  {
    return getPrototypeHelper<Traits::HasPrototype>(
        cx, wrapper, target, protop);
  }
