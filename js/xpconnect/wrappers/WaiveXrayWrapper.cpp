...
bool
WaiveXrayWrapper::getPropertyDescriptor(
    JSContext* cx,
    HandleObject wrapper,
    HandleId id,
    MutableHandle<PropertyDescriptor> desc) const
{
  return CrossCompartmentWrapper::getPropertyDescriptor(
             cx, wrapper, id, desc) &&
...
bool
WaiveXrayWrapper::getOwnPropertyDescriptor(
    JSContext* cx,
    HandleObject wrapper,
    HandleId id,
    MutableHandle<PropertyDescriptor> desc) const
{
  return CrossCompartmentWrapper::getOwnPropertyDescriptor(
             cx, wrapper, id, desc) &&
         WrapperFactory::WaiveXrayAndWrap(cx, desc.value()) &&
         WaiveAccessors(cx, desc);
}
...
bool
WaiveXrayWrapper::get(JSContext* cx,
                      HandleObject wrapper,
...
bool
WaiveXrayWrapper::call(JSContext* cx,
                       HandleObject wrapper,
...
bool
WaiveXrayWrapper::construct(JSContext* cx,
                            HandleObject wrapper,
                            const JS::CallArgs& args) const
{
...
bool
WaiveXrayWrapper::nativeCall(JSContext* cx,
...
bool
WaiveXrayWrapper::getPrototype(JSContext* cx,
                               HandleObject wrapper,
...
bool
WaiveXrayWrapper::getPrototypeIfOrdinary(JSContext* cx,
                                         HandleObject wrapper,
                                         bool* isOrdinary,
                                         MutableHandleObject protop) const
{
  return CrossCompartmentWrapper::getPrototypeIfOrdinary(
