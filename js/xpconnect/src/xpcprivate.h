...
static inline bool
IS_WN_CLASS(const js::Class* clazz)
{
  return clazz->isWrappedNative();
}

static inline bool
IS_WN_REFLECTOR(JSObject* obj)
{
...
class XPCJSRuntime final : public mozilla::CycleCollectedJSRuntime
{
 public:
  ...
  virtual bool DescribeCustomObjects(JSObject* aObject,
...
class MOZ_STACK_CLASS XPCCallContext final
{
 public:
  ...
  void SetCallInfo(XPCNativeInterface* iface,
...
// 4 classes?
static inline bool
IS_PROTO_CLASS(const js::Class* clazz)
{
  return clazz == &XPC_WN_NoMods_Proto_JSClass ||
         clazz == &XPC_WN_ModsAllowed_Proto_JSClass;
}

typedef js::HashSet<size_t, js::DefaultHasher<size_t>, js::SystemAllocPolicy>
...
class XPCWrappedNativeScope final
{
 public:
  ...
  bool SetExpandoChain(JSContext* cx,
  ...
  typedef js::
      HashSet<JSAddonId*, js::PointerHasher<JSAddonId*>, js::SystemAllocPolicy>
          AddonSet;
  ...
  static InterpositionWhitelist* GetInterpositionWhitelist(
      nsIAddonInterposition* interposition);
  static bool UpdateInterpositionWhitelist(
      JSContext* cx, nsIAddonInterposition* interposition);
...
class XPCNativeMember final
{
 public:
  ...
  bool GetConstantValue(XPCCallContext& ccx,
  ...
  bool NewFunctionObject(XPCCallContext& ccx,
                         XPCNativeInterface* iface,
 ...
 private:
  bool Resolve(XPCCallContext& ccx,
               XPCNativeInterface* iface,
               JS::HandleObject parent,
               JS::Value* vp);
...
#define XPC_WRAPPER_EXPIRED (intptr_t(0x2))
 ...
 public:
  ...
  static nsresult GetUsedOnly(nsISupports* Object,
                              XPCWrappedNativeScope* Scope,
                              XPCNativeInterface* Interface,
                              XPCWrappedNative** wrapper);
...
class nsXPCWrappedJSClass final : public nsIXPCWrappedJSClass
{
 ...
 public:
  ...
  NS_IMETHOD DelegatedQueryInterface(nsXPCWrappedJS* self,
                                     REFNSIID aIID,
                                     void** aInstancePtr);
 ...
 private:
  ...
  void CleanupOutparams(JSContext* cx,
                        uint16_t methodIndex,
                             ...
                             public XPCRootSetElem
{
 public:
  ...
  static nsresult GetNewOrUsed(JS::HandleObject aJSObj,
                               REFNSIID aIID,
...
class XPCConvert
{
 public:
  ...
  static bool JSData2Native(void* d,
                            JS::HandleValue s,
                            const nsXPTType& type,
                            const nsID* iid,
                            nsresult* pErr);
  ...
  static bool GetNativeInterfaceFromJSObject(void** dest,
                                             JSObject* src,
                                             const nsID* iid,
                                             nsresult* pErr);
  static bool JSObject2NativeInterface(void** dest,
                                       JS::HandleObject src,
                                       const nsID* iid,
                                       nsISupports* aOuter,
                                       nsresult* pErr);
  ...
  /**
     ...
     * @param pErr [out] relevant error code, if any.
     */
  static bool NativeArray2JS(JS::MutableHandleValue d,
                             const void** s,
                             const nsXPTType& type,
                             const nsID* iid,
                             uint32_t count,
  ...
  static bool JSArray2Native(void** d,
                             JS::HandleValue s,
                             uint32_t count,
                             const nsXPTType& type,
                             const nsID* iid,
  ...
  static bool NativeStringWithSize2JS(JS::MutableHandleValue d,
                                      const void* s,
                                      const nsXPTType& type,
                                      uint32_t count,
                                      nsresult* pErr);

  static bool JSStringWithSize2Native(void* d,
                                      JS::HandleValue s,
                                      uint32_t count,
                                      const nsXPTType& type,
                                      nsresult* pErr);
  ...
  static nsresult ConstructException(nsresult rv,
                                     const char* message,
                                     const char* ifaceName,
                                     const char* methodName,
                                     nsISupports* data,
...
class XPCThrower
{
 public:
  ...
  static void ThrowBadParam(nsresult rv,
                            unsigned paramNum,
                            XPCCallContext& ccx);
...
bool
NewFunctionForwarder(JSContext* cx,
                     JS::HandleId id,
...
// and used.
nsresult
CreateSandboxObject(JSContext* cx,
                    JS::MutableHandleValue vp,
...
nsresult
EvalInSandbox(JSContext* cx,
              JS::HandleObject sandbox,
...
nsresult
GetSandboxAddonId(JSContext* cx,
...
nsresult
GetSandboxMetadata(JSContext* cx,
                   JS::HandleObject sandboxArg,
                   JS::MutableHandleValue rval);

nsresult
SetSandboxMetadata(JSContext* cx,
                   JS::HandleObject sandboxArg,
                   JS::HandleValue metadata);

bool
CreateObjectIn(JSContext* cx,
               JS::HandleValue vobj,
               CreateObjectInOptions& options,
               JS::MutableHandleValue rval);

bool
EvalInWindow(JSContext* cx,
             const nsAString& source,
             JS::HandleObject scope,
             JS::MutableHandleValue rval);

bool
ExportFunction(JSContext* cx,
               JS::HandleValue vscope,
               JS::HandleValue vfunction,
               JS::HandleValue voptions,
               JS::MutableHandleValue rval);

bool
CloneInto(JSContext* cx,
          JS::HandleValue vobj,
          JS::HandleValue vscope,
          JS::HandleValue voptions,
          JS::MutableHandleValue rval);
...
JSObject*
NewOutObject(JSContext* cx);
bool
IsOutObject(JSContext* cx, JSObject* obj);

nsresult
HasInstance(JSContext* cx, JS::HandleObject objArg, const nsID* iid, bool* bp);
