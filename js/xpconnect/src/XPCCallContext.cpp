...
static inline bool
IsTearoffClass(const js::Class* clazz)
{
...
void
XPCCallContext::SetCallInfo(XPCNativeInterface* iface,
...
void
XPCCallContext::SetArgsAndResultPtr(unsigned argc, Value* argv, Value* rval)
{
  CHECK_STATE(HAVE_OBJECT);
