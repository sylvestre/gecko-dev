...
size_t
JSObject2WrappedJSMap::SizeOfIncludingThis(
...
size_t
Native2WrappedNativeMap::SizeOfIncludingThis(
    mozilla::MallocSizeOf mallocSizeOf) const
{
  size_t n = mallocSizeOf(this);
...
size_t
IID2NativeInterfaceMap::SizeOfIncludingThis(
    mozilla::MallocSizeOf mallocSizeOf) const
{
  size_t n = mallocSizeOf(this);
  n += mTable.ShallowSizeOfExcludingThis(mallocSizeOf);
...
// static
bool
ClassInfo2NativeSetMap::Entry::Match(const PLDHashEntryHdr* aEntry,
                                     const void* aKey)
{
...
// static
void
ClassInfo2NativeSetMap::Entry::Clear(PLDHashTable* aTable,
...
size_t
ClassInfo2NativeSetMap::ShallowSizeOfIncludingThis(
...
size_t
ClassInfo2WrappedNativeProtoMap::SizeOfIncludingThis(
    mozilla::MallocSizeOf mallocSizeOf) const
{
  size_t n = mallocSizeOf(this);
  n += mTable.ShallowSizeOfExcludingThis(mallocSizeOf);
