...
NS_IMETHODIMP
nsXPCComponents_ID::Call(nsIXPConnectWrappedNative* wrapper,
                         JSContext* cx,
                         JSObject* objArg,
                         const CallArgs& args,
                         bool* _retval)
...
NS_IMETHODIMP
nsXPCComponents_ID::Construct(nsIXPConnectWrappedNative* wrapper,
                              JSContext* cx,
                              JSObject* objArg,
                              const CallArgs& args,
                              bool* _retval)
...
struct MOZ_STACK_CLASS ExceptionArgParser
{
 ...
 protected:
  ...
  bool parseData(HandleValue v)
  {
    ...
    return NS_SUCCEEDED(xpc->WrapJS(
        cx, &v.toObject(), NS_GET_IID(nsISupports), getter_AddRefs(eData)));
  }
                                           ...
                                           bool* _retval)
{
  ...
  if (NS_FAILED(xpc->WrapNative(
          cx, obj, e, NS_GET_IID(nsIXPCException), newObj.address())) ||
      !newObj) {
...
NS_IMETHODIMP
nsXPCConstructor::Call(nsIXPConnectWrappedNative* wrapper,
                       JSContext* cx,
                       JSObject* objArg,
                       const CallArgs& args,
                       bool* _retval)
...
NS_IMETHODIMP
nsXPCConstructor::Construct(nsIXPConnectWrappedNative* wrapper,
                            JSContext* cx,
                            JSObject* objArg,
                            const CallArgs& args,
                            bool* _retval)
                                  ...
                                  bool* _retval)
{
  ...
  if (NS_FAILED(xpc->WrapNative(
          cx, obj, mClassID, NS_GET_IID(nsIJSCID), cidObj.address())) ||
      !cidObj ||
      NS_FAILED(xpc->WrapNative(
          cx, obj, mInterfaceID, NS_GET_IID(nsIJSIID), iidObj.address())) ||
      !iidObj) {
    return ThrowAndFail(NS_ERROR_XPC_CANT_CREATE_WN, cx, _retval);
  }
  ...
  if (!JS_CallFunctionName(
          cx, cidObj, "createInstance", JS::HandleValueArray(arg), &rval) ||
      rval.isPrimitive()) {
                                             ...
                                             bool* _retval)
{
  ...
  if (args.length() >= 2) {
    ...
    nsCOMPtr<nsIXPConnectWrappedNative> wn;
    if (NS_FAILED(xpc->GetWrappedNativeOfJSObject(
            cx, &val.toObject(), getter_AddRefs(wn))) ||
  ...
  // a new scope to avoid warnings about shadowed names
  {
    ...
    nsCOMPtr<nsIXPConnectWrappedNative> wn;
    if (NS_FAILED(xpc->GetWrappedNativeOfJSObject(
            cx, val.toObjectOrNull(), getter_AddRefs(wn))) ||
  ...
  if (NS_FAILED(xpc->WrapNative(
          cx, obj, ctor, NS_GET_IID(nsIXPCConstructor), newObj.address())) ||
      !newObj) {
    return ThrowAndFail(NS_ERROR_XPC_CANT_CREATE_WN, cx, _retval);
  }
...
nsXPCComponents_Utils::ReportError(HandleValue error, JSContext* cx)
{
  ...
  nsresult rv = scripterr->InitWithWindowID(msg,
                                            fileName,
                                            EmptyString(),
                                            lineNo,
                                            0,
                                     ...
                                     MutableHandleValue retval)
{
  ...
  if (optionalArgc >= 1) {
    ...
    if (!jsVersionStr) return NS_ERROR_INVALID_ARG;

    JSAutoByteString bytes(cx, jsVersionStr);
    if (!bytes) return NS_ERROR_INVALID_ARG;
  ...
  return xpc::EvalInSandbox(
      cx, sandbox, source, filename, lineNo, jsVersion, retval);
}
                              ...
                              MutableHandleValue retval)
{
  ...
  AUTO_PROFILER_LABEL_DYNAMIC(
      "nsXPCComponents_Utils::Import", OTHER, flatLocation.get());
#endif

  return moduleloader->Import(
      registryLocation, targetObj, cx, optionalArgc, retval);
}
...
NS_IMETHODIMP
nsXPCComponents_Utils::GetWeakReference(HandleValue object,
                                        JSContext* cx,
                                                  ...
                                                  MutableHandleValue retval)
{
  ...
  if (!JS_CallFunctionValue(
          cx, nullptr, function, JS::HandleValueArray::empty(), retval)) {
...
NS_IMETHODIMP
nsXPCComponents_Utils::ExportFunction(HandleValue vfunction,
                                      HandleValue vscope,
                                      HandleValue voptions,
                                      JSContext* cx,
                                      MutableHandleValue rval)
{
...
NS_IMETHODIMP
nsXPCComponents_Utils::CreateObjectIn(HandleValue vobj,
                                      HandleValue voptions,
                                      JSContext* cx,
                                      MutableHandleValue rval)
{
...
nsXPCComponents_Utils::RecomputeWrappers(HandleValue vobj, JSContext* cx)
{
  ...
  // Otherwise, recompute wrappers for the given compartment.
    ...
    js::RecomputeWrappers(
        cx, js::SingleCompartment(c), js::AllCompartments()) &&
        js::RecomputeWrappers(
            cx, js::AllCompartments(), js::SingleCompartment(c));
...
NS_IMETHODIMP
nsXPCComponents_Utils::GetComponentsForScope(HandleValue vscope,
                                             JSContext* cx,
                                             MutableHandleValue rval)
{
  if (!vscope.isObject()) return NS_ERROR_INVALID_ARG;
...
NS_IMETHODIMP
nsXPCComponents_Utils::Dispatch(HandleValue runnableArg,
                                HandleValue scope,
                                JSContext* cx)
{
                                            ...
                                            JSContext* cx)
{
  ...
  RootedObject global(cx,
                      UncheckedUnwrap(&globalArg.toObject(),
...
NS_IMETHODIMP
nsXPCComponents_Utils::WaiveXrays(HandleValue aVal,
                                  JSContext* aCx,
...
NS_IMETHODIMP
nsXPCComponents_Utils::UnwaiveXrays(HandleValue aVal,
                                    JSContext* aCx,
                                    MutableHandleValue aRetval)
{
  if (!aVal.isObject()) {
...
NS_IMETHODIMP
nsXPCComponents_Utils::GetClassName(HandleValue aObj,
                                    bool aUnwrap,
                                    JSContext* aCx,
                                    char** aRv)
{
                                          ...
                                          MutableHandleValue aOut)
{
  ...
  if (aCallback.isObject()) {
    ...
    if (!JS_CallFunctionValue(
            aCx, nullptr, aCallback, JS::HandleValueArray(globalVal), &ignored))
      return NS_ERROR_FAILURE;
  }
...
NS_INTERFACE_TABLE_HEAD(WrappedJSHolder)
  ...
  bool xpc::CloneInto(JSContext * aCx,
                      HandleValue aValue,
                      HandleValue aScope,
                      HandleValue aOptions,
  ...
  NS_IMETHODIMP
  nsXPCComponents_Utils::CloneInto(HandleValue aValue,
                                   HandleValue aScope,
                                   HandleValue aOptions,
                                   JSContext * aCx,
                                   MutableHandleValue aCloned)
  ...
  nsXPCComponents_Utils::GetWebIDLCallerPrincipal(nsIPrincipal * *aResult)
  {
    ...
    // and we throw.
    nsCOMPtr<nsIPrincipal> callerPrin =
        mozilla::dom::GetWebIDLCallerPrincipal();
  ...
  NS_IMETHODIMP
  nsXPCComponents_Utils::GetObjectPrincipal(
      HandleValue val, JSContext * cx, nsIPrincipal * *result)
  {
  ...
  nsXPCComponents_Utils::GetCompartmentLocation(
      HandleValue val, JSContext * cx, nsACString & result)
  {
    if (!val.isObject()) return NS_ERROR_INVALID_ARG;
    RootedObject obj(cx, &val.toObject());
    obj = js::CheckedUnwrap(obj);
  ...
  NS_IMETHODIMP
  nsXPCComponents_Utils::SetAddonInterposition(
      const nsACString& addonIdStr,
      nsIAddonInterposition* interposition,
      JSContext* cx)
  {
    JSAddonId* addonId = xpc::NewAddonId(cx, addonIdStr);
    if (!addonId) return NS_ERROR_FAILURE;
    if (!XPCWrappedNativeScope::SetAddonInterposition(
            cx, addonId, interposition))
      return NS_ERROR_FAILURE;
  ...
  NS_IMETHODIMP
  nsXPCComponents_Utils::AllowCPOWsInAddon(
      const nsACString& addonIdStr, bool allow, JSContext* cx)
  {
    JSAddonId* addonId = xpc::NewAddonId(cx, addonIdStr);
    if (!addonId) return NS_ERROR_FAILURE;
...
#undef XPC_IMPL_GET_OBJ_METHOD
  ...
  NS_IMETHODIMP_(MozExternalRefCountType) ComponentsSH::AddRef(void)
  {
    return 1;
  }
...
#include "xpc_map_end.h" /* This will #undef the above */
  ...
  NS_IMETHODIMP
  ComponentsSH::PreCreate(nsISupports * nativeObj,
                          JSContext * cx,
                          JSObject * globalObj,
                          JSObject * *parentObj)
  {
