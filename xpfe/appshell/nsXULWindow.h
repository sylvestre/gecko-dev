                    ...
                    public nsSupportsWeakReference
{
 ...
 protected:
  ...
  void OnChromeLoaded();
  void StaggerPosition(int32_t& aRequestedX,
                       int32_t& aRequestedY,
                       int32_t aSpecWidth,
                       int32_t aSpecHeight);
  ...
  NS_IMETHOD SizeShellTo(nsIDocShellTreeItem* aShellItem,
                         int32_t aCX,
                         int32_t aCY);
  ...
  bool ConstrainToZLevel(bool aImmediate,
                         nsWindowZ* aPlacement,
                         nsIWidget* aReqBelow,
                         nsIWidget** aActualBelow);
  void PlaceWindowLayersBehind(uint32_t aLowLevel,
                               uint32_t aHighLevel,
