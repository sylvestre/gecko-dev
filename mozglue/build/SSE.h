...
supports_mmx()
{
  return sse_private::mmx_enabled;
}
#else
inline bool
supports_mmx()
...
supports_sse()
{
  return sse_private::sse_enabled;
}
#else
inline bool
supports_sse()
...
supports_sse2()
{
  return sse_private::sse2_enabled;
}
#else
inline bool
supports_sse2()
...
supports_sse3()
{
  return sse_private::sse3_enabled;
}
#else
inline bool
supports_sse3()
...
supports_ssse3()
{
  return sse_private::ssse3_enabled;
}
#else
inline bool
supports_ssse3()
...
supports_sse4a()
{
  return sse_private::sse4a_enabled;
}
#else
inline bool
supports_sse4a()
...
supports_sse4_1()
{
  return sse_private::sse4_1_enabled;
}
#else
inline bool
supports_sse4_1()
...
supports_sse4_2()
{
  return sse_private::sse4_2_enabled;
}
#else
inline bool
supports_sse4_2()
...
supports_avx()
{
  return sse_private::avx_enabled;
}
#else
inline bool
supports_avx()
...
supports_avx2()
{
  return sse_private::avx2_enabled;
}
#else
inline bool
supports_avx2()
...
supports_aes()
{
  return sse_private::aes_enabled;
}
#else
inline bool
supports_aes()
