...
int
setup_nss_functions(void* nss_handle, void* nspr_handle, void* plc_handle)
{
...
Java_org_mozilla_gecko_NSSBridge_nativeEncrypt(JNIEnv* jenv,
                                               jclass,
                                               jstring jPath,
                                               jstring jValue)
{
...
extern "C" APKOPEN_EXPORT jstring MOZ_JNICALL
Java_org_mozilla_gecko_NSSBridge_nativeDecrypt(JNIEnv* jenv,
                                               jclass,
                                               jstring jPath,
                                               jstring jValue)
{
