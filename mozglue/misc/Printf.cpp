 ...
 */
bool
mozilla::PrintfTarget::fill_n(
    const char* src, int srclen, int width, int prec, int type, int flags)
{
  int zerowidth = 0;
  int precwidth = 0;
  int signwidth = 0;
...
bool
mozilla::PrintfTarget::cvt_l(long num,
                             int width,
                             int prec,
                             int radix,
                             int type,
...
bool
mozilla::PrintfTarget::cvt_ll(int64_t num,
                              int width,
                              int prec,
                              int radix,
                              int type,
