...
class MessageChannel : HasResultCodes, MessageLoop::DestructionObserver
{
  ...
  struct PromiseHolder
  {
    ...
    std::function<void(
        MozPromiseRefcountable*, PromiseRejectReason, const char*)>
        mRejectFunction;
  };
 ...
 public:
  ...
  bool Open(Transport* aTransport,
  ...
  bool Open(MessageChannel* aTargetChan,
 ...
 private:
  ...
  bool MaybeHandleError(Result code,
                        const Message& aMsg,
  ...
  void DebugAbort(const char* file,
                  int line,
                  const char* cond,
                  const char* why,
                  bool reply = false);
...
struct ParamTraits<mozilla::ipc::PromiseRejectReason>
    : public ContiguousEnumSerializer<
          mozilla::ipc::PromiseRejectReason,
