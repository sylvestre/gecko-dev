...
class ChildImpl::ActorCreatedRunnable final : public CancelableRunnable
{
...
ParentImpl::Destroy()
{
  ...
  MOZ_ALWAYS_SUCCEEDS(NS_DispatchToMainThread(
      NewNonOwningRunnableMethod("ParentImpl::MainThreadActorDestroy",
                                 this,
...
ChildImpl::GetOrCreateForCurrentThread()
{
  ...
  rv = PBackground::CreateEndpoints(
      content->OtherPid(), base::GetCurrentProcId(), &parent, &child);
  if (NS_FAILED(rv)) {
