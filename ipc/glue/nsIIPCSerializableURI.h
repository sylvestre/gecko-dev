...
class NS_NO_VTABLE nsIIPCSerializableURI : public nsISupports
{
 public:
  ...
  virtual bool Deserialize(const mozilla::ipc::URIParams& aParams) = 0;
};
...
#define NS_DECL_NSIIPCSERIALIZABLEURI                        \
  ...
  virtual bool Deserialize(const mozilla::ipc::URIParams&) override;
...
#define NS_FORWARD_NSIIPCSERIALIZABLEURI(_to)                               \
  ...
  virtual bool Deserialize(const mozilla::ipc::URIParams& aParams) override \
  {                                                                         \
