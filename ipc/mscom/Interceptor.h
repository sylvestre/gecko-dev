...
{
 public:
  static HRESULT Create(STAUniquePtr<IUnknown> aTarget,
  ...
  // IStdMarshalInfo
  STDMETHODIMP GetClassForHandler(DWORD aDestContext,
 ...
 private:
  ...
  HRESULT QueryInterfaceTarget(REFIID aIid,
                               void** aOutput,
                  ...
                  InterfaceT** aOutInterface)
{
  ...
  return Interceptor::Create(
      Move(targetUnknown), aEventSink, iidTarget, (void**)aOutInterface);
}
