...
class TestDataStructuresParent : public PTestDataStructuresParent
{
 ...
 protected:
  ...
  virtual mozilla::ipc::IPCResult RecvTest7(const Actors& i1,
                                            const Actors& i2,
                                            const Actors& i3,
                                            Actors* o1,
                                            Actors* o2,
  ...
  virtual mozilla::ipc::IPCResult RecvTest9(const Unions& i1,
                                            const Unions& i2,
                                            const Unions& i3,
                                            const Unions& i4,
                                            Unions* o1,
  ...
  virtual mozilla::ipc::IPCResult RecvTest15(const WithStructs& i1,
