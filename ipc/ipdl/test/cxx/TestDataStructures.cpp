...
bool
TestDataStructuresParent::DeallocPTestDataStructuresSubParent(
...
TestDataStructuresParent::RecvTest1(InfallibleTArray<int>&& ia,
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest2(
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest3(const IntDouble& i1,
                                    const IntDouble& i2,
                                    IntDouble* o1,
                                    IntDouble* o2)
{
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest4(InfallibleTArray<IntDouble>&& i1,
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest5(const IntDoubleArrays& i1,
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest7_0(const ActorWrapper& i1, ActorWrapper* o1)
{
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest6(InfallibleTArray<IntDoubleArrays>&& i1,
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest7(const Actors& i1,
                                    const Actors& i2,
                                    const Actors& i3,
                                    Actors* o1,
                                    Actors* o2,
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest8(InfallibleTArray<Actors>&& i1,
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest9(const Unions& i1,
                                    const Unions& i2,
                                    const Unions& i3,
                                    const Unions& i4,
                                    Unions* o1,
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest10(InfallibleTArray<Unions>&& i1,
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest11(const SIntDouble& i, SIntDouble* o)
{
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest12(const SIntDoubleArrays& i,
                                     SIntDoubleArrays* o)
{
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest13(const SActors& i, SActors* o)
{
  InfallibleTArray<int> ai;
  ai.AppendElement(1);
  ai.AppendElement(2);
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest14(const Structs& i, Structs* o)
{
  InfallibleTArray<int> ai;
  ai.AppendElement(1);
  ai.AppendElement(2);
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest15(const WithStructs& i1,
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest16(const WithUnions& i, WithUnions* o)
{
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest17(InfallibleTArray<Op>&& sa)
{
...
mozilla::ipc::IPCResult
TestDataStructuresParent::RecvTest18(RegionArray&& ra)
{
...
TestDataStructuresChild::Test9()
{
  ...
  Unions o1, o2, o3, o4;
  if (!SendTest9(
          i1, Unions(i2a), Unions(mKids), Unions(i4a), &o1, &o2, &o3, &o4))
