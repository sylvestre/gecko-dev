...
static const char gScheme[][sizeof("moz-safe-about")] = {"chrome",
                                                         "file",
                                                         "http",
                                                         "https",
                                                         "jar",
                          ...
                          public nsIIOServiceInternal
{
 public:
  ...
  nsresult Init();
  nsresult NewURI(const char* aSpec,
                  nsIURI* aBaseURI,
                  nsIURI** result,
  ...
  // redirect observers.
  nsresult AsyncOnChannelRedirect(nsIChannel* oldChan,
                                  nsIChannel* newChan,
                                  uint32_t flags,
 ...
 private:
  ...
  void LookupProxyInfo(nsIURI* aURI,
                       nsIURI* aProxyURI,
