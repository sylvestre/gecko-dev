...
void
Tickler::PostCheckTickler()
{
  mLock.AssertCurrentThreadOwns();
  mThread->Dispatch(
      NewRunnableMethod(
          "net::Tickler::CheckTickler", this, &Tickler::CheckTickler),
      NS_DISPATCH_NORMAL);
  return;
}
...
void
Tickler::SetIPV4Address(uint32_t address)
{
...
// argument should be in network byte order
void
Tickler::SetIPV4Port(uint16_t port)
{
...
NS_IMETHODIMP
TicklerTimer::Notify(nsITimer* timer)
{
