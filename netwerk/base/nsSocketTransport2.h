...
class nsSocketOutputStream : public nsIAsyncOutputStream
{
 ...
 private:
  static nsresult WriteFromSegments(nsIInputStream*,
                                    void*,
                                    const char*,
                                    uint32_t offset,
                                    uint32_t count,
                                ...
                                public nsIInterfaceRequestor
{
 public:
  ...
  nsresult Init(const char** socketTypes,
                uint32_t typeCount,
  ...
  // info).
  nsresult InitPreResolved(const char** socketTypes,
                           uint32_t typeCount,
                           const nsACString& host,
                           uint16_t port,
                           const nsACString& hostRoute,
 ...
 private:
  ...
  nsresult PostEvent(uint32_t type,
  ...
  class MOZ_STACK_CLASS PRFileDescAutoLock
  {
   public:
    ...
    nsresult SetKeepaliveVals(bool aEnabled,
                              int aIdleTime,
                              int aRetryInterval,
                              int aProbeCount);
