...
#endif
{
 ...
 public: /* internal -- HPUX compiler can't handle this being private */
  ...
  struct URLSegment
  {
    ...
    // is 'bar'.
    void Merge(const nsCString& spec,
 ...
 protected:
  ...
  nsresult CopyMembers(nsStandardURL* source,
 ...
 private:
  ...
  uint32_t AppendSegmentToBuf(char*,
                              uint32_t,
                              const char*,
                              const URLSegment& input,
                              URLSegment& output,
                              const nsCString* esc = nullptr,
                              bool useEsc = false,
                              int32_t* diff = nullptr);
  ...
  bool SegmentIs(const URLSegment& s1,
                 const char* val,
                 bool ignoreCase = false);
  bool SegmentIs(const char* spec,
                 const URLSegment& s1,
                 const char* val,
                 bool ignoreCase = false);
  bool SegmentIs(const URLSegment& s1,
  ...
  int32_t ReplaceSegment(uint32_t pos,
                         uint32_t len,
                         const char* val,
                         uint32_t valLen);
