                  ...
                  public nsINetworkPredictorVerifier
{
 public:
  ...
  static void UpdateCacheability(nsIURI* sourceURI,
                                 nsIURI* targetURI,
                                 uint32_t httpStatus,
 ...
 private:
                             ...
                             public nsICacheEntryMetaDataVisitor
  {
   public:
    ...
    CacheabilityAction(nsIURI* targetURI,
                       uint32_t httpStatus,
  ...
  class PrefetchListener : public nsIStreamListener
  {
   public:
    ...
    PrefetchListener(nsINetworkPredictorVerifier* verifier,
                     nsIURI* uri,
                     Predictor* predictor)
  ...
  bool PredictInternal(PredictorPredictReason reason,
                       nsICacheEntry* entry,
                       bool isNew,
                       bool fullUri,
                       nsIURI* targetURI,
  ...
  void UpdateRollingLoadCount(nsICacheEntry* entry,
  ...
  //                         this page
  int32_t CalculateConfidence(uint32_t hitCount,
  ...
  void CalculatePredictions(nsICacheEntry* entry,
                            nsIURI* referrer,
                            uint32_t lastLoad,
                            uint32_t loadCount,
                            int32_t globalDegradation,
  ...
  void SetupPrediction(int32_t confidence,
                       uint32_t flags,
                       const nsCString& uri);
  ...
  bool WouldRedirect(nsICacheEntry* entry,
                     uint32_t loadCount,
                     uint32_t lastLoad,
                     int32_t globalDegradation,
                     nsIURI** redirectURI);
  ...
  void LearnInternal(PredictorLearnReason reason,
                     nsICacheEntry* entry,
                     bool isNew,
                     bool fullUri,
                     nsIURI* targetURI,
  ...
  void MaybeLearnForStartup(nsIURI* uri,
                            bool fullUri,
                            const OriginAttributes& originAttributes);
  ...
  bool ParseMetaDataEntry(const char* key,
                          const char* value,
                          nsCString& uri,
                          uint32_t& hitCount,
                          uint32_t& lastHit,
  ...
  // sourceURI and targetURI are the same as the arguments to Learn
  // and httpStatus is the status code we got while loading targetURI.
  void UpdateCacheabilityInternal(nsIURI* sourceURI,
                                  nsIURI* targetURI,
                                  uint32_t httpStatus,
                                  const nsCString& method,
                                  const OriginAttributes& originAttributes,
