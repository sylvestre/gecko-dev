...
NS_IMETHODIMP
RustURL::GetAsciiSpec(nsACString& aAsciiSpec) { return GetSpec(aAsciiSpec); }
...
NS_IMETHODIMP
RustURL::GetAsciiHost(nsACString& aAsciiHost) { return GetHost(aAsciiHost); }
...
NS_IMETHODIMP
RustURL::GetFileName(nsACString& aFileName) { return NS_ERROR_NOT_IMPLEMENTED; }
...
NS_IMETHODIMP
RustURL::GetFile(nsIFile** aFile) { return NS_ERROR_NOT_IMPLEMENTED; }
...
NS_IMETHODIMP
RustURL::Init(uint32_t aUrlType,
...
NS_IMETHODIMP
RustURL::GetClassID(nsCID** aClassID) { return NS_ERROR_NOT_IMPLEMENTED; }
