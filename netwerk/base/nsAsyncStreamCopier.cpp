...
class AsyncApplyBufferingPolicyEvent final : public Runnable
{
 public:
  ...
  NS_IMETHOD Run() override
  {
    ...
    rv = mTarget->Dispatch(
        NewRunnableMethod("nsAsyncStreamCopier::AsyncCopyInternal",
                          mCopier,
...
NS_INTERFACE_TABLE_HEAD(nsAsyncStreamCopier)
  NS_INTERFACE_TABLE_BEGIN
    ...
    NS_INTERFACE_TABLE_ENTRY_AMBIGUOUS(
        nsAsyncStreamCopier, nsIRequest, nsIAsyncStreamCopier)
    NS_INTERFACE_TABLE_ENTRY_AMBIGUOUS(
        nsAsyncStreamCopier, nsISupports, nsIAsyncStreamCopier)
                            ...
                            bool closeSink)
  {
    ...
    return InitInternal(
        source, sink, target, chunkSize, closeSource, closeSink);
  }
 ...
 */
  ...
  NS_IMETHODIMP
  nsAsyncStreamCopier::AsyncCopy(nsIRequestObserver * observer,
                                 nsISupports * ctx)
  {
