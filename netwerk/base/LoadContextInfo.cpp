...
NS_IMETHODIMP
LoadContextInfo::GetOriginAttributes(JSContext* aCx,
...
NS_IMETHODIMP
LoadContextInfoFactory::GetDefault(nsILoadContextInfo** aDefault)
{
...
NS_IMETHODIMP
LoadContextInfoFactory::GetPrivate(nsILoadContextInfo** aPrivate)
{
...
NS_IMETHODIMP
LoadContextInfoFactory::GetAnonymous(nsILoadContextInfo** aAnonymous)
{
  nsCOMPtr<nsILoadContextInfo> info =
...
NS_IMETHODIMP
LoadContextInfoFactory::Custom(bool aAnonymous,
...
NS_IMETHODIMP
LoadContextInfoFactory::FromLoadContext(nsILoadContext* aLoadContext,
                                        bool aAnonymous,
                                        nsILoadContextInfo** _retval)
{
  nsCOMPtr<nsILoadContextInfo> info =
...
NS_IMETHODIMP
LoadContextInfoFactory::FromWindow(nsIDOMWindow* aWindow,
                                   bool aAnonymous,
                                   nsILoadContextInfo** _retval)
{
...
LoadContextInfo*
GetLoadContextInfo(nsIDOMWindow* aWindow, bool aIsAnonymous)
{
