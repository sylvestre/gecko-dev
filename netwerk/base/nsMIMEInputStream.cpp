...
NS_IMPL_CLASSINFO(nsMIMEInputStream,
                  nullptr,
...
nsresult
nsMIMEInputStream::ReadSegCb(nsIInputStream* aIn,
                             void* aClosure,
                             const char* aFromRawSegment,
                             uint32_t aToOffset,
                             uint32_t aCount,
...
NS_IMETHODIMP
nsMIMEInputStream::Read(char* buf, uint32_t count, uint32_t* _retval)
{
  INITSTREAMS;
                             ...
                             FileDescriptorArray& aFileDescriptors)
{
  ...
  if (mStream) {
    ...
    InputStreamHelper::SerializeInputStream(
        mStream, wrappedParams, aFileDescriptors);
