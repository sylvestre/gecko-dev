                              ...
                              public nsIMemoryReporter
{
 ...
 public:
  ...
  static bool CanSetCookie(nsIURI* aHostURI,
                           ...
                           bool aFromHttp,
                           nsIChannel* aChannel,
                           bool aLeaveSercureAlone,
                           bool& aSetCookie,
                           mozIThirdPartyUtil* aThirdPartyUtil);
  static CookieStatus CheckPrefs(nsICookiePermission* aPermissionServices,
  ...
  void GetCookiesForURI(nsIURI* aHostURI,
                        bool aIsForeign,
                        bool aHttpBound,
                        const OriginAttributes& aOriginAttrs,
 ...
 protected:
  ...
  OpenDBResult Read();
  template<class T>
  nsCookie* GetCookieFromRow(T& aRow,
  ...
  nsresult GetCookieStringCommon(nsIURI* aHostURI,
                                 nsIChannel* aChannel,
                                 bool aHttpBound,
                                 char** aCookie);
  void GetCookieStringInternal(nsIURI* aHostURI,
                               bool aIsForeign,
                               bool aHttpBound,
                               const OriginAttributes& aOriginAttrs,
                               nsCString& aCookie);
  nsresult SetCookieStringCommon(nsIURI* aHostURI,
                                 ...
                                 nsIChannel* aChannel,
                                 bool aFromHttp);
  void SetCookieStringInternal(nsIURI* aHostURI,
                               bool aIsForeign,
                               nsDependentCString& aCookieHeader,
                               ...
                               const OriginAttributes& aOriginAttrs,
                               nsIChannel* aChannel);
  bool SetCookieInternal(nsIURI* aHostURI,
                         const nsCookieKey& aKey,
                         bool aRequireHostMatch,
                         CookieStatus aStatus,
                         nsDependentCString& aCookieHeader,
                         ...
                         bool aFromHttp,
                         nsIChannel* aChannel);
  void AddInternal(const nsCookieKey& aKey,
                   nsCookie* aCookie,
  ...
  void AddCookieToList(const nsCookieKey& aKey,
                       nsCookie* aCookie,
                       DBState* aDBState,
                       mozIStorageBindingParamsArray* aParamsArray,
                       bool aWriteToDB = true);
  void UpdateCookieInList(nsCookie* aCookie,
  ...
  /**
     ...
     */
  nsresult Remove(const nsACString& aHost,
 ...
 protected:
  ...
  // cached prefs
  uint8_t
      mCookieBehavior;  // BEHAVIOR_{ACCEPT, REJECTFOREIGN, REJECT, LIMITFOREIGN}
