                           ...
                           public nsAHttpSegmentWriter
{
 ...
 public:
  ...
  MOZ_MUST_USE bool AddStream(nsAHttpTransaction*,
                              int32_t,
                              bool,
...
*/
  ...
  void CreateFrameHeader(charType dest,
  ...
  static void LogIO(
      Http2Session*, Http2Stream*, const char*, const char*, uint32_t);
  ...
  MOZ_MUST_USE nsresult ReadSegmentsAgain(nsAHttpSegmentReader*,
                                          uint32_t,
                                          uint32_t*,
                                          bool*) override final;
  MOZ_MUST_USE nsresult WriteSegmentsAgain(nsAHttpSegmentWriter*,
                                           uint32_t,
                                           uint32_t*,
                                           bool*) override final;
  MOZ_MUST_USE bool Do0RTT() override final { return true; }
  MOZ_MUST_USE nsresult Finish0RTT(bool aRestart,
                                   bool aAlpnChanged) override final;
 ...
 private:
  ...
  MOZ_MUST_USE nsresult NetworkRead(nsAHttpSegmentWriter*,
                                    char*,
                                    uint32_t,
                                    uint32_t*);
  ...
  {
   public:
    CachePushCheckCallback(Http2Session* session,
                           uint32_t promisedID,
 ...
 private:
  ...
  void CreateTunnel(nsHttpTransaction*,
