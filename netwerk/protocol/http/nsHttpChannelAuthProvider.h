                                  ...
                                  public nsIHttpAuthenticatorCallback
{
 ...
 private:
  ...
  MOZ_MUST_USE nsresult GenCredsAndSetEntry(nsIHttpAuthenticator*,
                                            bool proxyAuth,
                                            const char* scheme,
                                            const char* host,
                                            int32_t port,
  ...
  /**
     ...
     * error.
     */
  MOZ_MUST_USE nsresult GetCredentials(const char* challenges,
                                       bool proxyAuth,
                                       nsCString& creds);
  MOZ_MUST_USE nsresult GetCredentialsForChallenge(const char* challenge,
                                                   ...
                                                   nsIHttpAuthenticator* auth,
                                                   nsCString& creds);
  MOZ_MUST_USE nsresult PromptForIdentity(uint32_t level,
                                          bool proxyAuth,
                                          const char* realm,
                                          const char* authType,
                                          uint32_t authFlags,
  ...
  GetAuthorizationMembers(bool proxyAuth,
                          nsACString& scheme,
                          const char*& host,
                          int32_t& port,
                          nsACString& path,
