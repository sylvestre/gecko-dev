...
void
nsHttpConnectionInfo::Init(const nsACString& host,
                           int32_t port,
                           const nsACString& npnToken,
                           const nsACString& username,
                           nsProxyInfo* proxyInfo,
...
void
nsHttpConnectionInfo::SetNetworkInterfaceId(
...
void
nsHttpConnectionInfo::BuildHashKey()
{
  //
  // build hash key:
  //
...
nsHttpConnectionInfo::Clone() const
{
  ...
  if (mRoutedHost.IsEmpty()) {
    clone = new nsHttpConnectionInfo(mOrigin,
                                     mOriginPort,
                                     mNPNToken,
                                     mUsername,
                                     mProxyInfo,
...
nsHttpConnectionInfo::CloneAsDirectRoute(nsHttpConnectionInfo** outCI)
{
  ...
  RefPtr<nsHttpConnectionInfo> clone =
      new nsHttpConnectionInfo(mOrigin,
                               mOriginPort,
                               EmptyCString(),
                               mUsername,
                               mProxyInfo,
...
nsHttpConnectionInfo::CreateWildCard(nsHttpConnectionInfo** outParam)
{
  ...
  RefPtr<nsHttpConnectionInfo> clone;
  clone = new nsHttpConnectionInfo(NS_LITERAL_CSTRING("*"),
                                   0,
                                   mNPNToken,
                                   mUsername,
                                   mProxyInfo,
