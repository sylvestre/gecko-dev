                    ...
                    public SupportsWeakPtr<Http2Stream>
{
 public:
  ...
  MOZ_MUST_USE nsresult ConvertResponseHeaders(Http2Decompressor*,
                                               ...
                                               nsACString&,
                                               int32_t&);
  MOZ_MUST_USE nsresult ConvertPushHeaders(Http2Decompressor*,
                                           nsACString&,
                                           nsACString&);
 ...
 protected:
  ...
  MOZ_MUST_USE nsresult TransmitFrame(const char*,
                                      uint32_t*,
 ...
 private:
  ...
  MOZ_MUST_USE nsresult ParseHttpRequestHeaders(const char*,
                                                uint32_t,
                                                uint32_t*);
