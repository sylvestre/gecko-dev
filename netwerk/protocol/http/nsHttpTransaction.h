                                ...
                                public ARefBase
{
 ...
 private:
  ...
  MOZ_MUST_USE nsresult HandleContent(char*,
                                      uint32_t count,
  ...
  static MOZ_MUST_USE nsresult ReadRequestSegment(
      nsIInputStream*, void*, const char*, uint32_t, uint32_t, uint32_t*);
  static MOZ_MUST_USE nsresult WritePipeSegment(
      nsIOutputStream*, void*, char*, uint32_t, uint32_t, uint32_t*);
