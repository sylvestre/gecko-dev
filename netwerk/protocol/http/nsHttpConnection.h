                               ...
                               public nsSupportsWeakReference
{
 ...
 public:
  ...
  MOZ_MUST_USE nsresult Init(nsHttpConnectionInfo* info,
  ...
  MOZ_MUST_USE nsresult Activate(nsAHttpTransaction*,
                                 uint32_t caps,
                                 int32_t pri);
  ...
  MOZ_MUST_USE nsresult OnHeadersAvailable(nsAHttpTransaction*,
                                           ...
                                           nsHttpResponseHead*,
                                           bool* reset);
  void CloseTransaction(nsAHttpTransaction*,
                        nsresult reason,
  ...
  static MOZ_MUST_USE nsresult ReadFromStream(
