...
class nsHttpConnectionMgr final : public nsIObserver, public AltSvcCache
{
  ...
  class nsConnectionEntry
  {
   public:
    ...
    nsTArray<RefPtr<nsHalfOpenSocket>>
        mHalfOpenFastOpenBackups;  // backup half open connections for connection in fast open phase
 ...
 public:
  ...
  void RegisterOriginCoalescingKey(nsHttpConnection*,
 ...
 private:
  ...
  TryDispatchTransaction(nsConnectionEntry* ent,
  ...
  MOZ_MUST_USE nsresult
  CreateTransport(nsConnectionEntry*,
                  nsAHttpTransaction*,
                  uint32_t,
                  bool,
                  bool,
