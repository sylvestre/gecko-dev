                            ...
                            public nsITimerCallback
{
 ...
 private:
  ...
  SetupReplacementChannel(nsIURI*,
                          nsIChannel*,
                          bool preserveMethod,
  ...
  OnOfflineCacheEntryAvailable(nsICacheEntry* aEntry,
                               bool aNew,
  ...
  bool IsResumable(int64_t partialLen,
                   int64_t contentLength,
                   bool ignoreMissingPartialLen = false) const;
  MOZ_MUST_USE nsresult
  MaybeSetupByteRangeRequest(int64_t partialLen,
                             int64_t contentLength,
