...
NS_IMPL_ISUPPORTS(nsAboutCache::Channel,
                  nsIChannel,
                  nsIRequest,
...
nsAboutCache::Channel::Init(nsIURI* aURI, nsILoadInfo* aLoadInfo)
{
  ...
  rv = NS_NewPipe(getter_AddRefs(inputStream),
...
NS_IMETHODIMP
nsAboutCache::Channel::AsyncOpen(nsIStreamListener* aListener,
...
NS_IMETHODIMP
nsAboutCache::Channel::AsyncOpen2(nsIStreamListener* aListener)
{
  return AsyncOpen(aListener, nullptr);
}

NS_IMETHODIMP
nsAboutCache::Channel::Open(nsIInputStream** _retval)
{
  return NS_ERROR_NOT_IMPLEMENTED;
}

NS_IMETHODIMP
nsAboutCache::Channel::Open2(nsIInputStream** _retval)
{
  return NS_ERROR_NOT_IMPLEMENTED;
}
