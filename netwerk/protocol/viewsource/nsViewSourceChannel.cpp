...
nsViewSourceChannel::AsyncOpen(nsIStreamListener* aListener, nsISupports* ctxt)
{
  ...
  if (NS_FAILED(rv) && loadGroup)
    loadGroup->RemoveRequest(
        static_cast<nsIViewSourceChannel*>(this), nullptr, rv);
                                   ...
                                   nsresult aStatus)
{
  ...
  if (mChannel) {
    ...
    if (loadGroup) {
      loadGroup->RemoveRequest(
          static_cast<nsIViewSourceChannel*>(this), nullptr, aStatus);
    }
  }
  return mListener->OnStopRequest(
      static_cast<nsIViewSourceChannel*>(this), aContext, aStatus);
}
...
void
nsViewSourceChannel::SetCorsPreflightParameters(
