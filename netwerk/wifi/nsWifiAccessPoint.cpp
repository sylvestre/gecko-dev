...
NS_IMETHODIMP
nsWifiAccessPoint::GetMac(nsACString& aMac)
{
  aMac.Assign(mMac);
  return NS_OK;
}
...
NS_IMETHODIMP
nsWifiAccessPoint::GetSsid(nsAString& aSsid)
{
...
NS_IMETHODIMP
nsWifiAccessPoint::GetRawSSID(nsACString& aRawSsid)
{
...
void
ReplaceArray(nsCOMArray<nsWifiAccessPoint>& a, nsCOMArray<nsWifiAccessPoint>& b)
{
  a.Clear();
