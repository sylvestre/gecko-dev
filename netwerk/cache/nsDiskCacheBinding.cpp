...
static bool
MatchEntry(const PLDHashEntryHdr* header, const void* key)
{
...
static void
ClearEntry(PLDHashTable* /* table */, PLDHashEntryHdr* header)
{
...
const PLDHashTableOps nsDiskCacheBindery::ops = {
    HashKey, MatchEntry, MoveEntry, ClearEntry};
...
nsDiskCacheBindery::FindActiveBinding(uint32_t hashNumber)
{
  ...
  auto hashEntry =
      static_cast<HashTableEntry*>(table.Search((void*)(uintptr_t)hashNumber));
