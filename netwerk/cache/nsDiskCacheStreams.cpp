...
nsresult
nsDiskCacheStreamIO::GetInputStream(uint32_t offset,
...
// NOTE: called with service lock held
nsresult
nsDiskCacheStreamIO::GetOutputStream(uint32_t offset,
...
NS_IMETHODIMP
nsDiskCacheStreamIO::WriteFrom(nsIInputStream* inStream,
                               uint32_t count,
                               uint32_t* bytesWritten)
{
