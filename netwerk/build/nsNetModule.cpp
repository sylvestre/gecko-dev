...
#define WEB_SOCKET_HANDLER_CONSTRUCTOR(type, secure)      \
  static nsresult type##Constructor(                      \
...
nsresult
NS_NewFTPDirListingConv(nsFTPDirListingConv** result);
...
nsresult
NS_NewMultiMixedConv(nsMultiMixedConv** result);
nsresult
MOZ_NewTXTToHTMLConv(mozTXTToHTMLConv** result);
nsresult
NS_NewHTTPCompressConv(mozilla::net::nsHTTPCompressConv** result);
nsresult
...
static nsresult
CreateNewStreamConvServiceFactory(nsISupports* aOuter,
                                  REFNSIID aIID,
                                  void** aResult)
{
  if (!aResult) {
...
static nsresult
CreateNewMultiMixedConvFactory(nsISupports* aOuter,
                               REFNSIID aIID,
                               void** aResult)
{
  if (!aResult) {
...
static nsresult
CreateNewTXTToHTMLConvFactory(nsISupports* aOuter,
                              REFNSIID aIID,
                              void** aResult)
{
  if (!aResult) {
...
static nsresult
CreateNewHTTPCompressConvFactory(nsISupports* aOuter,
                                 REFNSIID aIID,
                                 void** aResult)
{
  if (!aResult) {
...
static nsresult
CreateNewUnknownDecoderFactory(nsISupports* aOuter,
                               REFNSIID aIID,
                               void** aResult)
{
  nsresult rv;
...
static nsresult
CreateNewBinaryDetectorFactory(nsISupports* aOuter,
                               REFNSIID aIID,
                               void** aResult)
{
  nsresult rv;
...
static const mozilla::Module::CIDEntry kNeckoCIDs[] = {
    ...
    {&kNS_STREAMLOADER_CID,
     false,
     nullptr,
     mozilla::net::nsStreamLoader::Create},
    {&kNS_INCREMENTALSTREAMLOADER_CID,
     false,
     nullptr,
     nsIncrementalStreamLoader::Create},
    ...
    {&kNS_NAMEDPIPESERVICE_CID,
     false,
     NULL,
     mozilla::net::NamedPipeServiceConstructor},
#endif
    ...
    {&kNS_THROTTLEQUEUE_CID,
     false,
     nullptr,
     mozilla::net::ThrottleQueueConstructor},
    {&kNS_BACKGROUNDCHANNELREGISTRAR_CID,
     false,
     nullptr,
     mozilla::net::BackgroundChannelRegistrarConstructor},
    ...
    {&kNS_EXTENSIONPROTOCOLHANDLER_CID,
     false,
     nullptr,
     mozilla::ExtensionProtocolHandlerConstructor},
    {&kNS_SUBSTITUTINGURL_CID,
     false,
     nullptr,
     mozilla::SubstitutingURLConstructor},
    ...
    {&kNS_CAPTIVEPORTAL_CID,
     false,
     nullptr,
     mozilla::net::CaptivePortalServiceConstructor},
...
static const mozilla::Module::ContractIDEntry kNeckoContracts[] = {
    ...
    {NS_NETWORK_PROTOCOL_CONTRACTID_PREFIX "resource",
     &kNS_RESPROTOCOLHANDLER_CID},
    {NS_NETWORK_PROTOCOL_CONTRACTID_PREFIX "moz-extension",
     &kNS_EXTENSIONPROTOCOLHANDLER_CID},
