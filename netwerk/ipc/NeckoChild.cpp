...
NeckoChild::AllocPAltDataOutputStreamChild(const nsCString& type,
...
bool
NeckoChild::DeallocPWebSocketEventListenerChild(
...
PTCPSocketChild*
NeckoChild::AllocPTCPSocketChild(const nsString& host, const uint16_t& port)
{
