...
void
SetTime(PRTime offsetTime,
        nsAutoCString& serverString,
        ...
        bool expiry)
{
  ...
  cookieString.ReplaceLiteral(
      0,
      strlen("test=expiry; expires=") + strlen(timeStringPreset) + 1,
      "test=expiry; expires=");
  cookieString.Append(timeStringPreset);
}

void
SetACookie(nsICookieService* aCookieService,
           const char* aSpec1,
           const char* aSpec2,
...
void
SetACookieNoHttp(nsICookieService* aCookieService,
                 const char* aSpec,
                 const char* aCookieString)
{
  nsCOMPtr<nsIURI> uri;
  ...
  nsresult rv = aCookieService->SetCookieString(
      uri, nullptr, (char*)aCookieString, nullptr);
  EXPECT_TRUE(NS_SUCCEEDED(rv));
}
...
bool
GetACookie(nsICookieService* aCookieService,
           const char* aSpec1,
           const char* aSpec2,
           char** aCookie)
{
  ...
  Unused << aCookieService->GetCookieStringFromHttp(
      uri1, uri2, nullptr, aCookie);
...
// the cookie string is returned via aCookie.
bool
GetACookieNoHttp(nsICookieService* aCookieService,
                 const char* aSpec,
                 char** aCookie)
{
  nsCOMPtr<nsIURI> uri;
...
TEST(TestCookie, TestCookieMain)
{
  ...
  SetACookie(
      cookieService, "http://www.basic.com", nullptr, "test=basic", nullptr);
  GetACookie(
      cookieService, "http://www.basic.com", nullptr, getter_Copies(cookie));
  ...
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_BE_NULL));
  GetACookie(
      cookieService, "http://www.basic2.com/", nullptr, getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_BE_NULL));
  ...
  SetACookie(cookieService,
             ...
             nullptr);
  GetACookie(
      cookieService, "http://domain.com", nullptr, getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_EQUAL, "test=domain"));
  GetACookie(
      cookieService, "http://domain.com.", nullptr, getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_BE_NULL));
  GetACookie(
      cookieService, "http://www.domain.com", nullptr, getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_EQUAL, "test=domain"));
  GetACookie(
      cookieService, "http://foo.domain.com", nullptr, getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_EQUAL, "test=domain"));
  SetACookie(cookieService,
             "http://www.domain.com",
             nullptr,
  ...
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_EQUAL, "test=domain"));
  GetACookie(
      cookieService, "http://bah.domain.com", nullptr, getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_EQUAL, "test=domain"));
  SetACookie(cookieService,
             "http://www.domain.com",
             nullptr,
  ...
  SetACookie(cookieService,
             ...
             nullptr);
  GetACookie(
      cookieService, "http://path.net/path", nullptr, getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_EQUAL, "test=path"));
  GetACookie(
      cookieService, "http://path.net/path/", nullptr, getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_EQUAL, "test=path"));
  GetACookie(cookieService,
             "http://path.net/path/hithere.foo",
             nullptr,
             getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_EQUAL, "test=path"));
  GetACookie(cookieService,
  ...
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_EQUAL, "test=path"));
  GetACookie(
      cookieService, "http://path.net/path2", nullptr, getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_BE_NULL));
  GetACookie(
      cookieService, "http://path.net/path2/", nullptr, getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_BE_NULL));
  ...
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_BE_NULL));
  GetACookie(
      cookieService, "http://path.net/foo", nullptr, getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_EQUAL, "test=path"));
  SetACookie(cookieService,
             "http://path.net/path/file",
             nullptr,
  ...
  SetACookie(cookieService,
             ...
             nullptr);
  GetACookie(cookieService,
             "http://path.net/foo\tbar/",
             nullptr,
             getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_BE_NULL));
  // the following cookie includes a tab in the name
  SetACookie(
      cookieService, "http://path.net/", nullptr, "test\ttabs=tab", nullptr);
  ...
  SetACookie(
      cookieService, "http://path.net/", nullptr, "test=tab\ttest", nullptr);
  GetACookie(cookieService, "http://path.net/", nullptr, getter_Copies(cookie));
  ...
  SetACookie(cookieService,
             ...
             nullptr);
  GetACookie(
      cookieService, "http://expireme.org/", nullptr, getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_BE_NULL));
  SetACookie(cookieService,
             "http://expireme.org/",
             nullptr,
  ...
  SetACookie(cookieService,
             ...
             nullptr);
  GetACookie(
      cookieService, "http://parser.test/", nullptr, getter_Copies(cookie));
  ...
  SetACookie(
      cookieService, "http://parser.test/", nullptr, "test=six", nullptr);
  GetACookie(
      cookieService, "http://parser.test/", nullptr, getter_Copies(cookie));
  ...
  SetACookie(cookieService,
             ...
             nullptr);
  SetACookie(cookieService,
             "http://multi.path.tests/one/two/three/four/five/",
             nullptr,
             "test6=path",
             nullptr);
  SetACookie(cookieService,
  ...
  GetACookie(cookieService,
             ...
             nullptr,
             getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(),
                          MUST_EQUAL,
  ...
  SetACookieNoHttp(
      cookieService, "http://httponly.test/", "test=httponly; httponly");
  GetACookie(
      cookieService, "http://httponly.test/", nullptr, getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_BE_NULL));
  ...
  GetACookieNoHttp(
      cookieService, "http://httponly.test/", getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_BE_NULL));
  ...
  SetACookie(cookieService,
             ...
             nullptr);
  SetACookieNoHttp(
      cookieService, "http://httponly.test/", "test=httponly; max-age=-1");
  GetACookie(
      cookieService, "http://httponly.test/", nullptr, getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_EQUAL, "test=httponly"));
  ...
  SetACookie(cookieService,
             ...
             nullptr);
  GetACookie(
      cookieService, "http://prefixed.test/", nullptr, getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_BE_NULL));
  ...
  SetACookie(cookieService,
             ...
             nullptr);
  GetACookie(
      cookieService, "https://prefixed.test/", nullptr, getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_BE_NULL));
  ...
  SetACookie(cookieService,
             ...
             nullptr);
  GetACookieNoHttp(
      cookieService, "https://www.security.test/", getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_BE_NULL));
  SetACookie(cookieService,
             ...
             nullptr);
  GetACookieNoHttp(
      cookieService, "https://www.security.test/path/", getter_Copies(cookie));
  ...
  SetACookie(cookieService,
             ...
             nullptr);
  GetACookieNoHttp(cookieService,
  ...
  SetACookie(cookieService,
             ...
             nullptr);
  GetACookieNoHttp(
      cookieService, "http://www.security.test/bar/", getter_Copies(cookie));
  ...
  EXPECT_TRUE(CheckResult(
      cookie.get(), MUST_EQUAL, "test_modify_cookie=security-cookie"));
  SetACookie(cookieService,
             "https://www.security.test/",
             nullptr,
  ...
  GetACookieNoHttp(
      cookieService, "https://www.security.test/", getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(
      cookie.get(), MUST_EQUAL, "test_modify_cookie=non-security-cookie"));
  ...
  SetACookie(cookieService,
             ...
             nullptr);
  GetACookieNoHttp(
      cookieService, "http://www.security.test/", getter_Copies(cookie));
  ...
  GetACookie(cookieService,
             "http://cookiemgr.test/foo/",
             nullptr,
             getter_Copies(cookie));
  EXPECT_TRUE(CheckResult(cookie.get(), MUST_CONTAIN, "test2=yes"));
  GetACookieNoHttp(
      cookieService, "http://cookiemgr.test/foo/", getter_Copies(cookie));
  ...
  SetACookie(
      cookieService, "http://samesite.test", nullptr, "unset=yes", nullptr);
