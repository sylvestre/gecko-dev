...
class CacheIndex : public CacheFileIOListener, public nsIRunnable
{
 public:
  ...
  static nsresult GetCacheStats(nsILoadContextInfo* aInfo,
                                uint32_t* aSize,
                                uint32_t* aCount);
  ...
  static nsresult GetIterator(nsILoadContextInfo* aInfo,
                              bool aAddNew,
