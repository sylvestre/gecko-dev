...
#define MOZ_DEFINE_ENUM_IMPL(aEnumName, aClassSpec, aBaseSpec, aEnumerators) \
  ...
  MOZ_FOR_EACH(                                                              \
      MOZ_ASSERT_ENUMERATOR_HAS_NO_INITIALIZER, (aEnumName, ), aEnumerators)
...
#define MOZ_DEFINE_ENUM_AT_CLASS_SCOPE_IMPL(                                \
    aEnumName, aClassSpec, aBaseSpec, aEnumerators)                         \
  enum aClassSpec aEnumName aBaseSpec{MOZ_UNWRAP_ARGS aEnumerators};        \
...
#define MOZ_DEFINE_ENUM_WITH_BASE_AT_CLASS_SCOPE( \
