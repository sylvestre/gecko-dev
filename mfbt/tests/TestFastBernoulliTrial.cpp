...
TestProportions()
{
  mozilla::FastBernoulliTrial bernoulli(
      1.0, 698079309544035222ULL, 6012389156611637584ULL);
...
{
  mozilla::FastBernoulliTrial bernoulli(
      0.1, 698079309544035222ULL, 6012389156611637584ULL);
...
{
  mozilla::FastBernoulliTrial bernoulli(
      0.01, 0x67ff17e25d855942ULL, 0x74f298193fe1c5b1ULL);
...
{
  mozilla::FastBernoulliTrial bernoulli(
      1.0, 0x67ff17e25d855942ULL, 0x74f298193fe1c5b1ULL);
...
TestCuspProbabilities()
{
   ...
   */
  mozilla::FastBernoulliTrial bernoulli(
      nextafter(1, 0), 0x67ff17e25d855942ULL, 0x74f298193fe1c5b1ULL);
