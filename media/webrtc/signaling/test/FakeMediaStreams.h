...
class Fake_SourceMediaStream : public Fake_MediaStream
{
 public:
  ...
  void AddTrack(mozilla::TrackID aID,
  ...
  void AddAudioTrack(mozilla::TrackID aID,
                     mozilla::TrackRate aRate,
                     mozilla::StreamTime aStart,
  ...
  bool AppendToTrack(mozilla::TrackID aID,
                     mozilla::MediaSegment* aSegment,
...
class Fake_DOMMediaStream : public nsISupports
{
 ...
 public:
  ...
  already_AddRefed<Fake_MediaStreamTrack> CreateDOMTrack(
      mozilla::TrackID aTrackID,
      mozilla::MediaSegment::Type aType,
