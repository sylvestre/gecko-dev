...
AudioControlWrapper::getRecordingDevices()
{
  if (_realAudioControl != nullptr) {
    return _realAudioControl->getRecordingDevices();
  } else {
    CSFLogWarn(logTag,
               "Attempt to getRecordingDevices for expired audio control");
...
std::vector<std::string>
AudioControlWrapper::getPlayoutDevices()
{
  if (_realAudioControl != nullptr) {
    return _realAudioControl->getPlayoutDevices();
  } else {
    CSFLogWarn(logTag,
               "Attempt to getPlayoutDevices for expired audio control");
    std::vector<std::string> vec;
    return vec;
  }
}
...
std::string
AudioControlWrapper::getRecordingDevice()
{
  if (_realAudioControl != nullptr) {
    return _realAudioControl->getRecordingDevice();
  } else {
    CSFLogWarn(logTag,
               "Attempt to getRecordingDevice for expired audio control");
    return "";
  }
}

std::string
AudioControlWrapper::getPlayoutDevice()
{
  if (_realAudioControl != nullptr) {
...
bool
AudioControlWrapper::setRecordingDevice(const std::string& name)
{
  if (_realAudioControl != nullptr) {
    return _realAudioControl->setRecordingDevice(name);
  } else {
    CSFLogWarn(logTag,
               "Attempt to setRecordingDevice to %s for expired audio control",
               name.c_str());
    return false;
  }
}
...
bool
AudioControlWrapper::setPlayoutDevice(const std::string& name)
{
  if (_realAudioControl != nullptr) {
    return _realAudioControl->setPlayoutDevice(name);
  } else {
    CSFLogWarn(logTag,
               "Attempt to setPlayoutDevice to %s for expired audio control",
               name.c_str());
    return false;
  }
}
...
bool
AudioControlWrapper::setDefaultVolume(int volume)
{
  if (_realAudioControl != nullptr) {
...
int
AudioControlWrapper::getDefaultVolume()
{
  if (_realAudioControl != nullptr) {
...
bool
AudioControlWrapper::setRingerVolume(int volume)
{
  if (_realAudioControl != nullptr) {
...
int
AudioControlWrapper::getRingerVolume()
{
  if (_realAudioControl != nullptr) {
