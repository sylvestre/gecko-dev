...
inline std::ostream&
operator<<(std::ostream& os, const SdpMediaSection& ms)
{
  ms.Serialize(os);
  return os;
}
...
inline std::ostream&
operator<<(std::ostream& os, SdpMediaSection::MediaType t)
{
  switch (t) {
...
inline std::ostream&
operator<<(std::ostream& os, SdpMediaSection::Protocol p)
{
  switch (p) {
...
{
 public:
  SdpConnection(sdp::AddrType addrType,
                std::string addr,
                uint8_t ttl = 0,
                uint32_t count = 0)
...
inline std::ostream&
operator<<(std::ostream& os, const SdpConnection& c)
{
  c.Serialize(os);
  return os;
}
