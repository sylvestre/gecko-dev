                           ...
                           public rtc::VideoSourceInterface<webrtc::VideoFrame>
{
  ...
  * hits Webrtc.org.
  */
  void SetLocalRTPExtensions(
      bool aIsSend,
      const std::vector<webrtc::RtpExtension>& extensions) override;
  std::vector<webrtc::RtpExtension> GetLocalRTPExtensions(
      bool aIsSend) const override;
  ...
  virtual MediaConduitErrorCode SendVideoFrame(
      webrtc::VideoFrame& frame) override;
 ...
 private:
  ...
  class VideoEncoderConfigBuilder
  {
   public:
    ...
    void ClearStreams();
    void ForEachStream(const std::function<void(webrtc::VideoStream&,
  ...
  {
   public:
    VideoStreamFactory(std::string aCodecName, WebrtcVideoConduit* aConduit)
