...
aom_clpf_block_c(uint8_t* dst,
                 ...
                 unsigned int bd);
void
aom_clpf_block_neon(uint8_t* dst,
                    const uint16_t* src,
                    int dstride,
                    int sstride,
                    int sizex,
...
aom_clpf_block_hbd_c(uint16_t* dst,
                     ...
                     unsigned int bd);
void
aom_clpf_block_hbd_neon(uint16_t* dst,
                        const uint16_t* src,
                        int dstride,
                        int sstride,
                        int sizex,
...
aom_clpf_hblock_c(uint8_t* dst,
                  ...
                  unsigned int bd);
void
aom_clpf_hblock_neon(uint8_t* dst,
                     const uint16_t* src,
                     int dstride,
                     int sstride,
                     int sizex,
...
aom_clpf_hblock_hbd_c(uint16_t* dst,
                      ...
                      unsigned int bd);
void
aom_clpf_hblock_hbd_neon(uint16_t* dst,
                         const uint16_t* src,
                         int dstride,
                         int sstride,
                         int sizex,
...
copy_4x4_16bit_to_16bit_c(uint16_t* dst,
                          ...
                          int sstride);
void
copy_4x4_16bit_to_16bit_neon(uint16_t* dst,
                             int dstride,
                             const uint16_t* src,
                             int sstride);
...
copy_4x4_16bit_to_8bit_c(uint8_t* dst,
                         ...
                         int sstride);
void
copy_4x4_16bit_to_8bit_neon(uint8_t* dst,
                            int dstride,
                            const uint16_t* src,
                            int sstride);
...
copy_8x8_16bit_to_16bit_c(uint16_t* dst,
                          ...
                          int sstride);
void
copy_8x8_16bit_to_16bit_neon(uint16_t* dst,
                             int dstride,
                             const uint16_t* src,
                             int sstride);
...
copy_8x8_16bit_to_8bit_c(uint8_t* dst,
                         ...
                         int sstride);
void
copy_8x8_16bit_to_8bit_neon(uint8_t* dst,
                            int dstride,
                            const uint16_t* src,
                            int sstride);
...
od_dir_find8_c(const od_dering_in* img,
               ...
               int coeff_shift);
int
od_dir_find8_neon(const od_dering_in* img,
                  int stride,
                  int32_t* var,
                  int coeff_shift);
...
od_filter_dering_direction_4x4_c(uint16_t* y,
                                 ...
                                 int damping);
void
od_filter_dering_direction_4x4_neon(uint16_t* y,
                                    int ystride,
                                    const uint16_t* in,
                                    int threshold,
                                    int dir,
...
od_filter_dering_direction_8x8_c(uint16_t* y,
                                 ...
                                 int damping);
void
od_filter_dering_direction_8x8_neon(uint16_t* y,
                                    int ystride,
                                    const uint16_t* in,
                                    int threshold,
                                    int dir,
...
setup_rtcd_internal(void)
{
  ...
  if (flags & HAS_NEON)
    od_filter_dering_direction_4x4 = od_filter_dering_direction_4x4_neon;
  od_filter_dering_direction_8x8 = od_filter_dering_direction_8x8_c;
  if (flags & HAS_NEON)
    od_filter_dering_direction_8x8 = od_filter_dering_direction_8x8_neon;
}
#endif
