...
void
aom_fdct8x8_ssse3(const int16_t* input, tran_low_t* output, int stride);
...
void
aom_hadamard_8x8_ssse3(const int16_t* src_diff, int src_stride, int16_t* coeff);
...
aom_highbd_convolve8_c(const uint8_t* src,
                       ...
                       int bps);
void
aom_highbd_convolve8_sse2(const uint8_t* src,
                          ptrdiff_t src_stride,
                          uint8_t* dst,
                          ptrdiff_t dst_stride,
                          const int16_t* filter_x,
...
aom_highbd_convolve8_avg_c(const uint8_t* src,
                           ...
                           int bps);
void
aom_highbd_convolve8_avg_sse2(const uint8_t* src,
                              ptrdiff_t src_stride,
                              uint8_t* dst,
                              ptrdiff_t dst_stride,
                              const int16_t* filter_x,
...
aom_highbd_convolve8_avg_horiz_c(const uint8_t* src,
                                 ...
                                 int bps);
void
aom_highbd_convolve8_avg_horiz_sse2(const uint8_t* src,
                                    ptrdiff_t src_stride,
                                    uint8_t* dst,
                                    ptrdiff_t dst_stride,
                                    const int16_t* filter_x,
...
aom_highbd_convolve8_avg_vert_c(const uint8_t* src,
                                ...
                                int bps);
void
aom_highbd_convolve8_avg_vert_sse2(const uint8_t* src,
                                   ptrdiff_t src_stride,
                                   uint8_t* dst,
                                   ptrdiff_t dst_stride,
                                   const int16_t* filter_x,
...
aom_highbd_convolve8_horiz_c(const uint8_t* src,
                             ...
                             int bps);
void
aom_highbd_convolve8_horiz_sse2(const uint8_t* src,
                                ptrdiff_t src_stride,
                                uint8_t* dst,
                                ptrdiff_t dst_stride,
                                const int16_t* filter_x,
...
aom_highbd_convolve8_vert_c(const uint8_t* src,
                            ...
                            int bps);
void
aom_highbd_convolve8_vert_sse2(const uint8_t* src,
                               ptrdiff_t src_stride,
                               uint8_t* dst,
                               ptrdiff_t dst_stride,
                               const int16_t* filter_x,
...
aom_quantize_b_sse2(const tran_low_t* coeff_ptr,
                    ...
                    const int16_t* iscan);
void
aom_quantize_b_ssse3(const tran_low_t* coeff_ptr,
                     intptr_t n_coeffs,
                     int skip_block,
                     const int16_t* zbin_ptr,
                     const int16_t* round_ptr,
                     ...
                     const int16_t* iscan);
void
aom_quantize_b_avx(const tran_low_t* coeff_ptr,
                   intptr_t n_coeffs,
                   int skip_block,
                   const int16_t* zbin_ptr,
                   const int16_t* round_ptr,
...
aom_quantize_b_32x32_c(const tran_low_t* coeff_ptr,
                       ...
                       const int16_t* iscan);
void
aom_quantize_b_32x32_ssse3(const tran_low_t* coeff_ptr,
                           intptr_t n_coeffs,
                           int skip_block,
                           const int16_t* zbin_ptr,
                           const int16_t* round_ptr,
                           ...
                           const int16_t* iscan);
void
aom_quantize_b_32x32_avx(const tran_low_t* coeff_ptr,
                         intptr_t n_coeffs,
                         int skip_block,
                         const int16_t* zbin_ptr,
                         const int16_t* round_ptr,
