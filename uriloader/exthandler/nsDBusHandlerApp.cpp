...
NS_IMETHODIMP
nsDBusHandlerApp::GetName(nsAString& aName)
{
  aName.Assign(mName);
  return NS_OK;
}
...
NS_IMETHODIMP
nsDBusHandlerApp::SetName(const nsAString& aName)
{
  mName.Assign(aName);
  return NS_OK;
}
...
NS_IMETHODIMP
nsDBusHandlerApp::SetDetailedDescription(const nsAString& aDescription)
{
...
NS_IMETHODIMP
nsDBusHandlerApp::GetDetailedDescription(nsAString& aDescription)
{
...
NS_IMETHODIMP
nsDBusHandlerApp::GetService(nsACString& aService)
{
...
NS_IMETHODIMP
nsDBusHandlerApp::SetService(const nsACString& aService)
{
...
NS_IMETHODIMP
nsDBusHandlerApp::GetMethod(nsACString& aMethod)
{
...
NS_IMETHODIMP
nsDBusHandlerApp::SetMethod(const nsACString& aMethod)
{
...
NS_IMETHODIMP
nsDBusHandlerApp::GetDBusInterface(nsACString& aInterface)
{
...
NS_IMETHODIMP
nsDBusHandlerApp::SetDBusInterface(const nsACString& aInterface)
{
...
NS_IMETHODIMP
nsDBusHandlerApp::GetObjectPath(nsACString& aObjpath)
{
...
NS_IMETHODIMP
nsDBusHandlerApp::SetObjectPath(const nsACString& aObjpath)
{
