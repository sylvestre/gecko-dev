...
{
  return XMLStylesheetProcessingInstructionBinding::Wrap(
...
void
XMLStylesheetProcessingInstruction::SetNodeValueInternal(
...
XMLStylesheetProcessingInstruction::GetStyleSheetURL(
