                                   ...
                                   public workers::WorkerHolder
{
 ...
 public:
  ...
  virtual void Open(const nsACString& aMethod,
                    const nsAString& aUrl,
                    ErrorResult& aRv) override
  {
    Open(
        aMethod, aUrl, true, Optional<nsAString>(), Optional<nsAString>(), aRv);
  }
  ...
  void Open(const nsACString& aMethod,
            const nsAString& aUrl,
            bool aAsync,
  ...
  virtual void GetStatusText(nsACString& aStatusText, ErrorResult& aRv) override
  {
  ...
  virtual void GetInterface(JSContext* aCx,
                            nsIJSID* aIID,
