...
static nsAtom** const unitMap[] = {nullptr, /* SVG_ANGLETYPE_UNKNOWN */
...
void
nsSVGAngle::SetBaseValue(float aValue,
                         nsSVGElement* aSVGElement,
                         bool aDoSetAttr)
{
...
nsresult
nsSVGAngle::SMILOrient::ValueFromString(
...
nsSVGAngle::SMILOrient::SetAnimValue(const nsSMILValue& aValue)
{
  ...
  if (aValue.mType == &SVGOrientSMILType::sSingleton) {
    ...
    if (aValue.mU.mOrient.mOrientType == SVG_MARKER_ORIENT_AUTO ||
      ...
      mAngle->SetAnimValue(
          aValue.mU.mOrient.mAngle, aValue.mU.mOrient.mUnit, mSVGElement);
    }
  }
  return NS_OK;
}
