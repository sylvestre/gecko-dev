...
{
  return mozilla::dom::SVGAnimatedNumberListBinding::Wrap(
...
void
DOMSVGAnimatedNumberList::InternalBaseValListWillChangeTo(
...
void
DOMSVGAnimatedNumberList::InternalAnimValListWillChangeTo(
    const SVGNumberList& aNewValue)
{
  if (mAnimVal) {
