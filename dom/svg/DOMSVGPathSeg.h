...
#define IMPL_SVGPATHSEG_SUBCLASS_COMMON(segName, segType)                     \
  ...
  DOMSVGPathSeg##segName(                                                     \
      DOMSVGPathSegList* aList, uint32_t aListIndex, bool aIsAnimValItem)     \
...
class DOMSVGPathSegCurvetoQuadraticAbs : public DOMSVGPathSeg
{
 public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(CurvetoQuadraticAbs,
...
class DOMSVGPathSegCurvetoQuadraticRel : public DOMSVGPathSeg
{
 public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(CurvetoQuadraticRel,
...
class DOMSVGPathSegLinetoHorizontalAbs : public DOMSVGPathSeg
{
 public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(LinetoHorizontalAbs,
...
class DOMSVGPathSegLinetoHorizontalRel : public DOMSVGPathSeg
{
 public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(LinetoHorizontalRel,
...
class DOMSVGPathSegLinetoVerticalAbs : public DOMSVGPathSeg
{
 public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(LinetoVerticalAbs,
...
class DOMSVGPathSegLinetoVerticalRel : public DOMSVGPathSeg
{
 public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(LinetoVerticalRel,
...
class DOMSVGPathSegCurvetoCubicSmoothAbs : public DOMSVGPathSeg
{
 public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(CurvetoCubicSmoothAbs,
...
class DOMSVGPathSegCurvetoCubicSmoothRel : public DOMSVGPathSeg
{
 public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(CurvetoCubicSmoothRel,
...
class DOMSVGPathSegCurvetoQuadraticSmoothAbs : public DOMSVGPathSeg
{
 public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(CurvetoQuadraticSmoothAbs,
...
class DOMSVGPathSegCurvetoQuadraticSmoothRel : public DOMSVGPathSeg
{
 public:
  ...
  IMPL_SVGPATHSEG_SUBCLASS_COMMON(CurvetoQuadraticSmoothRel,
