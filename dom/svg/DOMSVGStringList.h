...
class DOMSVGStringList final : public nsISupports, public nsWrapperCache
{
 ...
 public:
  ...
  void Clear();
  void Initialize(const nsAString& aNewItem,
                  nsAString& aRetval,
                  ErrorResult& aRv);
  ...
  void InsertItemBefore(const nsAString& aNewItem,
                        uint32_t aIndex,
                        nsAString& aRetval,
                        ErrorResult& aRv);
  void ReplaceItem(const nsAString& aNewItem,
                   uint32_t aIndex,
                   nsAString& aRetval,
                   ErrorResult& aRv);
  void RemoveItem(uint32_t aIndex, nsAString& aRetval, ErrorResult& aRv);
  void AppendItem(const nsAString& aNewItem,
                  nsAString& aRetval,
                  ErrorResult& aRv);
