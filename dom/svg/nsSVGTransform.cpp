  ...
  switch (mType) {
    case SVG_TRANSFORM_TRANSLATE:
      ...
      if (mMatrix._32 != 0)
        nsTextFormatter::ssprintf(
            aValue, u"translate(%g, %g)", mMatrix._31, mMatrix._32);
      else
    ...
    case SVG_TRANSFORM_ROTATE:
      if (mOriginX != 0.0f || mOriginY != 0.0f)
        nsTextFormatter::ssprintf(
            aValue, u"rotate(%g, %g, %g)", mAngle, mOriginX, mOriginY);
      else
    ...
    case SVG_TRANSFORM_SCALE:
      if (mMatrix._11 != mMatrix._22)
        nsTextFormatter::ssprintf(
            aValue, u"scale(%g, %g)", mMatrix._11, mMatrix._22);
      else
...
SVGTransformSMILData::ToSVGTransform() const
{
  ...
  switch (mTransformType) {
    case SVG_TRANSFORM_MATRIX:
      result.SetMatrix(gfxMatrix(mParams[0],
                                 mParams[1],
                                 mParams[2],
                                 mParams[3],
                                 mParams[4],
