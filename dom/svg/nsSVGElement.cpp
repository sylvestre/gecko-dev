...
NS_IMPL_ISUPPORTS_INHERITED(
    nsSVGElement, nsSVGElementBase, nsIDOMNode, nsIDOMElement, nsIDOMSVGElement)
...
nsresult
nsSVGElement::BindToTree(nsIDocument* aDocument,
                         nsIContent* aParent,
                         nsIContent* aBindingParent,
                         bool aCompileEventHandlers)
{
  nsresult rv = nsSVGElementBase::BindToTree(
  ...
  if (oldVal && oldVal->Type() == nsAttrValue::eCSSDeclaration) {
    ...
    rv = mAttrsAndChildren.SetAndSwapAttr(
        nsGkAtoms::style, attrValue, &oldValueSet);
    NS_ENSURE_SUCCESS(rv, rv);
  }
...
nsresult
nsSVGElement::AfterSetAttr(int32_t aNamespaceID,
                           nsAtom* aName,
                           ...
                           bool aNotify)
{
  ...
  return nsSVGElementBase::AfterSetAttr(
                             ...
                             nsAttrValue& aResult)
{
  ...
  return nsSVGElementBase::ParseAttribute(
      aNamespaceID, aAttribute, aValue, aResult);
}

void
nsSVGElement::UnsetAttrInternal(int32_t aNamespaceID,
                                nsAtom* aName,
                                bool aNotify)
{
...
nsresult
nsSVGElement::UnsetAttr(int32_t aNamespaceID, nsAtom* aName, bool aNotify)
{
...
/* static */ const Element::MappedAttributeEntry
    nsSVGElement::sFontSpecificationMap[] = {{&nsGkAtoms::font_family},
                                             {&nsGkAtoms::font_size},
                                       ...
                                       const nsAString& aMappedAttrValue)
{
  ...
  nsCSSPropertyID propertyID = nsCSSProps::LookupProperty(
      nsDependentAtomString(aMappedAttrName), CSSEnabledState::eForAllContent);
  if (propertyID != eCSSProperty_UNKNOWN) {
    bool changed = false;  // outparam for ParseProperty.
    if (mBackend == StyleBackendType::Gecko) {
      mParser.ParseProperty(propertyID,
                            aMappedAttrValue,
                            mDocURI,
                            mBaseURI,
    ...
    if (changed) {
      ...
      if (nsCSSProps::IsShorthand(propertyID)) {
        CSSPROPS_FOR_SHORTHAND_SUBPROPERTIES(
            subprop, propertyID, CSSEnabledState::eForAllContent)
        {
  ...
  if (aMappedAttrName == nsGkAtoms::lang) {
    ...
    if (mBackend == StyleBackendType::Gecko) {
      ...
      Servo_DeclarationBlock_SetIdentStringValue(
          mDecl->AsServo()->Raw(), propertyID, atom);
    }
  }
}
...
nsSVGElement::UpdateContentDeclarationBlock(mozilla::StyleBackendType aBackend)
{
  ...
  MappedAttrParser mappedAttrParser(
      doc->CSSLoader(), doc->GetDocumentURI(), GetBaseURI(), this, aBackend);
...
nsSVGElement::WillChangeValue(nsAtom* aName)
{
  ...
  uint8_t modType =
      attrValue ? static_cast<uint8_t>(nsIDOMMutationEvent::MODIFICATION)
                : static_cast<uint8_t>(nsIDOMMutationEvent::ADDITION);
  nsNodeUtils::AttributeWillChange(
      this, kNameSpaceID_None, aName, modType, nullptr);
                             ...
                             nsAttrValue& aNewValue)
{
  ...
  mozAutoDocUpdate updateBatch(
      document, UPDATE_CONTENT_MODEL, kNotifyDocumentObservers);
  ...
  SetAttrAndNotify(kNameSpaceID_None,
                   aName,
                   nullptr,
                   &aEmptyOrOldValue,
                   aNewValue,
...
/* static */
nsAtom*
nsSVGElement::GetEventNameForAttr(nsAtom* aAttr)
{
                              ...
                              const nsAttrValue& aEmptyOrOldValue)
{
  ...
  DidChangeValue(
      *info.mLengthInfo[aAttrEnum].mName, aEmptyOrOldValue, newValue);
}
                                  ...
                                  const nsAttrValue& aEmptyOrOldValue)
{
  ...
  DidChangeValue(
      *info.mLengthListInfo[aAttrEnum].mName, aEmptyOrOldValue, newValue);
}
...
nsSVGElement::GetAnimatedLengthListValues(SVGUserUnitList* aFirst, ...)
{
  ...
  while (list && i < info.mLengthListCount) {
    list->Init(&(info.mLengthLists[i].GetAnimValue()),
               this,
                                  ...
                                  const nsAttrValue& aEmptyOrOldValue)
{
  ...
  DidChangeValue(
      *info.mNumberListInfo[aAttrEnum].mName, aEmptyOrOldValue, newValue);
}
...
nsSVGElement::DidAnimatePointList()
{
  ...
  if (frame) {
    frame->AttributeChanged(
        kNameSpaceID_None, GetPointListAttrName(), nsIDOMMutationEvent::SMIL);
  }
}
...
nsSVGElement::DidAnimatePathSegList()
{
  ...
  if (frame) {
    frame->AttributeChanged(
        kNameSpaceID_None, GetPathDataAttrName(), nsIDOMMutationEvent::SMIL);
  }
}
...
nsSVGElement::DidChangeNumber(uint8_t aAttrEnum)
{
  ...
  SetParsedAttr(kNameSpaceID_None,
                                  ...
                                  const nsAttrValue& aEmptyOrOldValue)
{
  ...
  DidChangeValue(
      *info.mNumberPairInfo[aAttrEnum].mName, aEmptyOrOldValue, newValue);
}
                                   ...
                                   const nsAttrValue& aEmptyOrOldValue)
{
  ...
  DidChangeValue(
      *info.mIntegerPairInfo[aAttrEnum].mName, aEmptyOrOldValue, newValue);
}
...
nsSVGElement::DidAnimateViewBox()
{
  ...
  if (frame) {
    frame->AttributeChanged(
        kNameSpaceID_None, nsGkAtoms::viewBox, nsIDOMMutationEvent::SMIL);
  }
}
                                   ...
                                   uint8_t aAttrEnum)
{
  ...
  if (aIsConditionalProcessingAttribute) {
    nsCOMPtr<SVGTests> tests(
        do_QueryInterface(static_cast<nsIDOMSVGElement*>(this)));
                                          ...
                                          const nsAString& aValue)
{
  ...
  const char16_t* strings[] = {aAttribute->GetUTF16String(),
                               attributeValue.get()};
  return SVGContentUtils::ReportToConsole(
      aDocument, "AttributeParseWarning", strings, ArrayLength(strings));
}
