...
already_AddRefed<DOMSVGPathSeg>
DOMSVGPathSegList::IndexedGetter(uint32_t aIndex,
                                 bool& aFound,
                                 ErrorResult& aError)
{
  if (IsAnimValList()) {
                               ...
                               ErrorResult& aError)
{
  ...
  if (!InternalList().mData.ReplaceElementsAt(internalIndex,
                                              1 + oldArgCount,
                                              segAsRaw,
                                              1 + newArgCount,
                                              fallible)) {
...
already_AddRefed<DOMSVGPathSeg>
DOMSVGPathSegList::RemoveItem(uint32_t aIndex, ErrorResult& aError)
{
  if (IsAnimValList()) {
    aError.Throw(NS_ERROR_DOM_NO_MODIFICATION_ALLOWED_ERR);
    return nullptr;
...
void
DOMSVGPathSegList::MaybeInsertNullInAnimValListAt(uint32_t aIndex,
...
void
DOMSVGPathSegList::MaybeRemoveItemFromAnimValListAt(uint32_t aIndex,
