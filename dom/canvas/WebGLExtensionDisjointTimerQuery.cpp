...
void
WebGLExtensionDisjointTimerQuery::QueryCounterEXT(WebGLQuery& query,
                                                  GLenum target) const
{
...
void
WebGLExtensionDisjointTimerQuery::GetQueryEXT(
    JSContext* cx,
    GLenum target,
    GLenum pname,
...
void
WebGLExtensionDisjointTimerQuery::GetQueryObjectEXT(
    JSContext* cx,
