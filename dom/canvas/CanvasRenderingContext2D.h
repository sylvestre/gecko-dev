                                       ...
                                       public BasicRenderingContext2D
{
 ...
 public:
  ...
  already_AddRefed<CanvasGradient> CreateLinearGradient(double aX0,
                                                        double aY0,
                                                        double aX1,
                                                        double aY1) override;
  ...
  bool IsPointInPath(JSContext* aCx,
                     double aX,
                     double aY,
  ...
  bool IsPointInStroke(JSContext* aCx,
                       const CanvasPath& aPath,
                       double aX,
                       double aY);
  void FillText(const nsAString& aText,
                double aX,
                double aY,
                const Optional<double>& aMaxWidth,
                mozilla::ErrorResult& aError);
  void StrokeText(const nsAString& aText,
                  double aX,
                  double aY,
                  const Optional<double>& aMaxWidth,
                  mozilla::ErrorResult& aError);
  ...
  already_AddRefed<ImageData> CreateImageData(JSContext* aCx,
                                              ...
                                              mozilla::ErrorResult& aError);
  already_AddRefed<ImageData> GetImageData(JSContext* aCx,
                                           double aSx,
                                           double aSy,
                                           double aSw,
                                           double aSh,
  ...
  void BezierCurveTo(double aCp1x,
                     double aCp1y,
                     double aCp2x,
                     double aCp2y,
                     double aX,
  ...
  void DrawWindow(nsGlobalWindow& aWindow,
                  double aX,
                  double aY,
                  double aW,
                  double aH,
 ...
 protected:
  nsresult GetImageDataArray(JSContext* aCx,
                             int32_t aX,
                             int32_t aY,
                             uint32_t aWidth,
                             uint32_t aHeight,
  ...
  nsresult PutImageData_explicit(int32_t aX,
                                 int32_t aY,
                                 uint32_t aW,
                                 uint32_t aH,
