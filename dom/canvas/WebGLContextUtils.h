...
JS::Value
StringValue(JSContext* cx, const char* str, ErrorResult& rv);
...
JS::Value
WebGLContext::WebGLObjectAsJSValue(JSContext* cx,
                                   ...
                                   ErrorResult& rv) const
{
  ...
  if (!dom::GetOrCreateDOMReflector(
          cx, const_cast<WebGLObjectType*>(object), &v)) {
