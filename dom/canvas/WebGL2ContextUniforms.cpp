...
void
WebGLContext::Uniform3ui(WebGLUniformLocation* loc,
                         GLuint v0,
                         GLuint v1,
                         GLuint v2)
{
...
void
WebGL2Context::GetIndexedParameter(JSContext* cx,
                                   GLenum target,
                                   GLuint index,
                                   ...
                                   ErrorResult& out_error)
{
  ...
  if (index >= bindings->size()) {
    ErrorInvalidValue("%s: `index` must be < %s.",
                      funcName,
                                 ...
                                 JS::MutableHandleValue retval)
{
  ...
  gl->fGetActiveUniformsiv(
      program.mGLName, count, uniformIndices.Elements(), pname, samples.get());
...
void
WebGL2Context::GetActiveUniformBlockParameter(JSContext* cx,
                                              const WebGLProgram& program,
...
void
WebGL2Context::UniformBlockBinding(WebGLProgram& program,
                                   GLuint uniformBlockIndex,
