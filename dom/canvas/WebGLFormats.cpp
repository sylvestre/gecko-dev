...
static void
AddCompressedFormatInfo(EffectiveFormat format,
                        uint16_t bitsPerBlock,
                        uint8_t blockWidth,
                        uint8_t blockHeight,
                        CompressionFamily family)
{
  ...
  const CompressedFormatInfo info = {
      format, uint8_t(bytesPerBlock), blockWidth, blockHeight, family};
...
InitCompressedFormatInfo()
{
  ...
  AddCompressedFormatInfo(
      EffectiveFormat::COMPRESSED_RGB8_ETC2, 64, 4, 4, CompressionFamily::ES3);
  AddCompressedFormatInfo(
      EffectiveFormat::COMPRESSED_SRGB8_ETC2, 64, 4, 4, CompressionFamily::ES3);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA8_ETC2_EAC,
                          128,
                          4,
                          4,
                          CompressionFamily::ES3);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_SRGB8_ALPHA8_ETC2_EAC,
                          128,
                          4,
                          4,
                          CompressionFamily::ES3);
  AddCompressedFormatInfo(
      EffectiveFormat::COMPRESSED_R11_EAC, 64, 4, 4, CompressionFamily::ES3);
  AddCompressedFormatInfo(
      EffectiveFormat::COMPRESSED_RG11_EAC, 128, 4, 4, CompressionFamily::ES3);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_SIGNED_R11_EAC,
                          64,
                          4,
                          4,
                          CompressionFamily::ES3);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_SIGNED_RG11_EAC,
                          128,
                          4,
                          4,
                          CompressionFamily::ES3);
  AddCompressedFormatInfo(
      EffectiveFormat::COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2,
      64,
      4,
      4,
      CompressionFamily::ES3);
  AddCompressedFormatInfo(
      EffectiveFormat::COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2,
      64,
      4,
      4,
      CompressionFamily::ES3);
  ...
  AddCompressedFormatInfo(
      EffectiveFormat::ATC_RGB_AMD, 64, 4, 4, CompressionFamily::ATC);
  AddCompressedFormatInfo(EffectiveFormat::ATC_RGBA_EXPLICIT_ALPHA_AMD,
                          128,
                          4,
                          4,
                          CompressionFamily::ATC);
  AddCompressedFormatInfo(EffectiveFormat::ATC_RGBA_INTERPOLATED_ALPHA_AMD,
                          128,
                          4,
                          4,
                          CompressionFamily::ATC);
  ...
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGB_S3TC_DXT1_EXT,
                          64,
                          4,
                          4,
                          CompressionFamily::S3TC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_S3TC_DXT1_EXT,
                          64,
                          4,
                          4,
                          CompressionFamily::S3TC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_S3TC_DXT3_EXT,
                          128,
                          4,
                          4,
                          CompressionFamily::S3TC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_S3TC_DXT5_EXT,
                          128,
                          4,
                          4,
                          CompressionFamily::S3TC);
  ...
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_SRGB_S3TC_DXT1_EXT,
                          64,
                          4,
                          4,
                          CompressionFamily::S3TC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT,
                          64,
                          4,
                          4,
                          CompressionFamily::S3TC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT,
                          128,
                          4,
                          4,
                          CompressionFamily::S3TC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT,
                          128,
                          4,
                          4,
                          CompressionFamily::S3TC);
  ...
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_ASTC_4x4_KHR,
                          128,
                          4,
                          4,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_ASTC_5x4_KHR,
                          128,
                          5,
                          4,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_ASTC_5x5_KHR,
                          128,
                          5,
                          5,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_ASTC_6x5_KHR,
                          128,
                          6,
                          5,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_ASTC_6x6_KHR,
                          128,
                          6,
                          6,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_ASTC_8x5_KHR,
                          128,
                          8,
                          5,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_ASTC_8x6_KHR,
                          128,
                          8,
                          6,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_ASTC_8x8_KHR,
                          128,
                          8,
                          8,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_ASTC_10x5_KHR,
                          128,
                          10,
                          5,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_ASTC_10x6_KHR,
                          128,
                          10,
                          6,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_ASTC_10x8_KHR,
                          128,
                          10,
                          8,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_ASTC_10x10_KHR,
                          128,
                          10,
                          10,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_ASTC_12x10_KHR,
                          ...
                          10,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_ASTC_12x12_KHR,
                          128,
                          12,
                          12,
                          CompressionFamily::ASTC);

  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR,
                          128,
                          4,
                          4,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR,
                          128,
                          5,
                          4,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR,
                          128,
                          5,
                          5,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR,
                          128,
                          6,
                          5,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR,
                          128,
                          6,
                          6,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR,
                          128,
                          8,
                          5,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR,
                          128,
                          8,
                          6,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR,
                          128,
                          8,
                          8,
                          CompressionFamily::ASTC);
  AddCompressedFormatInfo(
      EffectiveFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR,
      128,
      10,
      5,
      CompressionFamily::ASTC);
  AddCompressedFormatInfo(
      EffectiveFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR,
      128,
      10,
      6,
      CompressionFamily::ASTC);
  AddCompressedFormatInfo(
      EffectiveFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR,
      128,
      10,
      8,
      CompressionFamily::ASTC);
  AddCompressedFormatInfo(
      EffectiveFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR,
      128,
      10,
      10,
      CompressionFamily::ASTC);
  AddCompressedFormatInfo(
      EffectiveFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR,
      128,
      12,
      10,
      CompressionFamily::ASTC);
  AddCompressedFormatInfo(
      EffectiveFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR,
      128,
      12,
      12,
      CompressionFamily::ASTC);
  ...
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGB_PVRTC_4BPPV1,
                          256,
                          8,
                          8,
                          CompressionFamily::PVRTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_PVRTC_4BPPV1,
                          256,
                          8,
                          8,
                          CompressionFamily::PVRTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGB_PVRTC_2BPPV1,
                          256,
                          16,
                          8,
                          CompressionFamily::PVRTC);
  AddCompressedFormatInfo(EffectiveFormat::COMPRESSED_RGBA_PVRTC_2BPPV1,
                          256,
                          16,
                          8,
                          CompressionFamily::PVRTC);
  ...
  AddCompressedFormatInfo(
      EffectiveFormat::ETC1_RGB8_OES, 64, 4, 4, CompressionFamily::ETC1);
}
...
#define FOO(x) EffectiveFormat::x, #x, LOCAL_GL_##x
  ...
  AddFormatInfo(FOO(R8),
                ...
                UnsizedFormat::R,
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(R8_SNORM),
                1,
                8,
                0,
                0,
                ...
                UnsizedFormat::R,
                false,
                ComponentType::NormInt);
  AddFormatInfo(FOO(RG8),
                2,
                8,
                8,
                0,
  ...
  AddFormatInfo(FOO(SRGB8),
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(SRGB8_ALPHA8),
                4,
                8,
                8,
                8,
  ...
  AddFormatInfo(FOO(R11F_G11F_B10F),
                4,
                11,
                11,
                10,
  ...
  AddFormatInfo(FOO(DEPTH_COMPONENT16),
                2,
                0,
                0,
                0,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(DEPTH_COMPONENT24),
                3,
                0,
                0,
                0,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(DEPTH_COMPONENT32F),
                4,
                0,
                0,
                0,
                ...
                false,
                ComponentType::Float);
  AddFormatInfo(FOO(DEPTH24_STENCIL8),
                4,
                0,
                0,
                0,
  ...
  AddFormatInfo(FOO(DEPTH32F_STENCIL8),
                5,
                0,
                0,
                0,
  ...
  AddFormatInfo(FOO(STENCIL_INDEX8),
                1,
                0,
                0,
                0,
  ...
  // GLES 3.0.4, p147, table 3.19
  // GLES 3.0.4  p286+  $C.1 "ETC Compressed Texture Image Formats"
  AddFormatInfo(FOO(COMPRESSED_RGB8_ETC2),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB8_ETC2),
                0,
                1,
                1,
                1,
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA8_ETC2_EAC),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB8_ALPHA8_ETC2_EAC),
                0,
                1,
                1,
                1,
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_R11_EAC),
                0,
                1,
                0,
                0,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RG11_EAC),
                0,
                1,
                1,
                0,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SIGNED_R11_EAC),
                0,
                1,
                0,
                0,
                ...
                false,
                ComponentType::NormInt);
  AddFormatInfo(FOO(COMPRESSED_SIGNED_RG11_EAC),
                0,
                1,
                1,
                0,
                ...
                false,
                ComponentType::NormInt);
  AddFormatInfo(FOO(COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2),
                0,
                1,
                1,
                1,
  ...
  AddFormatInfo(FOO(ATC_RGB_AMD),
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(ATC_RGBA_EXPLICIT_ALPHA_AMD),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(ATC_RGBA_INTERPOLATED_ALPHA_AMD),
                0,
                1,
                1,
                1,
  ...
  // EXT_texture_compression_s3tc
  AddFormatInfo(FOO(COMPRESSED_RGB_S3TC_DXT1_EXT),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_S3TC_DXT1_EXT),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_S3TC_DXT3_EXT),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_S3TC_DXT5_EXT),
                0,
                1,
                1,
                1,
  ...
  // EXT_texture_compression_s3tc_srgb
  AddFormatInfo(FOO(COMPRESSED_SRGB_S3TC_DXT1_EXT),
                0,
                1,
                1,
                1,
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT),
                0,
                1,
                1,
                1,
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT),
                0,
                1,
                1,
                1,
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT),
                0,
                1,
                1,
                1,
  ...
  // KHR_texture_compression_astc_ldr
  AddFormatInfo(FOO(COMPRESSED_RGBA_ASTC_4x4_KHR),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_ASTC_5x4_KHR),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_ASTC_5x5_KHR),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_ASTC_6x5_KHR),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_ASTC_6x6_KHR),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_ASTC_8x5_KHR),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_ASTC_8x6_KHR),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_ASTC_8x8_KHR),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_ASTC_10x5_KHR),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_ASTC_10x6_KHR),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_ASTC_10x8_KHR),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_ASTC_10x10_KHR),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_ASTC_12x10_KHR),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_ASTC_12x12_KHR),
                0,
                1,
                1,
                1,
  ...
  AddFormatInfo(FOO(COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR),
                0,
                1,
                1,
                1,
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR),
                0,
                1,
                1,
                1,
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR),
                0,
                1,
                1,
                1,
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR),
                0,
                1,
                1,
                1,
  ...
  AddFormatInfo(FOO(COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR),
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR),
                0,
                1,
                1,
                1,
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR),
                0,
                1,
                1,
                1,
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR),
                0,
                1,
                1,
                1,
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR),
                0,
                1,
                1,
                1,
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR),
                0,
                1,
                1,
                1,
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR),
                0,
                1,
                1,
                1,
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR),
                0,
                1,
                1,
                1,
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR),
                0,
                1,
                1,
                1,
                ...
                true,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR),
                0,
                1,
                1,
                1,
  ...
  // IMG_texture_compression_pvrtc
  AddFormatInfo(FOO(COMPRESSED_RGB_PVRTC_4BPPV1),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_PVRTC_4BPPV1),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGB_PVRTC_2BPPV1),
                0,
                1,
                1,
                1,
                ...
                false,
                ComponentType::NormUInt);
  AddFormatInfo(FOO(COMPRESSED_RGBA_PVRTC_2BPPV1),
                0,
                1,
                1,
                1,
  ...
  // OES_compressed_ETC1_RGB8_texture
  AddFormatInfo(FOO(ETC1_RGB8_OES),
                0,
                1,
                1,
                1,
...
#define FOO(x) EffectiveFormat::x, #x, 0
  ...
  AddFormatInfo(FOO(Luminance8Alpha8),
                2,
                8,
                0,
                0,
  ...
  AddFormatInfo(FOO(Luminance32FAlpha32F),
                ...
                false,
                ComponentType::Float);
  AddFormatInfo(FOO(Luminance32F),
                4,
                32,
                0,
                0,
  ...
  AddFormatInfo(FOO(Luminance16FAlpha16F),
                4,
                16,
                0,
                0,
                ...
                false,
                ComponentType::Float);
  AddFormatInfo(FOO(Luminance16F),
                2,
                16,
                0,
                0,
...
#undef FOO
  ...
  const auto fnSetCopyDecay = [](EffectiveFormat src,
                                 EffectiveFormat asR,
                                 EffectiveFormat asRG,
                                 EffectiveFormat asRGB,
                                 EffectiveFormat asRGBA,
                                 EffectiveFormat asL,
                                 EffectiveFormat asA,
    ...
    const auto fnSet = [&map](UnsizedFormat uf, EffectiveFormat ef) {
      if (ef == EffectiveFormat::MAX) return;
...
#define SET_COPY_DECAY(src, asR, asRG, asRGB, asRGBA, asL, asA, asLA) \
  fnSetCopyDecay(EffectiveFormat::src,                                \
                 EffectiveFormat::asR,                                \
                 EffectiveFormat::asRG,                               \
                 EffectiveFormat::asRGB,                              \
                 EffectiveFormat::asRGBA,                             \
...
#define SET_BY_SUFFIX(X)                                                   \
  ...
  SET_BY_SUFFIX(
      16F)  // RGB16F is renderable in EXT_color_buffer_half_float, though not
            // EXT_color_buffer_float.
  SET_BY_SUFFIX(
      32F)  // Technically RGB32F is never renderable, but no harm here.
...
#undef SET_BY_SUFFIX
  ...
  SET_COPY_DECAY(
      RGBA4, R8, RG8, RGB565, RGBA4, Luminance8, Alpha8, Luminance8Alpha8)
  SET_COPY_DECAY(
      RGB5_A1, R8, RG8, RGB565, RGB5_A1, Luminance8, Alpha8, Luminance8Alpha8)
...
FormatUsageInfo::ResolveMaxSamples(gl::GLContext* gl)
{
  ...
  gl->fGetInternalformativ(LOCAL_GL_RENDERBUFFER,
                           internalFormat,
                           LOCAL_GL_SAMPLES,
                           1,
                           &maxSamplesGL);
...
static void
AddSimpleUnsized(FormatUsageAuthority* fua,
                 GLenum unpackFormat,
                 GLenum unpackType,
...
AddLegacyFormats_LA8(FormatUsageAuthority* fua, gl::GLContext* gl)
{
  if (gl->IsCoreProfile()) {
    ...
    AddSimpleUnsized(fua,
                     LOCAL_GL_LUMINANCE,
                     LOCAL_GL_UNSIGNED_BYTE,
                     EffectiveFormat::Luminance8);
    AddSimpleUnsized(
        fua, LOCAL_GL_ALPHA, LOCAL_GL_UNSIGNED_BYTE, EffectiveFormat::Alpha8);
    AddSimpleUnsized(fua,
...
AddUnsizedFormats(FormatUsageAuthority* fua, gl::GLContext* gl)
{
  ...
  AddSimpleUnsized(
      fua, LOCAL_GL_RGBA, LOCAL_GL_UNSIGNED_BYTE, EffectiveFormat::RGBA8);
  AddSimpleUnsized(fua,
                   LOCAL_GL_RGBA,
  ...
  AddSimpleUnsized(
      fua, LOCAL_GL_RGB, LOCAL_GL_UNSIGNED_BYTE, EffectiveFormat::RGB8);
  AddSimpleUnsized(fua,
                   LOCAL_GL_RGB,
...
FormatUsageAuthority::CreateForWebGL1(gl::GLContext* gl)
{
  ...
  const auto fnSet =
      [ptr](EffectiveFormat effFormat, bool isRenderable, bool isFilterable) {
...
#define FOO(x) EffectiveFormat::x, LOCAL_GL_##x
  ...
  fnAddSizedUnpack(
      FOO(RGB5_A1), LOCAL_GL_RGBA, LOCAL_GL_UNSIGNED_SHORT_5_5_5_1);
  fnAddSizedUnpack(FOO(RGB5_A1), LOCAL_GL_RGBA, LOCAL_GL_UNSIGNED_BYTE);
  fnAddSizedUnpack(
      FOO(RGB5_A1), LOCAL_GL_RGBA, LOCAL_GL_UNSIGNED_INT_2_10_10_10_REV);
  ...
  fnAddSizedUnpack(
      FOO(RGB10_A2), LOCAL_GL_RGBA, LOCAL_GL_UNSIGNED_INT_2_10_10_10_REV);
  ...
  fnAddSizedUnpack(
      FOO(RGBA16UI), LOCAL_GL_RGBA_INTEGER, LOCAL_GL_UNSIGNED_SHORT);
  ...
  fnAddSizedUnpack(FOO(RGB10_A2UI),
  ...
  fnAddSizedUnpack(
      FOO(R11F_G11F_B10F), LOCAL_GL_RGB, LOCAL_GL_UNSIGNED_INT_10F_11F_11F_REV);
  ...
  // DEPTH_COMPONENT
  fnAddSizedUnpack(FOO(DEPTH_COMPONENT16),
                   LOCAL_GL_DEPTH_COMPONENT,
                   LOCAL_GL_UNSIGNED_SHORT);
  fnAddSizedUnpack(
      FOO(DEPTH_COMPONENT16), LOCAL_GL_DEPTH_COMPONENT, LOCAL_GL_UNSIGNED_INT);
  fnAddSizedUnpack(
      FOO(DEPTH_COMPONENT24), LOCAL_GL_DEPTH_COMPONENT, LOCAL_GL_UNSIGNED_INT);
  fnAddSizedUnpack(
      FOO(DEPTH_COMPONENT32F), LOCAL_GL_DEPTH_COMPONENT, LOCAL_GL_FLOAT);

  // DEPTH_STENCIL
  fnAddSizedUnpack(FOO(DEPTH24_STENCIL8),
                   LOCAL_GL_DEPTH_STENCIL,
                   LOCAL_GL_UNSIGNED_INT_24_8);
  fnAddSizedUnpack(FOO(DEPTH32F_STENCIL8),
                   LOCAL_GL_DEPTH_STENCIL,
...
#undef FOO
  ...
  if (gfxPrefs::WebGL2CompatMode()) {
    AddSimpleUnsized(
        ptr, LOCAL_GL_RGBA, LOCAL_GL_FLOAT, EffectiveFormat::RGBA32F);
    AddSimpleUnsized(
        ptr, LOCAL_GL_RGB, LOCAL_GL_FLOAT, EffectiveFormat::RGB32F);

    AddSimpleUnsized(
        ptr, LOCAL_GL_RGBA, LOCAL_GL_HALF_FLOAT_OES, EffectiveFormat::RGBA16F);
    AddSimpleUnsized(
        ptr, LOCAL_GL_RGB, LOCAL_GL_HALF_FLOAT_OES, EffectiveFormat::RGB16F);
  }
...
void
FormatUsageAuthority::AddTexUnpack(FormatUsageInfo* usage,
...
bool
FormatUsageAuthority::AreUnpackEnumsValid(GLenum unpackFormat,
...
void
FormatUsageAuthority::AllowRBFormat(GLenum sizedFormat,
