                                   ...
                                   bool)
{
  ...
  MOZ_COLLECT_REPORT("webgl-texture-count",
                     KIND_OTHER,
                     UNITS_COUNT,
                     GetTextureCount(),
  ...
  MOZ_COLLECT_REPORT("webgl-buffer-count",
                     KIND_OTHER,
                     UNITS_COUNT,
                     GetBufferCount(),
  ...
  MOZ_COLLECT_REPORT("webgl-renderbuffer-count",
                     KIND_OTHER,
                     UNITS_COUNT,
  ...
  MOZ_COLLECT_REPORT("webgl-shader-count",
                     KIND_OTHER,
                     UNITS_COUNT,
                     GetShaderCount(),
                     "Number of WebGL shaders.");

  MOZ_COLLECT_REPORT("webgl-context-count",
                     KIND_OTHER,
                     UNITS_COUNT,
                     GetContextCount(),
