...
class TexUnpackBlob
{
 ...
 protected:
  TexUnpackBlob(const WebGLContext* webgl,
 ...
 public:
  ...
  // error.
  virtual bool TexOrSubImage(bool isSubImage,
                             bool needsRespec,
                             const char* funcName,
                             WebGLTexture* tex,
                             TexImageTarget target,
...
class TexUnpackBytes final : public TexUnpackBlob
{
 public:
  ...
  TexUnpackBytes(const WebGLContext* webgl,
                 TexImageTarget target,
                 uint32_t width,
                 uint32_t height,
                 uint32_t depth,
...
class TexUnpackImage final : public TexUnpackBlob
{
 public:
  ...
  TexUnpackImage(const WebGLContext* webgl,
                 TexImageTarget target,
                 uint32_t width,
                 uint32_t height,
                 uint32_t depth,
...
class TexUnpackSurface final : public TexUnpackBlob
{
 public:
  ...
  TexUnpackSurface(const WebGLContext* webgl,
                   TexImageTarget target,
                   uint32_t width,
                   uint32_t height,
                   uint32_t depth,
