                             ...
                             uint32_t dataLen)
{
  ...
  if (!ValidatePackSize("readPixels",
                        width,
                        height,
                        bytesPerPixel,
                        &rowStride,
...
void
WebGLContext::Uniform4i(
    WebGLUniformLocation* loc, GLint a1, GLint a2, GLint a3, GLint a4)
{
...
WebGLContext::Uniform4f(
    WebGLUniformLocation* loc, GLfloat a1, GLfloat a2, GLfloat a3, GLfloat a4)
{
