...
struct TexImageSourceAdapter final : public TexImageSource
{
  ...
  TexImageSourceAdapter(const dom::ArrayBufferView* view,
  ...
  TexImageSourceAdapter(const WebGLsizeiptr* pboOffset,
                        GLuint ignored1,
                        GLuint ignored2 = 0)
  {
...
class WebGLContext : public nsIDOMWebGLRenderingContext,
                     ...
                     public nsWrapperCache
{
 ...
 public:
  ...
  NS_DECL_CYCLE_COLLECTION_SCRIPT_HOLDER_CLASS_AMBIGUOUS(
      WebGLContext, nsIDOMWebGLRenderingContext)
  ...
  void ErrorInvalidEnumInfo(const char* info,
                            const char* funcName,
                            GLenum enumValue);
  ...
  void ErrorInvalidEnumArg(const char* funcName,
                           const char* argName,
                           GLenum val);
  ...
  void GetExtension(JSContext* cx,
                    const nsAString& name,
                    JS::MutableHandle<JSObject*> retval,
                    dom::CallerType callerType,
                    ErrorResult& rv);
  void AttachShader(WebGLProgram& prog, WebGLShader& shader);
  void BindAttribLocation(WebGLProgram& prog,
                          GLuint location,
                          const nsAString& name);
  ...
  void GetBufferParameter(JSContext*,
                          GLenum target,
                          GLenum pname,
  ...
  void GetProgramParameter(JSContext*,
  ...
  void GetShaderParameter(JSContext*,
  ...
  JS::Value GetUniform(JSContext* cx,
                       const WebGLProgram& prog,
                       const WebGLUniformLocation& loc);

  void GetUniform(JSContext* cx,
                  const WebGLProgram& prog,
                  const WebGLUniformLocation& loc,
                  JS::MutableHandle<JS::Value> retval)
  {
 ...
 protected:
  void RenderbufferStorage_base(const char* funcName,
                                GLenum target,
                                GLsizei samples,
                                GLenum internalformat,
                                GLsizei width,
 ...
 public:
  ...
  void Uniform4f(
      WebGLUniformLocation* loc, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
  ...
  void Uniform4ui(
      WebGLUniformLocation* loc, GLuint v0, GLuint v1, GLuint v2, GLuint v3);
 ...
 protected:
  ...
  void UniformNfv(const char* funcName,
                  uint8_t N,
                  WebGLUniformLocation* loc,
                  const Float32Arr& arr,
                  GLuint elemOffset,
                  GLuint elemCountOverride);
  void UniformNiv(const char* funcName,
                  uint8_t N,
                  WebGLUniformLocation* loc,
                  const Int32Arr& arr,
                  GLuint elemOffset,
                  GLuint elemCountOverride);
  void UniformNuiv(const char* funcName,
                   uint8_t N,
                   WebGLUniformLocation* loc,
                   const Uint32Arr& arr,
                   GLuint elemOffset,
  ...
  void UniformMatrixAxBfv(const char* funcName,
                          uint8_t A,
                          uint8_t B,
                          WebGLUniformLocation* loc,
                          bool transpose,
 ...
 public:
#define FOO(N)                                      \
  void Uniform##N##fv(WebGLUniformLocation* loc,    \
                      const Float32ListU& list,     \
                      GLuint elemOffset = 0,        \
                      GLuint elemCountOverride = 0) \
  {                                                 \
    UniformNfv("uniform" #N "fv",                   \
               N,                                   \
               loc,                                 \
               Float32Arr::From(list),              \
               elemOffset,                          \
               elemCountOverride);                  \
  }
...
#define FOO(N)                                      \
  void Uniform##N##iv(WebGLUniformLocation* loc,    \
                      const Int32ListU& list,       \
                      GLuint elemOffset = 0,        \
                      GLuint elemCountOverride = 0) \
  {                                                 \
    UniformNiv("uniform" #N "iv",                   \
               N,                                   \
               loc,                                 \
               Int32Arr::From(list),                \
               elemOffset,                          \
...
#define FOO(N)                                       \
  void Uniform##N##uiv(WebGLUniformLocation* loc,    \
                       const Uint32ListU& list,      \
                       GLuint elemOffset = 0,        \
                       GLuint elemCountOverride = 0) \
  {                                                  \
    UniformNuiv("uniform" #N "uiv",                  \
                N,                                   \
                loc,                                 \
                Uint32Arr::From(list),               \
                elemOffset,                          \
...
#define FOO(X, A, B)                                      \
  void UniformMatrix##X##fv(WebGLUniformLocation* loc,    \
                            bool transpose,               \
                            const Float32ListU& list,     \
                            GLuint elemOffset = 0,        \
                            GLuint elemCountOverride = 0) \
  {                                                       \
    UniformMatrixAxBfv("uniformMatrix" #X "fv",           \
                       A,                                 \
                       B,                                 \
                       loc,                               \
                       transpose,                         \
...
#undef FOO
  ...
  bool ValidateAttribArraySetter(const char* name,
                                 uint32_t count,
                                 uint32_t arrayLength);
  bool ValidateUniformLocation(WebGLUniformLocation* loc, const char* funcName);
  bool ValidateUniformSetter(WebGLUniformLocation* loc,
                             uint8_t setterSize,
                             GLenum setterType,
                             const char* funcName);
 ...
 public:
  ...
  void BufferData(GLenum target,
                  ...
                  GLenum usage);
  void BufferData(GLenum target,
                  const dom::ArrayBufferView& srcData,
                  GLenum usage,
 ...
 public:
  ...
  void GetQuery(JSContext* cx,
                GLenum target,
                GLenum pname,
                JS::MutableHandleValue retval,
                const char* funcName = nullptr);
  void GetQueryParameter(JSContext* cx,
                         const WebGLQuery& query,
                         GLenum pname,
                         JS::MutableHandleValue retval,
                         const char* funcName = nullptr);
 ...
 public:
  ...
  void GetParameter(JSContext* cx,
                    GLenum pname,
                    JS::MutableHandle<JS::Value> retval,
                    ErrorResult& rv)
  {
  ...
  void GetParameterIndexed(JSContext* cx,
                           GLenum pname,
                           GLuint index,
                           JS::MutableHandle<JS::Value> retval);
 ...
 public:
  ...
  void GetTexParameter(JSContext*,
                       GLenum texTarget,
                       GLenum pname,
                       JS::MutableHandle<JS::Value> retval)
  {
 ...
 protected:
  ...
  void TexParameter_base(GLenum texTarget,
                         GLenum pname,
 ...
 public:
                            ...
                            GLuint viewElemLengthOverride = 0)
  {
    ...
    const uint8_t funcDims = 2;
    const GLsizei depth = 1;
    const TexImageSourceAdapter src(
        &anySrc, viewElemOffset, viewElemLengthOverride);
    CompressedTexImage(funcName,
                       funcDims,
                       target,
                       level,
 ...
 protected:
  void CompressedTexImage(const char* funcName,
                          uint8_t funcDims,
                          GLenum target,
                          GLint level,
                          GLenum internalFormat,
  ...
  void CompressedTexSubImage(const char* funcName,
                             uint8_t funcDims,
                             GLenum target,
                             GLint level,
                             GLint xOffset,
 ...
 protected:
  void CopyTexSubImage(const char* funcName,
                       uint8_t funcDims,
                       GLenum target,
                       GLint level,
                       GLint xOffset,
 ...
 protected:
  ...
  void TexImage(const char* funcName,
                uint8_t funcDims,
                GLenum target,
                GLint level,
                GLenum internalFormat,
 ...
 protected:
  ...
  void TexSubImage(const char* funcName,
                   uint8_t funcDims,
                   GLenum target,
                   GLint level,
                   GLint xOffset,
 ...
 protected:
  ...
  bool ValidateTexImageSelection(const char* funcName,
                                 uint8_t funcDims,
                                 GLenum texImageTarget,
                                 GLint level,
                                 GLint xOffset,
                                 ...
                                 WebGLTexture** const out_texture,
                                 WebGLTexture::ImageInfo** const out_imageInfo);
  bool ValidateUnpackInfo(const char* funcName,
                          bool usePBOs,
                          GLenum format,
                          GLenum type,
 ...
 public:
  ...
  JS::Value GetVertexAttrib(JSContext* cx,
                            GLuint index,
                            GLenum pname,
                            ErrorResult& rv);

  void GetVertexAttrib(JSContext* cx,
                       GLuint index,
                       GLenum pname,
                       JS::MutableHandle<JS::Value> retval,
                       ErrorResult& rv)
  ...
  void VertexAttrib4f(GLuint index,
                      GLfloat x,
                      GLfloat y,
                      GLfloat z,
                      GLfloat w,
 ...
 protected:
  void VertexAttribAnyPointer(const char* funcName,
                              bool isFuncInt,
                              GLuint index,
                              GLint size,
                              GLenum type,
 ...
 public:
                           ...
                           WebGLintptr byteOffset)
  {
    ...
    VertexAttribAnyPointer(
        funcName, isFuncInt, index, size, type, normalized, stride, byteOffset);
  }
 ...
 private:
  ...
  bool DrawArrays_check(const char* funcName,
                        GLenum mode,
                        GLint first,
                        GLsizei vertCount,
                        GLsizei instanceCount);
  bool DrawElements_check(const char* funcName,
                          GLenum mode,
                          GLsizei vertCount,
                          GLenum type,
                          WebGLintptr byteOffset,
  ...
  void VertexAttrib1fv_base(GLuint index,
                            uint32_t arrayLength,
                            const GLfloat* ptr);
  void VertexAttrib2fv_base(GLuint index,
                            uint32_t arrayLength,
                            const GLfloat* ptr);
  void VertexAttrib3fv_base(GLuint index,
                            uint32_t arrayLength,
                            const GLfloat* ptr);
  void VertexAttrib4fv_base(GLuint index,
                            uint32_t arrayLength,
                            const GLfloat* ptr);
 ...
 protected:
  ...
  bool ValidateBlendFuncEnumsCompatibility(GLenum sfactor,
                                           GLenum dfactor,
                                           const char* info);
  ...
  bool ValidateAttribPointer(bool integerMode,
                             GLuint index,
                             GLint size,
                             GLenum type,
                             WebGLboolean normalized,
  ...
  bool ValidateCopyTexImageInternalFormat(GLenum format,
                                          WebGLTexImageFunc func,
                                          WebGLTexDimensions dims);
  bool ValidateTexImageSize(TexImageTarget texImageTarget,
                            GLint level,
                            GLint width,
                            GLint height,
                            GLint depth,
                            WebGLTexImageFunc func,
                            WebGLTexDimensions dims);
  bool ValidateTexSubImageSize(GLint x,
                               GLint y,
                               GLint z,
                               GLsizei width,
                               GLsizei height,
 ...
 protected:
  ...
  bool ValidateNonNegative(const char* funcName,
                           const char* argName,
                           int64_t val)
  {
 ...
 protected:
  ...
  bool ConvertImage(size_t width,
                    size_t height,
                    size_t srcStride,
                    size_t dstStride,
                    const uint8_t* src,
 ...
 public:
  ...
  bool ValidateObject(const char* funcName,
 ...
 protected:
  ...
  bool ValidateInvalidateFramebuffer(const char* funcName,
                                     GLenum target,
  ...
  CheckedUint32 GetUnpackSize(bool isFunc3D,
                              uint32_t width,
                              uint32_t height,
                              uint32_t depth,
                              uint8_t bytesPerPixel);

  bool ValidatePackSize(const char* funcName,
                        uint32_t width,
                        uint32_t height,
                        uint8_t bytesPerPixel,
  ...
  bool BindFakeBlack(uint32_t texUnit,
                     TexTarget target,
 ...
 protected:
  ...
  struct ScopedDrawCallWrapper final
  {
    ...
    static bool ShouldFakeNoAlpha(WebGLContext& webgl)
    {
      ...
      return !webgl.mBoundDrawFramebuffer && webgl.mNeedsFakeNoAlpha &&
    ...
    static bool ShouldFakeNoDepth(WebGLContext& webgl)
    {
      ...
      return !webgl.mBoundDrawFramebuffer && webgl.mNeedsFakeNoDepth &&
    ...
    {
      if (!webgl.mStencilTestEnabled) return false;

      if (!webgl.mBoundDrawFramebuffer) {
        if (webgl.mNeedsFakeNoStencil) return true;

        if (webgl.mNeedsEmulatedLoneDepthStencil && webgl.mOptions.depth &&
            !webgl.mOptions.stencil) {
          return true;
        }
...
bool
ValidateTexTarget(WebGLContext* webgl,
                  const char* funcName,
                  uint8_t funcDims,
                  GLenum rawTexTarget,
...
bool
ValidateTexImageTarget(WebGLContext* webgl,
                       const char* funcName,
                       uint8_t funcDims,
...
bool
Intersect(int32_t srcSize,
          int32_t read0,
          int32_t readSize,
          int32_t* out_intRead0,
