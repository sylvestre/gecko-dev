...
class WebGLFBAttachPoint final
{
 ...
 public:
  ...
  void SetTexImage(const char* funcName,
                   WebGLTexture* tex,
  ...
  JS::Value GetParameter(const char* funcName,
                         WebGLContext* webgl,
                         JSContext* cx,
                         GLenum target,
                         GLenum attachment,
                               ...
                               public SupportsWeakPtr<WebGLFramebuffer>
{
 ...
 public:
  ...
  bool ValidateClearBufferType(const char* funcName,
                               GLenum buffer,
                               uint32_t drawBuffer,
...
#undef GETTER
  ...
  void FramebufferRenderbuffer(const char* funcName,
                               GLenum attachment,
                               GLenum rbtarget,
                               WebGLRenderbuffer* rb);
  void FramebufferTexture2D(const char* funcName,
                            GLenum attachment,
                            GLenum texImageTarget,
                            WebGLTexture* tex,
                            GLint level);
  void FramebufferTextureLayer(const char* funcName,
                               GLenum attachment,
                               WebGLTexture* tex,
                               GLint level,
                               GLint layer);
  ...
  JS::Value GetAttachmentParameter(const char* funcName,
                                   JSContext* cx,
                                   GLenum target,
                                   GLenum attachment,
                                   GLenum pname,
  ...
  static void BlitFramebuffer(WebGLContext* webgl,
                              const WebGLFramebuffer* src,
                              GLint srcX0,
                              GLint srcY0,
                              GLint srcX1,
                              GLint srcY1,
                              const WebGLFramebuffer* dst,
                              GLint dstX0,
                              GLint dstY0,
                              GLint dstX1,
                              GLint dstY1,
