...
WebGLContext::CreateShaderValidator(GLenum shaderType) const
{
  ...
  return webgl::ShaderValidator::Create(
      shaderType, spec, outputLanguage, resources, compileOptions);
}
...
ShaderValidator::Create(GLenum shaderType,
                        ShShaderSpec spec,
                        ...
                        ShCompileOptions compileOptions)
{
  ...
  return new ShaderValidator(
      handle, compileOptions, resources.MaxVaryingVectors);
}
...
bool
ShaderValidator::CanLinkTo(const ShaderValidator* prev,
...
bool
ShaderValidator::FindAttribUserNameByMappedName(
    const std::string& mappedName, const std::string** const out_userName) const
{
...
bool
ShaderValidator::FindAttribMappedNameByUserName(
...
bool
ShaderValidator::FindVaryingMappedNameByUserName(
    const std::string& userName, const std::string** const out_mappedName) const
{
...
void
ShaderValidator::EnumerateFragOutputs(
