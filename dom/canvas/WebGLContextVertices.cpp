...
WebGLContext::GetVertexAttribFloat32Array(JSContext* cx, GLuint index)
{
  ...
  if (index) {
    ...
    memcpy(
        attrib, mGenericVertexAttrib0Data, sizeof(mGenericVertexAttrib0Data));
  }
...
void
WebGLContext::VertexAttrib4f(GLuint index,
                             GLfloat x,
                             GLfloat y,
                             GLfloat z,
                             GLfloat w,
                             const char* funcName)
{
  ...
  if (!ValidateAttribIndex(index, funcName)) return;
...
void
WebGL2Context::VertexAttribI4i(
    GLuint index, GLint x, GLint y, GLint z, GLint w, const char* funcName)
{
  if (!funcName) {
...
void
WebGL2Context::VertexAttribI4ui(
    GLuint index, GLuint x, GLuint y, GLuint z, GLuint w, const char* funcName)
{
  if (!funcName) {
...
WebGLContext::EnableVertexAttribArray(GLuint index)
{
  ...
  if (!ValidateAttribIndex(index, "enableVertexAttribArray")) return;
...
WebGLContext::DisableVertexAttribArray(GLuint index)
{
  ...
  if (!ValidateAttribIndex(index, "disableVertexAttribArray")) return;
...
JS::Value
WebGLContext::GetVertexAttrib(JSContext* cx,
                              GLuint index,
                              GLenum pname,
                              ErrorResult& rv)
{
  ...
  if (!ValidateAttribIndex(index, funcName)) return JS::NullValue();
...
WebGLContext::GetVertexAttribOffset(GLuint index, GLenum pname)
{
  ...
  if (!ValidateAttribIndex(index, "getVertexAttribOffset")) return 0;
...
void
WebGLContext::VertexAttribAnyPointer(const char* funcName,
                                     bool isFuncInt,
                                     GLuint index,
                                     GLint size,
                                     GLenum type,
                                     ...
                                     WebGLintptr byteOffset)
{
  ...
  if (stride & typeAlignmentMask || byteOffset & typeAlignmentMask) {
    ErrorInvalidOperation(
        "%s: `stride` and `byteOffset` must satisfy the alignment"
        " requirement of `type`.",
        funcName);
    return;
  }
  ...
  if (!buffer && byteOffset) {
    ErrorInvalidOperation(
        "%s: If ARRAY_BUFFER is null, byteOffset must be zero.", funcName);
    return;
  }
  ...
  gl->MakeCurrent();
  if (isFuncInt) {
    gl->fVertexAttribIPointer(
        index, size, type, stride, reinterpret_cast<void*>(byteOffset));
  } else {
    gl->fVertexAttribPointer(index,
                             size,
                             type,
                             normalized,
                             stride,
  ...
  vd.VertexAttribPointer(
      isFuncInt, buffer, size, type, normalized, stride, byteOffset);
...
WebGLContext::VertexAttribDivisor(GLuint index, GLuint divisor)
{
  ...
  if (!ValidateAttribIndex(index, "vertexAttribDivisor")) return;
