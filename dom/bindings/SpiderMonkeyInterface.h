...
struct SpiderMonkeyInterfaceObjectStorage
{
 protected:
  ...
  SpiderMonkeyInterfaceObjectStorage() : mImplObj(nullptr), mWrappedObj(nullptr)
  {
  }
 ...
 public:
  ...
  {
    JS::UnsafeTraceRoot(
        trc, &mImplObj, "SpiderMonkeyInterfaceObjectStorage.mImplObj");
    JS::UnsafeTraceRoot(
        trc, &mWrappedObj, "SpiderMonkeyInterfaceObjectStorage.mWrappedObj");
  }
    ...
    : private JS::CustomAutoRooter
{
 public:
  ...
  SpiderMonkeyInterfaceRooter(const CX& cx,
                              Nullable<InterfaceType>* aInterface
