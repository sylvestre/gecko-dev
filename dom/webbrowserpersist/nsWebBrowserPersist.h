                                  ...
                                  public nsSupportsWeakReference
{
 ...
 private:
  ...
  nsresult SaveURIInternal(nsIURI* aURI,
                           ...
                           bool aCalcFileExt,
                           bool aIsPrivate);
  nsresult SaveChannelInternal(nsIChannel* aChannel,
                               nsIURI* aFile,
                               bool aCalcFileExt);
  ...
  nsresult StartUpload(nsIStorageStream* aOutStream,
                       nsIURI* aDestinationURI,
                       const nsACString& aContentType);
  nsresult StartUpload(nsIInputStream* aInputStream,
                       nsIURI* aDestinationURI,
                       const nsACString& aContentType);
  nsresult CalculateAndAppendFileExt(nsIURI* aURI,
                                     nsIChannel* aChannel,
  ...
  nsresult StoreURI(const char* aURI,
                    bool aNeedsPersisting = true,
                    URIData** aData = nullptr);
  nsresult StoreURI(nsIURI* aURI,
                    bool aNeedsPersisting = true,
                    URIData** aData = nullptr);
  ...
  nsresult SaveSubframeContent(nsIWebBrowserPersistDocument* aFrameContent,
                               ...
                               URIData* aData);
  nsresult SendErrorStatusChange(bool aIsReadError,
                                 nsresult aResult,
                                 nsIRequest* aRequest,
                                 nsIURI* aURI);
