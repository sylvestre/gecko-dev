...
class ServiceWorkerRegistrationListener
{
 public:
  ...
  virtual void InvalidateWorkers(WhichServiceWorker aWhichOnes) = 0;

  virtual void TransitionWorker(WhichServiceWorker aWhichOne) = 0;
...
class ServiceWorkerRegistration : public DOMEventTargetHelper
{
 public:
  ...
  static bool Visible(JSContext* aCx, JSObject* aObj);

  static bool NotificationAPIVisible(JSContext* aCx, JSObject* aObj);
  ...
  virtual already_AddRefed<workers::ServiceWorker> GetInstalling() = 0;

  virtual already_AddRefed<workers::ServiceWorker> GetWaiting() = 0;

  virtual already_AddRefed<workers::ServiceWorker> GetActive() = 0;

  virtual void GetScope(nsAString& aScope) const = 0;

  virtual ServiceWorkerUpdateViaCache UpdateViaCache() const = 0;
