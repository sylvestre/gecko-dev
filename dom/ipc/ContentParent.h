                            ...
                            public mozilla::MemoryReportingProcess
{
 ...
 public:
  ...
  virtual mozilla::ipc::IPCResult RecvRecordingDeviceEvents(
      const nsString& aRecordingStatus,
 ...
 private:
  ...
  virtual PFlyWebPublishedServerParent* AllocPFlyWebPublishedServerParent(
      const nsString& name, const FlyWebPublishOptions& params) override;

  virtual bool DeallocPFlyWebPublishedServerParent(
      PFlyWebPublishedServerParent* aActor) override;
