                           ...
                           public nsIContentChild
{
 ...
 public:
  ...
  virtual mozilla::ipc::IPCResult RecvPCycleCollectWithLogsConstructor(
      PCycleCollectWithLogsChild* aChild,
      const bool& aDumpAllTraces,
      const FileDescriptor& aGCLog,
      const FileDescriptor& aCCLog) override;
  ...
  virtual PFlyWebPublishedServerChild* AllocPFlyWebPublishedServerChild(
      const nsString& name, const FlyWebPublishOptions& params) override;

  virtual bool DeallocPFlyWebPublishedServerChild(
      PFlyWebPublishedServerChild* aActor) override;
  ...
  virtual mozilla::ipc::IPCResult RecvPreferenceUpdate(
      const PrefSetting& aPref) override;
  ...
  InfallibleTArray<mozilla::dom::FontFamilyListEntry>& SystemFontFamilyList()
  {
  ...
  void FileCreationRequest(nsID& aUUID,
