 ...
 */
class nsXULTemplateQueryProcessorRDF final
      ...
      public nsIRDFObserver
{
 public:
  ...
  /*
     ...
     */
  nsresult Propagate(nsIRDFResource* aSource,
  ...
  /*
     ...
     */
  nsresult Retract(nsIRDFResource* aSource,
                   nsIRDFResource* aProperty,
                   nsIRDFNode* aTarget);
  ...
  /*
     ...
     */
  nsresult SynchronizeAll(nsIRDFResource* aSource,
                          nsIRDFResource* aProperty,
  ...
  /*
     ...
     */
  nsresult CheckContainer(nsIRDFResource* aTargetResource, bool* aIsContainer);

  /*
     * Check if a resource does not have any children
     */
  nsresult CheckEmpty(nsIRDFResource* aTargetResource, bool* aIsEmpty);

  /**
     * Check if a resource is a separator
     */
  nsresult CheckIsSeparator(nsIRDFResource* aResource, bool* aIsSeparator);
  ...
  /*
     ...
     */
  nsresult ComputeContainmentProperties(nsIDOMNode* aRootNode);
  ...
  /**
     ...
     */
  nsresult CompileExtendedQuery(nsRDFQuery* aQuery,
  ...
  /**
     ...
     */
  virtual nsresult CompileQueryChild(nsAtom* aTag,
                                     nsRDFQuery* aQuery,
                                     nsIContent* aConditions,
  ...
  /**
     ...
     * set as a child of aParentNode.
     */
  nsresult CompileTripleCondition(nsRDFQuery* aQuery,
  ...
  /**
     ...
     * set as a child of aParentNode.
     */
  nsresult CompileMemberCondition(nsRDFQuery* aQuery,
                                  nsIContent* aCondition,
                                  TestNode* aParentNode,
                                  TestNode** aResult);
  ...
  /**
     ...
     */
  nsresult AddDefaultSimpleRules(nsRDFQuery* aQuery, TestNode** aChildNode);
  ...
  /**
     ...
     * which owns the nodes.
     */
  nsresult CompileSimpleQuery(nsRDFQuery* aQuery,
                              nsIContent* aQueryElement,
                              TestNode** aLastNode);

  RDFBindingSet* GetBindingsForRule(nsIDOMNode* aRule);
  ...
  /*
     ...
     */
  void AddBindingDependency(nsXULTemplateResultRDF* aResult,
                            nsIRDFResource* aResource);

  /**
     * Remove a dependency a result has on a particular resource.
     */
  void RemoveBindingDependency(nsXULTemplateResultRDF* aResult,
                               nsIRDFResource* aResource);
  ...
  /**
     ...
     */
  nsresult AddMemoryElements(const Instantiation& aInst,
  ...
  /**
     ...
     */
  nsresult RemoveMemoryElements(const Instantiation& aInst,
                                nsXULTemplateResultRDF* aResult);
  ...
  /**
     ...
     */
  int32_t GetContainerIndexOf(nsIXULTemplateResult* aResult);
  ...
  /**
     ...
     */
  nsresult GetSortValue(nsIXULTemplateResult* aResult,
  ...
  nsresult Log(const char* aOperation,
               nsIRDFResource* aSource,
               nsIRDFResource* aProperty,
               nsIRDFNode* aTarget);

#define LOG(_op, _src, _prop, _targ) Log(_op, _src, _prop, _targ)
 ...
 protected:
  ...
  /**
     ...
     */
  nsClassHashtable<nsUint32HashKey, nsCOMArray<nsXULTemplateResultRDF> >
