                             ...
                             public nsWrapperCache
{
 ...
 public:
  ...
  Element* GetParentObject() { return mRoot; }
  ...
  nsIRDFCompositeDataSource* GetDatabase() { return mCompDB; }
  nsIXULTemplateResult* GetRootResult() { return mRootResult; }
  void Rebuild(mozilla::ErrorResult& aError);
  void Refresh(mozilla::ErrorResult& aError);
  void AddResult(nsIXULTemplateResult* aResult,
                 nsINode& aQueryNode,
  ...
  void AddRuleFilter(nsINode& aRule,
  ...
  /**
     ...
     */
  nsresult UpdateResult(nsIXULTemplateResult* aOldResult,
                        nsIXULTemplateResult* aNewResult,
                        nsINode* aQueryNode);
  ...
  /**
     ...
     */
  nsresult UpdateResultInContainer(nsIXULTemplateResult* aOldResult,
                                   nsIXULTemplateResult* aNewResult,
  ...
  static bool IsTemplateElement(nsIContent* aContent);

  virtual nsresult RebuildAll() = 0;  // must be implemented by subclasses
  ...
  /**
     ...
     */
  nsresult CompileTemplate(nsIContent* aTemplate,
                           nsTemplateQuerySet* aQuerySet,
                           bool aIsQuerySet,
                           int32_t* aPriority,
  ...
  /**
     ...
     */
  nsresult CompileExtendedQuery(nsIContent* aRuleElement,
  ...
  /**
     ...
     */
  nsresult CompileSimpleQuery(nsIContent* aRuleElement,
                              nsTemplateQuerySet* aQuerySet,
                              bool* aCanUseTemplate);
  ...
  /**
     ...
     */
  nsresult CompileWhereCondition(nsTemplateRule* aRule,
  ...
  static void AddBindingsFor(nsXULTemplateBuilder* aSelf,
  ...
  /**
     ...
     */
  nsresult LoadDataSources(nsIDocument* aDoc, bool* shouldDelayBuilding);
  ...
  /**
     ...
     * RDF processor.
     */
  nsresult LoadDataSourceUrls(nsIDocument* aDocument,
  ...
  /**
     ...
     */
  nsresult DetermineMatchedRule(nsIContent* aContainer,
  ...
  void ParseAttribute(const nsAString& aAttributeValue,
                      void (*aVariableCallback)(nsXULTemplateBuilder* aThis,
                                                const nsAString&,
                                                void*),
                      void (*aTextCallback)(nsXULTemplateBuilder* aThis,
                                            const nsAString&,
                                            void*),
                      void* aClosure);

  nsresult SubstituteText(nsIXULTemplateResult* aMatch,
                          const nsAString& aAttributeValue,
                          nsAString& aResult);

  static void SubstituteTextAppendText(nsXULTemplateBuilder* aThis,
                                       const nsAString& aText,
                                       void* aClosure);

  static void SubstituteTextReplaceVariable(nsXULTemplateBuilder* aThis,
                                            const nsAString& aVariable,
                                            void* aClosure);
 ...
 protected:
  ...
  class ActivationEntry
  {
   public:
    ...
    ActivationEntry(nsIRDFResource* aResource, ActivationEntry** aLink)
        : mResource(aResource), mPrevious(*aLink), mLink(aLink)
    {
      *mLink = this;
    }
  ...
  /**
     ...
     */
  bool IsActivated(nsIRDFResource* aResource);
  ...
  /**
     ...
     */
  virtual bool GetInsertionLocations(nsIXULTemplateResult* aResult,
  ...
  /**
     ...
     * have changed.
     */
  virtual nsresult SynchronizeResult(nsIXULTemplateResult* aResult) = 0;
  ...
  /**
     ...
     */
  void OutputMatchToLog(nsIRDFResource* aId,
