...
class nsXULPrototypeElement : public nsXULPrototypeNode
{
 public:
  ...
  nsresult SetAttrAt(uint32_t aPos,
...
class nsXULPrototypeScript : public nsXULPrototypeNode
{
 public:
  ...
  nsresult Compile(const char16_t* aText,
                   int32_t aTextLength,
                   nsIURI* aURI,
                   uint32_t aLineNo,
                   nsIDocument* aDocument,
...
class nsXULElement final : public nsStyledElement, public nsIDOMXULElement
{
 public:
  ...
  bool GetTemplateGenerated()
  {
    return HasFlag(XUL_ELEMENT_TEMPLATE_GENERATED);
  }
  ...
  void GetRef(DOMString& aValue) const { GetXULAttr(nsGkAtoms::ref, aValue); }
 ...
 protected:
  ...
  friend void NS_TrustedNewXULElement(nsIContent** aResult,
                                      mozilla::dom::NodeInfo* aNodeInfo);

  static already_AddRefed<nsXULElement> Create(
      nsXULPrototypeElement* aPrototype,
      mozilla::dom::NodeInfo* aNodeInfo,
      bool aIsScriptable,
      bool aIsRoot);
