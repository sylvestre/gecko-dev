...
void
encoder::write_type_value(int major_type, unsigned int value)
{
  major_type <<= 5;
  if (value < 24) {
...
void
encoder::write_type_value(int major_type, unsigned long long value)
{
  major_type <<= 5;
  if (value < 24ULL) {
    _out->put_byte((unsigned char)(major_type | value));
...
void
encoder::write_int(unsigned int value)
{
  write_type_value(0, value);
}

void
encoder::write_int(unsigned long long value)
{
  write_type_value(0, value);
}

void
encoder::write_int(long long value)
{
  if (value < 0) {
...
void
encoder::write_bytes(const unsigned char* data, unsigned int size)
{
...
void
encoder::write_string(const char* data, unsigned int size)
{
...
void
encoder::write_string(const std::string str)
{
...
void
encoder::write_array(int size)
{
  write_type_value(4, (unsigned int)size);
}

void
encoder::write_map(int size)
{
  write_type_value(5, (unsigned int)size);
}

void
encoder::write_tag(const unsigned int tag)
{
  write_type_value(6, tag);
}

void
encoder::write_special(int special)
{
  write_type_value(7, (unsigned int)special);
}

void
encoder::write_bool(bool value)
{
  if (value == true) {
