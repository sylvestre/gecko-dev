...
/* virtual */ JSObject*
GamepadPose::WrapObject(JSContext* aJSContext,
                         ...
                         ErrorResult& aRv)
{
  SetFloat32Array(aJSContext,
                  aRetval,
                  mPosition,
                  mPoseState.isPositionValid ? mPoseState.position : nullptr,
                  3,
                               ...
                               ErrorResult& aRv)
{
  SetFloat32Array(
      ...
      aRetval,
      mLinearVelocity,
      mPoseState.isPositionValid ? mPoseState.linearVelocity : nullptr,
      3,
      bool(mPoseState.flags & GamepadCapabilityFlags::Cap_Position),
      aRv);
}
                                   ...
                                   ErrorResult& aRv)
{
  SetFloat32Array(
      ...
      aRetval,
      mLinearAcceleration,
      mPoseState.isPositionValid ? mPoseState.linearAcceleration : nullptr,
      3,
                            ...
                            ErrorResult& aRv)
{
  SetFloat32Array(
      ...
      aRetval,
      mOrientation,
      mPoseState.isOrientationValid ? mPoseState.orientation : nullptr,
      4,
                                ...
                                ErrorResult& aRv)
{
  SetFloat32Array(
      ...
      aRetval,
      mAngularVelocity,
      mPoseState.isOrientationValid ? mPoseState.angularVelocity : nullptr,
      3,
      bool(mPoseState.flags & GamepadCapabilityFlags::Cap_Orientation),
      aRv);
}
