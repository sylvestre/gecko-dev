...
#undef GENERATED_EVENT
  ...
  // ExtendableEvent is a ServiceWorker event that is not
  // autogenerated since it has some extra methods.
  virtual workers::ExtendableEvent* AsExtendableEvent() { return nullptr; }
...
#define NS_FORWARD_TO_EVENT                                                    \
  ...
  virtual void PreventDefault(JSContext* aCx, CallerType aCallerType) override \
  {                                                                            \
...
#define NS_FORWARD_NSIDOMEVENT_NO_SERIALIZATION_NO_DUPLICATION(_to)            \
  ...
  void InitEvent(                                                              \
      const nsAString& eventTypeArg, bool canBubbleArg, bool cancelableArg)    \
      override                                                                 \
  {                                                                            \
  ...
  NS_IMETHOD GetPreventDefault(bool* aRetval) override                         \
  {                                                                            \
    return _to GetPreventDefault(aRetval);                                     \
  }                                                                            \
