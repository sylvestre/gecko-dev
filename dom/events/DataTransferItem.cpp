...
NS_IMPL_CYCLE_COLLECTION_WRAPPERCACHE(
    DataTransferItem, mData, mPrincipal, mDataTransfer, mCachedFile)
...
DataTransferItem::GetAsFile(nsIPrincipal& aSubjectPrincipal, ErrorResult& aRv)
{
...
DataTransferItem::GetAsEntry(nsIPrincipal& aSubjectPrincipal, ErrorResult& aRv)
{
...
DataTransferItem::CreateFileFromInputStream(nsIInputStream* aStream)
{
  ...
  return File::CreateMemoryFile(
      mDataTransfer, data, available, fileName, mType, PR_Now());
}
