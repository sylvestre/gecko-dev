                                           ...
                                           public nsWrapperCache
{
 ...
 public:
  ...
  {
    return mozilla::dom::IntersectionObserverEntryBinding::Wrap(
...
class DOMIntersectionObserver final : public nsISupports, public nsWrapperCache
{
 ...
 public:
  ...
  virtual JSObject* WrapObject(JSContext* aCx,
                               JS::Handle<JSObject*> aGivenProto) override
  {
    return mozilla::dom::IntersectionObserverBinding::Wrap(
        aCx, this, aGivenProto);
  }
