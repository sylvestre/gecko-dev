...
already_AddRefed<Promise> SubtleCrypto::ImportKey(
    ...
    ErrorResult& aRv){SUBTLECRYPTO_METHOD_BODY(ImportKey,
                                               aRv,
                                               mParent,
                                               cx,
                                               format,
...
already_AddRefed<Promise> SubtleCrypto::GenerateKey(
    ...
    bool extractable,
    const Sequence<nsString>& keyUsages,
    ErrorResult& aRv){SUBTLECRYPTO_METHOD_BODY(
    GenerateKey, aRv, mParent, cx, algorithm, extractable, keyUsages)}
...
already_AddRefed<Promise> SubtleCrypto::DeriveKey(
    ...
    bool extractable,
    const Sequence<nsString>& keyUsages,
    ErrorResult& aRv){SUBTLECRYPTO_METHOD_BODY(DeriveKey,
                                               aRv,
                                               mParent,
                                               cx,
                                               algorithm,
...
already_AddRefed<Promise> SubtleCrypto::WrapKey(
    ...
    ErrorResult& aRv){SUBTLECRYPTO_METHOD_BODY(
    WrapKey, aRv, cx, format, key, wrappingKey, wrapAlgorithm)}
...
already_AddRefed<Promise> SubtleCrypto::UnwrapKey(
    ...
    ErrorResult& aRv)
{
  SUBTLECRYPTO_METHOD_BODY(UnwrapKey,
                           aRv,
                           mParent,
                           cx,
                           format,
