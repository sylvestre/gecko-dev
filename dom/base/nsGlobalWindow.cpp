...
#define FORWARD_TO_INNER_MODAL_CONTENT_WINDOW(method, args, err_rval) \
  ...
  if (IsOuterWindow()) {                                              \
    ...
    return ((nsGlobalModalWindow*)GetCurrentInnerWindowInternal())    \
        ->method args;                                                \
  }                                                                   \
  PR_END_MACRO
                                     ...
                                     public StorageNotificationObserver
{
 public:
  ...
  {
    if (mWindow) {
      mWindow->ObserveStorageNotification(
          aEvent, aStorageType, aPrivateBrowsing);
    }
  }
...
void
DialogValueHolder::Get(JSContext* aCx,
                       ...
                       mozilla::ErrorResult& aError)
{
  if (aSubject->Subsumes(mOrigin)) {
    aError =
        nsContentUtils::XPConnect()->VariantToJS(aCx, aScope, mValue, aResult);
  } else {
                                  ...
                                  public nsIIdleRunnable
{
 public:
  ...
  {
    return !mWindow || mWindow->AsInner()->InnerObjectsFreed();
  }
...
class IdleRequestTimeoutHandler final : public TimeoutHandler
{
 public:
  ...
  nsresult Call() override
  {
    return nsGlobalWindow::Cast(mWindow)->RunIdleRequest(
        mIdleRequest, 0.0, true);
  }
                                    ...
                                    ErrorResult& aError)
{
  ...
  if (aOptions.mTimeout.WasPassed()) {
    ...
    nsCOMPtr<nsITimeoutHandler> handler(
        new IdleRequestTimeoutHandler(aCx, request, AsInner()));

    nsresult rv =
        mTimeoutManager->SetTimeout(handler,
...
nsPIDOMWindow<T>::nsPIDOMWindow(nsPIDOMWindowOuter* aOuterWindow)
    : mFrameElement(nullptr),
      ...
      mIsInnerWindow(aOuterWindow != nullptr),
...
class nsOuterWindowProxy : public js::Wrapper
{
 public:
  ...
  bool preventExtensions(JSContext* cx,
                         JS::Handle<JSObject*> proxy,
                         JS::ObjectOpResult& result) const override;
  bool isExtensible(JSContext* cx,
                    JS::Handle<JSObject*> proxy,
                    bool* extensible) const override;
  bool has(JSContext* cx,
           JS::Handle<JSObject*> proxy,
           JS::Handle<jsid> id,
           bool* bp) const override;
  bool get(JSContext* cx,
           JS::Handle<JSObject*> proxy,
  ...
  bool getPropertyDescriptor(
      ...
      JS::Handle<jsid> id,
      JS::MutableHandle<JS::PropertyDescriptor> desc) const override;
  bool hasOwn(JSContext* cx,
              JS::Handle<JSObject*> proxy,
              JS::Handle<jsid> id,
              bool* bp) const override;
  bool getOwnEnumerablePropertyKeys(JSContext* cx,
                                    JS::Handle<JSObject*> proxy,
                                    JS::AutoIdVector& props) const override;
  ...
  bool watch(JSContext* cx,
             JS::Handle<JSObject*> proxy,
             JS::Handle<jsid> id,
             JS::Handle<JSObject*> callable) const override;
  bool unwatch(JSContext* cx,
               JS::Handle<JSObject*> proxy,
 ...
 protected:
  static nsGlobalWindow* GetOuterWindow(JSObject* proxy)
  {
    nsGlobalWindow* outerWindow =
        nsGlobalWindow::FromSupports(static_cast<nsISupports*>(
  ...
  bool GetSubframeWindow(JSContext* cx,
                         JS::Handle<JSObject*> proxy,
                         JS::Handle<jsid> id,
  ...
  bool AppendIndexedPropertyNames(JSContext* cx,
                                  JSObject* proxy,
...
bool
nsOuterWindowProxy::getOwnPropertyDescriptor(
    JSContext* cx,
    JS::Handle<JSObject*> proxy,
    JS::Handle<jsid> id,
    JS::MutableHandle<JS::PropertyDescriptor> desc) const
...
bool
nsOuterWindowProxy::delete_(JSContext* cx,
                            JS::Handle<JSObject*> proxy,
                            JS::Handle<jsid> id,
                            JS::ObjectOpResult& result) const
{
...
bool
nsOuterWindowProxy::getPrototypeIfOrdinary(
    JSContext* cx,
    JS::Handle<JSObject*> proxy,
    bool* isOrdinary,
...
bool
nsOuterWindowProxy::isExtensible(JSContext* cx,
                                 JS::Handle<JSObject*> proxy,
...
bool
nsOuterWindowProxy::has(JSContext* cx,
                        JS::Handle<JSObject*> proxy,
                        JS::Handle<jsid> id,
                        bool* bp) const
{
...
bool
nsOuterWindowProxy::hasOwn(JSContext* cx,
                           JS::Handle<JSObject*> proxy,
                           JS::Handle<jsid> id,
                           bool* bp) const
{
...
bool
nsOuterWindowProxy::get(JSContext* cx,
                        JS::Handle<JSObject*> proxy,
                        JS::Handle<JS::Value> receiver,
                        JS::Handle<jsid> id,
...
bool
nsOuterWindowProxy::set(JSContext* cx,
                        JS::Handle<JSObject*> proxy,
                        JS::Handle<jsid> id,
                        JS::Handle<JS::Value> v,
                        JS::Handle<JS::Value> receiver,
...
bool
nsOuterWindowProxy::getOwnEnumerablePropertyKeys(JSContext* cx,
                                                 JS::Handle<JSObject*> proxy,
                                                 JS::AutoIdVector& props) const
{
...
bool
nsOuterWindowProxy::AppendIndexedPropertyNames(JSContext* cx,
                                               JSObject* proxy,
                                               JS::AutoIdVector& props) const
{
...
bool
nsOuterWindowProxy::watch(JSContext* cx,
                          JS::Handle<JSObject*> proxy,
                          JS::Handle<jsid> id,
...
bool
nsOuterWindowProxy::unwatch(JSContext* cx,
                            JS::Handle<JSObject*> proxy,
                            JS::Handle<jsid> id) const
{
...
nsGlobalWindow::nsGlobalWindow(nsGlobalWindow* aOuterWindow)
    : nsPIDOMWindow<nsISupports>(aOuterWindow ? aOuterWindow->AsOuter()
                                              : nullptr),
      mIdleFuzzFactor(0),
...
NS_INTERFACE_MAP_BEGIN_CYCLE_COLLECTION(nsGlobalWindow)
  ...
  } else if (aIID.Equals(NS_GET_IID(mozIDOMWindow)) && IsInnerWindow()) {
    foundInterface = AsInner();
  } else if (aIID.Equals(NS_GET_IID(nsPIDOMWindowOuter))) {
    foundInterface = AsOuter();
  } else if (aIID.Equals(NS_GET_IID(mozIDOMWindowProxy)) && IsOuterWindow()) {
    foundInterface = AsOuter();
                            ...
                            unsigned aFlags)
{
  CycleCollectionNoteChild(
      aCallback, aField.mIdleObserver.get(), aName, aFlags);
}
...
NS_IMPL_CYCLE_COLLECTION_TRAVERSE_BEGIN_INTERNAL(nsGlobalWindow)
  ...
  NS_IMPL_CYCLE_COLLECTION_TRAVERSE(
      mChromeFields.mOpenerForInitialContentBrowser)
NS_IMPL_CYCLE_COLLECTION_TRAVERSE_END
                                       ...
                                       SecureContextFlags aFlags)
{
  ...
  if (nsGlobalWindow::Cast(parentOuterWin) != this) {
    ...
    MOZ_ASSERT(parentWin == nsGlobalWindow::Cast(
                               ...
                               bool aForceReuseInnerWindow)
{
  ...
  if (IsInnerWindow()) {
    ...
    return GetOuterWindowInternal()->SetNewDocument(
        aDocument, aState, aForceReuseInnerWindow);
  }
  ...
  if (reUseInnerWindow) {
    ...
    if (aState) {
      ...
      // new global.
      rv = CreateNativeGlobalForInner(cx,
                                      newInnerWindow,
    ...
    if (!GetWrapperPreserveColor()) {
      ...
      js::SetProxyReservedSlot(
          outerObject, 0, js::PrivateValue(ToSupports(this)));
...
nsGlobalWindow::DispatchDOMWindowCreated()
{
  ...
  nsContentUtils::DispatchChromeEvent(mDoc,
                                      mDoc,
...
nsGlobalWindow::SetDocShell(nsIDocShell* aDocShell)
{
  ...
  MOZ_RELEASE_ASSERT(!parentWindow || !mTabGroup ||
                     mTabGroup == Cast(parentWindow)->mTabGroup);
                           ...
                           ErrorResult& aError)
{
  FORWARD_TO_OUTER_OR_THROW(
      GetContentOuter, (aCx, aRetval, aCallerType, aError), aError, );
}
...
bool
nsGlobalWindow::DoResolve(JSContext* aCx,
...
void
nsGlobalWindow::GetOwnPropertyNames(JSContext* aCx,
                                    ...
                                    ErrorResult& aRv)
{
  ...
  if (nameSpaceManager) {
    ...
    for (auto i = nameSpaceManager->GlobalNameIter(); !i.Done(); i.Next()) {
      ...
      if (nsWindowSH::NameStructEnabled(
              aCx, this, entry->mKey, entry->mGlobalName)) {
        // Just append all of these; even if they get deleted our resolve hook
        // just goes ahead and recreates them.
        JSString* str = JS_AtomizeUCStringN(
            aCx, entry->mKey.BeginReading(), entry->mKey.Length());
...
nsGlobalWindow::GetApplicationCache(ErrorResult& aError)
{
  ...
  if (!mApplicationCache) {
    ...
    RefPtr<nsDOMOfflineResourceList> applicationCache =
        new nsDOMOfflineResourceList(
            manifestURI, uri, mDoc->NodePrincipal(), AsInner());
...
nsGlobalWindow::GetOpenerWindowOuter()
{
  ...
  if (nsContentUtils::LegacyIsCallerChromeOrNativeCode()) {
    ...
    if (GetPrincipal() == nsContentUtils::GetSystemPrincipal() &&
        nsGlobalWindow::Cast(opener)->GetPrincipal() !=
            nsContentUtils::GetSystemPrincipal()) {
      return nullptr;
    }
    return opener;
...
void
nsGlobalWindow::GetOpener(JSContext* aCx,
...
void
nsGlobalWindow::SetOpener(JSContext* aCx,
...
void
nsGlobalWindow::SetNameOuter(const nsAString& aName,
                             mozilla::ErrorResult& aError)
{
  MOZ_RELEASE_ASSERT(IsOuterWindow());
                              ...
                              ErrorResult& aError)
{
  GetReplaceableWindowCoord(
      aCx, &nsGlobalWindow::GetInnerWidth, aValue, aCallerType, aError);
}
...
{
  FORWARD_TO_OUTER_OR_THROW(
      SetInnerWidthOuter, (aInnerWidth, aCallerType, aError), aError, );
}

void
nsGlobalWindow::SetInnerWidth(JSContext* aCx,
                              JS::Handle<JS::Value> aValue,
                              CallerType aCallerType,
                              ErrorResult& aError)
{
  SetReplaceableWindowCoord(aCx,
                            &nsGlobalWindow::SetInnerWidth,
                            aValue,
                            "innerWidth",
                            aCallerType,
                            aError);
...
{
  GetReplaceableWindowCoord(
      aCx, &nsGlobalWindow::GetInnerHeight, aValue, aCallerType, aError);
}
...
{
  FORWARD_TO_OUTER_OR_THROW(
      SetInnerHeightOuter, (aInnerHeight, aCallerType, aError), aError, );
}

void
nsGlobalWindow::SetInnerHeight(JSContext* aCx,
                               JS::Handle<JS::Value> aValue,
                               CallerType aCallerType,
                               ErrorResult& aError)
{
  SetReplaceableWindowCoord(aCx,
                            &nsGlobalWindow::SetInnerHeight,
                            aValue,
                            "innerHeight",
                            aCallerType,
                            aError);
...
{
  FORWARD_TO_OUTER_OR_THROW(
      GetOuterWidthOuter, (aCallerType, aError), aError, 0);
}
...
{
  GetReplaceableWindowCoord(
      aCx, &nsGlobalWindow::GetOuterWidth, aValue, aCallerType, aError);
}
...
{
  FORWARD_TO_OUTER_OR_THROW(
      GetOuterHeightOuter, (aCallerType, aError), aError, 0);
}
...
{
  GetReplaceableWindowCoord(
      aCx, &nsGlobalWindow::GetOuterHeight, aValue, aCallerType, aError);
}

void
nsGlobalWindow::SetOuterSize(int32_t aLengthCSSPixels,
                             bool aIsWidth,
                             CallerType aCallerType,
                             ErrorResult& aError)
{
...
{
  FORWARD_TO_OUTER_OR_THROW(
      SetOuterWidthOuter, (aOuterWidth, aCallerType, aError), aError, );
}

void
nsGlobalWindow::SetOuterWidth(JSContext* aCx,
                              JS::Handle<JS::Value> aValue,
                              CallerType aCallerType,
                              ErrorResult& aError)
{
  SetReplaceableWindowCoord(aCx,
                            &nsGlobalWindow::SetOuterWidth,
                            aValue,
                            "outerWidth",
                            aCallerType,
                            aError);
...
{
  FORWARD_TO_OUTER_OR_THROW(
      SetOuterHeightOuter, (aOuterHeight, aCallerType, aError), aError, );
}

void
nsGlobalWindow::SetOuterHeight(JSContext* aCx,
                               JS::Handle<JS::Value> aValue,
                               CallerType aCallerType,
                               ErrorResult& aError)
{
  SetReplaceableWindowCoord(aCx,
                            &nsGlobalWindow::SetOuterHeight,
                            aValue,
                            "outerHeight",
                            aCallerType,
                            aError);
...
{
  GetReplaceableWindowCoord(
      aCx, &nsGlobalWindow::GetScreenX, aValue, aCallerType, aError);
}
...
{
  FORWARD_TO_OUTER_OR_THROW(
      GetDevicePixelRatioOuter, (aCallerType), aError, 0.0);
}
                           ...
                           ErrorResult& aError)
{
  ...
  FORWARD_TO_OUTER_OR_THROW(
      MatchMediaOuter, (aMediaQueryList), aError, nullptr);
}
...
{
  FORWARD_TO_OUTER_OR_THROW(
      SetScreenXOuter, (aScreenX, aCallerType, aError), aError, );
}

void
nsGlobalWindow::SetScreenX(JSContext* aCx,
                           JS::Handle<JS::Value> aValue,
                           CallerType aCallerType,
                           ErrorResult& aError)
{
  SetReplaceableWindowCoord(
      aCx, &nsGlobalWindow::SetScreenX, aValue, "screenX", aCallerType, aError);
}
...
{
  GetReplaceableWindowCoord(
      aCx, &nsGlobalWindow::GetScreenY, aValue, aCallerType, aError);
}
...
{
  FORWARD_TO_OUTER_OR_THROW(
      SetScreenYOuter, (aScreenY, aCallerType, aError), aError, );
}

void
nsGlobalWindow::SetScreenY(JSContext* aCx,
                           JS::Handle<JS::Value> aValue,
                           CallerType aCallerType,
                           ErrorResult& aError)
{
  SetReplaceableWindowCoord(
      aCx, &nsGlobalWindow::SetScreenY, aValue, "screenY", aCallerType, aError);
}

// NOTE: Arguments to this function should have values scaled to
// CSS pixels, not device pixels.
void
nsGlobalWindow::CheckSecurityWidthAndHeight(int32_t* aWidth,
                                            int32_t* aHeight,
                                            CallerType aCallerType)
{
  MOZ_ASSERT(IsOuterWindow());
...
nsresult
nsGlobalWindow::SetDocShellWidthAndHeight(int32_t aInnerWidth,
...
void
nsGlobalWindow::SetCSSViewportWidthAndHeight(nscoord aInnerWidth,
...
// CSS pixels, not device pixels.
void
nsGlobalWindow::CheckSecurityLeftAndTop(int32_t* aLeft,
                                        int32_t* aTop,
                                        CallerType aCallerType)
{
  MOZ_ASSERT(IsOuterWindow());
...
nsGlobalWindow::GetChildWindow(const nsAString& aName)
{
  ...
  docShell->FindChildWithName(
      aName, false, true, nullptr, nullptr, getter_AddRefs(child));
...
nsGlobalWindow::DispatchCustomEvent(const nsAString& aEventName)
{
  ...
  nsContentUtils::DispatchTrustedEvent(
      mDoc, ToSupports(this), aEventName, true, true, &defaultActionEnabled);
...
nsGlobalWindow::DispatchResizeEvent(const CSSIntSize& aSize)
{
  ...
  ErrorResult res;
  RefPtr<Event> domEvent = mDoc->CreateEvent(
      NS_LITERAL_STRING("CustomEvent"), CallerType::System, res);
  if (res.Failed()) {
    return false;
  }
                             ...
                             bool aLookForCallerOnJSStack)
{
  ...
  mDocShell->FindItemWithName(aName,
                              nullptr,
                              caller,
                              /* aSkipTabGroup = */ false,
...
void
nsGlobalWindow::SetFullScreenOuter(bool aFullScreen,
                                   mozilla::ErrorResult& aError)
{
  MOZ_RELEASE_ASSERT(IsOuterWindow());
                                ...
                                FullscreenTransitionDuration* aDuration)
{
  ...
  if (!prefValue.IsEmpty()) {
    sscanf(
        prefValue.get(), "%hu%hu", &aDuration->mFadeIn, &aDuration->mFadeOut);
  }
}
...
FullscreenTransitionTask::Run()
{
  ...
  if (stage == eBeforeToggle) {
    ...
    NS_NewTimerWithObserver(
        getter_AddRefs(mTimer), observer, timeout, nsITimer::TYPE_ONE_SHOT);
                                            ...
                                            const char16_t* aData)
{
  ...
  if (strcmp(aTopic, FullscreenTransitionTask::kPaintedTopic) == 0) {
    ...
    nsCOMPtr<nsIWidget> widget =
        win ? nsGlobalWindow::Cast(win)->GetMainWidget() : nullptr;
...
static bool
MakeWidgetFullscreen(nsGlobalWindow* aWindow,
...
bool
nsGlobalWindow::SetWidgetFullscreen(FullscreenReason aReason,
                                    bool aIsFullscreen,
                                    nsIWidget* aWidget,
                                    nsIScreen* aScreen)
{
  ...
  MOZ_ASSERT(!AsOuter()->GetFrameElementInternal(),
...
nsGlobalWindow::Dump(const nsAString& aStr)
{
  ...
  if (cstr) {
    MOZ_LOG(nsContentUtils::DOMDumpLog(),
            LogLevel::Debug,
            ("[Window.Dump] %s", cstr));
#ifdef XP_WIN
                               ...
                               ErrorResult& aError)
{
  ...
  aError = promptFac->GetPrompt(
      AsOuter(), NS_GET_IID(nsIPrompt), getter_AddRefs(prompt));
  if (aError.Failed()) {
    return false;
  }
  ...
  if (ShouldPromptToBlockDialogs()) {
    ...
    aError = aAlert
                 ? prompt->AlertCheck(
                       title.get(), final.get(), label.get(), &disallowDialog)
                 : prompt->ConfirmCheck(title.get(),
                                        final.get(),
                                        label.get(),
                                        &disallowDialog,
                                        &result);
...
void
nsGlobalWindow::Alert(nsIPrincipal& aSubjectPrincipal, ErrorResult& aError)
{
  MOZ_ASSERT(IsInnerWindow());
...
{
  FORWARD_TO_OUTER_OR_THROW(
      AlertOuter, (aMessage, aSubjectPrincipal, aError), aError, );
}
                             ...
                             ErrorResult& aError)
{
  ...
  return AlertOrConfirm(
      /* aAlert = */ false, aMessage, aSubjectPrincipal, aError);
}
...
{
  FORWARD_TO_OUTER_OR_THROW(
      ConfirmOuter, (aMessage, aSubjectPrincipal, aError), aError, false);
}
                            ...
                            ErrorResult& aError)
{
  ...
  nsAutoSyncOperation sync(mDoc);
  bool ok;
  aError = prompt->Prompt(title.get(),
                          fixedMessage.get(),
                          &inoutValue,
...
void
nsGlobalWindow::Prompt(const nsAString& aMessage,
                       const nsAString& aInitial,
                       nsAString& aReturn,
                       nsIPrincipal& aSubjectPrincipal,
                       ErrorResult& aError)
{
  FORWARD_TO_OUTER_OR_THROW(
      PromptOuter,
      (aMessage, aInitial, aReturn, aSubjectPrincipal, aError),
      aError, );
}
  ...
  if (siteWindow) {
    ...
    if (fm && mDoc) {
      ...
      fm->GetFocusedElementForWindow(
          AsOuter(), false, nullptr, getter_AddRefs(element));
...
void
nsGlobalWindow::MoveToOuter(int32_t aXPos,
                            int32_t aYPos,
                            CallerType aCallerType,
                            ErrorResult& aError)
{
  ...
  if (screenMgr) {
    ...
    screenMgr->ScreenForRect(
        aXPos, aYPos, size.width, size.height, getter_AddRefs(screen));
  }
...
void
nsGlobalWindow::MoveTo(int32_t aXPos,
                       int32_t aYPos,
                       CallerType aCallerType,
                       ErrorResult& aError)
{
  FORWARD_TO_OUTER_OR_THROW(
      MoveToOuter, (aXPos, aYPos, aCallerType, aError), aError, );
}

void
nsGlobalWindow::MoveByOuter(int32_t aXDif,
                            int32_t aYDif,
                            CallerType aCallerType,
                            ErrorResult& aError)
{
...
void
nsGlobalWindow::MoveBy(int32_t aXDif,
                       int32_t aYDif,
                       CallerType aCallerType,
                       ErrorResult& aError)
{
  FORWARD_TO_OUTER_OR_THROW(
      MoveByOuter, (aXDif, aYDif, aCallerType, aError), aError, );
}
...
void
nsGlobalWindow::ResizeToOuter(int32_t aWidth,
                              int32_t aHeight,
                              CallerType aCallerType,
                              ErrorResult& aError)
{
...
void
nsGlobalWindow::ResizeTo(int32_t aWidth,
                         int32_t aHeight,
                         CallerType aCallerType,
                         ErrorResult& aError)
{
  FORWARD_TO_OUTER_OR_THROW(
      ResizeToOuter, (aWidth, aHeight, aCallerType, aError), aError, );
}

void
nsGlobalWindow::ResizeByOuter(int32_t aWidthDif,
                              int32_t aHeightDif,
                              CallerType aCallerType,
                              ErrorResult& aError)
{
...
void
nsGlobalWindow::ResizeBy(int32_t aWidthDif,
                         int32_t aHeightDif,
                         CallerType aCallerType,
                         ErrorResult& aError)
{
...
{
  FORWARD_TO_OUTER_OR_THROW(
      SizeToContentOuter, (aCallerType, aError), aError, );
}
...
void
nsGlobalWindow::ScrollByLines(int32_t numLines, const ScrollOptions& aOptions)
{
  MOZ_ASSERT(IsInnerWindow());
  ...
  if (sf) {
    ...
    sf->ScrollBy(nsIntPoint(0, numLines),
...
void
nsGlobalWindow::ScrollByPages(int32_t numPages, const ScrollOptions& aOptions)
{
  MOZ_ASSERT(IsInnerWindow());
  ...
  if (sf) {
    ...
    sf->ScrollBy(nsIntPoint(0, numPages),
...
static bool
IsPopupBlocked(nsIDocument* aDoc)
{
                                ...
                                const nsAString& aPopupWindowFeatures)
{
  ...
  if (ios)
    ios->NewURI(NS_ConvertUTF16toUTF8(aPopupURL),
                nullptr,
                baseURL,
  ...
  FirePopupBlockedEvent(
      topDoc, popupURI, aPopupWindowName, aPopupWindowFeatures);
}

already_AddRefed<nsPIDOMWindowOuter>
nsGlobalWindow::OpenOuter(const nsAString& aUrl,
...
already_AddRefed<nsPIDOMWindowOuter>
nsGlobalWindow::Open(const nsAString& aUrl,
                     const nsAString& aName,
                     const nsAString& aOptions,
                     ErrorResult& aError)
{
  FORWARD_TO_OUTER_OR_THROW(
      OpenOuter, (aUrl, aName, aOptions, aError), aError, nullptr);
}
...
{
  FORWARD_TO_OUTER(Open,
                   (aUrl, aName, aOptions, aLoadInfo, aForceNoOpener, _retval),
                   NS_ERROR_NOT_INITIALIZED);
  return OpenInternal(aUrl,
                      aName,
                      aOptions,
                      false,  // aDialog
                      false,  // aContentModal
...
nsresult
nsGlobalWindow::OpenJS(const nsAString& aUrl,
                       const nsAString& aName,
                       const nsAString& aOptions,
                       nsPIDOMWindowOuter** _retval)
{
...
nsresult
nsGlobalWindow::OpenDialog(const nsAString& aUrl,
                           const nsAString& aName,
                           const nsAString& aOptions,
...
already_AddRefed<nsPIDOMWindowOuter>
nsGlobalWindow::OpenDialogOuter(JSContext* aCx,
                                ...
                                ErrorResult& aError)
{
  ...
  aError = NS_CreateJSArgv(aCx,
                           aExtraArgument.Length(),
...
already_AddRefed<nsPIDOMWindowOuter>
nsGlobalWindow::OpenDialog(JSContext* aCx,
                           const nsAString& aUrl,
                           const nsAString& aName,
                           const nsAString& aOptions,
                           const Sequence<JS::Value>& aExtraArgument,
...
void
nsGlobalWindow::PostMessageMozOuter(JSContext* aCx,
                               ...
                               ErrorResult& aRv)
{
  ...
  aRv = nsContentUtils::CreateJSValueFromSequenceOfObject(
      aCx, aTransfer, &transferArray);
  if (NS_WARN_IF(aRv.Failed())) {
    return;
  }

  PostMessageMoz(
      aCx, aMessage, aTargetOrigin, transferArray, aSubjectPrincipal, aRv);
}
...
class nsCloseEvent : public Runnable
{
 ...
 public:
  static nsresult PostCloseEvent(nsGlobalWindow* aWindow, bool aIndirect)
  {
...
{
  FORWARD_TO_OUTER_OR_THROW(
      CloseOuter, (nsContentUtils::IsCallerChrome()), aError, );
}
...
nsGlobalWindow::NotifyDOMWindowDestroyed(nsGlobalWindow* aWindow)
{
  ...
  if (observerService) {
    observerService->NotifyObservers(
        ToSupports(aWindow), DOM_WINDOW_DESTROYED_TOPIC, nullptr);
  }
}
      ...
      case Phase::Nuking: {
        ...
        if (window) {
          ...
          nsGlobalWindow* currentInner =
              win->IsInnerWindow() ? win : win->GetCurrentInnerWindowInternal();
...
nsGlobalWindow::NotifyDOMWindowFrozen(nsGlobalWindow* aWindow)
{
  if (aWindow && aWindow->IsInnerWindow()) {
    ...
    if (observerService) {
      observerService->NotifyObservers(
          ToSupports(aWindow), DOM_WINDOW_FROZEN_TOPIC, nullptr);
    }
  }
}
...
nsGlobalWindow::NotifyDOMWindowThawed(nsGlobalWindow* aWindow)
{
  if (aWindow && aWindow->IsInnerWindow()) {
    ...
    if (observerService) {
      observerService->NotifyObservers(
          ToSupports(aWindow), DOM_WINDOW_THAWED_TOPIC, nullptr);
    }
  }
}
...
{
  FORWARD_TO_OUTER_OR_THROW(
      GetFrameElementOuter, (aSubjectPrincipal), aError, nullptr);
}
 ...
 public:
  ...
  NS_IMETHOD Run() override
  {
    ...
    if (enabledCommands.Length() || disabledCommands.Length()) {
      mTabChild->EnableDisableCommands(
          mAction, enabledCommands, disabledCommands);
    }
                               ...
                               int16_t aReason)
{
  ...
  if (nsIDocShell* docShell = GetDocShell()) {
    if (nsCOMPtr<nsITabChild> child = docShell->GetTabChild()) {
      nsContentUtils::AddScriptRunner(
          new ChildCommandDispatcher(this, child, anAction));
      return NS_OK;
    }
  }

  nsPIDOMWindowOuter* rootWindow = nsGlobalWindow::GetPrivateRoot();
  if (!rootWindow) return NS_OK;
...
bool
nsGlobalWindow::FindOuter(const nsAString& aString,
                          bool aCaseSensitive,
                          bool aBackwards,
                          bool aWrapAround,
                          bool aWholeWord,
...
bool
nsGlobalWindow::Find(const nsAString& aString,
                     bool aCaseSensitive,
                     bool aBackwards,
                     bool aWrapAround,
                     bool aWholeWord,
...
nsGlobalWindow::DispatchEvent(nsIDOMEvent* aEvent, bool* aRetVal)
{
  ...
  nsresult rv = EventDispatcher::DispatchDOMEvent(
      AsInner(), nullptr, aEvent, presContext, &status);
...
nsGlobalWindow::GetContextForEventHandlers(nsresult* aRv)
{
  *aRv = NS_ERROR_UNEXPECTED;
  NS_ENSURE_TRUE(!IsInnerWindow() || AsInner()->IsCurrentInnerWindow(),
                 nullptr);
...
void
nsGlobalWindow::SetIsBackground(bool aIsBackground)
{
  MOZ_ASSERT(IsOuterWindow());
...
void
nsGlobalWindow::MaybeUpdateTouchState()
{
  ...
  if (mMayHaveTouchEventListener) {
    ...
    if (observerService) {
      observerService->NotifyObservers(
          static_cast<nsIDOMWindow*>(this), DOM_TOUCH_LISTENER_ADDED, nullptr);
    }
  }
}
...
static bool
IsLink(nsIContent* aContent)
{
  return aContent && (aContent->IsHTMLElement(nsGkAtoms::a) ||
                      aContent->AttrValueIs(kNameSpaceID_XLink,
                                            nsGkAtoms::type,
                                            nsGkAtoms::simple,
                                            eCaseMatters));
}
...
static bool
ShouldShowFocusRingIfFocusedByMouse(nsIContent* aNode)
{
  if (!aNode) {
    return true;
  }
...
nsGlobalWindow::GetComputedStyle(Element& aElt,
                                            ...
                                            bool aDefaultStylesOnly)
{
  ...
  RefPtr<nsComputedDOMStyle> compStyle = NS_NewComputedDOMStyle(
      &aElt,
      aPseudoElt,
      presShell,
...
nsGlobalWindow::GetSessionStorage(ErrorResult& aError)
{
  ...
  if (mSessionStorage) {
    MOZ_LOG(gDOMLeakPRLog,
            LogLevel::Debug,
            ("nsGlobalWindow %p has %p sessionStorage",
             this,
             mSessionStorage.get()));
  ...
  if (!mSessionStorage) {
    ...
    nsCOMPtr<nsIDOMStorage> storage;
    aError = storageManager->CreateStorage(AsInner(),
                                           principal,
                                           documentURI,
                                           IsPrivateBrowsing(),
    ...
    MOZ_LOG(gDOMLeakPRLog,
            LogLevel::Debug,
            ("nsGlobalWindow %p tried to get a new sessionStorage %p",
             this,
             mSessionStorage.get()));
  ...
  MOZ_LOG(gDOMLeakPRLog,
          LogLevel::Debug,
          ("nsGlobalWindow %p returns %p sessionStorage",
           this,
           mSessionStorage.get()));
...
nsGlobalWindow::GetIndexedDB(ErrorResult& aError)
{
  ...
  if (!mIndexedDB) {
    ...
    aError = IDBFactory::CreateForWindow(AsInner(), getter_AddRefs(mIndexedDB));
  }
...
nsGlobalWindow::GetInterface(const nsIID& aIID, void** aSink)
{
  ...
  *aSink = nullptr;
  ...
  if (aIID.Equals(NS_GET_IID(nsIDocCharset))) {
    ...
    NS_WARNING(
        "Using deprecated nsIDocCharset: use nsIDocShell.GetCharset() "
        "instead ");
...
void
nsGlobalWindow::GetInterface(JSContext* aCx,
                             nsIJSID* aIID,
                             JS::MutableHandle<JS::Value> aRetval,
                             ErrorResult& aError)
{
...
nsPIDOMWindowInner::GetServiceWorkerRegistration(const nsAString& aScope)
{
  ...
  if (!mServiceWorkerRegistrationTable.Get(aScope,
    ...
    registration = ServiceWorkerRegistration::CreateForMainThread(this, aScope);
...
{
  if (!AsInner()->IsCurrentInnerWindow()) return;
...
bool
nsGlobalWindow::ContainsIdleObserver(nsIIdleObserver* aIdleObserver,
                                     uint32_t aTimeInS)
{
...
class AutoUnblockScriptClosing
{
 ...
 public:
  explicit AutoUnblockScriptClosing(nsGlobalWindow* aWin) : mWin(aWin)
  {
    MOZ_ASSERT(mWin);
...
nsresult
nsGlobalWindow::OpenInternal(const nsAString& aUrl,
                             const nsAString& aName,
                             const nsAString& aOptions,
                             bool aDialog,
                             bool aContentModal,
  ...
  *aReturn = nullptr;
  ...
  if (checkForPopup) {
    ...
    if (abuseLevel >= openBlocked) {
      if (!aCalledNoScript) {
        ...
        if (entryWindow && entryWindow->GetOuterWindow() == this->AsOuter()) {
...

  {
    ...
    if (!aCalledNoScript) {
      ...
      // !aCalledNoScript.
      rv = pwwatch->OpenWindow2(AsOuter(),
                                url.IsVoid() ? nullptr : url.get(),
                                name_ptr,
                                options_ptr,
...
int32_t
nsGlobalWindow::SetTimeout(JSContext* aCx,
                           Function& aFunction,
                           int32_t aTimeout,
                           ...
                           ErrorResult& aError)
{
  return SetTimeoutOrInterval(
      aCx, aFunction, aTimeout, aArguments, false, aError);
}
...
int32_t
nsGlobalWindow::SetInterval(JSContext* aCx,
                            Function& aFunction,
                            ...
                            ErrorResult& aError)
{
  ...
  return SetTimeoutOrInterval(
      aCx, aFunction, timeout, aArguments, isInterval, aError);
}
...
int32_t
nsGlobalWindow::SetTimeoutOrInterval(JSContext* aCx,
                                     Function& aFunction,
                                     int32_t aTimeout,
                                     const Sequence<JS::Value>& aArguments,
                                     bool aIsInterval,
                                     ErrorResult& aError)
{
  ...
  if (inner != this) {
    return inner->SetTimeoutOrInterval(
        aCx, aFunction, aTimeout, aArguments, aIsInterval, aError);
  }
  ...
  int32_t result;
  aError = mTimeoutManager->SetTimeout(handler,
                                       aTimeout,
                                       aIsInterval,
                                     ...
                                     ErrorResult& aError)
{
  ...
  if (inner != this) {
    return inner->SetTimeoutOrInterval(
        aCx, aHandler, aTimeout, aIsInterval, aError);
  }
...
bool
nsGlobalWindow::RunTimeoutHandler(Timeout* aTimeout, nsIScriptContext* aScx)
{
  MOZ_ASSERT(IsInnerWindow());
...
nsGlobalWindow::SecurityCheckURL(const char* aURL)
{
  ...
  nsresult rv = NS_NewURI(
      getter_AddRefs(uri), nsDependentCString(aURL), encoding, baseURI);
  if (NS_WARN_IF(NS_FAILED(rv))) {
...
nsGlobalWindow::RestoreWindowState(nsISupports* aState)
{
  ...
  if (IsLink(focusedNode)) {
    ...
    if (fm) {
      ...
      fm->SetFocus(
          focusedElement,
          nsIFocusManager::FLAG_NOSCROLL | nsIFocusManager::FLAG_SHOWRING);
    }
  }
...
nsGlobalWindow::AddSizeOfIncludingThis(nsWindowSizes& aWindowSizes) const
{
  ...
  if (IsInnerWindow()) {
    ...
    if (mDoc) {
      ...
      if (!mDoc->GetInnerWindow() || mDoc->GetInnerWindow() == AsInner()) {
...
bool
nsGlobalWindow::UpdateVRDisplays(
...
void
nsGlobalWindow::DispatchVRDisplayActivate(
...
void
nsGlobalWindow::DispatchVRDisplayDeactivate(
    uint32_t aDisplayID, mozilla::dom::VRDisplayEventReason aReason)
{
  // Search for the display identified with aDisplayID and fire the
  // event if found.
...
void
nsGlobalWindow::BeginWindowMove(Event& aMouseDownEvent,
                                Element* aPanel,
                                ErrorResult& aError)
{
  MOZ_ASSERT(IsInnerWindow());
...
{
  FORWARD_TO_OUTER_OR_THROW(
      SetBrowserDOMWindowOuter, (aBrowserWindow), aError, );
}
                                       ...
                                       nsIMessageBroadcaster** aManager)
{
  MOZ_RELEASE_ASSERT(IsChromeWindow());
  FORWARD_TO_INNER(
      GetGroupMessageManager, (aGroup, aManager), NS_ERROR_UNEXPECTED);
      ...
      mChromeFields.mGroupMessageManagers.LookupForAdd(aGroup).OrInsert(
          [this, &aError]() {
            ...
            return new nsFrameMessageManager(
                nullptr, parent, MM_CHROME | MM_BROADCASTER);
          });
  return messageManager;
}

nsresult
nsGlobalWindow::SetOpenerForInitialContentBrowser(
...
nsresult
nsGlobalWindow::TakeOpenerForInitialContentBrowser(
    mozIDOMWindowProxy** aOpenerWindow)
{
  MOZ_RELEASE_ASSERT(IsChromeWindow());
  MOZ_RELEASE_ASSERT(IsOuterWindow());
...
void
nsGlobalWindow::RedefineProperty(JSContext* aCx,
...
void
nsGlobalWindow::GetReplaceableWindowCoord(
    JSContext* aCx,
  ...
  if (nsContentUtils::ShouldResistFingerprinting(GetDocShell())) {
    ...
    if (innerWidthSpecified || innerHeightSpecified || outerWidthSpecified ||
      ...
      if (treeOwnerAsWin && screenMgr) {
        ...
        treeOwnerAsWin->GetPositionAndSize(
        ...
        screenMgr->ScreenForRect(
            winLeft, winTop, winWidth, winHeight, getter_AddRefs(screen));
                                  ...
                                  ErrorResult& aRv)
{
  ...
  return ImageBitmap::Create(
      this, aImage, Some(gfx::IntRect(aSx, aSy, aSw, aSh)), aRv);
}
                                  ...
                                  ErrorResult& aRv)
{
  ...
  if (aImage.IsArrayBuffer() || aImage.IsArrayBufferView()) {
    return ImageBitmap::Create(
        this, aImage, aOffset, aLength, aFormat, aLayout, aRv);
  }
  aRv.Throw(NS_ERROR_TYPE_ERR);
  return nullptr;
}
...
{
  nsGlobalWindow* globalWindow = static_cast<nsGlobalWindow*>(
    ...
    nsGlobalWindow* aWindow MOZ_GUARD_OBJECT_NOTIFIER_PARAM_IN_IMPL)
{
  ...
  if (!topWindow) {
    NS_ERROR(
        "nsGlobalWindow::TemporarilyDisableDialogs used without a top "
        "window?");
    return;
  }
