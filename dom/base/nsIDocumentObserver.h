...
#define NS_IMPL_NSIDOCUMENTOBSERVER_STYLE_STUB(_class)             \
  ...
  void _class::StyleRuleChanged(mozilla::StyleSheet* aStyleSheet,  \
                                mozilla::css::Rule* aStyleRule)    \
  {                                                                \
  }                                                                \
  void _class::StyleRuleAdded(mozilla::StyleSheet* aStyleSheet,    \
                              mozilla::css::Rule* aStyleRule)      \
  {                                                                \
  }                                                                \
  void _class::StyleRuleRemoved(mozilla::StyleSheet* aStyleSheet,  \
                                mozilla::css::Rule* aStyleRule)    \
  {                                                                \
  }
