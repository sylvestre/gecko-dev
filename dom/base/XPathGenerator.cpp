 ...
 * */
bool
IsNonWordCharacter(const char16_t& aChar)
{
 ...
 * */
bool
ContainNonWordCharacter(const nsAString& aStr)
{
 ...
 * */
void
GetPrefix(const nsINode* aNode, nsAString& aResult)
{
...
void
GetNameAttribute(const nsINode* aNode, nsAString& aResult)
{
  if (aNode->HasName()) {
 ...
 * */
void
GenerateConcatExpression(const nsAString& aStr, nsAString& aResult)
{
  const char16_t* cur = aStr.BeginReading();
  const char16_t* end = aStr.EndReading();
...
void
XPathGenerator::QuoteArgument(const nsAString& aArg, nsAString& aResult)
{
  if (!aArg.Contains('\'')) {
...
void
XPathGenerator::EscapeName(const nsAString& aName, nsAString& aResult)
{
...
void
XPathGenerator::Generate(const nsINode* aNode, nsAString& aResult)
{
