...
class NodeInfo final
{
 public:
  ...
  inline bool Equals(const nsAString& aName,
   ...
   public:
    NodeInfoInner()
        : mName(nullptr),
          ...
          mExtraName(nullptr),
          mHash(0),
          mHashInitialized(false)
    {
    }
    NodeInfoInner(nsAtom* aName,
                  nsAtom* aPrefix,
                  int32_t aNamespaceID,
                  uint16_t aNodeType,
                  nsAtom* aExtraName)
    ...
    NodeInfoInner(const nsAString& aTmpName,
                  nsAtom* aPrefix,
                  int32_t aNamespaceID,
                  uint16_t aNodeType)
        : mName(nullptr),
