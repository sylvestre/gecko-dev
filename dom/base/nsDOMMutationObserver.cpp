...
void
nsMutationReceiver::NodeWillBeDestroyed(const nsINode* aNode)
{
...
NS_IMPL_ISUPPORTS_INHERITED(nsAnimationReceiver,
                            nsMutationReceiver,
...
nsMutationReceiver*
nsDOMMutationObserver::GetReceiverFor(nsINode* aNode,
                                      bool aMayCreate,
...
void
nsDOMMutationObserver::GetAllSubtreeObserversFor(
...
void
nsDOMMutationObserver::AddCurrentlyHandlingObserver(
