...
class nsMutationReceiverBase : public nsStubAnimationObserver
{
 ...
 protected:
  ...
  {
    if (mParent) {
      return mParent->ObservesAttr(
          aRegisterTarget, aElement, aNameSpaceID, aAttr);
    }
...
class nsAutoMutationBatch
{
 public:
  ...
  nsAutoMutationBatch(nsINode* aTarget,
