...
class nsXBLPrototypeHandler
{
 ...
 public:
  ...
  nsXBLPrototypeHandler(const char16_t* aEvent,
 ...
 protected:
  ...
  void ConstructPrototype(nsIContent* aKeyElement,
                          ...
                          const char16_t* aPhase = nullptr,
                          const char16_t* aAction = nullptr,
                          ...
                          const char16_t* aButton = nullptr,
                          const char16_t* aClickCount = nullptr,
                          const char16_t* aGroup = nullptr,
                          const char16_t* aPreventDefault = nullptr,
                          const char16_t* aAllowUntrusted = nullptr);

  void ReportKeyConflict(const char16_t* aKey,
                         const char16_t* aModifiers,
                         nsIContent* aElement,
  ...
  nsresult EnsureEventHandler(mozilla::dom::AutoJSAPI& jsapi,
                              nsAtom* aName,
