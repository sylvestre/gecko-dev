...
av_reallocp(void* ptr, size_t size);
 ...
 */
av_alloc_size(2,
              3) void* av_realloc_array(void* ptr, size_t nmemb, size_t size);
 ...
 */
void*
av_calloc(size_t nmemb, size_t size) av_malloc_attrib;
 ...
 */
char*
av_strndup(const char* s, size_t len) av_malloc_attrib;
 ...
 */
void
av_fast_mallocz(void* ptr, unsigned int* size, size_t min_size);
