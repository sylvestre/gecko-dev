 ...
 */
void
av_buffer_default_free(void* opaque, uint8_t* data);
 ...
 */
int
av_buffer_is_writable(const AVBufferRef* buf);

/**
 * @return the opaque parameter set by av_buffer_create.
 */
void*
av_buffer_get_opaque(const AVBufferRef* buf);
 ...
 */
int
av_buffer_realloc(AVBufferRef** buf, int size);
 ...
 */
AVBufferPool*
av_buffer_pool_init(int size, AVBufferRef* (*alloc)(int size));
