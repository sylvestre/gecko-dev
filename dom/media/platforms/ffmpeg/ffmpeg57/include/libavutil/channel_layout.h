 ...
 */
void
av_get_channel_layout_string(char* buf,
                             int buf_size,
                             int nb_channels,
 ...
 */
void
av_bprint_channel_layout(struct AVBPrint* bp,
                         int nb_channels,
                         uint64_t channel_layout);
 ...
 */
const char*
av_get_channel_name(uint64_t channel);
 ...
 */
const char*
av_get_channel_description(uint64_t channel);
 ...
 */
int
av_get_standard_channel_layout(unsigned index,
                               uint64_t* layout,
                               const char** name);
