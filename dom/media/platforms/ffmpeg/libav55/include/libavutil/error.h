...
#define AVERROR_INVALIDDATA \
  (-0x3ebbb1b7)  ///< Invalid data found when processing input
...
#define AVERROR_PATCHWELCOME \
  (-0x3aa8beb0)  ///< Not yet implemented in Libav, patches welcome
...
#define AVERROR_UNKNOWN \
  (-0x31b4b1ab)  ///< Unknown error, typically from an external library
