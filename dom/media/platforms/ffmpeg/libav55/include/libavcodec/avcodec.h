...
#define CODEC_FLAG_OUTPUT_CORRUPT \
  0x0008  ///< Output even those frames that might be corrupted
...
#define CODEC_FLAG2_IGNORE_CROP \
  0x00010000  ///< Discard cropping information from SPS.
...
#define FF_MB_DECISION_RD 2    ///< rate distortion
  ...
  /**
     ...
     */
  attribute_deprecated int (*get_buffer)(struct AVCodecContext* c,
                                         AVFrame* pic);
  ...
  /**
     ...
     */
  attribute_deprecated void (*release_buffer)(struct AVCodecContext* c,
                                              AVFrame* pic);
  ...
  /**
     ...
     * - decoding: Set by libavcodec, user can override.
     */
  attribute_deprecated int (*reget_buffer)(struct AVCodecContext* c,
                                           AVFrame* pic);
#endif
 ...
 */
int
av_packet_copy_props(AVPacket* dst, const AVPacket* src);
