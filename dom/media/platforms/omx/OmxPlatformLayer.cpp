...
UniquePtr<ConfigType>
ConfigForMime(const nsACString&);
 ...
 public:
  OMX_ERRORTYPE Apply(OmxPlatformLayer& aOmx, const AudioInfo& aInfo) override
  {
    ...
    err = aOmx.GetParameter(
        OMX_IndexParamAudioAac, &aacProfile, sizeof(aacProfile));
    RETURN_IF_ERR(err);
