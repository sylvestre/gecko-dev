...
template<typename T>
T
FloatToAudioSample(float aValue);
...
template<typename T>
T
UInt8bitToAudioSample(uint8_t aValue);
...
template<typename T>
T
IntegerToAudioSample(int16_t aValue);
...
template<typename From, typename To>
inline void
ConvertAudioSamplesWithScale(const From* aFrom,
                             To* aTo,
                             int aCount,
                             float aScale)
{
...
inline void
ConvertAudioSamplesWithScale(const int16_t* aFrom,
                             int16_t* aTo,
                             int aCount,
                             float aScale)
{
...
inline const void*
AddAudioSampleOffset(const void* aBase,
