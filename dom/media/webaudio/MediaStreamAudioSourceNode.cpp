...
void
MediaStreamAudioSourceNode::AttachToTrack(
...
void
MediaStreamAudioSourceNode::AttachToFirstTrack(
...
void
MediaStreamAudioSourceNode::NotifyTrackAdded(
    const RefPtr<MediaStreamTrack>& aTrack)
{
  if (mInputTrack) {
    return;
...
void
MediaStreamAudioSourceNode::NotifyTrackRemoved(
    const RefPtr<MediaStreamTrack>& aTrack)
{
 ...
 */
void
MediaStreamAudioSourceNode::PrincipalChanged(
...
size_t
MediaStreamAudioSourceNode::SizeOfExcludingThis(
...
size_t
MediaStreamAudioSourceNode::SizeOfIncludingThis(
    MallocSizeOf aMallocSizeOf) const
{
