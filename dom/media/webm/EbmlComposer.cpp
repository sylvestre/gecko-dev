...
EbmlComposer::WriteSimpleBlock(EncodedFrame* aFrame)
{
  ...
  writeSimpleBlock(&ebml,
                   isOpus ? 0x2 : 0x1,
                   static_cast<short>(timeCode),
                   isVP8IFrame,
                   0,
                   0,
...
void
EbmlComposer::SetVideoConfig(uint32_t aWidth,
                             uint32_t aHeight,
