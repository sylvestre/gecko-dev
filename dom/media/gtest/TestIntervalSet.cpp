...
ByteInterval
CreateByteInterval(int32_t aStart, int32_t aEnd)
{
  ByteInterval test(aStart, aEnd);
  return test;
}

media::IntervalSet<uint8_t>
CreateByteIntervalSet(int32_t aStart, int32_t aEnd)
{
...
media::TimeInterval
CreateTimeInterval(int32_t aStart, int32_t aEnd)
{
...
media::TimeIntervals
CreateTimeIntervals(int32_t aStart, int32_t aEnd)
{
...
template<typename T>
static void
Compare(const media::IntervalSet<T>& aI1, const media::IntervalSet<T>& aI2)
{
...
static void
GeneratePermutations(const IntIntervals& aI1, const IntIntervals& aI2)
{
...
static IntIntervals
Duplicate(const IntIntervals& aValue)
{
...
TEST(IntervalSet, Normalize)
{
  ...
  ti += media::TimeInterval(
      ti.Start(0), ti.End(0), media::TimeUnit::FromMicroseconds(35000));
...
static void
CheckTimeRanges(dom::TimeRanges* aTr, const media::TimeIntervals& aTi)
{
