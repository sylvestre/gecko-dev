...
class MediaPrefs final
{
 ...
 private:
  ...
  DECL_MEDIA_PREF("media.memory_cache_max_size",
  ...
  DECL_MEDIA_PREF("media.memory_caches_combined_limit_pc_sysmem",
                  ...
                  uint32_t,
                  5);
  DECL_MEDIA_PREF("media.cache.resource-index",
  ...
  DECL_MEDIA_PREF("media.resampling.enabled", AudioSinkResampling, bool, false);
  DECL_MEDIA_PREF("media.resampling.rate",
  ...
  DECL_MEDIA_PREF("media.forcestereo.enabled",
  ...
  DECL_MEDIA_PREF("media.libavcodec.allow-obsolete",
  ...
  DECL_MEDIA_PREF("media.wmf.decoder.thread-count",
                  PDMWMFThreadCount,
                  int32_t,
                  -1);
#endif
  DECL_MEDIA_PREF("media.decoder.fuzzing.enabled",
                  PDMFuzzingEnabled,
                  bool,
                  false);
  DECL_MEDIA_PREF("media.decoder.fuzzing.video-output-minimum-interval-ms",
                  PDMFuzzingInterval,
                  uint32_t,
                  0);
  DECL_MEDIA_PREF("media.decoder.fuzzing.dont-delay-inputexhausted",
                  PDMFuzzingDelayInputExhausted,
                  bool,
                  true);
  DECL_MEDIA_PREF("media.decoder.recycle.enabled",
  ...
  DECL_MEDIA_PREF("media.dormant-on-pause-timeout-ms",
  ...
  DECL_MEDIA_PREF("media.webspeech.synth.force_global_queue",
                  ...
                  bool,
                  false);
  DECL_MEDIA_PREF("media.webspeech.test.enable",
  ...
  DECL_MEDIA_PREF("media.num-decode-threads",
                  MediaThreadPoolDefaultCount,
                  uint32_t,
                  4);
  DECL_MEDIA_PREF("media.decoder.limit",
                  MediaDecoderLimit,
                  int32_t,
                  MediaDecoderLimitDefault());

#if defined(RELEASE_OR_BETA)
  DECL_MEDIA_PREF("media.audio-max-decode-error",
                  MaxAudioDecodeError,
                  uint32_t,
                  3);
  DECL_MEDIA_PREF("media.video-max-decode-error",
                  MaxVideoDecodeError,
                  uint32_t,
                  2);
#else
  ...
  DECL_MEDIA_PREF("media.playback.warnings-as-errors",
