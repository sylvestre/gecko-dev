...
IPCResult(Parent* aSelf, bool aSuccess);

template<>
inline mozilla::ipc::IPCResult
IPCResult(Parent<PMediaParent>* aSelf, bool aSuccess)
{
...
template<>
inline mozilla::ipc::IPCResult
IPCResult(Parent<NonE10s>* aSelf, bool aSuccess)
{
  return IPC_OK();
}
...
AllocPMediaParent();
bool
DeallocPMediaParent(PMediaParent* aActor);
