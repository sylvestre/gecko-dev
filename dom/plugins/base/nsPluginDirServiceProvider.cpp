...
NS_IMETHODIMP
nsPluginDirServiceProvider::GetFile(const char* charProp,
                                    bool* persistant,
                                    nsIFile** _retval)
{
...
nsresult
nsPluginDirServiceProvider::GetPLIDDirectories(
...
nsresult
nsPluginDirServiceProvider::GetPLIDDirectoriesWithRootKey(
