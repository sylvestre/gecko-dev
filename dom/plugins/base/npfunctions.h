...
typedef int32_t (*NPP_WriteProcPtr)(
...
typedef void (*NPP_URLRedirectNotifyPtr)(NPP instance,
                                         const char* url,
                                         int32_t status,
                                         void* notifyData);
typedef NPError (*NPP_ClearSiteDataPtr)(const char* site,
                                        uint64_t flags,
                                        uint64_t maxAge);
...
typedef bool (*NPN_RemovePropertyProcPtr)(NPP npp,
                                          NPObject* obj,
                                          NPIdentifier propertyName);
typedef bool (*NPN_HasPropertyProcPtr)(NPP npp,
                                       NPObject* obj,
                                       NPIdentifier propertyName);
...
typedef NPError (*NPN_GetAuthenticationInfoPtr)(NPP npp,
                                                ...
                                                char** password,
                                                uint32_t* plen);
typedef uint32_t (*NPN_ScheduleTimerPtr)(NPP instance,
                                         uint32_t interval,
                                         NPBool repeat,
...
typedef void (*NPN_URLRedirectResponsePtr)(NPP instance,
                                           void* notifyData,
                                           NPBool allow);
typedef NPError (*NPN_InitAsyncSurfacePtr)(NPP instance,
                                           NPSize* size,
...
OSErr
BP_GetSupportedMIMETypes(BPSupportedMIMETypes* mimeInfo, UInt32 flags);
