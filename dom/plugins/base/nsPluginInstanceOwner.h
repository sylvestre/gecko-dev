                                    ...
                                    public nsSupportsWeakReference
{
 public:
  ...
  NPBool ConvertPoint(double sourceX,
                      ...
                      double* destX,
                      double* destY,
                      NPCoordinateSpace destSpace) override;
  ...
  bool GetCompositionString(uint32_t aIndex,
                            nsTArray<uint8_t>* aString,
                            int32_t* aLength);
 ...
 private:
  ...
  {
   public:
    Renderer(NPWindow* aWindow,
             nsPluginInstanceOwner* aInstanceOwner,
             const nsIntSize& aPluginSize,
