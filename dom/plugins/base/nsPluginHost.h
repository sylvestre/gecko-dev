                           ...
                           public nsINamed
{
 ...
 public:
  ...
  nsresult GetURLWithHeaders(
      nsNPAPIPluginInstance* pluginInst,
      const char* url,
  ...
  nsresult InstantiatePluginInstance(const nsACString& aMimeType,
                                     nsIURI* aURL,
 ...
 private:
  ...
  nsresult TrySetUpPluginInstance(const nsACString& aMimeType,
                                  nsIURI* aURL,
                                  nsPluginInstanceOwner* aOwner);
  ...
  nsresult ScanPluginsDirectory(nsIFile* pluginsDir,
