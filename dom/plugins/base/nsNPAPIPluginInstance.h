      ...
      public mozilla::SupportsWeakPtr<nsNPAPIPluginInstance>
{
 ...
 public:
  ...
  nsresult Initialize(nsNPAPIPlugin* aPlugin,
                      nsPluginInstanceOwner* aOwner,
                      const nsACString& aMIMEType);
  nsresult Start();
  nsresult Stop();
  nsresult SetWindow(NPWindow* window);
  nsresult NewStreamFromPlugin(const char* type,
                               const char* target,
                               nsIOutputStream** result);
  nsresult Print(NPPrint* platformPrint);
  nsresult HandleEvent(void* event,
                       int16_t* result,
  ...
  nsresult NewStreamListener(const char* aURL,
                             void* notifyData,
  ...
  NPBool ConvertPoint(double sourceX,
                      double sourceY,
  ...
  NPError InitAsyncSurface(NPSize* size,
