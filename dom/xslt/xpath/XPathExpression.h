...
{
 public:
  XPathExpression(nsAutoPtr<Expr>&& aExpression,
  ...
  already_AddRefed<XPathResult> Evaluate(JSContext* aCx,
  ...
  already_AddRefed<XPathResult> EvaluateWithContext(
      ...
      JS::Handle<JSObject*> aInResult,
      ErrorResult& aRv);
  already_AddRefed<XPathResult> Evaluate(nsINode& aContextNode,
                                         uint16_t aType,
  ...
  already_AddRefed<XPathResult> EvaluateWithContext(nsINode& aContextNode,
                                                    uint32_t aContextPosition,
                                                    uint32_t aContextSize,
                                                    uint16_t aType,
                                                    XPathResult* aInResult,
