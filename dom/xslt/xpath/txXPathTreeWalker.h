...
{
 public:
  static bool getAttr(const txXPathNode& aNode,
                      nsAtom* aLocalName,
                      int32_t aNSID,
                      nsAString& aValue);
...
inline bool
txXPathTreeWalker::getAttr(nsAtom* aLocalName,
                           int32_t aNSID,
...
/* static */
inline bool
txXPathNodeUtils::localNameEquals(const txXPathNode& aNode, nsAtom* aLocalName)
{
