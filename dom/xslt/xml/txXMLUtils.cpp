...
// static
nsresult
XMLUtils::splitExpatName(const char16_t* aExpatName,
                         nsAtom** aPrefix,
                         nsAtom** aLocalName,
...
nsresult
XMLUtils::splitQName(const nsAString& aName,
                     nsAtom** aPrefix,
                     nsAtom** aLocalName)
{
 ...
 */
bool
XMLUtils::isWhitespace(const nsString& aText)
{
...
**/
void
XMLUtils::normalizePIValue(nsAString& piValue)
{
...
//static
bool
XMLUtils::isValidQName(const nsString& aQName, const char16_t** aColon)
{
...
//static
bool
XMLUtils::getXMLSpacePreserve(const txXPathNode& aNode)
{
  nsAutoString value;
