...
nsresult
txNodeSorter::addSortElement(Expr* aSelectExpr,
                             Expr* aLangExpr,
                             Expr* aDataTypeExpr,
                             Expr* aOrderExpr,
                             Expr* aCaseOrderExpr,
...
nsresult
txNodeSorter::sortNodeSet(txNodeSet* aNodes,
                          ...
                          txNodeSet** aResult)
{
  ...
  *aResult = nullptr;
  ...
  sortData.mRv = NS_OK;
  NS_QuickSort(
      indexes.get(), len.value(), sizeof(uint32_t), compareNodes, &sortData);
...
// static
int
txNodeSorter::compareNodes(const void* aIndexA,
                           const void* aIndexB,
                           void* aSortData)
{
...
//static
bool
txNodeSorter::calcSortValue(txObject*& aSortValue,
                            SortKey* aKey,
                            SortData* aSortData,
                            uint32_t aNodeIndex)
{
