...
static nsresult
createTextNode(txIEvalContext* aContext,
               nsString& aValue,
               txXPathNode** aResult)
{
  txExecutionState* es =
...
static nsresult
createAndAddToResult(nsAtom* aName,
...
static const char* const sTypes[] = {
    "node-set", "boolean", "number", "string", "RTF"};
...
static txEXSLTFunctionDescriptor descriptTable[] = {
    {1,
     ...
     0,
     &nsGkAtoms::nodeSet,
     kEXSLTCommonNS},  // NODE_SET
    {1,
     1,
     Expr::STRING_RESULT,
     0,
     &nsGkAtoms::objectType,
     kEXSLTCommonNS},  // OBJECT_TYPE
    {2,
     2,
     Expr::NODESET_RESULT,
     0,
     &nsGkAtoms::difference,
     kEXSLTSetsNS},  // DIFFERENCE
    {1,
     1,
     Expr::NODESET_RESULT,
     0,
    ...
    {2,
     ...
     kEXSLTSetsNS},  // HAS_SAME_NODE
    {2,
     2,
     Expr::NODESET_RESULT,
     0,
     &nsGkAtoms::intersection,
     kEXSLTSetsNS},  // INTERSECTION
    {2,
     2,
     Expr::NODESET_RESULT,
     0,
     &nsGkAtoms::leading,
     kEXSLTSetsNS},  // LEADING
    {2,
     2,
     Expr::NODESET_RESULT,
     0,
     &nsGkAtoms::trailing,
     kEXSLTSetsNS},  // TRAILING
    {1,
     1,
     Expr::STRING_RESULT,
     0,
     &nsGkAtoms::concat,
     kEXSLTStringsNS},  // CONCAT
    {1,
     2,
     Expr::STRING_RESULT,
     0,
     &nsGkAtoms::split,
     kEXSLTStringsNS},  // SPLIT
    {1,
     2,
     Expr::STRING_RESULT,
     0,
     &nsGkAtoms::tokenize,
     kEXSLTStringsNS},                                              // TOKENIZE
    ...
    {0,
     ...
     0,
     &nsGkAtoms::dateTime,
     kEXSLTDatesAndTimesNS},  // DATE_TIME
...
class txEXSLTFunctionCall : public FunctionCall
{
 public:
  ...
  explicit txEXSLTFunctionCall(eType aType) : mType(aType) {}
...
nsresult
txEXSLTFunctionCall::evaluate(txIEvalContext* aContext, txAExprResult** aResult)
{
  *aResult = nullptr;
                          ...
                          FunctionCall** aResult)
{
  ...
  for (i = 0; i < ArrayLength(descriptTable); ++i) {
    ...
    if (aName == *desc.mName && aNamespaceID == desc.mNamespaceID) {
      *aResult =
          new txEXSLTFunctionCall(static_cast<txEXSLTFunctionCall::eType>(i));
      return NS_OK;
    }
  }
...
TX_InitEXSLTFunction()
{
  ...
  for (i = 0; i < ArrayLength(descriptTable); ++i) {
    ...
    desc.mNamespaceID = txNamespaceManager::getNamespaceID(namespaceURI);
