...
class txMozillaXMLOutput : public txAOutputXMLEventHandler
{
 public:
  ...
  nsresult createResultDocument(const nsAString& aName,
                                int32_t aNsID,
 ...
 private:
  ...
  nsresult createHTMLElement(nsAtom* aName, nsIContent** aResult);

  nsresult attributeInternal(nsAtom* aPrefix,
                             nsAtom* aLocalName,
                             int32_t aNsID,
                             const nsString& aValue);
  nsresult startElementInternal(nsAtom* aPrefix,
                                nsAtom* aLocalName,
                                int32_t aNsID);
