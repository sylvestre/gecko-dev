...
#define TX_DECL_TXINSTRUCTION virtual nsresult execute(txExecutionState& aEs);
...
{
 public:
  txAttribute(nsAutoPtr<Expr>&& aName,
...
{
 public:
  txLREAttribute(int32_t aNamespaceID,
                 nsAtom* aLocalName,
                 nsAtom* aPrefix,
...
{
 public:
  txStartElement(nsAutoPtr<Expr>&& aName,
                 nsAutoPtr<Expr>&& aNamespace,
                 txNamespaceMap* aMappings);
