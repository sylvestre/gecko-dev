...
#define TX_DECL_ACOMPILEOBSERVER                                 \
  nsresult loadURI(const nsAString& aUri,                        \
                   const nsAString& aReferrerUri,                \
                   mozilla::net::ReferrerPolicy aReferrerPolicy, \
                   txStylesheetCompiler* aCompiler);             \
  void onDoneCompiling(txStylesheetCompiler* aCompiler,          \
                       nsresult aResult,                         \
                       const char16_t* aErrorText = nullptr,     \
                                   ...
                                   public txACompileObserver
{
 public:
  ...
  nsresult startElement(int32_t aNamespaceID,
                        nsAtom* aLocalName,
                        nsAtom* aPrefix,
 ...
 private:
  ...
  nsresult startElementInternal(int32_t aNamespaceID,
                                nsAtom* aLocalName,
                                nsAtom* aPrefix,
                                txStylesheetAttr* aAttributes,
                                int32_t aAttrCount);
