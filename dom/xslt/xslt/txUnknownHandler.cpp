...
nsresult
txUnknownHandler::attribute(nsAtom* aPrefix,
                            nsAtom* aLocalName,
...
txUnknownHandler::attribute(nsAtom* aPrefix,
                            ...
                            const nsString& aValue)
{
  return mFlushed ? mEs->mResultHandler->attribute(
                        aPrefix, aLocalName, aNsID, aValue)
                  : txBufferingHandler::attribute(
                        aPrefix, aLocalName, aNsID, aValue);
}
...
nsresult
txUnknownHandler::startElement(nsAtom* aPrefix,
                               nsAtom* aLocalName,
                               nsAtom* aLowercaseLocalName,
                               int32_t aNsID)
{
  ...
  return mEs->mResultHandler->startElement(
