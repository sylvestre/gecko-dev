...
nsresult
txResultStringComparator::init(const nsString& aLanguage)
{
  nsresult rv;
...
int
txResultStringComparator::compareValues(txObject* aVal1, txObject* aVal2)
{
  ...
  nsresult rv;
  int32_t result = -1;
  rv = mCollation->CompareRawSortKey(strval1->mKey,
                                     strval1->mLength,
                                     strval2->mKey,
                                     strval2->mLength,
                                     &result);
  ...
  rv = mCollation->CompareRawSortKey((uint8_t*)strval1->mCaseKey,
                                     strval1->mCaseLength,
                                     (uint8_t*)strval2->mCaseKey,
                                     strval2->mCaseLength,
                                     &result);
...
int
txResultNumberComparator::compareValues(txObject* aVal1, txObject* aVal2)
{
