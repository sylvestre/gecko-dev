...
#define TRANSFORMIIX_XSLT_PROCESSOR_CID              \
  {                                                  \
    0x618ee71d, 0xd7a7, 0x41a1,                      \
    {                                                \
      0xa3, 0xfb, 0xc2, 0xbe, 0xdc, 0x6a, 0x21, 0x7e \
    }                                                \
  }
                                     ...
                                     public nsWrapperCache
{
 public:
  ...
  void reportError(nsresult aResult,
                   const char16_t* aErrorText,
                   const char16_t* aSourceText);

  nsIDOMNode* GetSourceContentModel() { return mSource; }

  nsresult TransformToDoc(nsIDOMDocument** aResult, bool aCreateDataDocument);

  bool IsLoadDisabled() { return (mFlags & DISABLE_ALL_LOADS) != 0; }
