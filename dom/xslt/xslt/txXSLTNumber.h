...
class txXSLTNumber
{
 public:
  ...
  static nsresult createNumber(Expr* aValueExpr,
 ...
 private:
  static nsresult getValueList(Expr* aValueExpr,
                               txPattern* aCountPattern,
                               txPattern* aFromPattern,
                               LevelType aLevel,
                               txIEvalContext* aContext,
  ...
  static nsresult getCounters(Expr* aGroupSize,
                              Expr* aGroupSeparator,
                              Expr* aFormat,
                              txIEvalContext* aContext,
                              txList& aCounters,
...
class txFormattedCounter
{
 public:
  ...
  static nsresult getCounterFor(const nsString& aToken,
                                int aGroupSize,
