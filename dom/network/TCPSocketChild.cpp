...
void
TCPSocketChild::SendOpen(nsITCPSocketCallback* aSocket,
                         bool aUseSSL,
                                       ...
                                       bool aReuseAddrPort)
{
  ...
  PTCPSocketChild::SendOpenBind(nsCString(aRemoteHost),
                                aRemotePort,
                                nsCString(aLocalHost),
                                aLocalPort,
                                aUseSSL,
                                aReuseAddrPort,
                                true,
                         ...
                         uint32_t aTrackingNumber)
{
  ...
  if (!fallibleArr.InsertElementsAt(
          0, aData.Data() + offset, nbytes, fallible)) {
