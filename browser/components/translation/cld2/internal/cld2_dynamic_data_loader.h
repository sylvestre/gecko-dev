...
CLD2DynamicData::FileHeader*
loadHeader(const char* fileName);
...
CLD2::ScoringTables*
loadDataFile(const char* fileName, void** mmapAddressOut, int* mmapLengthOut);
...
void
unloadData(CLD2::ScoringTables** scoringTables,
           void** mmapAddress,
           int* mmapLength);
