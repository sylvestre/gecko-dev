...
#ifdef INTERPOSE
const void*
RealGetInterface(const char* interfaceName);
void
Logging_PP_CompletionCallback(void* user_data, int32_t result);
void
Logging_PPB_Audio_Callback_1_0(void* sample_buffer,
...
#else   // INTERPOSE
void
ToHost(std::stringstream& s, bool abortIfNonMainThread);
std::string
ToHostWithResult(std::stringstream& s, bool abortIfNonMainThread);
...
void
RPC(std::stringstream& s)
{
  return ToHost(s, rpcThread == MainThreadOnly);
}
template<RPCThread rpcThread>
std::string
RPCWithResult(std::stringstream& s)
{
...
static void
BeginProps(std::stringstream& s)
{
  s << '{';
}

static void
EndProps(std::stringstream& s)
{
  s << '}';
}

static void
BeginProp(std::stringstream& s, const std::string& key)
{
  if (s.str().back() != '{') s << ',';
  s << '"' << key << "\":";
}
...
static void
AddProp(std::stringstream& s, const std::string& key, const std::string& value)
{
  BeginProp(s, key);
  s << value;
}
...
static void
BeginElements(std::stringstream& s)
{
  s << '[';
}

static void
EndElements(std::stringstream& s)
{
  s << ']';
}

static void
BeginElement(std::stringstream& s)
{
  if (s.str().back() != '[') s << ',';
}

static void
AddElement(std::stringstream& s, const std::string& value)
{
  BeginElement(s);
  s << value;
}
...
static void
WriteEscapedChar(std::stringstream& x, const char value)
{
  switch (value) {
    case '\\':
      x << "\\\\";
...
template<typename T>
static void
WriteString(std::stringstream& x, const T* value, size_t length)
{
...
template<typename T>
static const std::string
StringToQuotedString(const T* value, size_t length)
{
  std::stringstream x;
  x << '"';
...
template<typename T>
static const std::string
StringToQuotedString(const T* value)
{
  return StringToQuotedString(value, strlen(*value));
}

static const std::string
StringToQuotedString(const char* value)
{
...
static const std::string
ToString_str_t(const str_t* value, size_t length)
{
...
static const std::string
ToString_GLboolean(const GLboolean* value)
{
  std::stringstream x;
  x << (*value ? "true" : "false");
  return x.str();
...
#ifdef INTERPOSE
static const std::string
ToString_GLubyte_ptr_t(const GLubyte* value)
{
  std::stringstream x;
  x << (const char*)value;
  return x.str();
...
static const std::string
ToString_uint16_ptr_t(const uint16_ptr_t value)
{
  return "";
}
extern const std::string
ToString_PP_DirContents_Dev(const PP_DirContents_Dev* v);
static const std::string
ToString_PP_DirContents_Dev(PP_DirContents_Dev** value)
{
  if (!value && !*value) {
    return "{}";
  }
...
static const std::string
ToString_PPP_MessageHandler(const PPP_MessageHandler_0_2* value)
{
  std::stringstream x;
  x << value;
  return x.str();
...
static const std::string
ToString_PPP_Class_Deprecated(const PPP_Class_Deprecated* value)
{
  return PointerToString(value);
}
...
static void
FromJSON_int(JSONIterator& iterator, long int& value)
{
  value = atol(iterator.getCurrentPrimitiveAndGotoNext().value().c_str());
}

static void
FromJSON_uintptr(JSONIterator& iterator, std::uintptr_t& value)
{
  long long pointer =
...
template<typename T>
static void
PointerValueFromJSON(JSONIterator& iterator, T*& value)
{
...
static void
FromJSON_charArray(JSONIterator& iterator, char* value, size_t count)
{
...
static void
FromJSON_mem_t(JSONIterator& iterator, OutParam<mem_t>::type& value)
{
  PointerValueFromJSON(iterator, value);
}
static void
FromJSON_mem_ptr_t(JSONIterator& iterator, OutParam<mem_ptr_t>::type& value)
{
  const JSON::Token& token = iterator.getCurrentAndGotoNext();
  Fail("UNIMPLEMENTED: %s\n", "FromJSON_mem_ptr_t");
}
static void
FromJSON_str_t(JSONIterator& iterator, OutParam<str_t>::type& value)
{
  const JSON::Token& token = iterator.getCurrentAndGotoNext();
  if (token.isString()) {
    size_t length = 0;
...
static void
FromJSON_str_t(JSONIterator& iterator, str_t& value)
{
  return FromJSON_str_t(iterator, const_cast<OutParam<str_t>::type&>(value));
}
static void
FromJSON_cstr_t(JSONIterator& iterator, cstr_t& value)
{
...
static void
FromJSON_GLenum(JSONIterator& iterator, OutParam<GLenum>::type& value)
{
  const JSON::Token& token = iterator.getCurrentAndGotoNext();
  Fail("UNIMPLEMENTED: %s\n", "FromJSON_GLenum");
}
static void
FromJSON_GLbitfield(JSONIterator& iterator, OutParam<GLbitfield>::type& value)
{
  const JSON::Token& token = iterator.getCurrentAndGotoNext();
  Fail("UNIMPLEMENTED: %s\n", "FromJSON_GLbitfield");
}
...
static void
FromJSON_GLfloat(JSONIterator& iterator, OutParam<GLfloat>::type& value)
{
  const JSON::Token& token = iterator.getCurrentAndGotoNext();
  Fail("UNIMPLEMENTED: %s\n", "FromJSON_GLfloat");
}
static void
FromJSON_GLclampf(JSONIterator& iterator, OutParam<GLclampf>::type& value)
{
  const JSON::Token& token = iterator.getCurrentAndGotoNext();
  Fail("UNIMPLEMENTED: %s\n", "FromJSON_GLclampf");
}
static void
FromJSON_GLintptr(JSONIterator& iterator, OutParam<GLintptr>::type& value)
{
  const JSON::Token& token = iterator.getCurrentAndGotoNext();
  Fail("UNIMPLEMENTED: %s\n", "FromJSON_GLintptr");
}
...
static void
FromJSON_GLboolean_ptr_t(JSONIterator& iterator,
...
static void
FromJSON_GLenum_ptr_t(JSONIterator& iterator,
...
static void
FromJSON_GLfloat_ptr_t(JSONIterator& iterator,
...
static void
FromJSON_GLint_ptr_t(JSONIterator& iterator, OutParam<GLint_ptr_t>::type& value)
{
  return FromJSON_GLint(iterator, *value);
  Fail("UNIMPLEMENTED: %s\n", "FromJSON_GLint_ptr_t");
}
static void
FromJSON_GLsizei_ptr_t(JSONIterator& iterator,
...
static void
FromJSON_GLubyte_ptr_t(JSONIterator& iterator,
...
static void
FromJSON_GLuint_ptr_t(JSONIterator& iterator,
...
#ifdef _WIN32
static void
FromJSON_PP_FileHandle(JSONIterator& iterator, PP_FileHandle& value)
{
  PointerValueFromJSON(iterator, value);
}
#else
...
#endif
static void
FromJSON_uint16_ptr_t(JSONIterator& iterator, uint16_ptr_t& value)
{
  PointerValueFromJSON(iterator, value);
}
...
void
FromJSON_PP_Flash_Menu(JSONIterator& iterator, PP_Flash_Menu& value);
void
FromJSON_PP_Flash_Menu(JSONIterator& iterator, PP_Flash_Menu*& value);
...
void
FromJSON_PP_DirEntry_Dev(JSONIterator& iterator, PP_DirEntry_Dev& value);
void
FromJSON_PP_DirContents_Dev(JSONIterator& iterator, PP_DirContents_Dev*& value);
