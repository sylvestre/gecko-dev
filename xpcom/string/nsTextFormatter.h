...
class nsTextFormatter
{
 public:
   ...
   */
  template<typename... T>
  static uint32_t snprintf(char16_t* aOut,
                           uint32_t aOutLen,
                           const char16_t* aFmt,
                           T... aArgs)
  {
    ...
    return vsnprintf(
        aOut, aOutLen, aFmt, mozilla::MakeSpan(values, sizeof...(aArgs)));
  }
 ...
 private:
  ...
  static int fill2(SprintfStateStr* aState,
                   const char16_t* aSrc,
                   int aSrcLen,
                   int aWidth,
                   int aFlags);
  static int fill_n(SprintfStateStr* aState,
                    const char16_t* aSrc,
                    int aSrcLen,
                    int aWidth,
                    int aPrec,
                    int aFlags);
  static int cvt_ll(SprintfStateStr* aState,
                    uint64_t aNum,
                    int aWidth,
                    int aPrec,
                    int aRadix,
  ...
  static int cvt_f(SprintfStateStr* aState,
                   double aDouble,
                   int aWidth,
                   int aPrec,
                   const char16_t aType,
                   int aFlags);
  static int cvt_S(SprintfStateStr* aState,
                   const char16_t* aStr,
                   int aWidth,
                   int aPrec,
                   int aFlags);
  static int cvt_s(SprintfStateStr* aState,
                   ...
                   int aPrec,
                   int aFlags);
  static int dosprintf(SprintfStateStr* aState,
                       const char16_t* aFmt,
                       mozilla::Span<BoxedValue> aValues);
  static int StringStuff(SprintfStateStr* aState,
                         const char16_t* aStr,
                         uint32_t aLen);
  static int LimitStuff(SprintfStateStr* aState,
                        const char16_t* aStr,
                        uint32_t aLen);
  static uint32_t vsnprintf(char16_t* aOut,
                            uint32_t aOutLen,
                            const char16_t* aFmt,
                            mozilla::Span<BoxedValue> aValues);
  static void vssprintf(nsAString& aOut,
                        const char16_t* aFmt,
                        mozilla::Span<BoxedValue> aValues);
};
