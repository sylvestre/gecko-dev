 ...
 */
static int32_t
FindChar1(const char* aDest,
          uint32_t aDestLength,
          int32_t anOffset,
 ...
 */
static int32_t
FindChar2(const char16_t* aDest,
          uint32_t aDestLength,
          int32_t anOffset,
          const char16_t aChar,
          int32_t aCount)
 ...
 */
static int32_t
RFindChar2(const char16_t* aDest,
           uint32_t aDestLength,
           int32_t anOffset,
           const char16_t aChar,
           int32_t aCount)
...
#endif /* __SUNPRO_CC */
    int32_t
    Compare2To1(const char16_t* aStr1,
                const char* aStr2,
                uint32_t aCount,
                bool aIgnoreCase)
{
...
struct nsBufferRoutines<char>
{
  ...
  static int32_t compare(const char* a,
                         const char16_t* b,
                         uint32_t max,
                         bool ic)
  {
  ...
  static int32_t find_char(const char* s,
                           uint32_t max,
                           int32_t offset,
                           const char16_t c,
                           int32_t count)
  ...
  static int32_t rfind_char(const char* s,
                            uint32_t max,
                            int32_t offset,
                            const char16_t c,
                            int32_t count)
...
{
  static int32_t compare(const char16_t* a,
                         const char16_t* b,
                         uint32_t max,
                         bool ic)
  {
  ...
  static int32_t find_char(const char16_t* s,
                           uint32_t max,
                           int32_t offset,
                           const char16_t c,
                           int32_t count)
  ...
  static int32_t rfind_char(const char16_t* s,
                            uint32_t max,
                            int32_t offset,
                            const char16_t c,
                            int32_t count)
 ...
 */
static void
Find_ComputeSearchRange(uint32_t bigLen,
                        uint32_t littleLen,
                        int32_t& offset,
                        int32_t& count)
{
 ...
 */
static void
RFind_ComputeSearchRange(uint32_t bigLen,
                         uint32_t littleLen,
                         int32_t& offset,
                         int32_t& count)
{
...
int32_t
nsTString<T>::Find(const self_type& aString,
                   int32_t aOffset,
                   int32_t aCount) const
{
  ...
  int32_t result = FindSubstring(
      this->mData + aOffset, aCount, str, aString.Length(), false);
...
template<typename Q, typename EnableIfChar16>
int32_t
nsTString<T>::Find(const char_type* aString,
                   int32_t aOffset,
                   int32_t aCount) const
{
...
template<typename Q, typename EnableIfChar16>
int32_t
nsTString<T>::RFind(const self_type& aString,
                    int32_t aOffset,
                    int32_t aCount) const
{
  // this method changes the meaning of aOffset and aCount:
...
template<typename Q, typename EnableIfChar16>
int32_t
nsTString<T>::RFind(const char_type* aString,
                    int32_t aOffset,
                    int32_t aCount) const
{
...
int32_t
nsTString<T>::Compare(const char_type* aString,
                      bool aIgnoreCase,
                      int32_t aCount) const
{
  ...
  int32_t result = nsBufferRoutines<T>::compare(
      this->mData, aString, compareCount, aIgnoreCase);
...
template<typename Q, typename EnableIfChar16>
bool
nsTString<T>::EqualsIgnoreCase(const incompatible_char_type* aString,
                               int32_t aCount) const
{
