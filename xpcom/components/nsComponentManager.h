...
{
 public:
  explicit SafeMutex(const char* aName) : mMutex(aName), mOwnerThread(nullptr)
  {
  }
                                     ...
                                     public nsIMemoryReporter
{
 public:
  ...
  // Mutex not held
  void RegisterManifest(NSLocationType aType,
                        mozilla::FileLocation& aFile,
                        bool aChromeOnly);
  ...
  void ManifestManifest(ManifestProcessingContext& aCx,
                        int aLineNo,
                        char* const* aArgv);
  void ManifestBinaryComponent(ManifestProcessingContext& aCx,
                               int aLineNo,
                               char* const* aArgv);
  void ManifestXPT(ManifestProcessingContext& aCx,
                   int aLineNo,
                   char* const* aArgv);
  void ManifestComponent(ManifestProcessingContext& aCx,
                         int aLineNo,
                         char* const* aArgv);
  void ManifestContract(ManifestProcessingContext& aCx,
                        int aLineNo,
                        char* const* aArgv);
  void ManifestCategory(ManifestProcessingContext& aCx,
                        int aLineNo,
                        char* const* aArgv);
