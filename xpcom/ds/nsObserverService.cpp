                                  ...
                                  bool aAnonymize)
{
  ...
  MOZ_COLLECT_REPORT(
      "observer-service/referent/strong",
      KIND_OTHER,
      UNITS_COUNT,
      totalNumStrong,
  ...
  MOZ_COLLECT_REPORT(
      "observer-service/referent/weak/alive",
      KIND_OTHER,
      UNITS_COUNT,
      totalNumWeakAlive,
  ...
  MOZ_COLLECT_REPORT(
      "observer-service/referent/weak/dead",
      KIND_OTHER,
      UNITS_COUNT,
      totalNumWeakDead,
      "The number of weak references held by the observer service that are "
...
nsresult
nsObserverService::Create(nsISupports* aOuter,
                          const nsIID& aIID,
                          void** aInstancePtr)
{
...
NS_IMETHODIMP
nsObserverService::AddObserver(nsIObserver* aObserver,
                               const char* aTopic,
                               bool aOwnsWeak)
{
...
NS_IMETHODIMP
nsObserverService::NotifyObservers(nsISupports* aSubject,
                                   const char* aTopic,
