...
bool
IsTwiceTheRequiredBytesRepresentableAsUint32(size_t aCapacity,
                                             size_t aElemSize);
...
template<typename ActualAlloc>
bool
nsTArray_base<Alloc, Copy>::InsertSlotsAt(index_type aIndex,
                                          size_type aCount,
                                          size_type aElemSize,
                                          size_t aElemAlign)
{
