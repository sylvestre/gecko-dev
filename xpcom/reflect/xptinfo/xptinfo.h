...
class nsXPTType : public XPTTypeDescriptorPrefix
{
 ...
 public:
  ...
  // place in xptcall. :-(
  bool IsArithmetic() const { return flags <= T_WCHAR; }
  ...
  bool IsArray() const { return TagPart() == T_ARRAY; }
  ...
  uint8_t TagPart() const { return (uint8_t)(flags & XPT_TDP_TAGMASK); }
...
class nsXPTParamInfo : public XPTParamDescriptor
{
 ...
 public:
  ...
  {
    return IsOut() || GetType().TagPart() == nsXPTType::T_JSVAL;
  }
...
class nsXPTMethodInfo : public XPTMethodDescriptor
{
 ...
 public:
  ...
  const nsXPTParamInfo GetResult() const { return result; }
