...
static void __stdcall invoke_copy_to_stack(uint32_t* d,
                                           uint32_t paramCount,
                                           nsXPCVariant* s)
{
...
static nsresult __stdcall DoInvoke(void* that,
                                   uint32_t index,
                                   uint32_t paramCount,
                                   nsXPCVariant* params)
{
...
static nsresult
DoInvoke(void* that, uint32_t index, uint32_t paramCount, nsXPCVariant* params)
{
  uint32_t result;
