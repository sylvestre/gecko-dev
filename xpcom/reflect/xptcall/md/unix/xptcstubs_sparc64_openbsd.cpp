  ...
  for (i = 0; i < paramCount; i++, ap++) {
    ...
    switch (type) {
      ...
      case nsXPTType::T_CHAR:
        dp->val.c = *((uint64_t*)ap);
        break;
      case nsXPTType::T_WCHAR:
        dp->val.wc = *((int64_t*)ap);
        break;
      case nsXPTType::T_I8:
        dp->val.i8 = *((int64_t*)ap);
        break;
      case nsXPTType::T_I16:
        dp->val.i16 = *((int64_t*)ap);
        break;
      case nsXPTType::T_I32:
        dp->val.i32 = *((int64_t*)ap);
        break;
      case nsXPTType::T_I64:
        dp->val.i64 = *((int64_t*)ap);
        break;
      case nsXPTType::T_U8:
        dp->val.u8 = *((uint64_t*)ap);
        break;
      case nsXPTType::T_U16:
        dp->val.u16 = *((uint64_t*)ap);
        break;
      case nsXPTType::T_U32:
        dp->val.u32 = *((uint64_t*)ap);
        break;
