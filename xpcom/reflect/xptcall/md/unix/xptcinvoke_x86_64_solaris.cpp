                 ...
                 nsXPTCVariant* params)
{
  ...
  if (nr_stack) nr_stack = (nr_stack + 1) & ~1;
  ...
  switch (nr_fpr) {
    case 8:
      asm("movupd %0, %xmm7" : : "xmm7"(fpregs[7]));
    case 7:
      asm("movupd %0, %xmm6" : : "xmm6"(fpregs[6]));
    case 6:
      asm("movupd %0, %xmm5" : : "xmm5"(fpregs[5]));
    case 5:
      asm("movupd %0, %xmm4" : : "xmm4"(fpregs[4]));
    case 4:
      asm("movupd %0, %xmm3" : : "xmm3"(fpregs[3]));
    case 3:
      asm("movupd %0, %xmm2" : : "xmm2"(fpregs[2]));
    case 2:
      asm("movupd %0, %xmm1" : : "xmm1"(fpregs[1]));
    case 1:
      asm("movupd %0, %xmm0" : : "xmm0"(fpregs[0]));
    case 0:;
  }
  ...
  uint32_t result = ((Method)methodAddress)(
      (uint64_t)that, gpregs[1], gpregs[2], gpregs[3], gpregs[4], gpregs[5]);
  return result;
}
