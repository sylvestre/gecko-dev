...
#define PARAM_BUFFER_COUNT 16
  ...
  for (i = 0; i < paramCount; ++i, --args) {
    ...
    switch (type) {
      case nsXPTType::T_I8:
        dp->val.i8 = *((int32_t*)args);
        break;
      case nsXPTType::T_I16:
        dp->val.i16 = *((int32_t*)args);
        break;
      ...
      case nsXPTType::T_FLOAT:
        ...
        break;
      case nsXPTType::T_U8:
        dp->val.u8 = *((uint32_t*)args);
        break;
      case nsXPTType::T_U16:
        dp->val.u16 = *((uint32_t*)args);
        break;
      case nsXPTType::T_U32:
        dp->val.u32 = *((uint32_t*)args);
        break;
      case nsXPTType::T_BOOL:
        dp->val.b = *((uint32_t*)args);
        break;
      case nsXPTType::T_CHAR:
        dp->val.c = *((uint32_t*)args);
        break;
      case nsXPTType::T_WCHAR:
        dp->val.wc = *((int32_t*)args);
        break;
      default:
        NS_ERROR("bad type");
        break;
...
#else
#define STUB_ENTRY(n) \
  nsresult nsXPTCStubBase::Stub##n() { return SharedStub(n); }
#endif
