...
extern "C" {
static nsresult ATTRIBUTE_USED __attribute__((regparm(3)))
...
#define STUB_HEADER(a, b)                                         \
  ".hidden " SYMBOL_UNDERSCORE "_ZN14nsXPTCStubBase" #a "Stub" #b \
  "Ev\n\t"                                                        \
  ".type   " SYMBOL_UNDERSCORE "_ZN14nsXPTCStubBase" #a "Stub" #b \
  "Ev,@function\n"

#define STUB_SIZE(a, b)                                                \
  ".size        " SYMBOL_UNDERSCORE "_ZN14nsXPTCStubBase" #a "Stub" #b \
  "Ev,.-" SYMBOL_UNDERSCORE "_ZN14nsXPTCStubBase" #a "Stub" #b "Ev\n\t"
...
#define STUB_ENTRY(n)                                                        \
  asm(".text\n\t"                                                            \
      ...
      ".if	" #n                                                         \
      " < 10\n\t"                                                            \
      ".globl	" SYMBOL_UNDERSCORE "_ZN14nsXPTCStubBase5Stub" #n            \
      "Ev\n\t" STUB_HEADER(5, n) SYMBOL_UNDERSCORE                           \
      "_ZN14nsXPTCStubBase5Stub" #n                                          \
      "Ev:\n\t"                                                              \
      ".elseif	" #n                                                         \
      " < 100\n\t"                                                           \
      ".globl	" SYMBOL_UNDERSCORE "_ZN14nsXPTCStubBase6Stub" #n            \
      "Ev\n\t" STUB_HEADER(6, n) SYMBOL_UNDERSCORE                           \
      "_ZN14nsXPTCStubBase6Stub" #n                                          \
      "Ev:\n\t"                                                              \
      ".elseif    " #n                                                       \
      " < 1000\n\t"                                                          \
      ".globl     " SYMBOL_UNDERSCORE "_ZN14nsXPTCStubBase7Stub" #n          \
      "Ev\n\t" STUB_HEADER(7, n) SYMBOL_UNDERSCORE                           \
