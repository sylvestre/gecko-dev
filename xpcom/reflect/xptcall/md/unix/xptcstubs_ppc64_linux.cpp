                   ...
                   double* fprData)
{
  ...
  for (i = 0; i < paramCount; i++) {
    ...
    if (!param.IsOut() && type == nsXPTType::T_DOUBLE) {
      ...
      if (i < FPR_COUNT)
        dp->val.f =
            (float)fprData[i];  // in registers floats are passed as doubles
      else {
        float* p = (float*)ap;
...
#define STUB_ENTRY(n)                           \
  __asm__(                                      \
      ...
      "addi     2,2,.TOC.-0b@l \n\t"            \
      ".localentry _ZN14nsXPTCStubBase5Stub" #n \
      "Ev,.-_ZN14nsXPTCStubBase5Stub" #n        \
      "Ev \n\t"                                 \
                                                \
      ".elseif " #n                             \
      " < 100 \n\t"                             \
      ...
      "0: addis 2,12,.TOC.-0b@ha \n\t"          \
      "addi     2,2,.TOC.-0b@l \n\t"            \
      ".localentry _ZN14nsXPTCStubBase6Stub" #n \
      "Ev,.-_ZN14nsXPTCStubBase6Stub" #n        \
      "Ev \n\t"                                 \
                                                \
      ".elseif " #n                             \
      " < 1000 \n\t"                            \
      ...
      "0: addis 2,12,.TOC.-0b@ha \n\t"          \
      "addi     2,2,.TOC.-0b@l \n\t"            \
      ".localentry _ZN14nsXPTCStubBase7Stub" #n \
      "Ev,.-_ZN14nsXPTCStubBase7Stub" #n        \
      "Ev \n\t"                                 \
                                                \
      ".else  \n\t"                             \
      ".err   \"stub number " #n                \
...
#define STUB_ENTRY(n)                       \
  __asm__(                                  \
      ...
      "_ZN14nsXPTCStubBase5Stub" #n         \
      "Ev: \n\t"                            \
      ".quad  ._ZN14nsXPTCStubBase5Stub" #n \
      "Ev,.TOC.@tocbase \n\t"               \
      ".previous \n\t"                      \
      ".type  _ZN14nsXPTCStubBase5Stub" #n  \
      "Ev,@function \n\n"                   \
      ...
      "_ZN14nsXPTCStubBase6Stub" #n         \
      "Ev: \n\t"                            \
      ".quad  ._ZN14nsXPTCStubBase6Stub" #n \
      "Ev,.TOC.@tocbase \n\t"               \
      ".previous \n\t"                      \
      ".type  _ZN14nsXPTCStubBase6Stub" #n  \
      "Ev,@function \n\n"                   \
      ...
      "_ZN14nsXPTCStubBase7Stub" #n         \
      "Ev: \n\t"                            \
      ".quad  ._ZN14nsXPTCStubBase7Stub" #n \
      "Ev,.TOC.@tocbase \n\t"               \
      ".previous \n\t"                      \
      ".type  _ZN14nsXPTCStubBase7Stub" #n  \
      "Ev,@function \n\n"                   \
