...
#define STUB_ENTRY(n)                          \
  asm(".section	\".text\"\n\t"                 \
      ...
      "Ev\n\t"                                 \
      ".hidden	_ZN14nsXPTCStubBase5Stub" #n   \
      "Ev\n\t"                                 \
      ...
      "Ev\n\t"                                 \
      ".hidden	_ZN14nsXPTCStubBase6Stub" #n   \
      "Ev\n\t"                                 \
      ...
      "Ev\n\t"                                 \
      ".hidden    _ZN14nsXPTCStubBase7Stub" #n \
      "Ev\n\t"                                 \
      ...
      ".if	" #n                           \
      " < 10\n\t"                              \
      ".size	_ZN14nsXPTCStubBase5Stub" #n   \
      "Ev,.-_ZN14nsXPTCStubBase5Stub" #n       \
      "Ev\n\t"                                 \
      ".elseif	" #n                           \
      " < 100\n\t"                             \
      ".size	_ZN14nsXPTCStubBase6Stub" #n   \
      "Ev,.-_ZN14nsXPTCStubBase6Stub" #n       \
      "Ev\n\t"                                 \
      ".else\n\t"                              \
      ".size	_ZN14nsXPTCStubBase7Stub" #n   \
