...
class NS_NO_VTABLE nsCycleCollectionParticipant
{
 public:
  ...
  static void NoteJSChild(JS::GCCellPtr aGCThing,
                          const char* aName,
                          void* aClosure);
  ...
  NS_IMETHOD_(void) Trace(void* aPtr, const TraceCallbacks& aCb, void* aClosure)
  {
  }
...
#define NS_INTERFACE_MAP_ENTRIES_CYCLE_COLLECTION(_class)                                                               \
  if (TopThreeWordsEquals(                                                                                              \
          ...
          NS_GET_IID(                                                                                                   \
              nsCycleCollectionISupports)) && /* The calls to LowWordEquals here are repeated inside the if branch.   \
...
#define NS_IMPL_QUERY_INTERFACE_CYCLE_COLLECTION_INHERITED(  \
    aClass, aSuper, ...)                                     \
 ...
 */
inline bool
TopThreeWordsEquals(const nsID& aID, const nsID& aOther1, const nsID& aOther2)
{
 ...
 */
inline bool
LowWordEquals(const nsID& aID, const nsID& aOther)
{
