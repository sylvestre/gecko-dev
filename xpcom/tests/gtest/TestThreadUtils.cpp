...
struct TestCopyWithNoMove
{
  ...
  TestCopyWithNoMove(const TestCopyWithNoMove& a) : mCopyCounter(a.mCopyCounter)
  {
    ++mCopyCounter;
  };
...
static void
Expect(const char* aContext, int aCounter, int aMaxExpected)
{
  EXPECT_LE(aCounter, aMaxExpected) << aContext;
}

static void
ExpectRunnableName(Runnable* aRunnable, const char* aExpectedName)
{
  nsAutoCString name;
  EXPECT_TRUE(NS_SUCCEEDED(aRunnable->GetName(name))) << "Runnable::GetName()";
#ifdef RELEASE_OR_BETA
  EXPECT_TRUE(name.IsEmpty())
      << "Runnable name shall be empty in RELEASE or BETA!";
#else
...
static void
TestNewRunnableFunction(bool aNamed)
{
      ...
      nsCOMPtr<nsIRunnable> trackedRunnable;
      {
        ...
        trackedRunnable = aNamed
                              ...
                              : NS_NewRunnableFunction(
                                    "TestNewRunnableFunction", Move(tracker));
      }
      trackedRunnable->Run();
    }
...
static void
TestNewRunnableMethod(bool aNamed)
{
  ...
  // Scope the smart ptrs so that the runnables need to hold on to whatever they need
  {
    ...
    NS_DispatchToMainThread(
        aNamed ? NewRunnableMethod<RefPtr<nsFoo>>(
                     "unused", bar, &nsBar::DoBar3, foo)
               : NewRunnableMethod<RefPtr<nsFoo>>(
                     "nsBar::DoBar3", bar, &nsBar::DoBar3, foo));
    NS_DispatchToMainThread(
        aNamed ? NewRunnableMethod<RefPtr<nsFoo>>(
                     "unused", bar, &nsBar::DoBar4, foo)
               : NewRunnableMethod<RefPtr<nsFoo>>(
    ...
    NS_DispatchToMainThread(
        aNamed ? NewRunnableMethod<RefPtr<nsFoo>>(
                     "unused", bar, &nsBar::DoBar3std, foo)
               : NewRunnableMethod<RefPtr<nsFoo>>(bar, &nsBar::DoBar3std, foo));
    NS_DispatchToMainThread(
        aNamed ? NewRunnableMethod<RefPtr<nsFoo>>(
                     "unused", bar, &nsBar::DoBar4std, foo)
               : NewRunnableMethod<RefPtr<nsFoo>>(bar, &nsBar::DoBar4std, foo));
    NS_DispatchToMainThread(
        aNamed ? NewRunnableMethod<nsFoo*>(
                     "unused", bar, &nsBar::DoBar5std, rawFoo)
               : NewRunnableMethod<nsFoo*>(bar, &nsBar::DoBar5std, rawFoo));
    NS_DispatchToMainThread(
        aNamed ? NewRunnableMethod<char*>(
                     "unused", bar, &nsBar::DoBar6std, message)
  ...
  void Method3()
  {
    ...
    NS_IdleDispatchToCurrentThread(
        NewIdleRunnableMethodWithTimer(
            "IdleObject::Method5", this, &IdleObject::Method5),
        50);
    NS_IdleDispatchToCurrentThread(
...
TEST(ThreadUtils, TypeTraits)
{
  ...
  static_assert(
      mozilla::IsSame<
          int,
          mozilla::RemoveSmartPointer<const RefPtr<int>>::Type>::value,
      "RemoveSmartPointer<const RefPtr<int>>::Type should be int");
  static_assert(
      mozilla::IsSame<
          int,
          mozilla::RemoveSmartPointer<volatile RefPtr<int>>::Type>::value,
      "RemoveSmartPointer<volatile RefPtr<int>>::Type should be int");
  static_assert(
      mozilla::IsSame<
          int,
          mozilla::RemoveSmartPointer<const volatile RefPtr<int>>::Type>::value,
  ...
  static_assert(
      mozilla::IsSame<
          int,
          mozilla::RemoveSmartPointer<const nsCOMPtr<int>>::Type>::value,
      "RemoveSmartPointer<const nsCOMPtr<int>>::Type should be int");
  static_assert(
      mozilla::IsSame<
          int,
          mozilla::RemoveSmartPointer<volatile nsCOMPtr<int>>::Type>::value,
  ...
  static_assert(
      mozilla::IsSame<
          UniquePtr<int>,
          mozilla::RemoveRawOrSmartPointer<UniquePtr<int>>::Type>::value,
  ...
  static_assert(
      mozilla::IsSame<
          const int,
          mozilla::RemoveRawOrSmartPointer<const int*>::Type>::value,
      "RemoveRawOrSmartPointer<const int*>::Type should be const int");
  static_assert(
      mozilla::IsSame<
          volatile int,
          mozilla::RemoveRawOrSmartPointer<volatile int*>::Type>::value,
  ...
  static_assert(mozilla::IsSame<
                    int,
                    mozilla::RemoveRawOrSmartPointer<RefPtr<int>>::Type>::value,
                "RemoveRawOrSmartPointer<RefPtr<int>>::Type should be int");
  static_assert(
      mozilla::IsSame<
          int,
          mozilla::RemoveRawOrSmartPointer<const RefPtr<int>>::Type>::value,
      "RemoveRawOrSmartPointer<const RefPtr<int>>::Type should be int");
  static_assert(
      mozilla::IsSame<
          int,
          mozilla::RemoveRawOrSmartPointer<volatile RefPtr<int>>::Type>::value,
      "RemoveRawOrSmartPointer<volatile RefPtr<int>>::Type should be int");
  static_assert(mozilla::IsSame<int,
                                mozilla::RemoveRawOrSmartPointer<
                                    const volatile RefPtr<int>>::Type>::value,
                "RemoveRawOrSmartPointer<const volatile RefPtr<int>>::Type "
                "should be int");
  static_assert(
      mozilla::IsSame<
          int,
          mozilla::RemoveRawOrSmartPointer<nsCOMPtr<int>>::Type>::value,
      "RemoveRawOrSmartPointer<nsCOMPtr<int>>::Type should be int");
  static_assert(
      mozilla::IsSame<
          int,
          mozilla::RemoveRawOrSmartPointer<const nsCOMPtr<int>>::Type>::value,
  ...
  static_assert(mozilla::IsSame<int,
                                mozilla::RemoveRawOrSmartPointer<
                                    const volatile nsCOMPtr<int>>::Type>::value,
                "RemoveRawOrSmartPointer<const volatile nsCOMPtr<int>>::Type "
                "should be int");
}
...
TEST(ThreadUtils, main)
{
  ...
  }
  {
    ...
    nsCOMPtr<nsIRunnable> r9 = NewRunnableMethod<Spy&>(
        "TestThreadUtils::ThreadUtilsObject::TestByLRef",
        rpt,
