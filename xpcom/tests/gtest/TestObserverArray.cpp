...
TEST(ObserverArray, Tests)
{
  ...
  DO_TEST(
      ForwardIterator, test2Expected, if (count == 1) arr.AppendElement(2););
  DO_TEST(ForwardIterator, test2Expected, {/* nothing */});

  DO_TEST(
      EndLimitedIterator, test2Expected, if (count == 1) arr.AppendElement(5););
  ...
  // Removals
  DO_TEST(
      ForwardIterator, test5Expected, if (count == 1) arr.RemoveElementAt(0););
  ...
  DO_TEST(
      ForwardIterator, test8Expected, if (count == 1) arr.RemoveElementAt(1););
  ...
  DO_TEST(
      ForwardIterator, test12Expected, if (count == 1) arr.RemoveElementAt(2););
  ...
  DO_TEST(ForwardIterator, test19Expected, if (count == 1) {
  ...
  DO_TEST(BackwardIterator,
          test24Expected,
          if (count == 1) arr.RemoveElementAt(1););

  // Appends
  DO_TEST(
      BackwardIterator, test24Expected, if (count == 1) arr.AppendElement(1););
