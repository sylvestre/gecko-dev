...
int WINAPI
WinMain(HINSTANCE inst, HINSTANCE prevInstance, LPSTR lpszCmdLine, int nShowCmd)
{
  ...
  {  //  Needed to scope all nsCOMPtr within XPCOM Init and Shutdown
    ...
    if (NS_FAILED(
            nativeAppService->CreateEventLoop(L"_MainLoop",
                                              nsEventLoopTypes::MainAppLoop,
