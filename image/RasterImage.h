...
#endif
{
 ...
 private:
  ...
  Pair<DrawResult, RefPtr<gfx::SourceSurface>> GetFrameInternal(
      const gfx::IntSize& aSize, uint32_t aWhichFrame, uint32_t aFlags);

  Pair<DrawResult, RefPtr<layers::Image>> GetCurrentImage(
