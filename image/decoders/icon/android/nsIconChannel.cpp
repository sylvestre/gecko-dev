...
static nsresult
GetIconForExtension(const nsACString& aFileExt,
                    uint32_t aIconSize,
                    uint8_t* const aBuf)
{
...
static nsresult
CallRemoteGetIconForExtension(const nsACString& aFileExt,
                              uint32_t aIconSize,
                              uint8_t* const aBuf)
{
...
static nsresult
moz_icon_to_channel(nsIURI* aURI,
...
nsIconChannel::Init(nsIURI* aURI)
{
  ...
  return moz_icon_to_channel(
      iconURI, iconFileExt, desiredImageSize, getter_AddRefs(mRealChannel));
}
