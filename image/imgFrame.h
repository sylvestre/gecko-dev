...
{
  AnimationData(uint8_t* aRawData,
...
class RawAccessFrameRef final
{
 public:
  ...
  RawAccessFrameRef(RawAccessFrameRef&& aOther) : mFrame(aOther.mFrame.forget())
  {
  }
...
void
MarkSurfaceShared(gfx::SourceSurface* aSurface);
