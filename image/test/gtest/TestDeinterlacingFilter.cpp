                        ...
                        Func aFunc)
{
  ...
  WithFilterPipeline(
      ...
      SurfaceConfig{decoder, 0, aSize, SurfaceFormat::B8G8R8A8, false});
}

template<typename Func>
void
WithPalettedDeinterlacingFilter(const IntSize& aSize, Func aFunc)
{
  RefPtr<Decoder> decoder = CreateTrivialDecoder();
...
{
  WithDeinterlacingFilter(IntSize(99, 99),
                          /* aProgressiveDisplay = */ true,
                          [](Decoder* aDecoder, SurfaceFilter* aFilter) {
                            CheckWritePixels(
                                aDecoder,
...
{
  WithDeinterlacingFilter(IntSize(8, 8),
                          /* aProgressiveDisplay = */ true,
                          [](Decoder* aDecoder, SurfaceFilter* aFilter) {
                            CheckWritePixels(
                                aDecoder,
...
{
  WithDeinterlacingFilter(IntSize(7, 7),
                          /* aProgressiveDisplay = */ true,
                          [](Decoder* aDecoder, SurfaceFilter* aFilter) {
                            CheckWritePixels(
                                aDecoder,
...
{
  WithDeinterlacingFilter(IntSize(3, 3),
                          /* aProgressiveDisplay = */ true,
                          [](Decoder* aDecoder, SurfaceFilter* aFilter) {
                            CheckWritePixels(
                                aDecoder,
...
{
  WithDeinterlacingFilter(IntSize(1, 1),
                          /* aProgressiveDisplay = */ true,
                          [](Decoder* aDecoder, SurfaceFilter* aFilter) {
                            CheckWritePixels(
                                aDecoder,
  ...
  WithDeinterlacingFilter(
      ...
      [](Decoder* aDecoder, SurfaceFilter* aFilter) {
        ...
        AssertCorrectPipelineFinalState(
            aFilter, IntRect(0, 0, 51, 52), IntRect(0, 0, 51, 52));
...
TEST_F(ImageDeinterlacingFilter, WritePixelsOutput20_20)
{
  WithDeinterlacingFilter(
      ...
      [](Decoder* aDecoder, SurfaceFilter* aFilter) {
        ...
        AssertCorrectPipelineFinalState(
            aFilter, IntRect(0, 0, 20, 20), IntRect(0, 0, 20, 20));
...
TEST_F(ImageDeinterlacingFilter, WritePixelsOutput7_7)
{
  WithDeinterlacingFilter(
      ...
      [](Decoder* aDecoder, SurfaceFilter* aFilter) {
        ...
        AssertCorrectPipelineFinalState(
            aFilter, IntRect(0, 0, 7, 7), IntRect(0, 0, 7, 7));
...
TEST_F(ImageDeinterlacingFilter, WritePixelsOutput3_3)
{
  WithDeinterlacingFilter(
      ...
      [](Decoder* aDecoder, SurfaceFilter* aFilter) {
        ...
        AssertCorrectPipelineFinalState(
            aFilter, IntRect(0, 0, 3, 3), IntRect(0, 0, 3, 3));
...
TEST_F(ImageDeinterlacingFilter, WritePixelsOutput1_1)
{
  WithDeinterlacingFilter(
      ...
      [](Decoder* aDecoder, SurfaceFilter* aFilter) {
        ...
        AssertCorrectPipelineFinalState(
            aFilter, IntRect(0, 0, 1, 1), IntRect(0, 0, 1, 1));
...
TEST_F(ImageDeinterlacingFilter, WritePixelsIntermediateOutput7_7)
{
  WithDeinterlacingFilter(
      ...
      [](Decoder* aDecoder, SurfaceFilter* aFilter) {
        ...
        WriteRowAndCheckInterlacerOutput(aDecoder,
                                         aFilter,
                                         BGRAColor::Green(),
