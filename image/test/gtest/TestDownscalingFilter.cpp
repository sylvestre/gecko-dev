                      ...
                      Func aFunc)
{
  ...
  WithFilterPipeline(
      ...
      SurfaceConfig{decoder, 0, aOutputSize, SurfaceFormat::B8G8R8A8, false});
}
...
{
  WithDownscalingFilter(IntSize(100, 100),
                        IntSize(99, 99),
  ...
  WithDownscalingFilter(
      ...
      [](Decoder* aDecoder, SurfaceFilter* aFilter) {
        ...
        AssertCorrectPipelineFinalState(
            aFilter, IntRect(0, 0, 100, 100), IntRect(0, 0, 20, 20));
        ...
        EXPECT_TRUE(RowsAreSolidColor(
            surface, 0, 4, BGRAColor::Green(), /* aFuzz = */ 2));
        EXPECT_TRUE(RowsAreSolidColor(
            surface, 6, 3, BGRAColor::Red(), /* aFuzz = */ 3));
        EXPECT_TRUE(RowsAreSolidColor(
            surface, 11, 3, BGRAColor::Green(), /* aFuzz = */ 3));
        EXPECT_TRUE(RowsAreSolidColor(
            surface, 16, 4, BGRAColor::Red(), /* aFuzz = */ 3));
      });
}
...
TEST(ImageDownscalingFilter, WritePixelsOutput100_100to10_20)
{
  WithDownscalingFilter(
      ...
      [](Decoder* aDecoder, SurfaceFilter* aFilter) {
        ...
        AssertCorrectPipelineFinalState(
            aFilter, IntRect(0, 0, 100, 100), IntRect(0, 0, 10, 20));
