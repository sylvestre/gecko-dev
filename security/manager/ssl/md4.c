...
static void
w2b(uint8_t* out, const uint32_t* in, uint32_t len)
{
  uint8_t* bp;
...
static void
b2w(uint32_t* out, const uint8_t* in, uint32_t len)
{
  uint32_t* wp;
...
static void
md4step(uint32_t state[4], const uint8_t* data)
{
...
void
md4sum(const uint8_t* input, uint32_t inputLen, uint8_t* result)
{
  uint8_t final[128];
