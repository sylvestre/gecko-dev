...
static const mozilla::Module::CIDEntry kNSSCIDs[] = {
    ...
    {&kNS_CERTOVERRIDE_CID,
     false,
     nullptr,
     Constructor<nsCertOverrideService,
    ...
    {&kTRANSPORTSECURITYINFO_CID,
     false,
     nullptr,
     Constructor<TransportSecurityInfo,
                 nullptr,
    ...
    {&kNS_SITE_SECURITY_SERVICE_CID,
     false,
     nullptr,
     Constructor<nsSiteSecurityService,
...
static const mozilla::Module kNSSModule = {
    mozilla::Module::kVersion, kNSSCIDs, kNSSContracts, kNSSCategories};
