...
void
CopyString(unsigned char (&dest)[DestSize], const char (&src)[SrcSize])
{
...
CK_RV
Test_C_GetSlotList(CK_BBOOL limitToTokensPresent,
...
CK_RV
Test_C_GetMechanismList(CK_SLOT_ID,
...
CK_RV Test_C_GetMechanismInfo(CK_SLOT_ID,
                              CK_MECHANISM_TYPE,
...
CK_RV
Test_C_OpenSession(CK_SLOT_ID slotID,
                   CK_FLAGS,
                   CK_VOID_PTR,
                   CK_NOTIFY,
...
CK_RV Test_C_SetOperationState(CK_SESSION_HANDLE,
                               CK_BYTE_PTR,
                               CK_ULONG,
                               CK_OBJECT_HANDLE,
                               CK_OBJECT_HANDLE)
...
CK_RV Test_C_CreateObject(CK_SESSION_HANDLE,
                          CK_ATTRIBUTE_PTR,
                          CK_ULONG,
...
CK_RV Test_C_CopyObject(CK_SESSION_HANDLE,
                        CK_OBJECT_HANDLE,
                        CK_ATTRIBUTE_PTR,
                        CK_ULONG,
                        CK_OBJECT_HANDLE_PTR)
...
CK_RV Test_C_GetAttributeValue(CK_SESSION_HANDLE,
                               CK_OBJECT_HANDLE,
                               CK_ATTRIBUTE_PTR,
                               CK_ULONG)
{
...
CK_RV Test_C_SetAttributeValue(CK_SESSION_HANDLE,
                               CK_OBJECT_HANDLE,
                               CK_ATTRIBUTE_PTR,
                               CK_ULONG)
{
...
CK_RV
Test_C_FindObjects(CK_SESSION_HANDLE,
                   CK_OBJECT_HANDLE_PTR,
                   CK_ULONG,
...
CK_RV Test_C_Decrypt(
    CK_SESSION_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG_PTR)
{
  return CKR_FUNCTION_NOT_SUPPORTED;
}

CK_RV Test_C_DecryptUpdate(
    CK_SESSION_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG_PTR)
{
  return CKR_FUNCTION_NOT_SUPPORTED;
}
...
CK_RV Test_C_SignRecoverInit(CK_SESSION_HANDLE,
                             CK_MECHANISM_PTR,
                             CK_OBJECT_HANDLE)
{
  return CKR_FUNCTION_NOT_SUPPORTED;
...
CK_RV Test_C_VerifyRecoverInit(CK_SESSION_HANDLE,
                               CK_MECHANISM_PTR,
                               CK_OBJECT_HANDLE)
{
  return CKR_FUNCTION_NOT_SUPPORTED;
...
CK_RV Test_C_VerifyRecover(
    CK_SESSION_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG_PTR)
{
  return CKR_FUNCTION_NOT_SUPPORTED;
}

CK_RV Test_C_DigestEncryptUpdate(
    CK_SESSION_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG_PTR)
{
  return CKR_FUNCTION_NOT_SUPPORTED;
}

CK_RV Test_C_DecryptDigestUpdate(
    CK_SESSION_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG_PTR)
{
  return CKR_FUNCTION_NOT_SUPPORTED;
}

CK_RV Test_C_SignEncryptUpdate(
    CK_SESSION_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG_PTR)
{
  return CKR_FUNCTION_NOT_SUPPORTED;
}

CK_RV Test_C_DecryptVerifyUpdate(
    CK_SESSION_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG_PTR)
{
  return CKR_FUNCTION_NOT_SUPPORTED;
}

CK_RV Test_C_GenerateKey(CK_SESSION_HANDLE,
                         CK_MECHANISM_PTR,
                         CK_ATTRIBUTE_PTR,
                         CK_ULONG,
                         CK_OBJECT_HANDLE_PTR)
...
CK_RV Test_C_GenerateKeyPair(CK_SESSION_HANDLE,
                             CK_MECHANISM_PTR,
                             CK_ATTRIBUTE_PTR,
                             CK_ULONG,
                             CK_ATTRIBUTE_PTR,
...
CK_RV Test_C_WrapKey(CK_SESSION_HANDLE,
                     CK_MECHANISM_PTR,
                     CK_OBJECT_HANDLE,
                     CK_OBJECT_HANDLE,
                     CK_BYTE_PTR,
...
CK_RV Test_C_UnwrapKey(CK_SESSION_HANDLE,
                       CK_MECHANISM_PTR,
                       CK_OBJECT_HANDLE,
                       CK_BYTE_PTR,
                       CK_ULONG,
...
CK_RV Test_C_DeriveKey(CK_SESSION_HANDLE,
                       CK_MECHANISM_PTR,
                       CK_OBJECT_HANDLE,
                       CK_ATTRIBUTE_PTR,
                       CK_ULONG,
...
CK_RV
Test_C_WaitForSlotEvent(CK_FLAGS, CK_SLOT_ID_PTR pSlot, CK_VOID_PTR)
{
#ifdef WIN32
