...
static void
nsProtectedAuthThreadRunner(void* arg)
{
...
NS_IMETHODIMP
nsProtectedAuthThread::Login(nsIObserver* aObserver)
{
  ...
  mThreadHandle = PR_CreateThread(PR_USER_THREAD,
...
NS_IMETHODIMP
nsProtectedAuthThread::GetTokenName(nsAString& _retval)
{
  MutexAutoLock lock(mMutex);
...
NS_IMETHODIMP
nsProtectedAuthThread::GetSlot(nsIPKCS11Slot** _retval)
{
...
SECStatus
nsProtectedAuthThread::GetResult()
{
  return mLoginResult;
}

void
nsProtectedAuthThread::Run(void)
{
