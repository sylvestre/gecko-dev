...
Result
DoOCSPRequest(const UniquePLArenaPool& arena,
              const char* url,
              ...
              /*out*/ SECItem*& encodedResponse)
{
  ...
  uint32_t pathPos;
  int32_t pathLen;
  nsresult nsrv = urlParser->ParseURL(url,
                                      static_cast<int32_t>(urlLen),
                                      &schemePos,
                                      &schemeLen,
                                      &authorityPos,
                                      &authorityLen,
  ...
  nsrv = urlParser->ParseAuthority(url + authorityPos,
                                   authorityLen,
                                   nullptr,
                                   nullptr,
                                   nullptr,
  ...
  rv = nsNSSHttpInterface::createFcn(serverSession.get(),
                                     "http",
                                     path.get(),
                                     method.get(),
                                     originAttributes,
  ...
  rv = nsNSSHttpInterface::trySendAndReceiveFcn(requestSession.get(),
                                                nullptr,
                                                &httpResponseCode,
                                                nullptr,
                                                &httpResponseData,
