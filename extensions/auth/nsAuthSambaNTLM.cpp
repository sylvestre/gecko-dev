...
static bool
SpawnIOChild(char* const* aArgs,
             PRProcess** aPID,
             PRFileDesc** aFromChildFD,
             PRFileDesc** aToChildFD)
{
...
static bool
WriteString(PRFileDesc* aFD, const nsACString& aString)
{
...
static bool
ReadLine(PRFileDesc* aFD, nsACString& aString)
{
 ...
 */
static uint8_t*
ExtractMessage(const nsACString& aLine, uint32_t* aLen)
{
...
nsAuthSambaNTLM::SpawnNTLMAuthHelper()
{
  ...
  bool isOK = SpawnIOChild(
      const_cast<char* const*>(args), &mChildPID, &mFromChildFD, &mToChildFD);
