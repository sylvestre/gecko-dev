...
//
class GetNextTokenCompleteEvent final : public nsIRunnable, public nsICancelable
{
 ...
 public:
  ...
  NS_IMETHODIMP Run() override
  {
    ...
    if (!mCancelled) {
      ...
      callback->OnCredsGenerated(
          mCreds, mFlags, mResult, mSessionState, mContinuationState);
    }
    return NS_OK;
  }
...
class GetNextTokenRunnable final : public mozilla::Runnable
{
 ...
 public:
  ...
  NS_IMETHODIMP Run() override
  {
    ...
    return mCompleteEvent->DispatchSuccess(
        creds, flags, mSessionState.forget(), mContinuationState.forget());
  }
